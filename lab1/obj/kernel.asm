...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200486:	0141                	addi	sp,sp,16
                    sbi_shutdown();
    80200488:	5920006f          	j	80200a1a <sbi_shutdown>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    8020062c:	be078793          	addi	a5,a5,-1056 # 80201208 <error_string+0x38>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200680:	9f8a0a13          	addi	s4,s4,-1544 # 80201074 <etext+0x606>
    ...
    8020068c:	b48c0c13          	addi	s8,s8,-1208 # 802011d0 <error_string>
    ...
    8020077a:	b4260613          	addi	a2,a2,-1214 # 802012b8 <error_string+0xe8>
    ...
    8020090e:	99e60613          	addi	a2,a2,-1634 # 802012a8 <error_string+0xd8>
    ...
    80200920:	98460613          	addi	a2,a2,-1660 # 802012a0 <error_string+0xd0>
            if (width > 0 && padc != '-') {
    80200924:	00001417          	auipc	s0,0x1
    80200928:	97d40413          	addi	s0,s0,-1667 # 802012a1 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
    ...
    802009b4:	8f140413          	addi	s0,s0,-1807 # 802012a1 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
