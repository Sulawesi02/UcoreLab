...
int kern_init(void) {
    ...
    memset(edata, 0, end - edata);
    80200022:	4c8000ef          	jal	ra,802004ea <memset>
...
int cprintf(const char *fmt, ...) {
    ...
    vprintfmt((void *)cputch, &cnt, fmt, ap);
    80200094:	4d4000ef          	jal	ra,80200568 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
void print_kerninfo(void) {
    ...
    802000dc:	f3058593          	addi	a1,a1,-208 # 80204008 <SBI_SET_TIMER>
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200146:	7be000ef          	jal	ra,80200904 <sbi_set_timer>
}
...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    80200166:	7840006f          	j	802008ea <sbi_console_putchar>
...
strnlen(const char *s, size_t len) {
    802004ce:	872a                	mv	a4,a0
    size_t cnt = 0;
    802004d0:	4501                	li	a0,0
    while (cnt < len && *s ++ != '\0') {
    802004d2:	e589                	bnez	a1,802004dc <strnlen+0xe>
    802004d4:	a811                	j	802004e8 <strnlen+0x1a>
        cnt ++;
    802004d6:	0505                	addi	a0,a0,1
    while (cnt < len && *s ++ != '\0') {
    802004d8:	00a58763          	beq	a1,a0,802004e6 <strnlen+0x18>
    802004dc:	00a707b3          	add	a5,a4,a0
    802004e0:	0007c783          	lbu	a5,0(a5)
    802004e4:	fbed                	bnez	a5,802004d6 <strnlen+0x8>
    }
    return cnt;
}
    802004e6:	8082                	ret
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
    802004ea:	ca01                	beqz	a2,802004fa <memset+0x10>
    802004ec:	962a                	add	a2,a2,a0
    char *p = s;
    802004ee:	87aa                	mv	a5,a0
        *p ++ = c;
    802004f0:	0785                	addi	a5,a5,1
    802004f2:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
    802004f6:	fec79de3          	bne	a5,a2,802004f0 <memset+0x6>
    }
    return s;
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802004fc:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
    80200500:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
    80200502:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
    80200506:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
    80200508:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
    8020050c:	f022                	sd	s0,32(sp)
    8020050e:	ec26                	sd	s1,24(sp)
    80200510:	e84a                	sd	s2,16(sp)
    80200512:	f406                	sd	ra,40(sp)
    80200514:	e44e                	sd	s3,8(sp)
    80200516:	84aa                	mv	s1,a0
    80200518:	892e                	mv	s2,a1
    8020051a:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
    8020051e:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
    80200520:	03067e63          	bgeu	a2,a6,8020055c <printnum+0x60>
    80200524:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
    80200526:	00805763          	blez	s0,80200534 <printnum+0x38>
    8020052a:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
    8020052c:	85ca                	mv	a1,s2
    8020052e:	854e                	mv	a0,s3
    80200530:	9482                	jalr	s1
        while (-- width > 0)
    80200532:	fc65                	bnez	s0,8020052a <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
    80200534:	1a02                	slli	s4,s4,0x20
    80200536:	020a5a13          	srli	s4,s4,0x20
    8020053a:	00001797          	auipc	a5,0x1
    8020053e:	94678793          	addi	a5,a5,-1722 # 80200e80 <etext+0x562>
}
    80200542:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
    80200544:	9a3e                	add	s4,s4,a5
    80200546:	000a4503          	lbu	a0,0(s4)
}
    8020054a:	70a2                	ld	ra,40(sp)
    8020054c:	69a2                	ld	s3,8(sp)
    8020054e:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
    80200550:	85ca                	mv	a1,s2
    80200552:	8326                	mv	t1,s1
}
    80200554:	6942                	ld	s2,16(sp)
    80200556:	64e2                	ld	s1,24(sp)
    80200558:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
    8020055a:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
    8020055c:	03065633          	divu	a2,a2,a6
    80200560:	8722                	mv	a4,s0
    80200562:	f9bff0ef          	jal	ra,802004fc <printnum>
    80200566:	b7f9                	j	80200534 <printnum+0x38>

0000000080200568 <vprintfmt>:
 *
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    80200568:	7119                	addi	sp,sp,-128
    8020056a:	f4a6                	sd	s1,104(sp)
    8020056c:	f0ca                	sd	s2,96(sp)
    8020056e:	ecce                	sd	s3,88(sp)
    80200570:	e8d2                	sd	s4,80(sp)
    80200572:	e4d6                	sd	s5,72(sp)
    80200574:	e0da                	sd	s6,64(sp)
    80200576:	fc5e                	sd	s7,56(sp)
    80200578:	f06a                	sd	s10,32(sp)
    8020057a:	fc86                	sd	ra,120(sp)
    8020057c:	f8a2                	sd	s0,112(sp)
    8020057e:	f862                	sd	s8,48(sp)
    80200580:	f466                	sd	s9,40(sp)
    80200582:	ec6e                	sd	s11,24(sp)
    80200584:	892a                	mv	s2,a0
    80200586:	84ae                	mv	s1,a1
    80200588:	8d32                	mv	s10,a2
    8020058a:	8a36                	mv	s4,a3
    register int ch, err;
    ...
    8020058c:	02500993          	li	s3,37
        ...
        char padc = ' ';
        width = precision = -1;
    80200590:	5b7d                	li	s6,-1
    80200592:	00001a97          	auipc	s5,0x1
    80200596:	922a8a93          	addi	s5,s5,-1758 # 80200eb4 <etext+0x596>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    8020059a:	00001b97          	auipc	s7,0x1
    8020059e:	af6b8b93          	addi	s7,s7,-1290 # 80201090 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    802005a2:	000d4503          	lbu	a0,0(s10)
    802005a6:	001d0413          	addi	s0,s10,1
    802005aa:	01350a63          	beq	a0,s3,802005be <vprintfmt+0x56>
            if (ch == '\0') {
    802005ae:	c121                	beqz	a0,802005ee <vprintfmt+0x86>
            putch(ch, putdat);
    802005b0:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    802005b2:	0405                	addi	s0,s0,1
            putch(ch, putdat);
    802005b4:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    802005b6:	fff44503          	lbu	a0,-1(s0)
    802005ba:	ff351ae3          	bne	a0,s3,802005ae <vprintfmt+0x46>
    802005be:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
    802005c2:	02000793          	li	a5,32
        lflag = altflag = 0;
    802005c6:	4c81                	li	s9,0
    802005c8:	4881                	li	a7,0
        width = precision = -1;
    802005ca:	5c7d                	li	s8,-1
    802005cc:	5dfd                	li	s11,-1
    802005ce:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
    802005d2:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
    802005d4:	fdd6059b          	addiw	a1,a2,-35
    802005d8:	0ff5f593          	andi	a1,a1,255
    802005dc:	00140d13          	addi	s10,s0,1
    802005e0:	04b56263          	bltu	a0,a1,80200624 <vprintfmt+0xbc>
    802005e4:	058a                	slli	a1,a1,0x2
    802005e6:	95d6                	add	a1,a1,s5
    802005e8:	4194                	lw	a3,0(a1)
    802005ea:	96d6                	add	a3,a3,s5
    802005ec:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
    ...
    802005ee:	70e6                	ld	ra,120(sp)
    802005f0:	7446                	ld	s0,112(sp)
    802005f2:	74a6                	ld	s1,104(sp)
    802005f4:	7906                	ld	s2,96(sp)
    802005f6:	69e6                	ld	s3,88(sp)
    802005f8:	6a46                	ld	s4,80(sp)
    802005fa:	6aa6                	ld	s5,72(sp)
    802005fc:	6b06                	ld	s6,64(sp)
    802005fe:	7be2                	ld	s7,56(sp)
    80200600:	7c42                	ld	s8,48(sp)
    80200602:	7ca2                	ld	s9,40(sp)
    80200604:	7d02                	ld	s10,32(sp)
    80200606:	6de2                	ld	s11,24(sp)
    80200608:	6109                	addi	sp,sp,128
    8020060a:	8082                	ret
            padc = '0';
    8020060c:	87b2                	mv	a5,a2
            goto reswitch;
    8020060e:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
    80200612:	846a                	mv	s0,s10
    80200614:	00140d13          	addi	s10,s0,1
    80200618:	fdd6059b          	addiw	a1,a2,-35
    8020061c:	0ff5f593          	andi	a1,a1,255
    80200620:	fcb572e3          	bgeu	a0,a1,802005e4 <vprintfmt+0x7c>
            putch('%', putdat);
    80200624:	85a6                	mv	a1,s1
    80200626:	02500513          	li	a0,37
    8020062a:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
    8020062c:	fff44783          	lbu	a5,-1(s0)
    80200630:	8d22                	mv	s10,s0
    80200632:	f73788e3          	beq	a5,s3,802005a2 <vprintfmt+0x3a>
    80200636:	ffed4783          	lbu	a5,-2(s10)
    8020063a:	1d7d                	addi	s10,s10,-1
    8020063c:	ff379de3          	bne	a5,s3,80200636 <vprintfmt+0xce>
    80200640:	b78d                	j	802005a2 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
    80200642:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
    80200646:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
    8020064a:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
    8020064c:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
    80200650:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
    80200654:	02d86463          	bltu	a6,a3,8020067c <vprintfmt+0x114>
                ch = *fmt;
    80200658:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
    8020065c:	002c169b          	slliw	a3,s8,0x2
    80200660:	0186873b          	addw	a4,a3,s8
    80200664:	0017171b          	slliw	a4,a4,0x1
    80200668:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
    8020066a:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
    8020066e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
    80200670:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
    80200674:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
    80200678:	fed870e3          	bgeu	a6,a3,80200658 <vprintfmt+0xf0>
            if (width < 0)
    8020067c:	f40ddce3          	bgez	s11,802005d4 <vprintfmt+0x6c>
                width = precision, precision = -1;
    80200680:	8de2                	mv	s11,s8
    80200682:	5c7d                	li	s8,-1
    80200684:	bf81                	j	802005d4 <vprintfmt+0x6c>
            if (width < 0)
    80200686:	fffdc693          	not	a3,s11
    8020068a:	96fd                	srai	a3,a3,0x3f
    8020068c:	00ddfdb3          	and	s11,s11,a3
    80200690:	00144603          	lbu	a2,1(s0)
    80200694:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
    80200696:	846a                	mv	s0,s10
            goto reswitch;
    80200698:	bf35                	j	802005d4 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
    8020069a:	000a2c03          	lw	s8,0(s4)
            goto process_precision;
    8020069e:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
    802006a2:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
    802006a4:	846a                	mv	s0,s10
            goto process_precision;
    802006a6:	bfd9                	j	8020067c <vprintfmt+0x114>
    if (lflag >= 2) {
    802006a8:	4705                	li	a4,1
    802006aa:	008a0593          	addi	a1,s4,8
    802006ae:	01174463          	blt	a4,a7,802006b6 <vprintfmt+0x14e>
    else if (lflag) {
    802006b2:	1a088e63          	beqz	a7,8020086e <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
    802006b6:	000a3603          	ld	a2,0(s4)
    802006ba:	46c1                	li	a3,16
    802006bc:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
    802006be:	2781                	sext.w	a5,a5
    802006c0:	876e                	mv	a4,s11
    802006c2:	85a6                	mv	a1,s1
    802006c4:	854a                	mv	a0,s2
    802006c6:	e37ff0ef          	jal	ra,802004fc <printnum>
            break;
    802006ca:	bde1                	j	802005a2 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
    802006cc:	000a2503          	lw	a0,0(s4)
    802006d0:	85a6                	mv	a1,s1
    802006d2:	0a21                	addi	s4,s4,8
    802006d4:	9902                	jalr	s2
            break;
    802006d6:	b5f1                	j	802005a2 <vprintfmt+0x3a>
    if (lflag >= 2) {
    802006d8:	4705                	li	a4,1
    802006da:	008a0593          	addi	a1,s4,8
    802006de:	01174463          	blt	a4,a7,802006e6 <vprintfmt+0x17e>
    else if (lflag) {
    802006e2:	18088163          	beqz	a7,80200864 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
    802006e6:	000a3603          	ld	a2,0(s4)
    802006ea:	46a9                	li	a3,10
    802006ec:	8a2e                	mv	s4,a1
    802006ee:	bfc1                	j	802006be <vprintfmt+0x156>
            goto reswitch;
    802006f0:	00144603          	lbu	a2,1(s0)
            altflag = 1;
    802006f4:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
    802006f6:	846a                	mv	s0,s10
            goto reswitch;
    802006f8:	bdf1                	j	802005d4 <vprintfmt+0x6c>
            putch(ch, putdat);
    802006fa:	85a6                	mv	a1,s1
    802006fc:	02500513          	li	a0,37
    80200700:	9902                	jalr	s2
            break;
    80200702:	b545                	j	802005a2 <vprintfmt+0x3a>
            lflag ++;
    80200704:	00144603          	lbu	a2,1(s0)
    80200708:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
    8020070a:	846a                	mv	s0,s10
            goto reswitch;
    8020070c:	b5e1                	j	802005d4 <vprintfmt+0x6c>
    if (lflag >= 2) {
    8020070e:	4705                	li	a4,1
    80200710:	008a0593          	addi	a1,s4,8
    80200714:	01174463          	blt	a4,a7,8020071c <vprintfmt+0x1b4>
    else if (lflag) {
    80200718:	14088163          	beqz	a7,8020085a <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
    8020071c:	000a3603          	ld	a2,0(s4)
    80200720:	46a1                	li	a3,8
    80200722:	8a2e                	mv	s4,a1
    80200724:	bf69                	j	802006be <vprintfmt+0x156>
            putch('0', putdat);
    ...
    8020073c:	46c1                	li	a3,16
            num = (unsigned long long)va_arg(ap, void *);
    8020073e:	ff8a3603          	ld	a2,-8(s4)
            goto number;
    80200742:	bfb5                	j	802006be <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
    80200744:	000a3403          	ld	s0,0(s4)
    80200748:	008a0713          	addi	a4,s4,8
    8020074c:	e03a                	sd	a4,0(sp)
    8020074e:	14040263          	beqz	s0,80200892 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
    80200752:	0fb05763          	blez	s11,80200840 <vprintfmt+0x2d8>
    80200756:	02d00693          	li	a3,45
    8020075a:	0cd79163          	bne	a5,a3,8020081c <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    8020075e:	00044783          	lbu	a5,0(s0)
    80200762:	0007851b          	sext.w	a0,a5
    80200766:	cf85                	beqz	a5,8020079e <vprintfmt+0x236>
    80200768:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
    8020076c:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    80200770:	000c4563          	bltz	s8,8020077a <vprintfmt+0x212>
    80200774:	3c7d                	addiw	s8,s8,-1
    80200776:	036c0263          	beq	s8,s6,8020079a <vprintfmt+0x232>
                    putch('?', putdat);
    8020077a:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
    8020077c:	0e0c8e63          	beqz	s9,80200878 <vprintfmt+0x310>
    80200780:	3781                	addiw	a5,a5,-32
    80200782:	0ef47b63          	bgeu	s0,a5,80200878 <vprintfmt+0x310>
                    putch('?', putdat);
    80200786:	03f00513          	li	a0,63
    8020078a:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    8020078c:	000a4783          	lbu	a5,0(s4)
    80200790:	3dfd                	addiw	s11,s11,-1
    80200792:	0a05                	addi	s4,s4,1
    80200794:	0007851b          	sext.w	a0,a5
    80200798:	ffe1                	bnez	a5,80200770 <vprintfmt+0x208>
            for (; width > 0; width --) {
    8020079a:	01b05963          	blez	s11,802007ac <vprintfmt+0x244>
    8020079e:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
    802007a0:	85a6                	mv	a1,s1
    802007a2:	02000513          	li	a0,32
    802007a6:	9902                	jalr	s2
            for (; width > 0; width --) {
    802007a8:	fe0d9be3          	bnez	s11,8020079e <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
    802007ac:	6a02                	ld	s4,0(sp)
    802007ae:	bbd5                	j	802005a2 <vprintfmt+0x3a>
    if (lflag >= 2) {
    802007b0:	4705                	li	a4,1
    802007b2:	008a0c93          	addi	s9,s4,8
    802007b6:	01174463          	blt	a4,a7,802007be <vprintfmt+0x256>
    else if (lflag) {
    802007ba:	08088d63          	beqz	a7,80200854 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
    802007be:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
    802007c2:	0a044d63          	bltz	s0,8020087c <vprintfmt+0x314>
            num = getint(&ap, lflag);
    802007c6:	8622                	mv	a2,s0
    802007c8:	8a66                	mv	s4,s9
    802007ca:	46a9                	li	a3,10
    802007cc:	bdcd                	j	802006be <vprintfmt+0x156>
            err = va_arg(ap, int);
    802007ce:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
    802007d2:	4719                	li	a4,6
            err = va_arg(ap, int);
    802007d4:	0a21                	addi	s4,s4,8
            if (err < 0) {
    802007d6:	41f7d69b          	sraiw	a3,a5,0x1f
    802007da:	8fb5                	xor	a5,a5,a3
    802007dc:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
    802007e0:	02d74163          	blt	a4,a3,80200802 <vprintfmt+0x29a>
    802007e4:	00369793          	slli	a5,a3,0x3
    802007e8:	97de                	add	a5,a5,s7
    802007ea:	639c                	ld	a5,0(a5)
    802007ec:	cb99                	beqz	a5,80200802 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
    802007ee:	86be                	mv	a3,a5
    802007f0:	00000617          	auipc	a2,0x0
    802007f4:	6c060613          	addi	a2,a2,1728 # 80200eb0 <etext+0x592>
    802007f8:	85a6                	mv	a1,s1
    802007fa:	854a                	mv	a0,s2
    802007fc:	0ce000ef          	jal	ra,802008ca <printfmt>
    80200800:	b34d                	j	802005a2 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
    80200802:	00000617          	auipc	a2,0x0
    80200806:	69e60613          	addi	a2,a2,1694 # 80200ea0 <etext+0x582>
    8020080a:	85a6                	mv	a1,s1
    8020080c:	854a                	mv	a0,s2
    8020080e:	0bc000ef          	jal	ra,802008ca <printfmt>
    80200812:	bb41                	j	802005a2 <vprintfmt+0x3a>
                p = "(null)";
    80200814:	00000417          	auipc	s0,0x0
    80200818:	68440413          	addi	s0,s0,1668 # 80200e98 <etext+0x57a>
                for (width -= strnlen(p, precision); width > 0; width --) {
    8020081c:	85e2                	mv	a1,s8
    8020081e:	8522                	mv	a0,s0
    80200820:	e43e                	sd	a5,8(sp)
    80200822:	cadff0ef          	jal	ra,802004ce <strnlen>
    80200826:	40ad8dbb          	subw	s11,s11,a0
    8020082a:	01b05b63          	blez	s11,80200840 <vprintfmt+0x2d8>
    8020082e:	67a2                	ld	a5,8(sp)
    80200830:	00078a1b          	sext.w	s4,a5
    80200834:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
    80200836:	85a6                	mv	a1,s1
    80200838:	8552                	mv	a0,s4
    8020083a:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
    8020083c:	fe0d9ce3          	bnez	s11,80200834 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    80200840:	00044783          	lbu	a5,0(s0)
    80200844:	00140a13          	addi	s4,s0,1
    80200848:	0007851b          	sext.w	a0,a5
    8020084c:	d3a5                	beqz	a5,802007ac <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
    8020084e:	05e00413          	li	s0,94
    80200852:	bf39                	j	80200770 <vprintfmt+0x208>
        return va_arg(*ap, int);
    80200854:	000a2403          	lw	s0,0(s4)
    80200858:	b7ad                	j	802007c2 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
    8020085a:	000a6603          	lwu	a2,0(s4)
    8020085e:	46a1                	li	a3,8
    80200860:	8a2e                	mv	s4,a1
    80200862:	bdb1                	j	802006be <vprintfmt+0x156>
    80200864:	000a6603          	lwu	a2,0(s4)
    80200868:	46a9                	li	a3,10
    8020086a:	8a2e                	mv	s4,a1
    8020086c:	bd89                	j	802006be <vprintfmt+0x156>
    8020086e:	000a6603          	lwu	a2,0(s4)
    80200872:	46c1                	li	a3,16
    80200874:	8a2e                	mv	s4,a1
    80200876:	b5a1                	j	802006be <vprintfmt+0x156>
                    putch(ch, putdat);
    80200878:	9902                	jalr	s2
    8020087a:	bf09                	j	8020078c <vprintfmt+0x224>
                putch('-', putdat);
    8020087c:	85a6                	mv	a1,s1
    8020087e:	02d00513          	li	a0,45
    80200882:	e03e                	sd	a5,0(sp)
    80200884:	9902                	jalr	s2
                num = -(long long)num;
    80200886:	6782                	ld	a5,0(sp)
    80200888:	8a66                	mv	s4,s9
    8020088a:	40800633          	neg	a2,s0
    8020088e:	46a9                	li	a3,10
    80200890:	b53d                	j	802006be <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
    80200892:	03b05163          	blez	s11,802008b4 <vprintfmt+0x34c>
    80200896:	02d00693          	li	a3,45
    8020089a:	f6d79de3          	bne	a5,a3,80200814 <vprintfmt+0x2ac>
                p = "(null)";
    8020089e:	00000417          	auipc	s0,0x0
    802008a2:	5fa40413          	addi	s0,s0,1530 # 80200e98 <etext+0x57a>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    802008a6:	02800793          	li	a5,40
    802008aa:	02800513          	li	a0,40
    802008ae:	00140a13          	addi	s4,s0,1
    802008b2:	bd6d                	j	8020076c <vprintfmt+0x204>
    802008b4:	00000a17          	auipc	s4,0x0
    802008b8:	5e5a0a13          	addi	s4,s4,1509 # 80200e99 <etext+0x57b>
    802008bc:	02800513          	li	a0,40
    802008c0:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
    802008c4:	05e00413          	li	s0,94
    802008c8:	b565                	j	80200770 <vprintfmt+0x208>

00000000802008ca <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
    802008ca:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
    802008cc:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
    802008d0:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
    802008d2:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
    802008d4:	ec06                	sd	ra,24(sp)
    802008d6:	f83a                	sd	a4,48(sp)
    802008d8:	fc3e                	sd	a5,56(sp)
    802008da:	e0c2                	sd	a6,64(sp)
    802008dc:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
    802008de:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
    802008e0:	c89ff0ef          	jal	ra,80200568 <vprintfmt>
}
    802008e4:	60e2                	ld	ra,24(sp)
    802008e6:	6161                	addi	sp,sp,80
    802008e8:	8082                	ret

00000000802008ea <sbi_console_putchar>:
...
uint64_t sbi_call(uint64_t sbi_type, uint64_t arg0, uint64_t arg1, uint64_t arg2) {
    uint64_t ret_val;
    __asm__ volatile (
    802008ea:	4781                	li	a5,0
    802008ec:	00003717          	auipc	a4,0x3
    802008f0:	71473703          	ld	a4,1812(a4) # 80204000 <SBI_CONSOLE_PUTCHAR>
    802008f4:	88ba                	mv	a7,a4
    802008f6:	852a                	mv	a0,a0
    802008f8:	85be                	mv	a1,a5
    802008fa:	863e                	mv	a2,a5
...
0000000080200904 <sbi_set_timer>:
    __asm__ volatile (
    80200904:	4781                	li	a5,0
    80200906:	00003717          	auipc	a4,0x3
    8020090a:	70273703          	ld	a4,1794(a4) # 80204008 <SBI_SET_TIMER>
