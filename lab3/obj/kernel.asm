...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	230040ef          	jal	ra,ffffffffc020427e <memset>
...
ffffffffc0200072:	522030ef          	jal	ra,ffffffffc0203594 <vmm_init>
...
ffffffffc02000b0:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000b2:	4e5030ef          	jal	ra,ffffffffc0203d96 <vprintfmt>
    return cnt;
}
...
ffffffffc02000e4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02000e6:	4b1030ef          	jal	ra,ffffffffc0203d96 <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020010c:	1f850513          	addi	a0,a0,504 # ffffffffc0204300 <etext+0x58>
void print_kerninfo(void) {
...
ffffffffc0200122:	20250513          	addi	a0,a0,514 # ffffffffc0204320 <etext+0x78>
ffffffffc0200126:	f99ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020012a:	00004597          	auipc	a1,0x4
ffffffffc020012e:	17e58593          	addi	a1,a1,382 # ffffffffc02042a8 <etext>
ffffffffc0200132:	00004517          	auipc	a0,0x4
ffffffffc0200136:	20e50513          	addi	a0,a0,526 # ffffffffc0204340 <etext+0x98>
...
ffffffffc020014a:	21a50513          	addi	a0,a0,538 # ffffffffc0204360 <etext+0xb8>
...
ffffffffc020015e:	22650513          	addi	a0,a0,550 # ffffffffc0204380 <etext+0xd8>
...
ffffffffc020018c:	21850513          	addi	a0,a0,536 # ffffffffc02043a0 <etext+0xf8>
}
...
ffffffffc020019c:	13860613          	addi	a2,a2,312 # ffffffffc02042d0 <etext+0x28>
ffffffffc02001a0:	04e00593          	li	a1,78
ffffffffc02001a4:	00004517          	auipc	a0,0x4
ffffffffc02001a8:	14450513          	addi	a0,a0,324 # ffffffffc02042e8 <etext+0x40>
void print_stackframe(void) {
...
ffffffffc02001b8:	2f460613          	addi	a2,a2,756 # ffffffffc02044a8 <commands+0xd8>
ffffffffc02001bc:	00004597          	auipc	a1,0x4
ffffffffc02001c0:	30c58593          	addi	a1,a1,780 # ffffffffc02044c8 <commands+0xf8>
ffffffffc02001c4:	00004517          	auipc	a0,0x4
ffffffffc02001c8:	30c50513          	addi	a0,a0,780 # ffffffffc02044d0 <commands+0x100>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02001d6:	30e60613          	addi	a2,a2,782 # ffffffffc02044e0 <commands+0x110>
ffffffffc02001da:	00004597          	auipc	a1,0x4
ffffffffc02001de:	32e58593          	addi	a1,a1,814 # ffffffffc0204508 <commands+0x138>
ffffffffc02001e2:	00004517          	auipc	a0,0x4
ffffffffc02001e6:	2ee50513          	addi	a0,a0,750 # ffffffffc02044d0 <commands+0x100>
ffffffffc02001ea:	ed5ff0ef          	jal	ra,ffffffffc02000be <cprintf>
ffffffffc02001ee:	00004617          	auipc	a2,0x4
ffffffffc02001f2:	32a60613          	addi	a2,a2,810 # ffffffffc0204518 <commands+0x148>
ffffffffc02001f6:	00004597          	auipc	a1,0x4
ffffffffc02001fa:	34258593          	addi	a1,a1,834 # ffffffffc0204538 <commands+0x168>
ffffffffc02001fe:	00004517          	auipc	a0,0x4
ffffffffc0200202:	2d250513          	addi	a0,a0,722 # ffffffffc02044d0 <commands+0x100>
...
ffffffffc020023c:	1e050513          	addi	a0,a0,480 # ffffffffc0204418 <commands+0x48>
kmonitor(struct trapframe *tf) {
...
ffffffffc020025e:	1e650513          	addi	a0,a0,486 # ffffffffc0204440 <commands+0x70>
...
ffffffffc0200274:	160c8c93          	addi	s9,s9,352 # ffffffffc02043d0 <commands>
        if ((buf = readline("")) != NULL) {
ffffffffc0200278:	00005997          	auipc	s3,0x5
ffffffffc020027c:	6f098993          	addi	s3,s3,1776 # ffffffffc0205968 <default_pmm_manager+0x990>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200280:	00004917          	auipc	s2,0x4
ffffffffc0200284:	1e890913          	addi	s2,s2,488 # ffffffffc0204468 <commands+0x98>
        if (argc == MAXARGS - 1) {
ffffffffc0200288:	4a3d                	li	s4,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020028a:	00004b17          	auipc	s6,0x4
ffffffffc020028e:	1e6b0b13          	addi	s6,s6,486 # ffffffffc0204470 <commands+0xa0>
    if (argc == 0) {
ffffffffc0200292:	00004a97          	auipc	s5,0x4
ffffffffc0200296:	236a8a93          	addi	s5,s5,566 # ffffffffc02044c8 <commands+0xf8>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc020029a:	4b8d                	li	s7,3
        if ((buf = readline("")) != NULL) {
ffffffffc020029c:	854e                	mv	a0,s3
ffffffffc020029e:	685030ef          	jal	ra,ffffffffc0204122 <readline>
...
ffffffffc02002b0:	7b1030ef          	jal	ra,ffffffffc0204260 <strchr>
...
ffffffffc02002ca:	10ad0d13          	addi	s10,s10,266 # ffffffffc02043d0 <commands>
    if (argc == 0) {
...
ffffffffc02002d4:	763030ef          	jal	ra,ffffffffc0204236 <strcmp>
...
ffffffffc02002e8:	74f030ef          	jal	ra,ffffffffc0204236 <strcmp>
...
ffffffffc020034e:	713030ef          	jal	ra,ffffffffc0204260 <strchr>
...
ffffffffc020036a:	12a50513          	addi	a0,a0,298 # ffffffffc0204490 <commands+0xc0>
...
ffffffffc02003aa:	1a250513          	addi	a0,a0,418 # ffffffffc0204548 <commands+0x178>
    va_start(ap, fmt);
...
ffffffffc02003c0:	10450513          	addi	a0,a0,260 # ffffffffc02054c0 <default_pmm_manager+0x4e8>
...
ffffffffc02003fe:	16e50513          	addi	a0,a0,366 # ffffffffc0204568 <commands+0x198>
    ticks = 0;
...
ffffffffc02004c0:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc02004c2:	5cf030ef          	jal	ra,ffffffffc0204290 <memcpy>
    return 0;
}
...
ffffffffc02004e6:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02004e8:	5a9030ef          	jal	ra,ffffffffc0204290 <memcpy>
    return 0;
}
...
ffffffffc0200534:	33050513          	addi	a0,a0,816 # ffffffffc0204860 <commands+0x490>
...
ffffffffc0200554:	0141                	addi	sp,sp,16
        return do_pgfault(check_mm_struct, tf->cause, tf->badvaddr);
ffffffffc0200556:	57c0306f          	j	ffffffffc0203ad2 <do_pgfault>
    panic("unhandled page fault.\n");
ffffffffc020055a:	00004617          	auipc	a2,0x4
ffffffffc020055e:	32660613          	addi	a2,a2,806 # ffffffffc0204880 <commands+0x4b0>
ffffffffc0200562:	07800593          	li	a1,120
ffffffffc0200566:	00004517          	auipc	a0,0x4
ffffffffc020056a:	33250513          	addi	a0,a0,818 # ffffffffc0204898 <commands+0x4c8>
...
ffffffffc020059c:	31850513          	addi	a0,a0,792 # ffffffffc02048b0 <commands+0x4e0>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200742:	44250513          	addi	a0,a0,1090 # ffffffffc0204b80 <commands+0x7b0>
...
ffffffffc0200754:	44850513          	addi	a0,a0,1096 # ffffffffc0204b98 <commands+0x7c8>
}
...
ffffffffc020076a:	44a50513          	addi	a0,a0,1098 # ffffffffc0204bb0 <commands+0x7e0>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200782:	44a50513          	addi	a0,a0,1098 # ffffffffc0204bc8 <commands+0x7f8>
ffffffffc0200786:	939ff0ef          	jal	ra,ffffffffc02000be <cprintf>
    cprintf("  epc      0x%08x\n", tf->epc);
ffffffffc020078a:	10843583          	ld	a1,264(s0)
ffffffffc020078e:	00004517          	auipc	a0,0x4
ffffffffc0200792:	45250513          	addi	a0,a0,1106 # ffffffffc0204be0 <commands+0x810>
...
ffffffffc02007a2:	45a50513          	addi	a0,a0,1114 # ffffffffc0204bf8 <commands+0x828>
...
ffffffffc02007b6:	45e50513          	addi	a0,a0,1118 # ffffffffc0204c10 <commands+0x840>
}
...
ffffffffc02007d4:	db470713          	addi	a4,a4,-588 # ffffffffc0204584 <commands+0x1b4>
...
ffffffffc02007e6:	02e50513          	addi	a0,a0,46 # ffffffffc0204810 <commands+0x440>
ffffffffc02007ea:	8d5ff06f          	j	ffffffffc02000be <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02007ee:	00004517          	auipc	a0,0x4
ffffffffc02007f2:	00250513          	addi	a0,a0,2 # ffffffffc02047f0 <commands+0x420>
ffffffffc02007f6:	8c9ff06f          	j	ffffffffc02000be <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02007fa:	00004517          	auipc	a0,0x4
ffffffffc02007fe:	fb650513          	addi	a0,a0,-74 # ffffffffc02047b0 <commands+0x3e0>
ffffffffc0200802:	8bdff06f          	j	ffffffffc02000be <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc0200806:	00004517          	auipc	a0,0x4
ffffffffc020080a:	fca50513          	addi	a0,a0,-54 # ffffffffc02047d0 <commands+0x400>
...
ffffffffc0200816:	02e50513          	addi	a0,a0,46 # ffffffffc0204840 <commands+0x470>
...
ffffffffc0200858:	fdc50513          	addi	a0,a0,-36 # ffffffffc0204830 <commands+0x460>
}
...
ffffffffc0200870:	d4870713          	addi	a4,a4,-696 # ffffffffc02045b4 <commands+0x1e4>
...
ffffffffc020088c:	f1050513          	addi	a0,a0,-240 # ffffffffc0204798 <commands+0x3c8>
...
ffffffffc02008ae:	d4e50513          	addi	a0,a0,-690 # ffffffffc02045f8 <commands+0x228>
}
...
ffffffffc0200908:	d9460613          	addi	a2,a2,-620 # ffffffffc0204698 <commands+0x2c8>
ffffffffc020090c:	0ca00593          	li	a1,202
ffffffffc0200910:	00004517          	auipc	a0,0x4
ffffffffc0200914:	f8850513          	addi	a0,a0,-120 # ffffffffc0204898 <commands+0x4c8>
ffffffffc0200918:	a5dff0ef          	jal	ra,ffffffffc0200374 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc020091c:	00004517          	auipc	a0,0x4
ffffffffc0200920:	d9c50513          	addi	a0,a0,-612 # ffffffffc02046b8 <commands+0x2e8>
ffffffffc0200924:	b779                	j	ffffffffc02008b2 <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc0200926:	00004517          	auipc	a0,0x4
ffffffffc020092a:	daa50513          	addi	a0,a0,-598 # ffffffffc02046d0 <commands+0x300>
...
ffffffffc02009b2:	cea60613          	addi	a2,a2,-790 # ffffffffc0204698 <commands+0x2c8>
ffffffffc02009b6:	0ea00593          	li	a1,234
ffffffffc02009ba:	00004517          	auipc	a0,0x4
ffffffffc02009be:	ede50513          	addi	a0,a0,-290 # ffffffffc0204898 <commands+0x4c8>
...
ffffffffc02009e2:	cba60613          	addi	a2,a2,-838 # ffffffffc0204698 <commands+0x2c8>
ffffffffc02009e6:	0f100593          	li	a1,241
ffffffffc02009ea:	00004517          	auipc	a0,0x4
ffffffffc02009ee:	eae50513          	addi	a0,a0,-338 # ffffffffc0204898 <commands+0x4c8>
...
ffffffffc0200b9a:	09270713          	addi	a4,a4,146 # ffffffffc0204c28 <commands+0x858>
...
ffffffffc0200bae:	4ee68693          	addi	a3,a3,1262 # ffffffffc0206098 <nbase>
...
ffffffffc0200e38:	dfc68693          	addi	a3,a3,-516 # ffffffffc0204c30 <commands+0x860>
ffffffffc0200e3c:	00004617          	auipc	a2,0x4
ffffffffc0200e40:	e0460613          	addi	a2,a2,-508 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200e44:	0f000593          	li	a1,240
ffffffffc0200e48:	00004517          	auipc	a0,0x4
ffffffffc0200e4c:	e1050513          	addi	a0,a0,-496 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200e50:	d24ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e54:	00004697          	auipc	a3,0x4
ffffffffc0200e58:	e9c68693          	addi	a3,a3,-356 # ffffffffc0204cf0 <commands+0x920>
ffffffffc0200e5c:	00004617          	auipc	a2,0x4
ffffffffc0200e60:	de460613          	addi	a2,a2,-540 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200e64:	0bd00593          	li	a1,189
ffffffffc0200e68:	00004517          	auipc	a0,0x4
ffffffffc0200e6c:	df050513          	addi	a0,a0,-528 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200e70:	d04ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200e74:	00004697          	auipc	a3,0x4
ffffffffc0200e78:	ea468693          	addi	a3,a3,-348 # ffffffffc0204d18 <commands+0x948>
ffffffffc0200e7c:	00004617          	auipc	a2,0x4
ffffffffc0200e80:	dc460613          	addi	a2,a2,-572 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200e84:	0be00593          	li	a1,190
ffffffffc0200e88:	00004517          	auipc	a0,0x4
ffffffffc0200e8c:	dd050513          	addi	a0,a0,-560 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200e90:	ce4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200e94:	00004697          	auipc	a3,0x4
ffffffffc0200e98:	ec468693          	addi	a3,a3,-316 # ffffffffc0204d58 <commands+0x988>
ffffffffc0200e9c:	00004617          	auipc	a2,0x4
ffffffffc0200ea0:	da460613          	addi	a2,a2,-604 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200ea4:	0c000593          	li	a1,192
ffffffffc0200ea8:	00004517          	auipc	a0,0x4
ffffffffc0200eac:	db050513          	addi	a0,a0,-592 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200eb0:	cc4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200eb4:	00004697          	auipc	a3,0x4
ffffffffc0200eb8:	f2c68693          	addi	a3,a3,-212 # ffffffffc0204de0 <commands+0xa10>
ffffffffc0200ebc:	00004617          	auipc	a2,0x4
ffffffffc0200ec0:	d8460613          	addi	a2,a2,-636 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200ec4:	0d900593          	li	a1,217
ffffffffc0200ec8:	00004517          	auipc	a0,0x4
ffffffffc0200ecc:	d9050513          	addi	a0,a0,-624 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200ed0:	ca4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200ed4:	00004697          	auipc	a3,0x4
ffffffffc0200ed8:	dbc68693          	addi	a3,a3,-580 # ffffffffc0204c90 <commands+0x8c0>
ffffffffc0200edc:	00004617          	auipc	a2,0x4
ffffffffc0200ee0:	d6460613          	addi	a2,a2,-668 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200ee4:	0d200593          	li	a1,210
ffffffffc0200ee8:	00004517          	auipc	a0,0x4
ffffffffc0200eec:	d7050513          	addi	a0,a0,-656 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200ef0:	c84ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 3);
ffffffffc0200ef4:	00004697          	auipc	a3,0x4
ffffffffc0200ef8:	edc68693          	addi	a3,a3,-292 # ffffffffc0204dd0 <commands+0xa00>
ffffffffc0200efc:	00004617          	auipc	a2,0x4
ffffffffc0200f00:	d4460613          	addi	a2,a2,-700 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200f04:	0d000593          	li	a1,208
ffffffffc0200f08:	00004517          	auipc	a0,0x4
ffffffffc0200f0c:	d5050513          	addi	a0,a0,-688 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200f10:	c64ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f14:	00004697          	auipc	a3,0x4
ffffffffc0200f18:	ea468693          	addi	a3,a3,-348 # ffffffffc0204db8 <commands+0x9e8>
ffffffffc0200f1c:	00004617          	auipc	a2,0x4
ffffffffc0200f20:	d2460613          	addi	a2,a2,-732 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200f24:	0cb00593          	li	a1,203
ffffffffc0200f28:	00004517          	auipc	a0,0x4
ffffffffc0200f2c:	d3050513          	addi	a0,a0,-720 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200f30:	c44ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f34:	00004697          	auipc	a3,0x4
ffffffffc0200f38:	e6468693          	addi	a3,a3,-412 # ffffffffc0204d98 <commands+0x9c8>
ffffffffc0200f3c:	00004617          	auipc	a2,0x4
ffffffffc0200f40:	d0460613          	addi	a2,a2,-764 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200f44:	0c200593          	li	a1,194
ffffffffc0200f48:	00004517          	auipc	a0,0x4
ffffffffc0200f4c:	d1050513          	addi	a0,a0,-752 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200f50:	c24ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 != NULL);
ffffffffc0200f54:	00004697          	auipc	a3,0x4
ffffffffc0200f58:	ed468693          	addi	a3,a3,-300 # ffffffffc0204e28 <commands+0xa58>
ffffffffc0200f5c:	00004617          	auipc	a2,0x4
ffffffffc0200f60:	ce460613          	addi	a2,a2,-796 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200f64:	0f800593          	li	a1,248
ffffffffc0200f68:	00004517          	auipc	a0,0x4
ffffffffc0200f6c:	cf050513          	addi	a0,a0,-784 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200f70:	c04ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0200f74:	00004697          	auipc	a3,0x4
ffffffffc0200f78:	ea468693          	addi	a3,a3,-348 # ffffffffc0204e18 <commands+0xa48>
ffffffffc0200f7c:	00004617          	auipc	a2,0x4
ffffffffc0200f80:	cc460613          	addi	a2,a2,-828 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200f84:	0df00593          	li	a1,223
ffffffffc0200f88:	00004517          	auipc	a0,0x4
ffffffffc0200f8c:	cd050513          	addi	a0,a0,-816 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200f90:	be4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f94:	00004697          	auipc	a3,0x4
ffffffffc0200f98:	e2468693          	addi	a3,a3,-476 # ffffffffc0204db8 <commands+0x9e8>
ffffffffc0200f9c:	00004617          	auipc	a2,0x4
ffffffffc0200fa0:	ca460613          	addi	a2,a2,-860 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200fa4:	0dd00593          	li	a1,221
ffffffffc0200fa8:	00004517          	auipc	a0,0x4
ffffffffc0200fac:	cb050513          	addi	a0,a0,-848 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200fb0:	bc4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200fb4:	00004697          	auipc	a3,0x4
ffffffffc0200fb8:	e4468693          	addi	a3,a3,-444 # ffffffffc0204df8 <commands+0xa28>
ffffffffc0200fbc:	00004617          	auipc	a2,0x4
ffffffffc0200fc0:	c8460613          	addi	a2,a2,-892 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200fc4:	0dc00593          	li	a1,220
ffffffffc0200fc8:	00004517          	auipc	a0,0x4
ffffffffc0200fcc:	c9050513          	addi	a0,a0,-880 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200fd0:	ba4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200fd4:	00004697          	auipc	a3,0x4
ffffffffc0200fd8:	cbc68693          	addi	a3,a3,-836 # ffffffffc0204c90 <commands+0x8c0>
ffffffffc0200fdc:	00004617          	auipc	a2,0x4
ffffffffc0200fe0:	c6460613          	addi	a2,a2,-924 # ffffffffc0204c40 <commands+0x870>
ffffffffc0200fe4:	0b900593          	li	a1,185
ffffffffc0200fe8:	00004517          	auipc	a0,0x4
ffffffffc0200fec:	c7050513          	addi	a0,a0,-912 # ffffffffc0204c58 <commands+0x888>
ffffffffc0200ff0:	b84ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200ff4:	00004697          	auipc	a3,0x4
ffffffffc0200ff8:	dc468693          	addi	a3,a3,-572 # ffffffffc0204db8 <commands+0x9e8>
ffffffffc0200ffc:	00004617          	auipc	a2,0x4
ffffffffc0201000:	c4460613          	addi	a2,a2,-956 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201004:	0d600593          	li	a1,214
ffffffffc0201008:	00004517          	auipc	a0,0x4
ffffffffc020100c:	c5050513          	addi	a0,a0,-944 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201010:	b64ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201014:	00004697          	auipc	a3,0x4
ffffffffc0201018:	cbc68693          	addi	a3,a3,-836 # ffffffffc0204cd0 <commands+0x900>
ffffffffc020101c:	00004617          	auipc	a2,0x4
ffffffffc0201020:	c2460613          	addi	a2,a2,-988 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201024:	0d400593          	li	a1,212
ffffffffc0201028:	00004517          	auipc	a0,0x4
ffffffffc020102c:	c3050513          	addi	a0,a0,-976 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201030:	b44ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201034:	00004697          	auipc	a3,0x4
ffffffffc0201038:	c7c68693          	addi	a3,a3,-900 # ffffffffc0204cb0 <commands+0x8e0>
ffffffffc020103c:	00004617          	auipc	a2,0x4
ffffffffc0201040:	c0460613          	addi	a2,a2,-1020 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201044:	0d300593          	li	a1,211
ffffffffc0201048:	00004517          	auipc	a0,0x4
ffffffffc020104c:	c1050513          	addi	a0,a0,-1008 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201050:	b24ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201054:	00004697          	auipc	a3,0x4
ffffffffc0201058:	c7c68693          	addi	a3,a3,-900 # ffffffffc0204cd0 <commands+0x900>
ffffffffc020105c:	00004617          	auipc	a2,0x4
ffffffffc0201060:	be460613          	addi	a2,a2,-1052 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201064:	0bb00593          	li	a1,187
ffffffffc0201068:	00004517          	auipc	a0,0x4
ffffffffc020106c:	bf050513          	addi	a0,a0,-1040 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201070:	b04ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(count == 0);
ffffffffc0201074:	00004697          	auipc	a3,0x4
ffffffffc0201078:	f0468693          	addi	a3,a3,-252 # ffffffffc0204f78 <commands+0xba8>
ffffffffc020107c:	00004617          	auipc	a2,0x4
ffffffffc0201080:	bc460613          	addi	a2,a2,-1084 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201084:	12500593          	li	a1,293
ffffffffc0201088:	00004517          	auipc	a0,0x4
ffffffffc020108c:	bd050513          	addi	a0,a0,-1072 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201090:	ae4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free == 0);
ffffffffc0201094:	00004697          	auipc	a3,0x4
ffffffffc0201098:	d8468693          	addi	a3,a3,-636 # ffffffffc0204e18 <commands+0xa48>
ffffffffc020109c:	00004617          	auipc	a2,0x4
ffffffffc02010a0:	ba460613          	addi	a2,a2,-1116 # ffffffffc0204c40 <commands+0x870>
ffffffffc02010a4:	11a00593          	li	a1,282
ffffffffc02010a8:	00004517          	auipc	a0,0x4
ffffffffc02010ac:	bb050513          	addi	a0,a0,-1104 # ffffffffc0204c58 <commands+0x888>
ffffffffc02010b0:	ac4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010b4:	00004697          	auipc	a3,0x4
ffffffffc02010b8:	d0468693          	addi	a3,a3,-764 # ffffffffc0204db8 <commands+0x9e8>
ffffffffc02010bc:	00004617          	auipc	a2,0x4
ffffffffc02010c0:	b8460613          	addi	a2,a2,-1148 # ffffffffc0204c40 <commands+0x870>
ffffffffc02010c4:	11800593          	li	a1,280
ffffffffc02010c8:	00004517          	auipc	a0,0x4
ffffffffc02010cc:	b9050513          	addi	a0,a0,-1136 # ffffffffc0204c58 <commands+0x888>
ffffffffc02010d0:	aa4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc02010d4:	00004697          	auipc	a3,0x4
ffffffffc02010d8:	ca468693          	addi	a3,a3,-860 # ffffffffc0204d78 <commands+0x9a8>
ffffffffc02010dc:	00004617          	auipc	a2,0x4
ffffffffc02010e0:	b6460613          	addi	a2,a2,-1180 # ffffffffc0204c40 <commands+0x870>
ffffffffc02010e4:	0c100593          	li	a1,193
ffffffffc02010e8:	00004517          	auipc	a0,0x4
ffffffffc02010ec:	b7050513          	addi	a0,a0,-1168 # ffffffffc0204c58 <commands+0x888>
ffffffffc02010f0:	a84ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc02010f4:	00004697          	auipc	a3,0x4
ffffffffc02010f8:	e4468693          	addi	a3,a3,-444 # ffffffffc0204f38 <commands+0xb68>
ffffffffc02010fc:	00004617          	auipc	a2,0x4
ffffffffc0201100:	b4460613          	addi	a2,a2,-1212 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201104:	11200593          	li	a1,274
ffffffffc0201108:	00004517          	auipc	a0,0x4
ffffffffc020110c:	b5050513          	addi	a0,a0,-1200 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201110:	a64ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201114:	00004697          	auipc	a3,0x4
ffffffffc0201118:	e0468693          	addi	a3,a3,-508 # ffffffffc0204f18 <commands+0xb48>
ffffffffc020111c:	00004617          	auipc	a2,0x4
ffffffffc0201120:	b2460613          	addi	a2,a2,-1244 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201124:	11000593          	li	a1,272
ffffffffc0201128:	00004517          	auipc	a0,0x4
ffffffffc020112c:	b3050513          	addi	a0,a0,-1232 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201130:	a44ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201134:	00004697          	auipc	a3,0x4
ffffffffc0201138:	dbc68693          	addi	a3,a3,-580 # ffffffffc0204ef0 <commands+0xb20>
ffffffffc020113c:	00004617          	auipc	a2,0x4
ffffffffc0201140:	b0460613          	addi	a2,a2,-1276 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201144:	10e00593          	li	a1,270
ffffffffc0201148:	00004517          	auipc	a0,0x4
ffffffffc020114c:	b1050513          	addi	a0,a0,-1264 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201150:	a24ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201154:	00004697          	auipc	a3,0x4
ffffffffc0201158:	d7468693          	addi	a3,a3,-652 # ffffffffc0204ec8 <commands+0xaf8>
ffffffffc020115c:	00004617          	auipc	a2,0x4
ffffffffc0201160:	ae460613          	addi	a2,a2,-1308 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201164:	10d00593          	li	a1,269
ffffffffc0201168:	00004517          	auipc	a0,0x4
ffffffffc020116c:	af050513          	addi	a0,a0,-1296 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201170:	a04ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(p0 + 2 == p1);
ffffffffc0201174:	00004697          	auipc	a3,0x4
ffffffffc0201178:	d4468693          	addi	a3,a3,-700 # ffffffffc0204eb8 <commands+0xae8>
ffffffffc020117c:	00004617          	auipc	a2,0x4
ffffffffc0201180:	ac460613          	addi	a2,a2,-1340 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201184:	10800593          	li	a1,264
ffffffffc0201188:	00004517          	auipc	a0,0x4
ffffffffc020118c:	ad050513          	addi	a0,a0,-1328 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201190:	9e4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201194:	00004697          	auipc	a3,0x4
ffffffffc0201198:	c2468693          	addi	a3,a3,-988 # ffffffffc0204db8 <commands+0x9e8>
ffffffffc020119c:	00004617          	auipc	a2,0x4
ffffffffc02011a0:	aa460613          	addi	a2,a2,-1372 # ffffffffc0204c40 <commands+0x870>
ffffffffc02011a4:	10700593          	li	a1,263
ffffffffc02011a8:	00004517          	auipc	a0,0x4
ffffffffc02011ac:	ab050513          	addi	a0,a0,-1360 # ffffffffc0204c58 <commands+0x888>
ffffffffc02011b0:	9c4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011b4:	00004697          	auipc	a3,0x4
ffffffffc02011b8:	ce468693          	addi	a3,a3,-796 # ffffffffc0204e98 <commands+0xac8>
ffffffffc02011bc:	00004617          	auipc	a2,0x4
ffffffffc02011c0:	a8460613          	addi	a2,a2,-1404 # ffffffffc0204c40 <commands+0x870>
ffffffffc02011c4:	10600593          	li	a1,262
ffffffffc02011c8:	00004517          	auipc	a0,0x4
ffffffffc02011cc:	a9050513          	addi	a0,a0,-1392 # ffffffffc0204c58 <commands+0x888>
ffffffffc02011d0:	9a4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc02011d4:	00004697          	auipc	a3,0x4
ffffffffc02011d8:	c9468693          	addi	a3,a3,-876 # ffffffffc0204e68 <commands+0xa98>
ffffffffc02011dc:	00004617          	auipc	a2,0x4
ffffffffc02011e0:	a6460613          	addi	a2,a2,-1436 # ffffffffc0204c40 <commands+0x870>
ffffffffc02011e4:	10500593          	li	a1,261
ffffffffc02011e8:	00004517          	auipc	a0,0x4
ffffffffc02011ec:	a7050513          	addi	a0,a0,-1424 # ffffffffc0204c58 <commands+0x888>
ffffffffc02011f0:	984ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc02011f4:	00004697          	auipc	a3,0x4
ffffffffc02011f8:	c5c68693          	addi	a3,a3,-932 # ffffffffc0204e50 <commands+0xa80>
ffffffffc02011fc:	00004617          	auipc	a2,0x4
ffffffffc0201200:	a4460613          	addi	a2,a2,-1468 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201204:	10400593          	li	a1,260
ffffffffc0201208:	00004517          	auipc	a0,0x4
ffffffffc020120c:	a5050513          	addi	a0,a0,-1456 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201210:	964ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201214:	00004697          	auipc	a3,0x4
ffffffffc0201218:	ba468693          	addi	a3,a3,-1116 # ffffffffc0204db8 <commands+0x9e8>
ffffffffc020121c:	00004617          	auipc	a2,0x4
ffffffffc0201220:	a2460613          	addi	a2,a2,-1500 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201224:	0fe00593          	li	a1,254
ffffffffc0201228:	00004517          	auipc	a0,0x4
ffffffffc020122c:	a3050513          	addi	a0,a0,-1488 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201230:	944ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201234:	00004697          	auipc	a3,0x4
ffffffffc0201238:	c0468693          	addi	a3,a3,-1020 # ffffffffc0204e38 <commands+0xa68>
ffffffffc020123c:	00004617          	auipc	a2,0x4
ffffffffc0201240:	a0460613          	addi	a2,a2,-1532 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201244:	0f900593          	li	a1,249
ffffffffc0201248:	00004517          	auipc	a0,0x4
ffffffffc020124c:	a1050513          	addi	a0,a0,-1520 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201250:	924ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201254:	00004697          	auipc	a3,0x4
ffffffffc0201258:	d0468693          	addi	a3,a3,-764 # ffffffffc0204f58 <commands+0xb88>
ffffffffc020125c:	00004617          	auipc	a2,0x4
ffffffffc0201260:	9e460613          	addi	a2,a2,-1564 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201264:	11700593          	li	a1,279
ffffffffc0201268:	00004517          	auipc	a0,0x4
ffffffffc020126c:	9f050513          	addi	a0,a0,-1552 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201270:	904ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == 0);
ffffffffc0201274:	00004697          	auipc	a3,0x4
ffffffffc0201278:	d1468693          	addi	a3,a3,-748 # ffffffffc0204f88 <commands+0xbb8>
ffffffffc020127c:	00004617          	auipc	a2,0x4
ffffffffc0201280:	9c460613          	addi	a2,a2,-1596 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201284:	12600593          	li	a1,294
ffffffffc0201288:	00004517          	auipc	a0,0x4
ffffffffc020128c:	9d050513          	addi	a0,a0,-1584 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201290:	8e4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201294:	00004697          	auipc	a3,0x4
ffffffffc0201298:	9dc68693          	addi	a3,a3,-1572 # ffffffffc0204c70 <commands+0x8a0>
ffffffffc020129c:	00004617          	auipc	a2,0x4
ffffffffc02012a0:	9a460613          	addi	a2,a2,-1628 # ffffffffc0204c40 <commands+0x870>
ffffffffc02012a4:	0f300593          	li	a1,243
ffffffffc02012a8:	00004517          	auipc	a0,0x4
ffffffffc02012ac:	9b050513          	addi	a0,a0,-1616 # ffffffffc0204c58 <commands+0x888>
ffffffffc02012b0:	8c4ff0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012b4:	00004697          	auipc	a3,0x4
ffffffffc02012b8:	9fc68693          	addi	a3,a3,-1540 # ffffffffc0204cb0 <commands+0x8e0>
ffffffffc02012bc:	00004617          	auipc	a2,0x4
ffffffffc02012c0:	98460613          	addi	a2,a2,-1660 # ffffffffc0204c40 <commands+0x870>
ffffffffc02012c4:	0ba00593          	li	a1,186
ffffffffc02012c8:	00004517          	auipc	a0,0x4
ffffffffc02012cc:	99050513          	addi	a0,a0,-1648 # ffffffffc0204c58 <commands+0x888>
...
ffffffffc020143c:	b6068693          	addi	a3,a3,-1184 # ffffffffc0204f98 <commands+0xbc8>
ffffffffc0201440:	00004617          	auipc	a2,0x4
ffffffffc0201444:	80060613          	addi	a2,a2,-2048 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201448:	08300593          	li	a1,131
ffffffffc020144c:	00004517          	auipc	a0,0x4
ffffffffc0201450:	80c50513          	addi	a0,a0,-2036 # ffffffffc0204c58 <commands+0x888>
ffffffffc0201454:	f21fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201458:	00004697          	auipc	a3,0x4
ffffffffc020145c:	b6868693          	addi	a3,a3,-1176 # ffffffffc0204fc0 <commands+0xbf0>
ffffffffc0201460:	00003617          	auipc	a2,0x3
ffffffffc0201464:	7e060613          	addi	a2,a2,2016 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201468:	08000593          	li	a1,128
ffffffffc020146c:	00003517          	auipc	a0,0x3
ffffffffc0201470:	7ec50513          	addi	a0,a0,2028 # ffffffffc0204c58 <commands+0x888>
...
ffffffffc020151a:	aaa68693          	addi	a3,a3,-1366 # ffffffffc0204fc0 <commands+0xbf0>
ffffffffc020151e:	00003617          	auipc	a2,0x3
ffffffffc0201522:	72260613          	addi	a2,a2,1826 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201526:	06200593          	li	a1,98
ffffffffc020152a:	00003517          	auipc	a0,0x3
ffffffffc020152e:	72e50513          	addi	a0,a0,1838 # ffffffffc0204c58 <commands+0x888>
default_alloc_pages(size_t n) {
...
ffffffffc0201606:	9c668693          	addi	a3,a3,-1594 # ffffffffc0204fc8 <commands+0xbf8>
ffffffffc020160a:	00003617          	auipc	a2,0x3
ffffffffc020160e:	63660613          	addi	a2,a2,1590 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201612:	04900593          	li	a1,73
ffffffffc0201616:	00003517          	auipc	a0,0x3
ffffffffc020161a:	64250513          	addi	a0,a0,1602 # ffffffffc0204c58 <commands+0x888>
ffffffffc020161e:	d57fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(n > 0);
ffffffffc0201622:	00004697          	auipc	a3,0x4
ffffffffc0201626:	99e68693          	addi	a3,a3,-1634 # ffffffffc0204fc0 <commands+0xbf0>
ffffffffc020162a:	00003617          	auipc	a2,0x3
ffffffffc020162e:	61660613          	addi	a2,a2,1558 # ffffffffc0204c40 <commands+0x870>
ffffffffc0201632:	04600593          	li	a1,70
ffffffffc0201636:	00003517          	auipc	a0,0x3
ffffffffc020163a:	62250513          	addi	a0,a0,1570 # ffffffffc0204c58 <commands+0x888>
...
ffffffffc0201648:	a5c60613          	addi	a2,a2,-1444 # ffffffffc02050a0 <default_pmm_manager+0xc8>
ffffffffc020164c:	06500593          	li	a1,101
ffffffffc0201650:	00004517          	auipc	a0,0x4
ffffffffc0201654:	a7050513          	addi	a0,a0,-1424 # ffffffffc02050c0 <default_pmm_manager+0xe8>
static inline struct Page *pa2page(uintptr_t pa) {
...
ffffffffc02017c0:	46c78793          	addi	a5,a5,1132 # ffffffffc0204c28 <commands+0x858>
...
ffffffffc0201804:	27b020ef          	jal	ra,ffffffffc020427e <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc0201874:	3b878793          	addi	a5,a5,952 # ffffffffc0204c28 <commands+0x858>
...
ffffffffc02018aa:	1d5020ef          	jal	ra,ffffffffc020427e <memset>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
...
ffffffffc020190a:	72260613          	addi	a2,a2,1826 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc020190e:	10200593          	li	a1,258
ffffffffc0201912:	00003517          	auipc	a0,0x3
ffffffffc0201916:	73e50513          	addi	a0,a0,1854 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc020191a:	a5bfe0ef          	jal	ra,ffffffffc0200374 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc020191e:	00003617          	auipc	a2,0x3
ffffffffc0201922:	70a60613          	addi	a2,a2,1802 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc0201926:	10f00593          	li	a1,271
ffffffffc020192a:	00003517          	auipc	a0,0x3
ffffffffc020192e:	72650513          	addi	a0,a0,1830 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc020193c:	6f060613          	addi	a2,a2,1776 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc0201940:	10b00593          	li	a1,267
ffffffffc0201944:	00003517          	auipc	a0,0x3
ffffffffc0201948:	70c50513          	addi	a0,a0,1804 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc0201956:	6d660613          	addi	a2,a2,1750 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc020195a:	0ff00593          	li	a1,255
ffffffffc020195e:	00003517          	auipc	a0,0x3
ffffffffc0201962:	6f250513          	addi	a0,a0,1778 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc0201a80:	1ac70713          	addi	a4,a4,428 # ffffffffc0204c28 <commands+0x858>
...
ffffffffc0201b1a:	4c278793          	addi	a5,a5,1218 # ffffffffc0204fd8 <default_pmm_manager>
...
ffffffffc0201b26:	5c650513          	addi	a0,a0,1478 # ffffffffc02050e8 <default_pmm_manager+0x110>
void pmm_init(void) {
...
ffffffffc0201b84:	58050513          	addi	a0,a0,1408 # ffffffffc0205100 <default_pmm_manager+0x128>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201b98:	59c50513          	addi	a0,a0,1436 # ffffffffc0205130 <default_pmm_manager+0x158>
...
ffffffffc0201bb2:	59a50513          	addi	a0,a0,1434 # ffffffffc0205148 <default_pmm_manager+0x170>
...
ffffffffc0201c46:	55650513          	addi	a0,a0,1366 # ffffffffc0205198 <default_pmm_manager+0x1c0>
...
ffffffffc0201e4a:	de2a8a93          	addi	s5,s5,-542 # ffffffffc0204c28 <commands+0x858>
...
ffffffffc0201eca:	5e250513          	addi	a0,a0,1506 # ffffffffc02054a8 <default_pmm_manager+0x4d0>
...
ffffffffc0201f76:	66e58593          	addi	a1,a1,1646 # ffffffffc02055e0 <default_pmm_manager+0x608>
ffffffffc0201f7a:	10000513          	li	a0,256
ffffffffc0201f7e:	2a6020ef          	jal	ra,ffffffffc0204224 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0201f82:	100b8593          	addi	a1,s7,256
ffffffffc0201f86:	10000513          	li	a0,256
ffffffffc0201f8a:	2ac020ef          	jal	ra,ffffffffc0204236 <strcmp>
...
ffffffffc0201fc6:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fdedb68>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0201fca:	216020ef          	jal	ra,ffffffffc02041e0 <strlen>
...
ffffffffc0202084:	5d850513          	addi	a0,a0,1496 # ffffffffc0205658 <default_pmm_manager+0x680>
}
...
ffffffffc02020c6:	f6660613          	addi	a2,a2,-154 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc02020ca:	1cd00593          	li	a1,461
ffffffffc02020ce:	00003517          	auipc	a0,0x3
ffffffffc02020d2:	f8250513          	addi	a0,a0,-126 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02020d6:	a9efe0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc02020da:	00003697          	auipc	a3,0x3
ffffffffc02020de:	3ee68693          	addi	a3,a3,1006 # ffffffffc02054c8 <default_pmm_manager+0x4f0>
ffffffffc02020e2:	00003617          	auipc	a2,0x3
ffffffffc02020e6:	b5e60613          	addi	a2,a2,-1186 # ffffffffc0204c40 <commands+0x870>
ffffffffc02020ea:	1cd00593          	li	a1,461
ffffffffc02020ee:	00003517          	auipc	a0,0x3
ffffffffc02020f2:	f6250513          	addi	a0,a0,-158 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02020f6:	a7efe0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc02020fa:	00003697          	auipc	a3,0x3
ffffffffc02020fe:	40e68693          	addi	a3,a3,1038 # ffffffffc0205508 <default_pmm_manager+0x530>
ffffffffc0202102:	00003617          	auipc	a2,0x3
ffffffffc0202106:	b3e60613          	addi	a2,a2,-1218 # ffffffffc0204c40 <commands+0x870>
ffffffffc020210a:	1ce00593          	li	a1,462
ffffffffc020210e:	00003517          	auipc	a0,0x3
ffffffffc0202112:	f4250513          	addi	a0,a0,-190 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc0202122:	f0a60613          	addi	a2,a2,-246 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc0202126:	06a00593          	li	a1,106
ffffffffc020212a:	00003517          	auipc	a0,0x3
ffffffffc020212e:	f9650513          	addi	a0,a0,-106 # ffffffffc02050c0 <default_pmm_manager+0xe8>
ffffffffc0202132:	a42fe0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202136:	00003617          	auipc	a2,0x3
ffffffffc020213a:	16260613          	addi	a2,a2,354 # ffffffffc0205298 <default_pmm_manager+0x2c0>
ffffffffc020213e:	07000593          	li	a1,112
ffffffffc0202142:	00003517          	auipc	a0,0x3
ffffffffc0202146:	f7e50513          	addi	a0,a0,-130 # ffffffffc02050c0 <default_pmm_manager+0xe8>
ffffffffc020214a:	a2afe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc020214e:	00003697          	auipc	a3,0x3
ffffffffc0202152:	08a68693          	addi	a3,a3,138 # ffffffffc02051d8 <default_pmm_manager+0x200>
ffffffffc0202156:	00003617          	auipc	a2,0x3
ffffffffc020215a:	aea60613          	addi	a2,a2,-1302 # ffffffffc0204c40 <commands+0x870>
ffffffffc020215e:	19300593          	li	a1,403
ffffffffc0202162:	00003517          	auipc	a0,0x3
ffffffffc0202166:	eee50513          	addi	a0,a0,-274 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc020216a:	a0afe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc020216e:	00003697          	auipc	a3,0x3
ffffffffc0202172:	0a268693          	addi	a3,a3,162 # ffffffffc0205210 <default_pmm_manager+0x238>
ffffffffc0202176:	00003617          	auipc	a2,0x3
ffffffffc020217a:	aca60613          	addi	a2,a2,-1334 # ffffffffc0204c40 <commands+0x870>
ffffffffc020217e:	19400593          	li	a1,404
ffffffffc0202182:	00003517          	auipc	a0,0x3
ffffffffc0202186:	ece50513          	addi	a0,a0,-306 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc020218a:	9eafe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020218e:	00003697          	auipc	a3,0x3
ffffffffc0202192:	2fa68693          	addi	a3,a3,762 # ffffffffc0205488 <default_pmm_manager+0x4b0>
ffffffffc0202196:	00003617          	auipc	a2,0x3
ffffffffc020219a:	aaa60613          	addi	a2,a2,-1366 # ffffffffc0204c40 <commands+0x870>
ffffffffc020219e:	1c000593          	li	a1,448
ffffffffc02021a2:	00003517          	auipc	a0,0x3
ffffffffc02021a6:	eae50513          	addi	a0,a0,-338 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02021aa:	9cafe0ef          	jal	ra,ffffffffc0200374 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc02021ae:	00003617          	auipc	a2,0x3
ffffffffc02021b2:	fc260613          	addi	a2,a2,-62 # ffffffffc0205170 <default_pmm_manager+0x198>
ffffffffc02021b6:	07700593          	li	a1,119
ffffffffc02021ba:	00003517          	auipc	a0,0x3
ffffffffc02021be:	e9650513          	addi	a0,a0,-362 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02021c2:	9b2fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, 0x0, 0)) != NULL);
ffffffffc02021c6:	00003697          	auipc	a3,0x3
ffffffffc02021ca:	0a268693          	addi	a3,a3,162 # ffffffffc0205268 <default_pmm_manager+0x290>
ffffffffc02021ce:	00003617          	auipc	a2,0x3
ffffffffc02021d2:	a7260613          	addi	a2,a2,-1422 # ffffffffc0204c40 <commands+0x870>
ffffffffc02021d6:	19a00593          	li	a1,410
ffffffffc02021da:	00003517          	auipc	a0,0x3
ffffffffc02021de:	e7650513          	addi	a0,a0,-394 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02021e2:	992fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc02021e6:	00003697          	auipc	a3,0x3
ffffffffc02021ea:	05268693          	addi	a3,a3,82 # ffffffffc0205238 <default_pmm_manager+0x260>
ffffffffc02021ee:	00003617          	auipc	a2,0x3
ffffffffc02021f2:	a5260613          	addi	a2,a2,-1454 # ffffffffc0204c40 <commands+0x870>
ffffffffc02021f6:	19800593          	li	a1,408
ffffffffc02021fa:	00003517          	auipc	a0,0x3
ffffffffc02021fe:	e5650513          	addi	a0,a0,-426 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202202:	972fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202206:	00003697          	auipc	a3,0x3
ffffffffc020220a:	17a68693          	addi	a3,a3,378 # ffffffffc0205380 <default_pmm_manager+0x3a8>
ffffffffc020220e:	00003617          	auipc	a2,0x3
ffffffffc0202212:	a3260613          	addi	a2,a2,-1486 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202216:	1a500593          	li	a1,421
ffffffffc020221a:	00003517          	auipc	a0,0x3
ffffffffc020221e:	e3650513          	addi	a0,a0,-458 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202222:	952fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202226:	00003697          	auipc	a3,0x3
ffffffffc020222a:	12a68693          	addi	a3,a3,298 # ffffffffc0205350 <default_pmm_manager+0x378>
ffffffffc020222e:	00003617          	auipc	a2,0x3
ffffffffc0202232:	a1260613          	addi	a2,a2,-1518 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202236:	1a400593          	li	a1,420
ffffffffc020223a:	00003517          	auipc	a0,0x3
ffffffffc020223e:	e1650513          	addi	a0,a0,-490 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202242:	932fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202246:	00003697          	auipc	a3,0x3
ffffffffc020224a:	0d268693          	addi	a3,a3,210 # ffffffffc0205318 <default_pmm_manager+0x340>
ffffffffc020224e:	00003617          	auipc	a2,0x3
ffffffffc0202252:	9f260613          	addi	a2,a2,-1550 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202256:	1a300593          	li	a1,419
ffffffffc020225a:	00003517          	auipc	a0,0x3
ffffffffc020225e:	df650513          	addi	a0,a0,-522 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202262:	912fe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202266:	00003697          	auipc	a3,0x3
ffffffffc020226a:	08a68693          	addi	a3,a3,138 # ffffffffc02052f0 <default_pmm_manager+0x318>
ffffffffc020226e:	00003617          	auipc	a2,0x3
ffffffffc0202272:	9d260613          	addi	a2,a2,-1582 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202276:	1a000593          	li	a1,416
ffffffffc020227a:	00003517          	auipc	a0,0x3
ffffffffc020227e:	dd650513          	addi	a0,a0,-554 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc020228c:	da060613          	addi	a2,a2,-608 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc0202290:	19f00593          	li	a1,415
ffffffffc0202294:	00003517          	auipc	a0,0x3
ffffffffc0202298:	dbc50513          	addi	a0,a0,-580 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc02022a6:	d8660613          	addi	a2,a2,-634 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc02022aa:	19e00593          	li	a1,414
ffffffffc02022ae:	00003517          	auipc	a0,0x3
ffffffffc02022b2:	da250513          	addi	a0,a0,-606 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02022b6:	8befe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02022ba:	00003697          	auipc	a3,0x3
ffffffffc02022be:	01e68693          	addi	a3,a3,30 # ffffffffc02052d8 <default_pmm_manager+0x300>
ffffffffc02022c2:	00003617          	auipc	a2,0x3
ffffffffc02022c6:	97e60613          	addi	a2,a2,-1666 # ffffffffc0204c40 <commands+0x870>
ffffffffc02022ca:	19c00593          	li	a1,412
ffffffffc02022ce:	00003517          	auipc	a0,0x3
ffffffffc02022d2:	d8250513          	addi	a0,a0,-638 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02022d6:	89efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02022da:	00003697          	auipc	a3,0x3
ffffffffc02022de:	fe668693          	addi	a3,a3,-26 # ffffffffc02052c0 <default_pmm_manager+0x2e8>
ffffffffc02022e2:	00003617          	auipc	a2,0x3
ffffffffc02022e6:	95e60613          	addi	a2,a2,-1698 # ffffffffc0204c40 <commands+0x870>
ffffffffc02022ea:	19b00593          	li	a1,411
ffffffffc02022ee:	00003517          	auipc	a0,0x3
ffffffffc02022f2:	d6250513          	addi	a0,a0,-670 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02022f6:	87efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02022fa:	00003697          	auipc	a3,0x3
ffffffffc02022fe:	fc668693          	addi	a3,a3,-58 # ffffffffc02052c0 <default_pmm_manager+0x2e8>
ffffffffc0202302:	00003617          	auipc	a2,0x3
ffffffffc0202306:	93e60613          	addi	a2,a2,-1730 # ffffffffc0204c40 <commands+0x870>
ffffffffc020230a:	1ae00593          	li	a1,430
ffffffffc020230e:	00003517          	auipc	a0,0x3
ffffffffc0202312:	d4250513          	addi	a0,a0,-702 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202316:	85efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020231a:	00003697          	auipc	a3,0x3
ffffffffc020231e:	03668693          	addi	a3,a3,54 # ffffffffc0205350 <default_pmm_manager+0x378>
ffffffffc0202322:	00003617          	auipc	a2,0x3
ffffffffc0202326:	91e60613          	addi	a2,a2,-1762 # ffffffffc0204c40 <commands+0x870>
ffffffffc020232a:	1ad00593          	li	a1,429
ffffffffc020232e:	00003517          	auipc	a0,0x3
ffffffffc0202332:	d2250513          	addi	a0,a0,-734 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202336:	83efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020233a:	00003697          	auipc	a3,0x3
ffffffffc020233e:	0de68693          	addi	a3,a3,222 # ffffffffc0205418 <default_pmm_manager+0x440>
ffffffffc0202342:	00003617          	auipc	a2,0x3
ffffffffc0202346:	8fe60613          	addi	a2,a2,-1794 # ffffffffc0204c40 <commands+0x870>
ffffffffc020234a:	1ac00593          	li	a1,428
ffffffffc020234e:	00003517          	auipc	a0,0x3
ffffffffc0202352:	d0250513          	addi	a0,a0,-766 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202356:	81efe0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020235a:	00003697          	auipc	a3,0x3
ffffffffc020235e:	0a668693          	addi	a3,a3,166 # ffffffffc0205400 <default_pmm_manager+0x428>
ffffffffc0202362:	00003617          	auipc	a2,0x3
ffffffffc0202366:	8de60613          	addi	a2,a2,-1826 # ffffffffc0204c40 <commands+0x870>
ffffffffc020236a:	1ab00593          	li	a1,427
ffffffffc020236e:	00003517          	auipc	a0,0x3
ffffffffc0202372:	ce250513          	addi	a0,a0,-798 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202376:	ffffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020237a:	00003697          	auipc	a3,0x3
ffffffffc020237e:	05668693          	addi	a3,a3,86 # ffffffffc02053d0 <default_pmm_manager+0x3f8>
ffffffffc0202382:	00003617          	auipc	a2,0x3
ffffffffc0202386:	8be60613          	addi	a2,a2,-1858 # ffffffffc0204c40 <commands+0x870>
ffffffffc020238a:	1aa00593          	li	a1,426
ffffffffc020238e:	00003517          	auipc	a0,0x3
ffffffffc0202392:	cc250513          	addi	a0,a0,-830 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202396:	fdffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc020239a:	00003697          	auipc	a3,0x3
ffffffffc020239e:	01e68693          	addi	a3,a3,30 # ffffffffc02053b8 <default_pmm_manager+0x3e0>
ffffffffc02023a2:	00003617          	auipc	a2,0x3
ffffffffc02023a6:	89e60613          	addi	a2,a2,-1890 # ffffffffc0204c40 <commands+0x870>
ffffffffc02023aa:	1a800593          	li	a1,424
ffffffffc02023ae:	00003517          	auipc	a0,0x3
ffffffffc02023b2:	ca250513          	addi	a0,a0,-862 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02023b6:	fbffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02023ba:	00003697          	auipc	a3,0x3
ffffffffc02023be:	fe668693          	addi	a3,a3,-26 # ffffffffc02053a0 <default_pmm_manager+0x3c8>
ffffffffc02023c2:	00003617          	auipc	a2,0x3
ffffffffc02023c6:	87e60613          	addi	a2,a2,-1922 # ffffffffc0204c40 <commands+0x870>
ffffffffc02023ca:	1a700593          	li	a1,423
ffffffffc02023ce:	00003517          	auipc	a0,0x3
ffffffffc02023d2:	c8250513          	addi	a0,a0,-894 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02023d6:	f9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02023da:	00003697          	auipc	a3,0x3
ffffffffc02023de:	fb668693          	addi	a3,a3,-74 # ffffffffc0205390 <default_pmm_manager+0x3b8>
ffffffffc02023e2:	00003617          	auipc	a2,0x3
ffffffffc02023e6:	85e60613          	addi	a2,a2,-1954 # ffffffffc0204c40 <commands+0x870>
ffffffffc02023ea:	1a600593          	li	a1,422
ffffffffc02023ee:	00003517          	auipc	a0,0x3
ffffffffc02023f2:	c6250513          	addi	a0,a0,-926 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02023f6:	f7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02023fa:	00003697          	auipc	a3,0x3
ffffffffc02023fe:	08e68693          	addi	a3,a3,142 # ffffffffc0205488 <default_pmm_manager+0x4b0>
ffffffffc0202402:	00003617          	auipc	a2,0x3
ffffffffc0202406:	83e60613          	addi	a2,a2,-1986 # ffffffffc0204c40 <commands+0x870>
ffffffffc020240a:	1e800593          	li	a1,488
ffffffffc020240e:	00003517          	auipc	a0,0x3
ffffffffc0202412:	c4250513          	addi	a0,a0,-958 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202416:	f5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc020241a:	00003697          	auipc	a3,0x3
ffffffffc020241e:	21668693          	addi	a3,a3,534 # ffffffffc0205630 <default_pmm_manager+0x658>
ffffffffc0202422:	00003617          	auipc	a2,0x3
ffffffffc0202426:	81e60613          	addi	a2,a2,-2018 # ffffffffc0204c40 <commands+0x870>
ffffffffc020242a:	1e000593          	li	a1,480
ffffffffc020242e:	00003517          	auipc	a0,0x3
ffffffffc0202432:	c2250513          	addi	a0,a0,-990 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202436:	f3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc020243a:	00003697          	auipc	a3,0x3
ffffffffc020243e:	1be68693          	addi	a3,a3,446 # ffffffffc02055f8 <default_pmm_manager+0x620>
ffffffffc0202442:	00002617          	auipc	a2,0x2
ffffffffc0202446:	7fe60613          	addi	a2,a2,2046 # ffffffffc0204c40 <commands+0x870>
ffffffffc020244a:	1dd00593          	li	a1,477
ffffffffc020244e:	00003517          	auipc	a0,0x3
ffffffffc0202452:	c0250513          	addi	a0,a0,-1022 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202456:	f1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 2);
ffffffffc020245a:	00003697          	auipc	a3,0x3
ffffffffc020245e:	16e68693          	addi	a3,a3,366 # ffffffffc02055c8 <default_pmm_manager+0x5f0>
ffffffffc0202462:	00002617          	auipc	a2,0x2
ffffffffc0202466:	7de60613          	addi	a2,a2,2014 # ffffffffc0204c40 <commands+0x870>
ffffffffc020246a:	1d900593          	li	a1,473
ffffffffc020246e:	00003517          	auipc	a0,0x3
ffffffffc0202472:	be250513          	addi	a0,a0,-1054 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202476:	efffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc020247a:	00003697          	auipc	a3,0x3
ffffffffc020247e:	fce68693          	addi	a3,a3,-50 # ffffffffc0205448 <default_pmm_manager+0x470>
ffffffffc0202482:	00002617          	auipc	a2,0x2
ffffffffc0202486:	7be60613          	addi	a2,a2,1982 # ffffffffc0204c40 <commands+0x870>
ffffffffc020248a:	1b600593          	li	a1,438
ffffffffc020248e:	00003517          	auipc	a0,0x3
ffffffffc0202492:	bc250513          	addi	a0,a0,-1086 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202496:	edffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020249a:	00003697          	auipc	a3,0x3
ffffffffc020249e:	f7e68693          	addi	a3,a3,-130 # ffffffffc0205418 <default_pmm_manager+0x440>
ffffffffc02024a2:	00002617          	auipc	a2,0x2
ffffffffc02024a6:	79e60613          	addi	a2,a2,1950 # ffffffffc0204c40 <commands+0x870>
ffffffffc02024aa:	1b300593          	li	a1,435
ffffffffc02024ae:	00003517          	auipc	a0,0x3
ffffffffc02024b2:	ba250513          	addi	a0,a0,-1118 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02024b6:	ebffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02024ba:	00003697          	auipc	a3,0x3
ffffffffc02024be:	e1e68693          	addi	a3,a3,-482 # ffffffffc02052d8 <default_pmm_manager+0x300>
ffffffffc02024c2:	00002617          	auipc	a2,0x2
ffffffffc02024c6:	77e60613          	addi	a2,a2,1918 # ffffffffc0204c40 <commands+0x870>
ffffffffc02024ca:	1b200593          	li	a1,434
ffffffffc02024ce:	00003517          	auipc	a0,0x3
ffffffffc02024d2:	b8250513          	addi	a0,a0,-1150 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02024d6:	e9ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc02024da:	00003697          	auipc	a3,0x3
ffffffffc02024de:	f5668693          	addi	a3,a3,-170 # ffffffffc0205430 <default_pmm_manager+0x458>
ffffffffc02024e2:	00002617          	auipc	a2,0x2
ffffffffc02024e6:	75e60613          	addi	a2,a2,1886 # ffffffffc0204c40 <commands+0x870>
ffffffffc02024ea:	1af00593          	li	a1,431
ffffffffc02024ee:	00003517          	auipc	a0,0x3
ffffffffc02024f2:	b6250513          	addi	a0,a0,-1182 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02024f6:	e7ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02024fa:	00003697          	auipc	a3,0x3
ffffffffc02024fe:	f6668693          	addi	a3,a3,-154 # ffffffffc0205460 <default_pmm_manager+0x488>
ffffffffc0202502:	00002617          	auipc	a2,0x2
ffffffffc0202506:	73e60613          	addi	a2,a2,1854 # ffffffffc0204c40 <commands+0x870>
ffffffffc020250a:	1b900593          	li	a1,441
ffffffffc020250e:	00003517          	auipc	a0,0x3
ffffffffc0202512:	b4250513          	addi	a0,a0,-1214 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202516:	e5ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020251a:	00003697          	auipc	a3,0x3
ffffffffc020251e:	efe68693          	addi	a3,a3,-258 # ffffffffc0205418 <default_pmm_manager+0x440>
ffffffffc0202522:	00002617          	auipc	a2,0x2
ffffffffc0202526:	71e60613          	addi	a2,a2,1822 # ffffffffc0204c40 <commands+0x870>
ffffffffc020252a:	1b700593          	li	a1,439
ffffffffc020252e:	00003517          	auipc	a0,0x3
ffffffffc0202532:	b2250513          	addi	a0,a0,-1246 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202536:	e3ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020253a:	00003697          	auipc	a3,0x3
ffffffffc020253e:	c7e68693          	addi	a3,a3,-898 # ffffffffc02051b8 <default_pmm_manager+0x1e0>
ffffffffc0202542:	00002617          	auipc	a2,0x2
ffffffffc0202546:	6fe60613          	addi	a2,a2,1790 # ffffffffc0204c40 <commands+0x870>
ffffffffc020254a:	19200593          	li	a1,402
ffffffffc020254e:	00003517          	auipc	a0,0x3
ffffffffc0202552:	b0250513          	addi	a0,a0,-1278 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc0202556:	e1ffd0ef          	jal	ra,ffffffffc0200374 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc020255a:	00003617          	auipc	a2,0x3
ffffffffc020255e:	c1660613          	addi	a2,a2,-1002 # ffffffffc0205170 <default_pmm_manager+0x198>
ffffffffc0202562:	0bd00593          	li	a1,189
ffffffffc0202566:	00003517          	auipc	a0,0x3
ffffffffc020256a:	aea50513          	addi	a0,a0,-1302 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc020256e:	e07fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202572:	00003697          	auipc	a3,0x3
ffffffffc0202576:	01668693          	addi	a3,a3,22 # ffffffffc0205588 <default_pmm_manager+0x5b0>
ffffffffc020257a:	00002617          	auipc	a2,0x2
ffffffffc020257e:	6c660613          	addi	a2,a2,1734 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202582:	1d800593          	li	a1,472
ffffffffc0202586:	00003517          	auipc	a0,0x3
ffffffffc020258a:	aca50513          	addi	a0,a0,-1334 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc020258e:	de7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202592:	00003697          	auipc	a3,0x3
ffffffffc0202596:	fde68693          	addi	a3,a3,-34 # ffffffffc0205570 <default_pmm_manager+0x598>
ffffffffc020259a:	00002617          	auipc	a2,0x2
ffffffffc020259e:	6a660613          	addi	a2,a2,1702 # ffffffffc0204c40 <commands+0x870>
ffffffffc02025a2:	1d700593          	li	a1,471
ffffffffc02025a6:	00003517          	auipc	a0,0x3
ffffffffc02025aa:	aaa50513          	addi	a0,a0,-1366 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02025ae:	dc7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc02025b2:	00003697          	auipc	a3,0x3
ffffffffc02025b6:	f8668693          	addi	a3,a3,-122 # ffffffffc0205538 <default_pmm_manager+0x560>
ffffffffc02025ba:	00002617          	auipc	a2,0x2
ffffffffc02025be:	68660613          	addi	a2,a2,1670 # ffffffffc0204c40 <commands+0x870>
ffffffffc02025c2:	1d600593          	li	a1,470
ffffffffc02025c6:	00003517          	auipc	a0,0x3
ffffffffc02025ca:	a8a50513          	addi	a0,a0,-1398 # ffffffffc0205050 <default_pmm_manager+0x78>
ffffffffc02025ce:	da7fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc02025d2:	00003697          	auipc	a3,0x3
ffffffffc02025d6:	f4e68693          	addi	a3,a3,-178 # ffffffffc0205520 <default_pmm_manager+0x548>
ffffffffc02025da:	00002617          	auipc	a2,0x2
ffffffffc02025de:	66660613          	addi	a2,a2,1638 # ffffffffc0204c40 <commands+0x870>
ffffffffc02025e2:	1d200593          	li	a1,466
ffffffffc02025e6:	00003517          	auipc	a0,0x3
ffffffffc02025ea:	a6a50513          	addi	a0,a0,-1430 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc0202662:	a7268693          	addi	a3,a3,-1422 # ffffffffc02050d0 <default_pmm_manager+0xf8>
ffffffffc0202666:	00002617          	auipc	a2,0x2
ffffffffc020266a:	5da60613          	addi	a2,a2,1498 # ffffffffc0204c40 <commands+0x870>
ffffffffc020266e:	17a00593          	li	a1,378
ffffffffc0202672:	00003517          	auipc	a0,0x3
ffffffffc0202676:	9de50513          	addi	a0,a0,-1570 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc02026b8:	57478793          	addi	a5,a5,1396 # ffffffffc0204c28 <commands+0x858>
...
ffffffffc02026f6:	97e68693          	addi	a3,a3,-1666 # ffffffffc0205070 <default_pmm_manager+0x98>
ffffffffc02026fa:	00002617          	auipc	a2,0x2
ffffffffc02026fe:	54660613          	addi	a2,a2,1350 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202702:	1f000593          	li	a1,496
ffffffffc0202706:	00003517          	auipc	a0,0x3
ffffffffc020270a:	94a50513          	addi	a0,a0,-1718 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc0202718:	91460613          	addi	a2,a2,-1772 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc020271c:	06a00593          	li	a1,106
ffffffffc0202720:	00003517          	auipc	a0,0x3
ffffffffc0202724:	9a050513          	addi	a0,a0,-1632 # ffffffffc02050c0 <default_pmm_manager+0xe8>
ffffffffc0202728:	c4dfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(base != NULL);
ffffffffc020272c:	00003697          	auipc	a3,0x3
ffffffffc0202730:	96468693          	addi	a3,a3,-1692 # ffffffffc0205090 <default_pmm_manager+0xb8>
ffffffffc0202734:	00002617          	auipc	a2,0x2
ffffffffc0202738:	50c60613          	addi	a2,a2,1292 # ffffffffc0204c40 <commands+0x870>
ffffffffc020273c:	1f300593          	li	a1,499
ffffffffc0202740:	00003517          	auipc	a0,0x3
ffffffffc0202744:	91050513          	addi	a0,a0,-1776 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc02027b2:	8c268693          	addi	a3,a3,-1854 # ffffffffc0205070 <default_pmm_manager+0x98>
ffffffffc02027b6:	00002617          	auipc	a2,0x2
ffffffffc02027ba:	48a60613          	addi	a2,a2,1162 # ffffffffc0204c40 <commands+0x870>
ffffffffc02027be:	1f900593          	li	a1,505
ffffffffc02027c2:	00003517          	auipc	a0,0x3
ffffffffc02027c6:	88e50513          	addi	a0,a0,-1906 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc02027d8:	99c60613          	addi	a2,a2,-1636 # ffffffffc0205170 <default_pmm_manager+0x198>
ffffffffc02027dc:	06c00593          	li	a1,108
ffffffffc02027e0:	00003517          	auipc	a0,0x3
ffffffffc02027e4:	8e050513          	addi	a0,a0,-1824 # ffffffffc02050c0 <default_pmm_manager+0xe8>
ffffffffc02027e8:	b8dfd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(ptr != NULL);
ffffffffc02027ec:	00003697          	auipc	a3,0x3
ffffffffc02027f0:	87468693          	addi	a3,a3,-1932 # ffffffffc0205060 <default_pmm_manager+0x88>
ffffffffc02027f4:	00002617          	auipc	a2,0x2
ffffffffc02027f8:	44c60613          	addi	a2,a2,1100 # ffffffffc0204c40 <commands+0x870>
ffffffffc02027fc:	1fa00593          	li	a1,506
ffffffffc0202800:	00003517          	auipc	a0,0x3
ffffffffc0202804:	85050513          	addi	a0,a0,-1968 # ffffffffc0205050 <default_pmm_manager+0x78>
...
ffffffffc0202826:	fc6e                	sd	s11,56(sp)
     swapfs_init();
ffffffffc0202828:	37e010ef          	jal	ra,ffffffffc0203ba6 <swapfs_init>
...
ffffffffc020288a:	e7250513          	addi	a0,a0,-398 # ffffffffc02056f8 <default_pmm_manager+0x720>
    return listelm->next;
...
ffffffffc02028e8:	e2c50513          	addi	a0,a0,-468 # ffffffffc0205710 <default_pmm_manager+0x738>
ffffffffc02028ec:	fd2fd0ef          	jal	ra,ffffffffc02000be <cprintf>
     
     //now we set the phy pages env     
     struct mm_struct *mm = mm_create();
ffffffffc02028f0:	2e9000ef          	jal	ra,ffffffffc02033d8 <mm_create>
...
ffffffffc020292a:	2fb000ef          	jal	ra,ffffffffc0203424 <vma_create>
...
ffffffffc0202936:	35b000ef          	jal	ra,ffffffffc0203490 <insert_vma_struct>

     //setup the temp Page Table vaddr 0~4MB
     cprintf("setup Page Table for vaddr 0X1000, so alloc a page\n");
ffffffffc020293a:	00003517          	auipc	a0,0x3
ffffffffc020293e:	e4650513          	addi	a0,a0,-442 # ffffffffc0205780 <default_pmm_manager+0x7a8>
...
ffffffffc020295a:	e7a50513          	addi	a0,a0,-390 # ffffffffc02057d0 <default_pmm_manager+0x7f8>
...
ffffffffc02029da:	e8250513          	addi	a0,a0,-382 # ffffffffc0205858 <default_pmm_manager+0x880>
...
ffffffffc0202aba:	5e2d0d13          	addi	s10,s10,1506 # ffffffffc0206098 <nbase>
...
ffffffffc0202b1e:	de650513          	addi	a0,a0,-538 # ffffffffc0205900 <default_pmm_manager+0x928>
...
ffffffffc0202b4a:	215000ef          	jal	ra,ffffffffc020355e <mm_destroy>
...
ffffffffc0202b86:	dae50513          	addi	a0,a0,-594 # ffffffffc0205930 <default_pmm_manager+0x958>
ffffffffc0202b8a:	d34fd0ef          	jal	ra,ffffffffc02000be <cprintf>
     //assert(count == 0);
     
     cprintf("check_swap() succeeded!\n");
ffffffffc0202b8e:	00003517          	auipc	a0,0x3
ffffffffc0202b92:	dc250513          	addi	a0,a0,-574 # ffffffffc0205950 <default_pmm_manager+0x978>
...
ffffffffc0202ba8:	08c68693          	addi	a3,a3,140 # ffffffffc0204c30 <commands+0x860>
ffffffffc0202bac:	00002617          	auipc	a2,0x2
ffffffffc0202bb0:	09460613          	addi	a2,a2,148 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202bb4:	0ba00593          	li	a1,186
ffffffffc0202bb8:	00003517          	auipc	a0,0x3
ffffffffc0202bbc:	b3050513          	addi	a0,a0,-1232 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202bc0:	fb4fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202bc4:	00003697          	auipc	a3,0x3
ffffffffc0202bc8:	d1468693          	addi	a3,a3,-748 # ffffffffc02058d8 <default_pmm_manager+0x900>
ffffffffc0202bcc:	00002617          	auipc	a2,0x2
ffffffffc0202bd0:	07460613          	addi	a2,a2,116 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202bd4:	0fa00593          	li	a1,250
ffffffffc0202bd8:	00003517          	auipc	a0,0x3
ffffffffc0202bdc:	b1050513          	addi	a0,a0,-1264 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202be0:	f94fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202be4:	00002617          	auipc	a2,0x2
ffffffffc0202be8:	6b460613          	addi	a2,a2,1716 # ffffffffc0205298 <default_pmm_manager+0x2c0>
ffffffffc0202bec:	07000593          	li	a1,112
ffffffffc0202bf0:	00002517          	auipc	a0,0x2
ffffffffc0202bf4:	4d050513          	addi	a0,a0,1232 # ffffffffc02050c0 <default_pmm_manager+0xe8>
ffffffffc0202bf8:	f7cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0202bfc:	00002617          	auipc	a2,0x2
ffffffffc0202c00:	4a460613          	addi	a2,a2,1188 # ffffffffc02050a0 <default_pmm_manager+0xc8>
ffffffffc0202c04:	06500593          	li	a1,101
ffffffffc0202c08:	00002517          	auipc	a0,0x2
ffffffffc0202c0c:	4b850513          	addi	a0,a0,1208 # ffffffffc02050c0 <default_pmm_manager+0xe8>
ffffffffc0202c10:	f64fd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0202c14:	00003697          	auipc	a3,0x3
ffffffffc0202c18:	bfc68693          	addi	a3,a3,-1028 # ffffffffc0205810 <default_pmm_manager+0x838>
ffffffffc0202c1c:	00002617          	auipc	a2,0x2
ffffffffc0202c20:	02460613          	addi	a2,a2,36 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202c24:	0db00593          	li	a1,219
ffffffffc0202c28:	00003517          	auipc	a0,0x3
ffffffffc0202c2c:	ac050513          	addi	a0,a0,-1344 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202c30:	f44fd0ef          	jal	ra,ffffffffc0200374 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202c34:	00003697          	auipc	a3,0x3
ffffffffc0202c38:	bc468693          	addi	a3,a3,-1084 # ffffffffc02057f8 <default_pmm_manager+0x820>
ffffffffc0202c3c:	00002617          	auipc	a2,0x2
ffffffffc0202c40:	00460613          	addi	a2,a2,4 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202c44:	0da00593          	li	a1,218
ffffffffc0202c48:	00003517          	auipc	a0,0x3
ffffffffc0202c4c:	aa050513          	addi	a0,a0,-1376 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202c50:	f24fd0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202c54:	00003697          	auipc	a3,0x3
ffffffffc0202c58:	c6c68693          	addi	a3,a3,-916 # ffffffffc02058c0 <default_pmm_manager+0x8e8>
ffffffffc0202c5c:	00002617          	auipc	a2,0x2
ffffffffc0202c60:	fe460613          	addi	a2,a2,-28 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202c64:	0f900593          	li	a1,249
ffffffffc0202c68:	00003517          	auipc	a0,0x3
ffffffffc0202c6c:	a8050513          	addi	a0,a0,-1408 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202c70:	f04fd0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202c74:	00003617          	auipc	a2,0x3
ffffffffc0202c78:	a5460613          	addi	a2,a2,-1452 # ffffffffc02056c8 <default_pmm_manager+0x6f0>
ffffffffc0202c7c:	02700593          	li	a1,39
ffffffffc0202c80:	00003517          	auipc	a0,0x3
ffffffffc0202c84:	a6850513          	addi	a0,a0,-1432 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202c88:	eecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202c8c:	00003697          	auipc	a3,0x3
ffffffffc0202c90:	c0468693          	addi	a3,a3,-1020 # ffffffffc0205890 <default_pmm_manager+0x8b8>
ffffffffc0202c94:	00002617          	auipc	a2,0x2
ffffffffc0202c98:	fac60613          	addi	a2,a2,-84 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202c9c:	09500593          	li	a1,149
ffffffffc0202ca0:	00003517          	auipc	a0,0x3
ffffffffc0202ca4:	a4850513          	addi	a0,a0,-1464 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202ca8:	eccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==2);
ffffffffc0202cac:	00003697          	auipc	a3,0x3
ffffffffc0202cb0:	be468693          	addi	a3,a3,-1052 # ffffffffc0205890 <default_pmm_manager+0x8b8>
ffffffffc0202cb4:	00002617          	auipc	a2,0x2
ffffffffc0202cb8:	f8c60613          	addi	a2,a2,-116 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202cbc:	09700593          	li	a1,151
ffffffffc0202cc0:	00003517          	auipc	a0,0x3
ffffffffc0202cc4:	a2850513          	addi	a0,a0,-1496 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202cc8:	eacfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202ccc:	00003697          	auipc	a3,0x3
ffffffffc0202cd0:	bd468693          	addi	a3,a3,-1068 # ffffffffc02058a0 <default_pmm_manager+0x8c8>
ffffffffc0202cd4:	00002617          	auipc	a2,0x2
ffffffffc0202cd8:	f6c60613          	addi	a2,a2,-148 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202cdc:	09900593          	li	a1,153
ffffffffc0202ce0:	00003517          	auipc	a0,0x3
ffffffffc0202ce4:	a0850513          	addi	a0,a0,-1528 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202ce8:	e8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==3);
ffffffffc0202cec:	00003697          	auipc	a3,0x3
ffffffffc0202cf0:	bb468693          	addi	a3,a3,-1100 # ffffffffc02058a0 <default_pmm_manager+0x8c8>
ffffffffc0202cf4:	00002617          	auipc	a2,0x2
ffffffffc0202cf8:	f4c60613          	addi	a2,a2,-180 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202cfc:	09b00593          	li	a1,155
ffffffffc0202d00:	00003517          	auipc	a0,0x3
ffffffffc0202d04:	9e850513          	addi	a0,a0,-1560 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202d08:	e6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202d0c:	00003697          	auipc	a3,0x3
ffffffffc0202d10:	b7468693          	addi	a3,a3,-1164 # ffffffffc0205880 <default_pmm_manager+0x8a8>
ffffffffc0202d14:	00002617          	auipc	a2,0x2
ffffffffc0202d18:	f2c60613          	addi	a2,a2,-212 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202d1c:	09100593          	li	a1,145
ffffffffc0202d20:	00003517          	auipc	a0,0x3
ffffffffc0202d24:	9c850513          	addi	a0,a0,-1592 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202d28:	e4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==1);
ffffffffc0202d2c:	00003697          	auipc	a3,0x3
ffffffffc0202d30:	b5468693          	addi	a3,a3,-1196 # ffffffffc0205880 <default_pmm_manager+0x8a8>
ffffffffc0202d34:	00002617          	auipc	a2,0x2
ffffffffc0202d38:	f0c60613          	addi	a2,a2,-244 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202d3c:	09300593          	li	a1,147
ffffffffc0202d40:	00003517          	auipc	a0,0x3
ffffffffc0202d44:	9a850513          	addi	a0,a0,-1624 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202d48:	e2cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0202d4c:	00003697          	auipc	a3,0x3
ffffffffc0202d50:	ae468693          	addi	a3,a3,-1308 # ffffffffc0205830 <default_pmm_manager+0x858>
ffffffffc0202d54:	00002617          	auipc	a2,0x2
ffffffffc0202d58:	eec60613          	addi	a2,a2,-276 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202d5c:	0e800593          	li	a1,232
ffffffffc0202d60:	00003517          	auipc	a0,0x3
ffffffffc0202d64:	98850513          	addi	a0,a0,-1656 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202d68:	e0cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc0202d6c:	00003697          	auipc	a3,0x3
ffffffffc0202d70:	a4c68693          	addi	a3,a3,-1460 # ffffffffc02057b8 <default_pmm_manager+0x7e0>
ffffffffc0202d74:	00002617          	auipc	a2,0x2
ffffffffc0202d78:	ecc60613          	addi	a2,a2,-308 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202d7c:	0d500593          	li	a1,213
ffffffffc0202d80:	00003517          	auipc	a0,0x3
ffffffffc0202d84:	96850513          	addi	a0,a0,-1688 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202d88:	decfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202d8c:	00003697          	auipc	a3,0x3
ffffffffc0202d90:	b2468693          	addi	a3,a3,-1244 # ffffffffc02058b0 <default_pmm_manager+0x8d8>
ffffffffc0202d94:	00002617          	auipc	a2,0x2
ffffffffc0202d98:	eac60613          	addi	a2,a2,-340 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202d9c:	09d00593          	li	a1,157
ffffffffc0202da0:	00003517          	auipc	a0,0x3
ffffffffc0202da4:	94850513          	addi	a0,a0,-1720 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202da8:	dccfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgfault_num==4);
ffffffffc0202dac:	00003697          	auipc	a3,0x3
ffffffffc0202db0:	b0468693          	addi	a3,a3,-1276 # ffffffffc02058b0 <default_pmm_manager+0x8d8>
ffffffffc0202db4:	00002617          	auipc	a2,0x2
ffffffffc0202db8:	e8c60613          	addi	a2,a2,-372 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202dbc:	09f00593          	li	a1,159
ffffffffc0202dc0:	00003517          	auipc	a0,0x3
ffffffffc0202dc4:	92850513          	addi	a0,a0,-1752 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202dc8:	dacfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert( nr_free == 0);         
ffffffffc0202dcc:	00002697          	auipc	a3,0x2
ffffffffc0202dd0:	04c68693          	addi	a3,a3,76 # ffffffffc0204e18 <commands+0xa48>
ffffffffc0202dd4:	00002617          	auipc	a2,0x2
ffffffffc0202dd8:	e6c60613          	addi	a2,a2,-404 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202ddc:	0f100593          	li	a1,241
ffffffffc0202de0:	00003517          	auipc	a0,0x3
ffffffffc0202de4:	90850513          	addi	a0,a0,-1784 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202de8:	d8cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(ret==0);
ffffffffc0202dec:	00003697          	auipc	a3,0x3
ffffffffc0202df0:	b3c68693          	addi	a3,a3,-1220 # ffffffffc0205928 <default_pmm_manager+0x950>
ffffffffc0202df4:	00002617          	auipc	a2,0x2
ffffffffc0202df8:	e4c60613          	addi	a2,a2,-436 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202dfc:	10000593          	li	a1,256
ffffffffc0202e00:	00003517          	auipc	a0,0x3
ffffffffc0202e04:	8e850513          	addi	a0,a0,-1816 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202e08:	d6cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(mm != NULL);
ffffffffc0202e0c:	00003697          	auipc	a3,0x3
ffffffffc0202e10:	92c68693          	addi	a3,a3,-1748 # ffffffffc0205738 <default_pmm_manager+0x760>
ffffffffc0202e14:	00002617          	auipc	a2,0x2
ffffffffc0202e18:	e2c60613          	addi	a2,a2,-468 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202e1c:	0c200593          	li	a1,194
ffffffffc0202e20:	00003517          	auipc	a0,0x3
ffffffffc0202e24:	8c850513          	addi	a0,a0,-1848 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202e28:	d4cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0202e2c:	00003697          	auipc	a3,0x3
ffffffffc0202e30:	91c68693          	addi	a3,a3,-1764 # ffffffffc0205748 <default_pmm_manager+0x770>
ffffffffc0202e34:	00002617          	auipc	a2,0x2
ffffffffc0202e38:	e0c60613          	addi	a2,a2,-500 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202e3c:	0c500593          	li	a1,197
ffffffffc0202e40:	00003517          	auipc	a0,0x3
ffffffffc0202e44:	8a850513          	addi	a0,a0,-1880 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202e48:	d2cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0202e4c:	00003697          	auipc	a3,0x3
ffffffffc0202e50:	91468693          	addi	a3,a3,-1772 # ffffffffc0205760 <default_pmm_manager+0x788>
ffffffffc0202e54:	00002617          	auipc	a2,0x2
ffffffffc0202e58:	dec60613          	addi	a2,a2,-532 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202e5c:	0ca00593          	li	a1,202
ffffffffc0202e60:	00003517          	auipc	a0,0x3
ffffffffc0202e64:	88850513          	addi	a0,a0,-1912 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202e68:	d0cfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(vma != NULL);
ffffffffc0202e6c:	00003697          	auipc	a3,0x3
ffffffffc0202e70:	90468693          	addi	a3,a3,-1788 # ffffffffc0205770 <default_pmm_manager+0x798>
ffffffffc0202e74:	00002617          	auipc	a2,0x2
ffffffffc0202e78:	dcc60613          	addi	a2,a2,-564 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202e7c:	0cd00593          	li	a1,205
ffffffffc0202e80:	00003517          	auipc	a0,0x3
ffffffffc0202e84:	86850513          	addi	a0,a0,-1944 # ffffffffc02056e8 <default_pmm_manager+0x710>
ffffffffc0202e88:	cecfd0ef          	jal	ra,ffffffffc0200374 <__panic>
     assert(total == nr_free_pages());
ffffffffc0202e8c:	00002697          	auipc	a3,0x2
ffffffffc0202e90:	de468693          	addi	a3,a3,-540 # ffffffffc0204c70 <commands+0x8a0>
ffffffffc0202e94:	00002617          	auipc	a2,0x2
ffffffffc0202e98:	dac60613          	addi	a2,a2,-596 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202e9c:	0bd00593          	li	a1,189
ffffffffc0202ea0:	00003517          	auipc	a0,0x3
ffffffffc0202ea4:	84850513          	addi	a0,a0,-1976 # ffffffffc02056e8 <default_pmm_manager+0x710>
...
ffffffffc0202ef8:	adcb0b13          	addi	s6,s6,-1316 # ffffffffc02059d0 <default_pmm_manager+0x9f8>
                    cprintf("SWAP: failed to save\n");
ffffffffc0202efc:	00003b97          	auipc	s7,0x3
ffffffffc0202f00:	abcb8b93          	addi	s7,s7,-1348 # ffffffffc02059b8 <default_pmm_manager+0x9e0>
...
ffffffffc0202f70:	515000ef          	jal	ra,ffffffffc0203c84 <swapfs_write>
...
ffffffffc0202fb2:	9c250513          	addi	a0,a0,-1598 # ffffffffc0205970 <default_pmm_manager+0x998>
...
ffffffffc0202fc4:	9e068693          	addi	a3,a3,-1568 # ffffffffc02059a0 <default_pmm_manager+0x9c8>
ffffffffc0202fc8:	00002617          	auipc	a2,0x2
ffffffffc0202fcc:	c7860613          	addi	a2,a2,-904 # ffffffffc0204c40 <commands+0x870>
ffffffffc0202fd0:	06600593          	li	a1,102
ffffffffc0202fd4:	00002517          	auipc	a0,0x2
ffffffffc0202fd8:	71450513          	addi	a0,a0,1812 # ffffffffc02056e8 <default_pmm_manager+0x710>
...
ffffffffc020300e:	3d1000ef          	jal	ra,ffffffffc0203bde <swapfs_read>
     cprintf("swap_in: load disk swap entry %d with swap_page in vadr 0x%x\n", (*ptep)>>8, addr);
ffffffffc0203012:	00093583          	ld	a1,0(s2)
ffffffffc0203016:	8626                	mv	a2,s1
ffffffffc0203018:	00002517          	auipc	a0,0x2
ffffffffc020301c:	67050513          	addi	a0,a0,1648 # ffffffffc0205688 <default_pmm_manager+0x6b0>
...
ffffffffc020303e:	63e68693          	addi	a3,a3,1598 # ffffffffc0205678 <default_pmm_manager+0x6a0>
ffffffffc0203042:	00002617          	auipc	a2,0x2
ffffffffc0203046:	bfe60613          	addi	a2,a2,-1026 # ffffffffc0204c40 <commands+0x870>
ffffffffc020304a:	07c00593          	li	a1,124
ffffffffc020304e:	00002517          	auipc	a0,0x2
ffffffffc0203052:	69a50513          	addi	a0,a0,1690 # ffffffffc02056e8 <default_pmm_manager+0x710>
...
ffffffffc020313c:	77868693          	addi	a3,a3,1912 # ffffffffc02058b0 <default_pmm_manager+0x8d8>
ffffffffc0203140:	00002617          	auipc	a2,0x2
ffffffffc0203144:	b0060613          	addi	a2,a2,-1280 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203148:	08d00593          	li	a1,141
ffffffffc020314c:	00003517          	auipc	a0,0x3
ffffffffc0203150:	8c450513          	addi	a0,a0,-1852 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203154:	a20fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==6);
ffffffffc0203158:	00003697          	auipc	a3,0x3
ffffffffc020315c:	90868693          	addi	a3,a3,-1784 # ffffffffc0205a60 <default_pmm_manager+0xa88>
ffffffffc0203160:	00002617          	auipc	a2,0x2
ffffffffc0203164:	ae060613          	addi	a2,a2,-1312 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203168:	0a400593          	li	a1,164
ffffffffc020316c:	00003517          	auipc	a0,0x3
ffffffffc0203170:	8a450513          	addi	a0,a0,-1884 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203174:	a00fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203178:	00003697          	auipc	a3,0x3
ffffffffc020317c:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205a38 <default_pmm_manager+0xa60>
ffffffffc0203180:	00002617          	auipc	a2,0x2
ffffffffc0203184:	ac060613          	addi	a2,a2,-1344 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203188:	0a200593          	li	a1,162
ffffffffc020318c:	00003517          	auipc	a0,0x3
ffffffffc0203190:	88450513          	addi	a0,a0,-1916 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203194:	9e0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203198:	00003697          	auipc	a3,0x3
ffffffffc020319c:	89068693          	addi	a3,a3,-1904 # ffffffffc0205a28 <default_pmm_manager+0xa50>
ffffffffc02031a0:	00002617          	auipc	a2,0x2
ffffffffc02031a4:	aa060613          	addi	a2,a2,-1376 # ffffffffc0204c40 <commands+0x870>
ffffffffc02031a8:	0a100593          	li	a1,161
ffffffffc02031ac:	00003517          	auipc	a0,0x3
ffffffffc02031b0:	86450513          	addi	a0,a0,-1948 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc02031b4:	9c0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02031b8:	00003697          	auipc	a3,0x3
ffffffffc02031bc:	87068693          	addi	a3,a3,-1936 # ffffffffc0205a28 <default_pmm_manager+0xa50>
ffffffffc02031c0:	00002617          	auipc	a2,0x2
ffffffffc02031c4:	a8060613          	addi	a2,a2,-1408 # ffffffffc0204c40 <commands+0x870>
ffffffffc02031c8:	09f00593          	li	a1,159
ffffffffc02031cc:	00003517          	auipc	a0,0x3
ffffffffc02031d0:	84450513          	addi	a0,a0,-1980 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc02031d4:	9a0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02031d8:	00003697          	auipc	a3,0x3
ffffffffc02031dc:	85068693          	addi	a3,a3,-1968 # ffffffffc0205a28 <default_pmm_manager+0xa50>
ffffffffc02031e0:	00002617          	auipc	a2,0x2
ffffffffc02031e4:	a6060613          	addi	a2,a2,-1440 # ffffffffc0204c40 <commands+0x870>
ffffffffc02031e8:	09d00593          	li	a1,157
ffffffffc02031ec:	00003517          	auipc	a0,0x3
ffffffffc02031f0:	82450513          	addi	a0,a0,-2012 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc02031f4:	980fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc02031f8:	00003697          	auipc	a3,0x3
ffffffffc02031fc:	83068693          	addi	a3,a3,-2000 # ffffffffc0205a28 <default_pmm_manager+0xa50>
ffffffffc0203200:	00002617          	auipc	a2,0x2
ffffffffc0203204:	a4060613          	addi	a2,a2,-1472 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203208:	09b00593          	li	a1,155
ffffffffc020320c:	00003517          	auipc	a0,0x3
ffffffffc0203210:	80450513          	addi	a0,a0,-2044 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203214:	960fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203218:	00003697          	auipc	a3,0x3
ffffffffc020321c:	81068693          	addi	a3,a3,-2032 # ffffffffc0205a28 <default_pmm_manager+0xa50>
ffffffffc0203220:	00002617          	auipc	a2,0x2
ffffffffc0203224:	a2060613          	addi	a2,a2,-1504 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203228:	09900593          	li	a1,153
ffffffffc020322c:	00002517          	auipc	a0,0x2
ffffffffc0203230:	7e450513          	addi	a0,a0,2020 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203234:	940fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203238:	00002697          	auipc	a3,0x2
ffffffffc020323c:	7f068693          	addi	a3,a3,2032 # ffffffffc0205a28 <default_pmm_manager+0xa50>
ffffffffc0203240:	00002617          	auipc	a2,0x2
ffffffffc0203244:	a0060613          	addi	a2,a2,-1536 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203248:	09700593          	li	a1,151
ffffffffc020324c:	00002517          	auipc	a0,0x2
ffffffffc0203250:	7c450513          	addi	a0,a0,1988 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203254:	920fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==5);
ffffffffc0203258:	00002697          	auipc	a3,0x2
ffffffffc020325c:	7d068693          	addi	a3,a3,2000 # ffffffffc0205a28 <default_pmm_manager+0xa50>
ffffffffc0203260:	00002617          	auipc	a2,0x2
ffffffffc0203264:	9e060613          	addi	a2,a2,-1568 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203268:	09500593          	li	a1,149
ffffffffc020326c:	00002517          	auipc	a0,0x2
ffffffffc0203270:	7a450513          	addi	a0,a0,1956 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203274:	900fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203278:	00002697          	auipc	a3,0x2
ffffffffc020327c:	63868693          	addi	a3,a3,1592 # ffffffffc02058b0 <default_pmm_manager+0x8d8>
ffffffffc0203280:	00002617          	auipc	a2,0x2
ffffffffc0203284:	9c060613          	addi	a2,a2,-1600 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203288:	09300593          	li	a1,147
ffffffffc020328c:	00002517          	auipc	a0,0x2
ffffffffc0203290:	78450513          	addi	a0,a0,1924 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203294:	8e0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc0203298:	00002697          	auipc	a3,0x2
ffffffffc020329c:	61868693          	addi	a3,a3,1560 # ffffffffc02058b0 <default_pmm_manager+0x8d8>
ffffffffc02032a0:	00002617          	auipc	a2,0x2
ffffffffc02032a4:	9a060613          	addi	a2,a2,-1632 # ffffffffc0204c40 <commands+0x870>
ffffffffc02032a8:	09100593          	li	a1,145
ffffffffc02032ac:	00002517          	auipc	a0,0x2
ffffffffc02032b0:	76450513          	addi	a0,a0,1892 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc02032b4:	8c0fd0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgfault_num==4);
ffffffffc02032b8:	00002697          	auipc	a3,0x2
ffffffffc02032bc:	5f868693          	addi	a3,a3,1528 # ffffffffc02058b0 <default_pmm_manager+0x8d8>
ffffffffc02032c0:	00002617          	auipc	a2,0x2
ffffffffc02032c4:	98060613          	addi	a2,a2,-1664 # ffffffffc0204c40 <commands+0x870>
ffffffffc02032c8:	08f00593          	li	a1,143
ffffffffc02032cc:	00002517          	auipc	a0,0x2
ffffffffc02032d0:	74450513          	addi	a0,a0,1860 # ffffffffc0205a10 <default_pmm_manager+0xa38>
...
ffffffffc02032dc:	7518                	ld	a4,40(a0)
    assert(entry != NULL && curr_ptr != NULL);
ffffffffc02032de:	c385                	beqz	a5,ffffffffc02032fe <_clock_map_swappable+0x26>
ffffffffc02032e0:	0000e697          	auipc	a3,0xe
ffffffffc02032e4:	2a868693          	addi	a3,a3,680 # ffffffffc0211588 <curr_ptr>
ffffffffc02032e8:	6294                	ld	a3,0(a3)
ffffffffc02032ea:	ca91                	beqz	a3,ffffffffc02032fe <_clock_map_swappable+0x26>
    __list_add(elm, listelm->prev, listelm);
ffffffffc02032ec:	6314                	ld	a3,0(a4)
    prev->next = next->prev = elm;
ffffffffc02032ee:	e31c                	sd	a5,0(a4)
}
ffffffffc02032f0:	4501                	li	a0,0
ffffffffc02032f2:	e69c                	sd	a5,8(a3)
    page->visited = 1;
ffffffffc02032f4:	4785                	li	a5,1
    elm->next = next;
ffffffffc02032f6:	fe18                	sd	a4,56(a2)
    elm->prev = prev;
ffffffffc02032f8:	fa14                	sd	a3,48(a2)
...
ffffffffc0203304:	77068693          	addi	a3,a3,1904 # ffffffffc0205a70 <default_pmm_manager+0xa98>
ffffffffc0203308:	00002617          	auipc	a2,0x2
ffffffffc020330c:	93860613          	addi	a2,a2,-1736 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203310:	03700593          	li	a1,55
ffffffffc0203314:	00002517          	auipc	a0,0x2
ffffffffc0203318:	6fc50513          	addi	a0,a0,1788 # ffffffffc0205a10 <default_pmm_manager+0xa38>
{
...
ffffffffc0203326:	e406                	sd	ra,8(sp)
         assert(head != NULL);
ffffffffc0203328:	c735                	beqz	a4,ffffffffc0203394 <_clock_swap_out_victim+0x72>
     assert(in_tick==0);
ffffffffc020332a:	e629                	bnez	a2,ffffffffc0203374 <_clock_swap_out_victim+0x52>
    return listelm->next;
ffffffffc020332c:	671c                	ld	a5,8(a4)
        curr_ptr = list_next(head);
ffffffffc020332e:	0000e697          	auipc	a3,0xe
ffffffffc0203332:	24f6bd23          	sd	a5,602(a3) # ffffffffc0211588 <curr_ptr>
        if (curr_ptr != head) {
ffffffffc0203336:	02e78963          	beq	a5,a4,ffffffffc0203368 <_clock_swap_out_victim+0x46>
            if(!page->visited) {
ffffffffc020333a:	fe07b703          	ld	a4,-32(a5)
ffffffffc020333e:	c319                	beqz	a4,ffffffffc0203344 <_clock_swap_out_victim+0x22>
ffffffffc0203340:	fe07b023          	sd	zero,-32(a5)
    __list_del(listelm->prev, listelm->next);
ffffffffc0203344:	6394                	ld	a3,0(a5)
ffffffffc0203346:	6798                	ld	a4,8(a5)
            struct Page* page = le2page(curr_ptr, pra_page_link);
ffffffffc0203348:	fd078613          	addi	a2,a5,-48
                *ptr_page = page;
ffffffffc020334c:	e190                	sd	a2,0(a1)
    prev->next = next;
ffffffffc020334e:	e698                	sd	a4,8(a3)
    next->prev = prev;
ffffffffc0203350:	e314                	sd	a3,0(a4)
                cprintf("curr_ptr %p\n",curr_ptr);
ffffffffc0203352:	85be                	mv	a1,a5
ffffffffc0203354:	00002517          	auipc	a0,0x2
ffffffffc0203358:	76450513          	addi	a0,a0,1892 # ffffffffc0205ab8 <default_pmm_manager+0xae0>
ffffffffc020335c:	d63fc0ef          	jal	ra,ffffffffc02000be <cprintf>
}
ffffffffc0203360:	60a2                	ld	ra,8(sp)
ffffffffc0203362:	4501                	li	a0,0
ffffffffc0203364:	0141                	addi	sp,sp,16
ffffffffc0203366:	8082                	ret
ffffffffc0203368:	60a2                	ld	ra,8(sp)
            *ptr_page = NULL;
ffffffffc020336a:	0005b023          	sd	zero,0(a1) # 1000 <BASE_ADDRESS-0xffffffffc01ff000>
}
ffffffffc020336e:	4501                	li	a0,0
ffffffffc0203370:	0141                	addi	sp,sp,16
ffffffffc0203372:	8082                	ret
     assert(in_tick==0);
ffffffffc0203374:	00002697          	auipc	a3,0x2
ffffffffc0203378:	73468693          	addi	a3,a3,1844 # ffffffffc0205aa8 <default_pmm_manager+0xad0>
ffffffffc020337c:	00002617          	auipc	a2,0x2
ffffffffc0203380:	8c460613          	addi	a2,a2,-1852 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203384:	04a00593          	li	a1,74
ffffffffc0203388:	00002517          	auipc	a0,0x2
ffffffffc020338c:	68850513          	addi	a0,a0,1672 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc0203390:	fe5fc0ef          	jal	ra,ffffffffc0200374 <__panic>
         assert(head != NULL);
ffffffffc0203394:	00002697          	auipc	a3,0x2
ffffffffc0203398:	70468693          	addi	a3,a3,1796 # ffffffffc0205a98 <default_pmm_manager+0xac0>
ffffffffc020339c:	00002617          	auipc	a2,0x2
ffffffffc02033a0:	8a460613          	addi	a2,a2,-1884 # ffffffffc0204c40 <commands+0x870>
ffffffffc02033a4:	04900593          	li	a1,73
ffffffffc02033a8:	00002517          	auipc	a0,0x2
ffffffffc02033ac:	66850513          	addi	a0,a0,1640 # ffffffffc0205a10 <default_pmm_manager+0xa38>
ffffffffc02033b0:	fc5fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033b4 <check_vma_overlap.isra.0.part.1>:
}
...
ffffffffc02033b6:	00002697          	auipc	a3,0x2
ffffffffc02033ba:	72a68693          	addi	a3,a3,1834 # ffffffffc0205ae0 <default_pmm_manager+0xb08>
ffffffffc02033be:	00002617          	auipc	a2,0x2
ffffffffc02033c2:	88260613          	addi	a2,a2,-1918 # ffffffffc0204c40 <commands+0x870>
ffffffffc02033c6:	07d00593          	li	a1,125
ffffffffc02033ca:	00002517          	auipc	a0,0x2
ffffffffc02033ce:	73650513          	addi	a0,a0,1846 # ffffffffc0205b00 <default_pmm_manager+0xb28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
ffffffffc02033d2:	e406                	sd	ra,8(sp)
    assert(next->vm_start < next->vm_end);
ffffffffc02033d4:	fa1fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc02033d8 <mm_create>:
mm_create(void) {
ffffffffc02033d8:	1141                	addi	sp,sp,-16
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02033da:	03000513          	li	a0,48
mm_create(void) {
ffffffffc02033de:	e022                	sd	s0,0(sp)
ffffffffc02033e0:	e406                	sd	ra,8(sp)
    struct mm_struct *mm = kmalloc(sizeof(struct mm_struct));
ffffffffc02033e2:	aa8ff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc02033e6:	842a                	mv	s0,a0
    if (mm != NULL) {
ffffffffc02033e8:	c115                	beqz	a0,ffffffffc020340c <mm_create+0x34>
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc02033ea:	0000e797          	auipc	a5,0xe
ffffffffc02033ee:	07e78793          	addi	a5,a5,126 # ffffffffc0211468 <swap_init_ok>
ffffffffc02033f2:	439c                	lw	a5,0(a5)
    elm->prev = elm->next = elm;
ffffffffc02033f4:	e408                	sd	a0,8(s0)
ffffffffc02033f6:	e008                	sd	a0,0(s0)
        mm->mmap_cache = NULL;
ffffffffc02033f8:	00053823          	sd	zero,16(a0)
        mm->pgdir = NULL;
ffffffffc02033fc:	00053c23          	sd	zero,24(a0)
        mm->map_count = 0;
ffffffffc0203400:	02052023          	sw	zero,32(a0)
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203404:	2781                	sext.w	a5,a5
ffffffffc0203406:	eb81                	bnez	a5,ffffffffc0203416 <mm_create+0x3e>
        else mm->sm_priv = NULL;
ffffffffc0203408:	02053423          	sd	zero,40(a0)
}
ffffffffc020340c:	8522                	mv	a0,s0
ffffffffc020340e:	60a2                	ld	ra,8(sp)
ffffffffc0203410:	6402                	ld	s0,0(sp)
ffffffffc0203412:	0141                	addi	sp,sp,16
ffffffffc0203414:	8082                	ret
        if (swap_init_ok) swap_init_mm(mm);
ffffffffc0203416:	a97ff0ef          	jal	ra,ffffffffc0202eac <swap_init_mm>
}
ffffffffc020341a:	8522                	mv	a0,s0
ffffffffc020341c:	60a2                	ld	ra,8(sp)
ffffffffc020341e:	6402                	ld	s0,0(sp)
ffffffffc0203420:	0141                	addi	sp,sp,16
ffffffffc0203422:	8082                	ret

ffffffffc0203424 <vma_create>:
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc0203424:	1101                	addi	sp,sp,-32
ffffffffc0203426:	e04a                	sd	s2,0(sp)
ffffffffc0203428:	892a                	mv	s2,a0
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020342a:	03000513          	li	a0,48
vma_create(uintptr_t vm_start, uintptr_t vm_end, uint_t vm_flags) {
ffffffffc020342e:	e822                	sd	s0,16(sp)
ffffffffc0203430:	e426                	sd	s1,8(sp)
ffffffffc0203432:	ec06                	sd	ra,24(sp)
ffffffffc0203434:	84ae                	mv	s1,a1
ffffffffc0203436:	8432                	mv	s0,a2
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203438:	a52ff0ef          	jal	ra,ffffffffc020268a <kmalloc>
    if (vma != NULL) {
ffffffffc020343c:	c509                	beqz	a0,ffffffffc0203446 <vma_create+0x22>
        vma->vm_start = vm_start;
ffffffffc020343e:	01253423          	sd	s2,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203442:	e904                	sd	s1,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203444:	ed00                	sd	s0,24(a0)
}
ffffffffc0203446:	60e2                	ld	ra,24(sp)
ffffffffc0203448:	6442                	ld	s0,16(sp)
ffffffffc020344a:	64a2                	ld	s1,8(sp)
ffffffffc020344c:	6902                	ld	s2,0(sp)
ffffffffc020344e:	6105                	addi	sp,sp,32
ffffffffc0203450:	8082                	ret

ffffffffc0203452 <find_vma>:
    if (mm != NULL) {
ffffffffc0203452:	c51d                	beqz	a0,ffffffffc0203480 <find_vma+0x2e>
        vma = mm->mmap_cache;
ffffffffc0203454:	691c                	ld	a5,16(a0)
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203456:	c781                	beqz	a5,ffffffffc020345e <find_vma+0xc>
ffffffffc0203458:	6798                	ld	a4,8(a5)
ffffffffc020345a:	02e5f663          	bleu	a4,a1,ffffffffc0203486 <find_vma+0x34>
                list_entry_t *list = &(mm->mmap_list), *le = list;
ffffffffc020345e:	87aa                	mv	a5,a0
    return listelm->next;
ffffffffc0203460:	679c                	ld	a5,8(a5)
                while ((le = list_next(le)) != list) {
ffffffffc0203462:	00f50f63          	beq	a0,a5,ffffffffc0203480 <find_vma+0x2e>
                    if (vma->vm_start<=addr && addr < vma->vm_end) {
ffffffffc0203466:	fe87b703          	ld	a4,-24(a5)
ffffffffc020346a:	fee5ebe3          	bltu	a1,a4,ffffffffc0203460 <find_vma+0xe>
ffffffffc020346e:	ff07b703          	ld	a4,-16(a5)
ffffffffc0203472:	fee5f7e3          	bleu	a4,a1,ffffffffc0203460 <find_vma+0xe>
                    vma = le2vma(le, list_link);
ffffffffc0203476:	1781                	addi	a5,a5,-32
        if (vma != NULL) {
ffffffffc0203478:	c781                	beqz	a5,ffffffffc0203480 <find_vma+0x2e>
            mm->mmap_cache = vma;
ffffffffc020347a:	e91c                	sd	a5,16(a0)
}
ffffffffc020347c:	853e                	mv	a0,a5
ffffffffc020347e:	8082                	ret
    struct vma_struct *vma = NULL;
ffffffffc0203480:	4781                	li	a5,0
}
ffffffffc0203482:	853e                	mv	a0,a5
ffffffffc0203484:	8082                	ret
        if (!(vma != NULL && vma->vm_start <= addr && vma->vm_end > addr)) {
ffffffffc0203486:	6b98                	ld	a4,16(a5)
ffffffffc0203488:	fce5fbe3          	bleu	a4,a1,ffffffffc020345e <find_vma+0xc>
            mm->mmap_cache = vma;
ffffffffc020348c:	e91c                	sd	a5,16(a0)
    return vma;
ffffffffc020348e:	b7fd                	j	ffffffffc020347c <find_vma+0x2a>

ffffffffc0203490 <insert_vma_struct>:
...
ffffffffc0203490:	6590                	ld	a2,8(a1)
ffffffffc0203492:	0105b803          	ld	a6,16(a1)
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
ffffffffc0203496:	1141                	addi	sp,sp,-16
ffffffffc0203498:	e406                	sd	ra,8(sp)
ffffffffc020349a:	872a                	mv	a4,a0
    assert(vma->vm_start < vma->vm_end);
ffffffffc020349c:	01066863          	bltu	a2,a6,ffffffffc02034ac <insert_vma_struct+0x1c>
ffffffffc02034a0:	a8b9                	j	ffffffffc02034fe <insert_vma_struct+0x6e>
...
ffffffffc02034a2:	fe87b683          	ld	a3,-24(a5)
ffffffffc02034a6:	04d66763          	bltu	a2,a3,ffffffffc02034f4 <insert_vma_struct+0x64>
ffffffffc02034aa:	873e                	mv	a4,a5
ffffffffc02034ac:	671c                	ld	a5,8(a4)
        while ((le = list_next(le)) != list) {
ffffffffc02034ae:	fef51ae3          	bne	a0,a5,ffffffffc02034a2 <insert_vma_struct+0x12>
        }
    ...
    /* check overlap */
    if (le_prev != list) {
ffffffffc02034b2:	02a70463          	beq	a4,a0,ffffffffc02034da <insert_vma_struct+0x4a>
        check_vma_overlap(le2vma(le_prev, list_link), vma);
ffffffffc02034b6:	ff073683          	ld	a3,-16(a4)
    assert(prev->vm_start < prev->vm_end);
ffffffffc02034ba:	fe873883          	ld	a7,-24(a4)
ffffffffc02034be:	08d8f063          	bleu	a3,a7,ffffffffc020353e <insert_vma_struct+0xae>
    assert(prev->vm_end <= next->vm_start);
ffffffffc02034c2:	04d66e63          	bltu	a2,a3,ffffffffc020351e <insert_vma_struct+0x8e>
    }
    if (le_next != list) {
ffffffffc02034c6:	00f50a63          	beq	a0,a5,ffffffffc02034da <insert_vma_struct+0x4a>
ffffffffc02034ca:	fe87b683          	ld	a3,-24(a5)
    assert(prev->vm_end <= next->vm_start);
ffffffffc02034ce:	0506e863          	bltu	a3,a6,ffffffffc020351e <insert_vma_struct+0x8e>
    assert(next->vm_start < next->vm_end);
ffffffffc02034d2:	ff07b603          	ld	a2,-16(a5)
ffffffffc02034d6:	02c6f263          	bleu	a2,a3,ffffffffc02034fa <insert_vma_struct+0x6a>
    }
    ...
    mm->map_count ++;
ffffffffc02034da:	5114                	lw	a3,32(a0)
    vma->vm_mm = mm;
ffffffffc02034dc:	e188                	sd	a0,0(a1)
    list_add_after(le_prev, &(vma->list_link));
ffffffffc02034de:	02058613          	addi	a2,a1,32
    prev->next = next->prev = elm;
ffffffffc02034e2:	e390                	sd	a2,0(a5)
ffffffffc02034e4:	e710                	sd	a2,8(a4)
}
ffffffffc02034e6:	60a2                	ld	ra,8(sp)
    elm->next = next;
ffffffffc02034e8:	f59c                	sd	a5,40(a1)
    elm->prev = prev;
ffffffffc02034ea:	f198                	sd	a4,32(a1)
    mm->map_count ++;
ffffffffc02034ec:	2685                	addiw	a3,a3,1
ffffffffc02034ee:	d114                	sw	a3,32(a0)
}
ffffffffc02034f0:	0141                	addi	sp,sp,16
ffffffffc02034f2:	8082                	ret
    if (le_prev != list) {
ffffffffc02034f4:	fca711e3          	bne	a4,a0,ffffffffc02034b6 <insert_vma_struct+0x26>
ffffffffc02034f8:	bfd9                	j	ffffffffc02034ce <insert_vma_struct+0x3e>
ffffffffc02034fa:	ebbff0ef          	jal	ra,ffffffffc02033b4 <check_vma_overlap.isra.0.part.1>
    assert(vma->vm_start < vma->vm_end);
ffffffffc02034fe:	00002697          	auipc	a3,0x2
ffffffffc0203502:	69268693          	addi	a3,a3,1682 # ffffffffc0205b90 <default_pmm_manager+0xbb8>
ffffffffc0203506:	00001617          	auipc	a2,0x1
ffffffffc020350a:	73a60613          	addi	a2,a2,1850 # ffffffffc0204c40 <commands+0x870>
ffffffffc020350e:	08400593          	li	a1,132
ffffffffc0203512:	00002517          	auipc	a0,0x2
ffffffffc0203516:	5ee50513          	addi	a0,a0,1518 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc020351a:	e5bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020351e:	00002697          	auipc	a3,0x2
ffffffffc0203522:	6b268693          	addi	a3,a3,1714 # ffffffffc0205bd0 <default_pmm_manager+0xbf8>
ffffffffc0203526:	00001617          	auipc	a2,0x1
ffffffffc020352a:	71a60613          	addi	a2,a2,1818 # ffffffffc0204c40 <commands+0x870>
ffffffffc020352e:	07c00593          	li	a1,124
ffffffffc0203532:	00002517          	auipc	a0,0x2
ffffffffc0203536:	5ce50513          	addi	a0,a0,1486 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc020353a:	e3bfc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc020353e:	00002697          	auipc	a3,0x2
ffffffffc0203542:	67268693          	addi	a3,a3,1650 # ffffffffc0205bb0 <default_pmm_manager+0xbd8>
ffffffffc0203546:	00001617          	auipc	a2,0x1
ffffffffc020354a:	6fa60613          	addi	a2,a2,1786 # ffffffffc0204c40 <commands+0x870>
ffffffffc020354e:	07b00593          	li	a1,123
ffffffffc0203552:	00002517          	auipc	a0,0x2
ffffffffc0203556:	5ae50513          	addi	a0,a0,1454 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc020355a:	e1bfc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc020355e <mm_destroy>:

// mm_destroy - free mm and mm internal fields
void
mm_destroy(struct mm_struct *mm) {
ffffffffc020355e:	1141                	addi	sp,sp,-16
ffffffffc0203560:	e022                	sd	s0,0(sp)
ffffffffc0203562:	842a                	mv	s0,a0
    return listelm->next;
ffffffffc0203564:	6508                	ld	a0,8(a0)
ffffffffc0203566:	e406                	sd	ra,8(sp)

    list_entry_t *list = &(mm->mmap_list), *le;
    while ((le = list_next(list)) != list) {
ffffffffc0203568:	00a40e63          	beq	s0,a0,ffffffffc0203584 <mm_destroy+0x26>
    __list_del(listelm->prev, listelm->next);
ffffffffc020356c:	6118                	ld	a4,0(a0)
ffffffffc020356e:	651c                	ld	a5,8(a0)
        list_del(le);
        kfree(le2vma(le, list_link),sizeof(struct vma_struct));  //kfree vma        
ffffffffc0203570:	03000593          	li	a1,48
ffffffffc0203574:	1501                	addi	a0,a0,-32
    prev->next = next;
ffffffffc0203576:	e71c                	sd	a5,8(a4)
    next->prev = prev;
ffffffffc0203578:	e398                	sd	a4,0(a5)
ffffffffc020357a:	9d2ff0ef          	jal	ra,ffffffffc020274c <kfree>
    return listelm->next;
ffffffffc020357e:	6408                	ld	a0,8(s0)
    while ((le = list_next(list)) != list) {
ffffffffc0203580:	fea416e3          	bne	s0,a0,ffffffffc020356c <mm_destroy+0xe>
    }
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203584:	8522                	mv	a0,s0
    mm=NULL;
}
ffffffffc0203586:	6402                	ld	s0,0(sp)
ffffffffc0203588:	60a2                	ld	ra,8(sp)
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc020358a:	03000593          	li	a1,48
}
ffffffffc020358e:	0141                	addi	sp,sp,16
    kfree(mm, sizeof(struct mm_struct)); //kfree mm
ffffffffc0203590:	9bcff06f          	j	ffffffffc020274c <kfree>

ffffffffc0203594 <vmm_init>:

// vmm_init - initialize virtual memory management
//          - now just call check_vmm to check correctness of vmm
void
vmm_init(void) {
ffffffffc0203594:	715d                	addi	sp,sp,-80
ffffffffc0203596:	e486                	sd	ra,72(sp)
ffffffffc0203598:	e0a2                	sd	s0,64(sp)
ffffffffc020359a:	fc26                	sd	s1,56(sp)
ffffffffc020359c:	f84a                	sd	s2,48(sp)
ffffffffc020359e:	f052                	sd	s4,32(sp)
ffffffffc02035a0:	f44e                	sd	s3,40(sp)
ffffffffc02035a2:	ec56                	sd	s5,24(sp)
ffffffffc02035a4:	e85a                	sd	s6,16(sp)
ffffffffc02035a6:	e45e                	sd	s7,8(sp)
}
...
ffffffffc02035a8:	984fe0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc02035ac:	892a                	mv	s2,a0
...
check_vma_struct(void) {
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc02035ae:	97efe0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc02035b2:	8a2a                	mv	s4,a0

    struct mm_struct *mm = mm_create();
ffffffffc02035b4:	e25ff0ef          	jal	ra,ffffffffc02033d8 <mm_create>
    assert(mm != NULL);
ffffffffc02035b8:	842a                	mv	s0,a0
ffffffffc02035ba:	03200493          	li	s1,50
ffffffffc02035be:	e919                	bnez	a0,ffffffffc02035d4 <vmm_init+0x40>
ffffffffc02035c0:	aeed                	j	ffffffffc02039ba <vmm_init+0x426>
        vma->vm_start = vm_start;
ffffffffc02035c2:	e504                	sd	s1,8(a0)
        vma->vm_end = vm_end;
ffffffffc02035c4:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc02035c6:	00053c23          	sd	zero,24(a0)
    ...
    for (i = step1; i >= 1; i --) {
        ...
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc02035ca:	14ed                	addi	s1,s1,-5
ffffffffc02035cc:	8522                	mv	a0,s0
ffffffffc02035ce:	ec3ff0ef          	jal	ra,ffffffffc0203490 <insert_vma_struct>
    for (i = step1; i >= 1; i --) {
ffffffffc02035d2:	c88d                	beqz	s1,ffffffffc0203604 <vmm_init+0x70>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc02035d4:	03000513          	li	a0,48
ffffffffc02035d8:	8b2ff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc02035dc:	85aa                	mv	a1,a0
ffffffffc02035de:	00248793          	addi	a5,s1,2
    if (vma != NULL) {
ffffffffc02035e2:	f165                	bnez	a0,ffffffffc02035c2 <vmm_init+0x2e>
        assert(vma != NULL);
ffffffffc02035e4:	00002697          	auipc	a3,0x2
ffffffffc02035e8:	18c68693          	addi	a3,a3,396 # ffffffffc0205770 <default_pmm_manager+0x798>
ffffffffc02035ec:	00001617          	auipc	a2,0x1
ffffffffc02035f0:	65460613          	addi	a2,a2,1620 # ffffffffc0204c40 <commands+0x870>
ffffffffc02035f4:	0ce00593          	li	a1,206
ffffffffc02035f8:	00002517          	auipc	a0,0x2
ffffffffc02035fc:	50850513          	addi	a0,a0,1288 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203600:	d75fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    for (i = step1; i >= 1; i --) {
ffffffffc0203604:	03700493          	li	s1,55
    }

    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc0203608:	1f900993          	li	s3,505
ffffffffc020360c:	a819                	j	ffffffffc0203622 <vmm_init+0x8e>
        vma->vm_start = vm_start;
ffffffffc020360e:	e504                	sd	s1,8(a0)
        vma->vm_end = vm_end;
ffffffffc0203610:	e91c                	sd	a5,16(a0)
        vma->vm_flags = vm_flags;
ffffffffc0203612:	00053c23          	sd	zero,24(a0)
        struct vma_struct *vma = vma_create(i * 5, i * 5 + 2, 0);
        assert(vma != NULL);
        insert_vma_struct(mm, vma);
ffffffffc0203616:	0495                	addi	s1,s1,5
ffffffffc0203618:	8522                	mv	a0,s0
ffffffffc020361a:	e77ff0ef          	jal	ra,ffffffffc0203490 <insert_vma_struct>
    for (i = step1 + 1; i <= step2; i ++) {
ffffffffc020361e:	03348a63          	beq	s1,s3,ffffffffc0203652 <vmm_init+0xbe>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc0203622:	03000513          	li	a0,48
ffffffffc0203626:	864ff0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc020362a:	85aa                	mv	a1,a0
ffffffffc020362c:	00248793          	addi	a5,s1,2
    if (vma != NULL) {
ffffffffc0203630:	fd79                	bnez	a0,ffffffffc020360e <vmm_init+0x7a>
        assert(vma != NULL);
ffffffffc0203632:	00002697          	auipc	a3,0x2
ffffffffc0203636:	13e68693          	addi	a3,a3,318 # ffffffffc0205770 <default_pmm_manager+0x798>
ffffffffc020363a:	00001617          	auipc	a2,0x1
ffffffffc020363e:	60660613          	addi	a2,a2,1542 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203642:	0d400593          	li	a1,212
ffffffffc0203646:	00002517          	auipc	a0,0x2
ffffffffc020364a:	4ba50513          	addi	a0,a0,1210 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc020364e:	d27fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203652:	6418                	ld	a4,8(s0)
ffffffffc0203654:	479d                	li	a5,7
    }

    list_entry_t *le = list_next(&(mm->mmap_list));

    for (i = 1; i <= step2; i ++) {
ffffffffc0203656:	1fb00593          	li	a1,507
        assert(le != &(mm->mmap_list));
ffffffffc020365a:	2ae40063          	beq	s0,a4,ffffffffc02038fa <vmm_init+0x366>
        struct vma_struct *mmap = le2vma(le, list_link);
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc020365e:	fe873603          	ld	a2,-24(a4)
ffffffffc0203662:	ffe78693          	addi	a3,a5,-2
ffffffffc0203666:	20d61a63          	bne	a2,a3,ffffffffc020387a <vmm_init+0x2e6>
ffffffffc020366a:	ff073683          	ld	a3,-16(a4)
ffffffffc020366e:	20d79663          	bne	a5,a3,ffffffffc020387a <vmm_init+0x2e6>
ffffffffc0203672:	0795                	addi	a5,a5,5
ffffffffc0203674:	6718                	ld	a4,8(a4)
    for (i = 1; i <= step2; i ++) {
ffffffffc0203676:	feb792e3          	bne	a5,a1,ffffffffc020365a <vmm_init+0xc6>
ffffffffc020367a:	499d                	li	s3,7
ffffffffc020367c:	4495                	li	s1,5
        le = list_next(le);
    }

    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc020367e:	1f900b93          	li	s7,505
        struct vma_struct *vma1 = find_vma(mm, i);
ffffffffc0203682:	85a6                	mv	a1,s1
ffffffffc0203684:	8522                	mv	a0,s0
ffffffffc0203686:	dcdff0ef          	jal	ra,ffffffffc0203452 <find_vma>
ffffffffc020368a:	8b2a                	mv	s6,a0
        assert(vma1 != NULL);
ffffffffc020368c:	2e050763          	beqz	a0,ffffffffc020397a <vmm_init+0x3e6>
        struct vma_struct *vma2 = find_vma(mm, i+1);
ffffffffc0203690:	00148593          	addi	a1,s1,1
ffffffffc0203694:	8522                	mv	a0,s0
ffffffffc0203696:	dbdff0ef          	jal	ra,ffffffffc0203452 <find_vma>
ffffffffc020369a:	8aaa                	mv	s5,a0
        assert(vma2 != NULL);
ffffffffc020369c:	2a050f63          	beqz	a0,ffffffffc020395a <vmm_init+0x3c6>
        struct vma_struct *vma3 = find_vma(mm, i+2);
ffffffffc02036a0:	85ce                	mv	a1,s3
ffffffffc02036a2:	8522                	mv	a0,s0
ffffffffc02036a4:	dafff0ef          	jal	ra,ffffffffc0203452 <find_vma>
        assert(vma3 == NULL);
ffffffffc02036a8:	28051963          	bnez	a0,ffffffffc020393a <vmm_init+0x3a6>
        struct vma_struct *vma4 = find_vma(mm, i+3);
ffffffffc02036ac:	00348593          	addi	a1,s1,3
ffffffffc02036b0:	8522                	mv	a0,s0
ffffffffc02036b2:	da1ff0ef          	jal	ra,ffffffffc0203452 <find_vma>
        assert(vma4 == NULL);
ffffffffc02036b6:	26051263          	bnez	a0,ffffffffc020391a <vmm_init+0x386>
        struct vma_struct *vma5 = find_vma(mm, i+4);
ffffffffc02036ba:	00448593          	addi	a1,s1,4
ffffffffc02036be:	8522                	mv	a0,s0
ffffffffc02036c0:	d93ff0ef          	jal	ra,ffffffffc0203452 <find_vma>
        assert(vma5 == NULL);
ffffffffc02036c4:	2c051b63          	bnez	a0,ffffffffc020399a <vmm_init+0x406>

        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc02036c8:	008b3783          	ld	a5,8(s6)
ffffffffc02036cc:	1c979763          	bne	a5,s1,ffffffffc020389a <vmm_init+0x306>
ffffffffc02036d0:	010b3783          	ld	a5,16(s6)
ffffffffc02036d4:	1d379363          	bne	a5,s3,ffffffffc020389a <vmm_init+0x306>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02036d8:	008ab783          	ld	a5,8(s5)
ffffffffc02036dc:	1c979f63          	bne	a5,s1,ffffffffc02038ba <vmm_init+0x326>
ffffffffc02036e0:	010ab783          	ld	a5,16(s5)
ffffffffc02036e4:	1d379b63          	bne	a5,s3,ffffffffc02038ba <vmm_init+0x326>
ffffffffc02036e8:	0495                	addi	s1,s1,5
ffffffffc02036ea:	0995                	addi	s3,s3,5
    for (i = 5; i <= 5 * step2; i +=5) {
ffffffffc02036ec:	f9749be3          	bne	s1,s7,ffffffffc0203682 <vmm_init+0xee>
ffffffffc02036f0:	4491                	li	s1,4
    }

    for (i =4; i>=0; i--) {
ffffffffc02036f2:	59fd                	li	s3,-1
        struct vma_struct *vma_below_5= find_vma(mm,i);
ffffffffc02036f4:	85a6                	mv	a1,s1
ffffffffc02036f6:	8522                	mv	a0,s0
ffffffffc02036f8:	d5bff0ef          	jal	ra,ffffffffc0203452 <find_vma>
ffffffffc02036fc:	0004859b          	sext.w	a1,s1
        if (vma_below_5 != NULL ) {
ffffffffc0203700:	c90d                	beqz	a0,ffffffffc0203732 <vmm_init+0x19e>
           cprintf("vma_below_5: i %x, start %x, end %x\n",i, vma_below_5->vm_start, vma_below_5->vm_end); 
ffffffffc0203702:	6914                	ld	a3,16(a0)
ffffffffc0203704:	6510                	ld	a2,8(a0)
ffffffffc0203706:	00002517          	auipc	a0,0x2
ffffffffc020370a:	5ea50513          	addi	a0,a0,1514 # ffffffffc0205cf0 <default_pmm_manager+0xd18>
ffffffffc020370e:	9b1fc0ef          	jal	ra,ffffffffc02000be <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203712:	00002697          	auipc	a3,0x2
ffffffffc0203716:	60668693          	addi	a3,a3,1542 # ffffffffc0205d18 <default_pmm_manager+0xd40>
ffffffffc020371a:	00001617          	auipc	a2,0x1
ffffffffc020371e:	52660613          	addi	a2,a2,1318 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203722:	0f600593          	li	a1,246
ffffffffc0203726:	00002517          	auipc	a0,0x2
ffffffffc020372a:	3da50513          	addi	a0,a0,986 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc020372e:	c47fc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203732:	14fd                	addi	s1,s1,-1
    for (i =4; i>=0; i--) {
ffffffffc0203734:	fd3490e3          	bne	s1,s3,ffffffffc02036f4 <vmm_init+0x160>
    }

    mm_destroy(mm);
ffffffffc0203738:	8522                	mv	a0,s0
ffffffffc020373a:	e25ff0ef          	jal	ra,ffffffffc020355e <mm_destroy>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020373e:	feffd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc0203742:	28aa1c63          	bne	s4,a0,ffffffffc02039da <vmm_init+0x446>

    cprintf("check_vma_struct() succeeded!\n");
ffffffffc0203746:	00002517          	auipc	a0,0x2
ffffffffc020374a:	61250513          	addi	a0,a0,1554 # ffffffffc0205d58 <default_pmm_manager+0xd80>
ffffffffc020374e:	971fc0ef          	jal	ra,ffffffffc02000be <cprintf>
...
check_pgfault(void) {
    ...
    size_t nr_free_pages_store = nr_free_pages();
ffffffffc0203752:	fdbfd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc0203756:	89aa                	mv	s3,a0

    check_mm_struct = mm_create();
ffffffffc0203758:	c81ff0ef          	jal	ra,ffffffffc02033d8 <mm_create>
ffffffffc020375c:	0000e797          	auipc	a5,0xe
ffffffffc0203760:	e2a7ba23          	sd	a0,-460(a5) # ffffffffc0211590 <check_mm_struct>
ffffffffc0203764:	842a                	mv	s0,a0

    assert(check_mm_struct != NULL);
ffffffffc0203766:	2a050a63          	beqz	a0,ffffffffc0203a1a <vmm_init+0x486>
    struct mm_struct *mm = check_mm_struct;
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc020376a:	0000e797          	auipc	a5,0xe
ffffffffc020376e:	ce678793          	addi	a5,a5,-794 # ffffffffc0211450 <boot_pgdir>
ffffffffc0203772:	6384                	ld	s1,0(a5)
    assert(pgdir[0] == 0);
ffffffffc0203774:	609c                	ld	a5,0(s1)
    pde_t *pgdir = mm->pgdir = boot_pgdir;
ffffffffc0203776:	ed04                	sd	s1,24(a0)
    assert(pgdir[0] == 0);
ffffffffc0203778:	32079d63          	bnez	a5,ffffffffc0203ab2 <vmm_init+0x51e>
    struct vma_struct *vma = kmalloc(sizeof(struct vma_struct));
ffffffffc020377c:	03000513          	li	a0,48
ffffffffc0203780:	f0bfe0ef          	jal	ra,ffffffffc020268a <kmalloc>
ffffffffc0203784:	8a2a                	mv	s4,a0
    if (vma != NULL) {
ffffffffc0203786:	14050a63          	beqz	a0,ffffffffc02038da <vmm_init+0x346>
        vma->vm_end = vm_end;
ffffffffc020378a:	002007b7          	lui	a5,0x200
ffffffffc020378e:	00fa3823          	sd	a5,16(s4)
        vma->vm_flags = vm_flags;
ffffffffc0203792:	4789                	li	a5,2
    ...
    insert_vma_struct(mm, vma);
ffffffffc0203794:	85aa                	mv	a1,a0
        vma->vm_flags = vm_flags;
ffffffffc0203796:	00fa3c23          	sd	a5,24(s4)
    insert_vma_struct(mm, vma);
ffffffffc020379a:	8522                	mv	a0,s0
        vma->vm_start = vm_start;
ffffffffc020379c:	000a3423          	sd	zero,8(s4)
    insert_vma_struct(mm, vma);
ffffffffc02037a0:	cf1ff0ef          	jal	ra,ffffffffc0203490 <insert_vma_struct>

    uintptr_t addr = 0x100;
    assert(find_vma(mm, addr) == vma);
ffffffffc02037a4:	10000593          	li	a1,256
ffffffffc02037a8:	8522                	mv	a0,s0
ffffffffc02037aa:	ca9ff0ef          	jal	ra,ffffffffc0203452 <find_vma>
ffffffffc02037ae:	10000793          	li	a5,256

    int i, sum = 0;
    for (i = 0; i < 100; i ++) {
ffffffffc02037b2:	16400713          	li	a4,356
    assert(find_vma(mm, addr) == vma);
ffffffffc02037b6:	2aaa1263          	bne	s4,a0,ffffffffc0203a5a <vmm_init+0x4c6>
        *(char *)(addr + i) = i;
ffffffffc02037ba:	00f78023          	sb	a5,0(a5) # 200000 <BASE_ADDRESS-0xffffffffc0000000>
        sum += i;
ffffffffc02037be:	0785                	addi	a5,a5,1
    for (i = 0; i < 100; i ++) {
ffffffffc02037c0:	fee79de3          	bne	a5,a4,ffffffffc02037ba <vmm_init+0x226>
        sum += i;
ffffffffc02037c4:	6705                	lui	a4,0x1
    for (i = 0; i < 100; i ++) {
ffffffffc02037c6:	10000793          	li	a5,256
        sum += i;
ffffffffc02037ca:	35670713          	addi	a4,a4,854 # 1356 <BASE_ADDRESS-0xffffffffc01fecaa>
    }
    for (i = 0; i < 100; i ++) {
ffffffffc02037ce:	16400613          	li	a2,356
        sum -= *(char *)(addr + i);
ffffffffc02037d2:	0007c683          	lbu	a3,0(a5)
ffffffffc02037d6:	0785                	addi	a5,a5,1
ffffffffc02037d8:	9f15                	subw	a4,a4,a3
    for (i = 0; i < 100; i ++) {
ffffffffc02037da:	fec79ce3          	bne	a5,a2,ffffffffc02037d2 <vmm_init+0x23e>
    }
    assert(sum == 0);
ffffffffc02037de:	2a071a63          	bnez	a4,ffffffffc0203a92 <vmm_init+0x4fe>

    page_remove(pgdir, ROUNDDOWN(addr, PGSIZE));
ffffffffc02037e2:	4581                	li	a1,0
ffffffffc02037e4:	8526                	mv	a0,s1
ffffffffc02037e6:	9ecfe0ef          	jal	ra,ffffffffc02019d2 <page_remove>
    return pa2page(PDE_ADDR(pde));
ffffffffc02037ea:	609c                	ld	a5,0(s1)
    if (PPN(pa) >= npage) {
ffffffffc02037ec:	0000e717          	auipc	a4,0xe
ffffffffc02037f0:	c6c70713          	addi	a4,a4,-916 # ffffffffc0211458 <npage>
ffffffffc02037f4:	6318                	ld	a4,0(a4)
    return pa2page(PDE_ADDR(pde));
ffffffffc02037f6:	078a                	slli	a5,a5,0x2
ffffffffc02037f8:	83b1                	srli	a5,a5,0xc
    if (PPN(pa) >= npage) {
ffffffffc02037fa:	28e7f063          	bleu	a4,a5,ffffffffc0203a7a <vmm_init+0x4e6>
    return &pages[PPN(pa) - nbase];
ffffffffc02037fe:	00003717          	auipc	a4,0x3
ffffffffc0203802:	89a70713          	addi	a4,a4,-1894 # ffffffffc0206098 <nbase>
ffffffffc0203806:	6318                	ld	a4,0(a4)
ffffffffc0203808:	0000e697          	auipc	a3,0xe
ffffffffc020380c:	ca068693          	addi	a3,a3,-864 # ffffffffc02114a8 <pages>
ffffffffc0203810:	6288                	ld	a0,0(a3)
ffffffffc0203812:	8f99                	sub	a5,a5,a4
ffffffffc0203814:	00379713          	slli	a4,a5,0x3
ffffffffc0203818:	97ba                	add	a5,a5,a4
ffffffffc020381a:	078e                	slli	a5,a5,0x3

    free_page(pde2page(pgdir[0]));
ffffffffc020381c:	953e                	add	a0,a0,a5
ffffffffc020381e:	4585                	li	a1,1
ffffffffc0203820:	ec7fd0ef          	jal	ra,ffffffffc02016e6 <free_pages>

    pgdir[0] = 0;
ffffffffc0203824:	0004b023          	sd	zero,0(s1)

    mm->pgdir = NULL;
    mm_destroy(mm);
ffffffffc0203828:	8522                	mv	a0,s0
    mm->pgdir = NULL;
ffffffffc020382a:	00043c23          	sd	zero,24(s0)
    mm_destroy(mm);
ffffffffc020382e:	d31ff0ef          	jal	ra,ffffffffc020355e <mm_destroy>

    check_mm_struct = NULL;
    nr_free_pages_store--;	// szx : Sv39第二级页表多占了一个内存页，所以执行此操作
ffffffffc0203832:	19fd                	addi	s3,s3,-1
    check_mm_struct = NULL;
ffffffffc0203834:	0000e797          	auipc	a5,0xe
ffffffffc0203838:	d407be23          	sd	zero,-676(a5) # ffffffffc0211590 <check_mm_struct>

    assert(nr_free_pages_store == nr_free_pages());
ffffffffc020383c:	ef1fd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
ffffffffc0203840:	1aa99d63          	bne	s3,a0,ffffffffc02039fa <vmm_init+0x466>

    cprintf("check_pgfault() succeeded!\n");
ffffffffc0203844:	00002517          	auipc	a0,0x2
ffffffffc0203848:	57c50513          	addi	a0,a0,1404 # ffffffffc0205dc0 <default_pmm_manager+0xde8>
ffffffffc020384c:	873fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203850:	eddfd0ef          	jal	ra,ffffffffc020172c <nr_free_pages>
    nr_free_pages_store--;	// szx : Sv39三级页表多占一个内存页，所以执行此操作
ffffffffc0203854:	197d                	addi	s2,s2,-1
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203856:	1ea91263          	bne	s2,a0,ffffffffc0203a3a <vmm_init+0x4a6>
}
ffffffffc020385a:	6406                	ld	s0,64(sp)
ffffffffc020385c:	60a6                	ld	ra,72(sp)
ffffffffc020385e:	74e2                	ld	s1,56(sp)
ffffffffc0203860:	7942                	ld	s2,48(sp)
ffffffffc0203862:	79a2                	ld	s3,40(sp)
ffffffffc0203864:	7a02                	ld	s4,32(sp)
ffffffffc0203866:	6ae2                	ld	s5,24(sp)
ffffffffc0203868:	6b42                	ld	s6,16(sp)
ffffffffc020386a:	6ba2                	ld	s7,8(sp)
    cprintf("check_vmm() succeeded.\n");
ffffffffc020386c:	00002517          	auipc	a0,0x2
ffffffffc0203870:	57450513          	addi	a0,a0,1396 # ffffffffc0205de0 <default_pmm_manager+0xe08>
}
ffffffffc0203874:	6161                	addi	sp,sp,80
    cprintf("check_vmm() succeeded.\n");
ffffffffc0203876:	849fc06f          	j	ffffffffc02000be <cprintf>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc020387a:	00002697          	auipc	a3,0x2
ffffffffc020387e:	38e68693          	addi	a3,a3,910 # ffffffffc0205c08 <default_pmm_manager+0xc30>
ffffffffc0203882:	00001617          	auipc	a2,0x1
ffffffffc0203886:	3be60613          	addi	a2,a2,958 # ffffffffc0204c40 <commands+0x870>
ffffffffc020388a:	0dd00593          	li	a1,221
ffffffffc020388e:	00002517          	auipc	a0,0x2
ffffffffc0203892:	27250513          	addi	a0,a0,626 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203896:	adffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc020389a:	00002697          	auipc	a3,0x2
ffffffffc020389e:	3f668693          	addi	a3,a3,1014 # ffffffffc0205c90 <default_pmm_manager+0xcb8>
ffffffffc02038a2:	00001617          	auipc	a2,0x1
ffffffffc02038a6:	39e60613          	addi	a2,a2,926 # ffffffffc0204c40 <commands+0x870>
ffffffffc02038aa:	0ed00593          	li	a1,237
ffffffffc02038ae:	00002517          	auipc	a0,0x2
ffffffffc02038b2:	25250513          	addi	a0,a0,594 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc02038b6:	abffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc02038ba:	00002697          	auipc	a3,0x2
ffffffffc02038be:	40668693          	addi	a3,a3,1030 # ffffffffc0205cc0 <default_pmm_manager+0xce8>
ffffffffc02038c2:	00001617          	auipc	a2,0x1
ffffffffc02038c6:	37e60613          	addi	a2,a2,894 # ffffffffc0204c40 <commands+0x870>
ffffffffc02038ca:	0ee00593          	li	a1,238
ffffffffc02038ce:	00002517          	auipc	a0,0x2
ffffffffc02038d2:	23250513          	addi	a0,a0,562 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc02038d6:	a9ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(vma != NULL);
ffffffffc02038da:	00002697          	auipc	a3,0x2
ffffffffc02038de:	e9668693          	addi	a3,a3,-362 # ffffffffc0205770 <default_pmm_manager+0x798>
ffffffffc02038e2:	00001617          	auipc	a2,0x1
ffffffffc02038e6:	35e60613          	addi	a2,a2,862 # ffffffffc0204c40 <commands+0x870>
ffffffffc02038ea:	11100593          	li	a1,273
ffffffffc02038ee:	00002517          	auipc	a0,0x2
ffffffffc02038f2:	21250513          	addi	a0,a0,530 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc02038f6:	a7ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc02038fa:	00002697          	auipc	a3,0x2
ffffffffc02038fe:	2f668693          	addi	a3,a3,758 # ffffffffc0205bf0 <default_pmm_manager+0xc18>
ffffffffc0203902:	00001617          	auipc	a2,0x1
ffffffffc0203906:	33e60613          	addi	a2,a2,830 # ffffffffc0204c40 <commands+0x870>
ffffffffc020390a:	0db00593          	li	a1,219
ffffffffc020390e:	00002517          	auipc	a0,0x2
ffffffffc0203912:	1f250513          	addi	a0,a0,498 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203916:	a5ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma4 == NULL);
ffffffffc020391a:	00002697          	auipc	a3,0x2
ffffffffc020391e:	35668693          	addi	a3,a3,854 # ffffffffc0205c70 <default_pmm_manager+0xc98>
ffffffffc0203922:	00001617          	auipc	a2,0x1
ffffffffc0203926:	31e60613          	addi	a2,a2,798 # ffffffffc0204c40 <commands+0x870>
ffffffffc020392a:	0e900593          	li	a1,233
ffffffffc020392e:	00002517          	auipc	a0,0x2
ffffffffc0203932:	1d250513          	addi	a0,a0,466 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203936:	a3ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma3 == NULL);
ffffffffc020393a:	00002697          	auipc	a3,0x2
ffffffffc020393e:	32668693          	addi	a3,a3,806 # ffffffffc0205c60 <default_pmm_manager+0xc88>
ffffffffc0203942:	00001617          	auipc	a2,0x1
ffffffffc0203946:	2fe60613          	addi	a2,a2,766 # ffffffffc0204c40 <commands+0x870>
ffffffffc020394a:	0e700593          	li	a1,231
ffffffffc020394e:	00002517          	auipc	a0,0x2
ffffffffc0203952:	1b250513          	addi	a0,a0,434 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203956:	a1ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma2 != NULL);
ffffffffc020395a:	00002697          	auipc	a3,0x2
ffffffffc020395e:	2f668693          	addi	a3,a3,758 # ffffffffc0205c50 <default_pmm_manager+0xc78>
ffffffffc0203962:	00001617          	auipc	a2,0x1
ffffffffc0203966:	2de60613          	addi	a2,a2,734 # ffffffffc0204c40 <commands+0x870>
ffffffffc020396a:	0e500593          	li	a1,229
ffffffffc020396e:	00002517          	auipc	a0,0x2
ffffffffc0203972:	19250513          	addi	a0,a0,402 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203976:	9fffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma1 != NULL);
ffffffffc020397a:	00002697          	auipc	a3,0x2
ffffffffc020397e:	2c668693          	addi	a3,a3,710 # ffffffffc0205c40 <default_pmm_manager+0xc68>
ffffffffc0203982:	00001617          	auipc	a2,0x1
ffffffffc0203986:	2be60613          	addi	a2,a2,702 # ffffffffc0204c40 <commands+0x870>
ffffffffc020398a:	0e300593          	li	a1,227
ffffffffc020398e:	00002517          	auipc	a0,0x2
ffffffffc0203992:	17250513          	addi	a0,a0,370 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203996:	9dffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        assert(vma5 == NULL);
ffffffffc020399a:	00002697          	auipc	a3,0x2
ffffffffc020399e:	2e668693          	addi	a3,a3,742 # ffffffffc0205c80 <default_pmm_manager+0xca8>
ffffffffc02039a2:	00001617          	auipc	a2,0x1
ffffffffc02039a6:	29e60613          	addi	a2,a2,670 # ffffffffc0204c40 <commands+0x870>
ffffffffc02039aa:	0eb00593          	li	a1,235
ffffffffc02039ae:	00002517          	auipc	a0,0x2
ffffffffc02039b2:	15250513          	addi	a0,a0,338 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc02039b6:	9bffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(mm != NULL);
ffffffffc02039ba:	00002697          	auipc	a3,0x2
ffffffffc02039be:	d7e68693          	addi	a3,a3,-642 # ffffffffc0205738 <default_pmm_manager+0x760>
ffffffffc02039c2:	00001617          	auipc	a2,0x1
ffffffffc02039c6:	27e60613          	addi	a2,a2,638 # ffffffffc0204c40 <commands+0x870>
ffffffffc02039ca:	0c700593          	li	a1,199
ffffffffc02039ce:	00002517          	auipc	a0,0x2
ffffffffc02039d2:	13250513          	addi	a0,a0,306 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc02039d6:	99ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039da:	00002697          	auipc	a3,0x2
ffffffffc02039de:	35668693          	addi	a3,a3,854 # ffffffffc0205d30 <default_pmm_manager+0xd58>
ffffffffc02039e2:	00001617          	auipc	a2,0x1
ffffffffc02039e6:	25e60613          	addi	a2,a2,606 # ffffffffc0204c40 <commands+0x870>
ffffffffc02039ea:	0fb00593          	li	a1,251
ffffffffc02039ee:	00002517          	auipc	a0,0x2
ffffffffc02039f2:	11250513          	addi	a0,a0,274 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc02039f6:	97ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc02039fa:	00002697          	auipc	a3,0x2
ffffffffc02039fe:	33668693          	addi	a3,a3,822 # ffffffffc0205d30 <default_pmm_manager+0xd58>
ffffffffc0203a02:	00001617          	auipc	a2,0x1
ffffffffc0203a06:	23e60613          	addi	a2,a2,574 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203a0a:	12e00593          	li	a1,302
ffffffffc0203a0e:	00002517          	auipc	a0,0x2
ffffffffc0203a12:	0f250513          	addi	a0,a0,242 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203a16:	95ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203a1a:	00002697          	auipc	a3,0x2
ffffffffc0203a1e:	35e68693          	addi	a3,a3,862 # ffffffffc0205d78 <default_pmm_manager+0xda0>
ffffffffc0203a22:	00001617          	auipc	a2,0x1
ffffffffc0203a26:	21e60613          	addi	a2,a2,542 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203a2a:	10a00593          	li	a1,266
ffffffffc0203a2e:	00002517          	auipc	a0,0x2
ffffffffc0203a32:	0d250513          	addi	a0,a0,210 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203a36:	93ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203a3a:	00002697          	auipc	a3,0x2
ffffffffc0203a3e:	2f668693          	addi	a3,a3,758 # ffffffffc0205d30 <default_pmm_manager+0xd58>
ffffffffc0203a42:	00001617          	auipc	a2,0x1
ffffffffc0203a46:	1fe60613          	addi	a2,a2,510 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203a4a:	0bd00593          	li	a1,189
ffffffffc0203a4e:	00002517          	auipc	a0,0x2
ffffffffc0203a52:	0b250513          	addi	a0,a0,178 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203a56:	91ffc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203a5a:	00002697          	auipc	a3,0x2
ffffffffc0203a5e:	33668693          	addi	a3,a3,822 # ffffffffc0205d90 <default_pmm_manager+0xdb8>
ffffffffc0203a62:	00001617          	auipc	a2,0x1
ffffffffc0203a66:	1de60613          	addi	a2,a2,478 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203a6a:	11600593          	li	a1,278
ffffffffc0203a6e:	00002517          	auipc	a0,0x2
ffffffffc0203a72:	09250513          	addi	a0,a0,146 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203a76:	8fffc0ef          	jal	ra,ffffffffc0200374 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203a7a:	00001617          	auipc	a2,0x1
ffffffffc0203a7e:	62660613          	addi	a2,a2,1574 # ffffffffc02050a0 <default_pmm_manager+0xc8>
ffffffffc0203a82:	06500593          	li	a1,101
ffffffffc0203a86:	00001517          	auipc	a0,0x1
ffffffffc0203a8a:	63a50513          	addi	a0,a0,1594 # ffffffffc02050c0 <default_pmm_manager+0xe8>
ffffffffc0203a8e:	8e7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(sum == 0);
ffffffffc0203a92:	00002697          	auipc	a3,0x2
ffffffffc0203a96:	31e68693          	addi	a3,a3,798 # ffffffffc0205db0 <default_pmm_manager+0xdd8>
ffffffffc0203a9a:	00001617          	auipc	a2,0x1
ffffffffc0203a9e:	1a660613          	addi	a2,a2,422 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203aa2:	12000593          	li	a1,288
ffffffffc0203aa6:	00002517          	auipc	a0,0x2
ffffffffc0203aaa:	05a50513          	addi	a0,a0,90 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203aae:	8c7fc0ef          	jal	ra,ffffffffc0200374 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203ab2:	00002697          	auipc	a3,0x2
ffffffffc0203ab6:	cae68693          	addi	a3,a3,-850 # ffffffffc0205760 <default_pmm_manager+0x788>
ffffffffc0203aba:	00001617          	auipc	a2,0x1
ffffffffc0203abe:	18660613          	addi	a2,a2,390 # ffffffffc0204c40 <commands+0x870>
ffffffffc0203ac2:	10d00593          	li	a1,269
ffffffffc0203ac6:	00002517          	auipc	a0,0x2
ffffffffc0203aca:	03a50513          	addi	a0,a0,58 # ffffffffc0205b00 <default_pmm_manager+0xb28>
ffffffffc0203ace:	8a7fc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203ad2 <do_pgfault>:
...
ffffffffc0203ad4:	85b2                	mv	a1,a2
do_pgfault(struct mm_struct *mm, uint_t error_code, uintptr_t addr) {
ffffffffc0203ad6:	f022                	sd	s0,32(sp)
ffffffffc0203ad8:	ec26                	sd	s1,24(sp)
ffffffffc0203ada:	f406                	sd	ra,40(sp)
ffffffffc0203adc:	e84a                	sd	s2,16(sp)
ffffffffc0203ade:	8432                	mv	s0,a2
ffffffffc0203ae0:	84aa                	mv	s1,a0
    struct vma_struct *vma = find_vma(mm, addr);
ffffffffc0203ae2:	971ff0ef          	jal	ra,ffffffffc0203452 <find_vma>

    pgfault_num++;
ffffffffc0203ae6:	0000e797          	auipc	a5,0xe
ffffffffc0203aea:	98678793          	addi	a5,a5,-1658 # ffffffffc021146c <pgfault_num>
ffffffffc0203aee:	439c                	lw	a5,0(a5)
ffffffffc0203af0:	2785                	addiw	a5,a5,1
ffffffffc0203af2:	0000e717          	auipc	a4,0xe
ffffffffc0203af6:	96f72d23          	sw	a5,-1670(a4) # ffffffffc021146c <pgfault_num>
    //If the addr is in the range of a mm's vma?
    if (vma == NULL || vma->vm_start > addr) {
ffffffffc0203afa:	c549                	beqz	a0,ffffffffc0203b84 <do_pgfault+0xb2>
ffffffffc0203afc:	651c                	ld	a5,8(a0)
ffffffffc0203afe:	08f46363          	bltu	s0,a5,ffffffffc0203b84 <do_pgfault+0xb2>
...
ffffffffc0203b02:	6d1c                	ld	a5,24(a0)
    uint32_t perm = PTE_U;
ffffffffc0203b04:	4941                	li	s2,16
    if (vma->vm_flags & VM_WRITE) {
ffffffffc0203b06:	8b89                	andi	a5,a5,2
ffffffffc0203b08:	efa9                	bnez	a5,ffffffffc0203b62 <do_pgfault+0x90>
        perm |= (PTE_R | PTE_W);
    }
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203b0a:	767d                	lui	a2,0xfffff
...
ffffffffc0203b0c:	6c88                	ld	a0,24(s1)
    addr = ROUNDDOWN(addr, PGSIZE);
ffffffffc0203b0e:	8c71                	and	s0,s0,a2
    ptep = get_pte(mm->pgdir, addr, 1);  //(1) try to find a pte, if pte's
ffffffffc0203b10:	85a2                	mv	a1,s0
ffffffffc0203b12:	4605                	li	a2,1
ffffffffc0203b14:	c59fd0ef          	jal	ra,ffffffffc020176c <get_pte>
                                         //PT(Page Table) isn't existed, then
                                         //create a PT.
    if (*ptep == 0) {
ffffffffc0203b18:	610c                	ld	a1,0(a0)
ffffffffc0203b1a:	c5b1                	beqz	a1,ffffffffc0203b66 <do_pgfault+0x94>
        ...
        */
        if (swap_init_ok) {
ffffffffc0203b1c:	0000e797          	auipc	a5,0xe
ffffffffc0203b20:	94c78793          	addi	a5,a5,-1716 # ffffffffc0211468 <swap_init_ok>
ffffffffc0203b24:	439c                	lw	a5,0(a5)
ffffffffc0203b26:	2781                	sext.w	a5,a5
ffffffffc0203b28:	c7bd                	beqz	a5,ffffffffc0203b96 <do_pgfault+0xc4>
...
ffffffffc0203b2c:	0030                	addi	a2,sp,8
ffffffffc0203b2e:	8526                	mv	a0,s1
            struct Page *page = NULL;
ffffffffc0203b30:	e402                	sd	zero,8(sp)
            swap_in(mm, addr, &page);
ffffffffc0203b32:	caeff0ef          	jal	ra,ffffffffc0202fe0 <swap_in>
...
ffffffffc0203b3a:	86ca                	mv	a3,s2
ffffffffc0203b3c:	8622                	mv	a2,s0
ffffffffc0203b3e:	f07fd0ef          	jal	ra,ffffffffc0201a44 <page_insert>
...
ffffffffc0203b4a:	b72ff0ef          	jal	ra,ffffffffc0202ebc <swap_map_swappable>
            page->pra_vaddr = addr;
ffffffffc0203b4e:	6722                	ld	a4,8(sp)
   ...
   ret = 0;
ffffffffc0203b50:	4781                	li	a5,0
            page->pra_vaddr = addr;
ffffffffc0203b52:	e320                	sd	s0,64(a4)
failed:
    return ret;
}
ffffffffc0203b54:	70a2                	ld	ra,40(sp)
ffffffffc0203b56:	7402                	ld	s0,32(sp)
ffffffffc0203b58:	64e2                	ld	s1,24(sp)
ffffffffc0203b5a:	6942                	ld	s2,16(sp)
ffffffffc0203b5c:	853e                	mv	a0,a5
ffffffffc0203b5e:	6145                	addi	sp,sp,48
ffffffffc0203b60:	8082                	ret
        perm |= (PTE_R | PTE_W);
ffffffffc0203b62:	4959                	li	s2,22
ffffffffc0203b64:	b75d                	j	ffffffffc0203b0a <do_pgfault+0x38>
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203b66:	6c88                	ld	a0,24(s1)
ffffffffc0203b68:	864a                	mv	a2,s2
ffffffffc0203b6a:	85a2                	mv	a1,s0
ffffffffc0203b6c:	a8dfe0ef          	jal	ra,ffffffffc02025f8 <pgdir_alloc_page>
   ret = 0;
ffffffffc0203b70:	4781                	li	a5,0
        if (pgdir_alloc_page(mm->pgdir, addr, perm) == NULL) {
ffffffffc0203b72:	f16d                	bnez	a0,ffffffffc0203b54 <do_pgfault+0x82>
            cprintf("pgdir_alloc_page in do_pgfault failed\n");
ffffffffc0203b74:	00002517          	auipc	a0,0x2
ffffffffc0203b78:	fcc50513          	addi	a0,a0,-52 # ffffffffc0205b40 <default_pmm_manager+0xb68>
ffffffffc0203b7c:	d42fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203b80:	57f1                	li	a5,-4
            goto failed;
ffffffffc0203b82:	bfc9                	j	ffffffffc0203b54 <do_pgfault+0x82>
        cprintf("not valid addr %x, and  can not find it in vma\n", addr);
ffffffffc0203b84:	85a2                	mv	a1,s0
ffffffffc0203b86:	00002517          	auipc	a0,0x2
ffffffffc0203b8a:	f8a50513          	addi	a0,a0,-118 # ffffffffc0205b10 <default_pmm_manager+0xb38>
ffffffffc0203b8e:	d30fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    int ret = -E_INVAL;
ffffffffc0203b92:	57f5                	li	a5,-3
        goto failed;
ffffffffc0203b94:	b7c1                	j	ffffffffc0203b54 <do_pgfault+0x82>
            cprintf("no swap_init_ok but ptep is %x, failed\n", *ptep);
ffffffffc0203b96:	00002517          	auipc	a0,0x2
ffffffffc0203b9a:	fd250513          	addi	a0,a0,-46 # ffffffffc0205b68 <default_pmm_manager+0xb90>
ffffffffc0203b9e:	d20fc0ef          	jal	ra,ffffffffc02000be <cprintf>
    ret = -E_NO_MEM;
ffffffffc0203ba2:	57f1                	li	a5,-4
            goto failed;
ffffffffc0203ba4:	bf45                	j	ffffffffc0203b54 <do_pgfault+0x82>
...
ffffffffc0203bec:	95070713          	addi	a4,a4,-1712 # ffffffffc0211538 <max_swap_offset>
...
ffffffffc0203bfa:	8b270713          	addi	a4,a4,-1870 # ffffffffc02114a8 <pages>
ffffffffc0203bfe:	6310                	ld	a2,0(a4)
ffffffffc0203c00:	00001717          	auipc	a4,0x1
ffffffffc0203c04:	02870713          	addi	a4,a4,40 # ffffffffc0204c28 <commands+0x858>
...
ffffffffc0203c3e:	85e78793          	addi	a5,a5,-1954 # ffffffffc0211498 <va_pa_offset>
...
ffffffffc0203c4c:	0141                	addi	sp,sp,16
    return ide_read_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203c4e:	85dfc06f          	j	ffffffffc02004aa <ide_read_secs>
ffffffffc0203c52:	86aa                	mv	a3,a0
ffffffffc0203c54:	00002617          	auipc	a2,0x2
ffffffffc0203c58:	1dc60613          	addi	a2,a2,476 # ffffffffc0205e30 <default_pmm_manager+0xe58>
ffffffffc0203c5c:	45d1                	li	a1,20
ffffffffc0203c5e:	00002517          	auipc	a0,0x2
ffffffffc0203c62:	1ba50513          	addi	a0,a0,442 # ffffffffc0205e18 <default_pmm_manager+0xe40>
ffffffffc0203c66:	f0efc0ef          	jal	ra,ffffffffc0200374 <__panic>
ffffffffc0203c6a:	86b2                	mv	a3,a2
ffffffffc0203c6c:	06a00593          	li	a1,106
ffffffffc0203c70:	00001617          	auipc	a2,0x1
ffffffffc0203c74:	3b860613          	addi	a2,a2,952 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc0203c78:	00001517          	auipc	a0,0x1
ffffffffc0203c7c:	44850513          	addi	a0,a0,1096 # ffffffffc02050c0 <default_pmm_manager+0xe8>
...
ffffffffc0203c92:	8aa70713          	addi	a4,a4,-1878 # ffffffffc0211538 <max_swap_offset>
ffffffffc0203c96:	6318                	ld	a4,0(a4)
ffffffffc0203c98:	06e7f063          	bleu	a4,a5,ffffffffc0203cf8 <swapfs_write+0x74>
static inline ppn_t page2ppn(struct Page *page) { return page - pages + nbase; }
ffffffffc0203c9c:	0000e717          	auipc	a4,0xe
ffffffffc0203ca0:	80c70713          	addi	a4,a4,-2036 # ffffffffc02114a8 <pages>
ffffffffc0203ca4:	6310                	ld	a2,0(a4)
ffffffffc0203ca6:	00001717          	auipc	a4,0x1
ffffffffc0203caa:	f8270713          	addi	a4,a4,-126 # ffffffffc0204c28 <commands+0x858>
...
ffffffffc0203ce4:	7b878793          	addi	a5,a5,1976 # ffffffffc0211498 <va_pa_offset>
...
ffffffffc0203cf2:	0141                	addi	sp,sp,16
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc0203cf4:	fdafc06f          	j	ffffffffc02004ce <ide_write_secs>
ffffffffc0203cf8:	86aa                	mv	a3,a0
ffffffffc0203cfa:	00002617          	auipc	a2,0x2
ffffffffc0203cfe:	13660613          	addi	a2,a2,310 # ffffffffc0205e30 <default_pmm_manager+0xe58>
ffffffffc0203d02:	45e5                	li	a1,25
ffffffffc0203d04:	00002517          	auipc	a0,0x2
ffffffffc0203d08:	11450513          	addi	a0,a0,276 # ffffffffc0205e18 <default_pmm_manager+0xe40>
...
ffffffffc0203d1a:	31260613          	addi	a2,a2,786 # ffffffffc0205028 <default_pmm_manager+0x50>
ffffffffc0203d1e:	00001517          	auipc	a0,0x1
ffffffffc0203d22:	3a250513          	addi	a0,a0,930 # ffffffffc02050c0 <default_pmm_manager+0xe8>
ffffffffc0203d26:	e4efc0ef          	jal	ra,ffffffffc0200374 <__panic>

ffffffffc0203d2a <printnum>:
 * */
static void
...
ffffffffc0203d2a:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d2e:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0203d30:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d34:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0203d36:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0203d3a:	f022                	sd	s0,32(sp)
ffffffffc0203d3c:	ec26                	sd	s1,24(sp)
ffffffffc0203d3e:	e84a                	sd	s2,16(sp)
ffffffffc0203d40:	f406                	sd	ra,40(sp)
ffffffffc0203d42:	e44e                	sd	s3,8(sp)
ffffffffc0203d44:	84aa                	mv	s1,a0
ffffffffc0203d46:	892e                	mv	s2,a1
ffffffffc0203d48:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0203d4c:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc0203d4e:	03067e63          	bleu	a6,a2,ffffffffc0203d8a <printnum+0x60>
ffffffffc0203d52:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc0203d54:	00805763          	blez	s0,ffffffffc0203d62 <printnum+0x38>
ffffffffc0203d58:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0203d5a:	85ca                	mv	a1,s2
ffffffffc0203d5c:	854e                	mv	a0,s3
ffffffffc0203d5e:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0203d60:	fc65                	bnez	s0,ffffffffc0203d58 <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203d62:	1a02                	slli	s4,s4,0x20
ffffffffc0203d64:	020a5a13          	srli	s4,s4,0x20
ffffffffc0203d68:	00002797          	auipc	a5,0x2
ffffffffc0203d6c:	27878793          	addi	a5,a5,632 # ffffffffc0205fe0 <error_string+0x38>
ffffffffc0203d70:	9a3e                	add	s4,s4,a5
}
ffffffffc0203d72:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203d74:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0203d78:	70a2                	ld	ra,40(sp)
ffffffffc0203d7a:	69a2                	ld	s3,8(sp)
ffffffffc0203d7c:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203d7e:	85ca                	mv	a1,s2
ffffffffc0203d80:	8326                	mv	t1,s1
}
ffffffffc0203d82:	6942                	ld	s2,16(sp)
ffffffffc0203d84:	64e2                	ld	s1,24(sp)
ffffffffc0203d86:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0203d88:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0203d8a:	03065633          	divu	a2,a2,a6
ffffffffc0203d8e:	8722                	mv	a4,s0
ffffffffc0203d90:	f9bff0ef          	jal	ra,ffffffffc0203d2a <printnum>
ffffffffc0203d94:	b7f9                	j	ffffffffc0203d62 <printnum+0x38>

ffffffffc0203d96 <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0203d96:	7119                	addi	sp,sp,-128
ffffffffc0203d98:	f4a6                	sd	s1,104(sp)
ffffffffc0203d9a:	f0ca                	sd	s2,96(sp)
ffffffffc0203d9c:	e8d2                	sd	s4,80(sp)
ffffffffc0203d9e:	e4d6                	sd	s5,72(sp)
ffffffffc0203da0:	e0da                	sd	s6,64(sp)
ffffffffc0203da2:	fc5e                	sd	s7,56(sp)
ffffffffc0203da4:	f862                	sd	s8,48(sp)
ffffffffc0203da6:	f06a                	sd	s10,32(sp)
ffffffffc0203da8:	fc86                	sd	ra,120(sp)
ffffffffc0203daa:	f8a2                	sd	s0,112(sp)
ffffffffc0203dac:	ecce                	sd	s3,88(sp)
ffffffffc0203dae:	f466                	sd	s9,40(sp)
ffffffffc0203db0:	ec6e                	sd	s11,24(sp)
ffffffffc0203db2:	892a                	mv	s2,a0
ffffffffc0203db4:	84ae                	mv	s1,a1
ffffffffc0203db6:	8d32                	mv	s10,a2
ffffffffc0203db8:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0203dba:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203dbc:	00002a17          	auipc	s4,0x2
ffffffffc0203dc0:	094a0a13          	addi	s4,s4,148 # ffffffffc0205e50 <default_pmm_manager+0xe78>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203dc4:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203dc8:	00002c17          	auipc	s8,0x2
ffffffffc0203dcc:	1e0c0c13          	addi	s8,s8,480 # ffffffffc0205fa8 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203dd0:	000d4503          	lbu	a0,0(s10)
ffffffffc0203dd4:	02500793          	li	a5,37
ffffffffc0203dd8:	001d0413          	addi	s0,s10,1
ffffffffc0203ddc:	00f50e63          	beq	a0,a5,ffffffffc0203df8 <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0203de0:	c521                	beqz	a0,ffffffffc0203e28 <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203de2:	02500993          	li	s3,37
ffffffffc0203de6:	a011                	j	ffffffffc0203dea <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc0203de8:	c121                	beqz	a0,ffffffffc0203e28 <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0203dea:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203dec:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0203dee:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0203df0:	fff44503          	lbu	a0,-1(s0)
ffffffffc0203df4:	ff351ae3          	bne	a0,s3,ffffffffc0203de8 <vprintfmt+0x52>
ffffffffc0203df8:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0203dfc:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0203e00:	4981                	li	s3,0
ffffffffc0203e02:	4801                	li	a6,0
        width = precision = -1;
ffffffffc0203e04:	5cfd                	li	s9,-1
ffffffffc0203e06:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e08:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0203e0c:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e0e:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0203e12:	0ff6f693          	andi	a3,a3,255
ffffffffc0203e16:	00140d13          	addi	s10,s0,1
ffffffffc0203e1a:	20d5e563          	bltu	a1,a3,ffffffffc0204024 <vprintfmt+0x28e>
ffffffffc0203e1e:	068a                	slli	a3,a3,0x2
ffffffffc0203e20:	96d2                	add	a3,a3,s4
ffffffffc0203e22:	4294                	lw	a3,0(a3)
ffffffffc0203e24:	96d2                	add	a3,a3,s4
ffffffffc0203e26:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0203e28:	70e6                	ld	ra,120(sp)
ffffffffc0203e2a:	7446                	ld	s0,112(sp)
ffffffffc0203e2c:	74a6                	ld	s1,104(sp)
ffffffffc0203e2e:	7906                	ld	s2,96(sp)
ffffffffc0203e30:	69e6                	ld	s3,88(sp)
ffffffffc0203e32:	6a46                	ld	s4,80(sp)
ffffffffc0203e34:	6aa6                	ld	s5,72(sp)
ffffffffc0203e36:	6b06                	ld	s6,64(sp)
ffffffffc0203e38:	7be2                	ld	s7,56(sp)
ffffffffc0203e3a:	7c42                	ld	s8,48(sp)
ffffffffc0203e3c:	7ca2                	ld	s9,40(sp)
ffffffffc0203e3e:	7d02                	ld	s10,32(sp)
ffffffffc0203e40:	6de2                	ld	s11,24(sp)
ffffffffc0203e42:	6109                	addi	sp,sp,128
ffffffffc0203e44:	8082                	ret
    if (lflag >= 2) {
ffffffffc0203e46:	4705                	li	a4,1
ffffffffc0203e48:	008a8593          	addi	a1,s5,8
ffffffffc0203e4c:	01074463          	blt	a4,a6,ffffffffc0203e54 <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0203e50:	26080363          	beqz	a6,ffffffffc02040b6 <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc0203e54:	000ab603          	ld	a2,0(s5)
ffffffffc0203e58:	46c1                	li	a3,16
ffffffffc0203e5a:	8aae                	mv	s5,a1
ffffffffc0203e5c:	a06d                	j	ffffffffc0203f06 <vprintfmt+0x170>
            goto reswitch;
ffffffffc0203e5e:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0203e62:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203e64:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203e66:	b765                	j	ffffffffc0203e0e <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc0203e68:	000aa503          	lw	a0,0(s5)
ffffffffc0203e6c:	85a6                	mv	a1,s1
ffffffffc0203e6e:	0aa1                	addi	s5,s5,8
ffffffffc0203e70:	9902                	jalr	s2
            break;
ffffffffc0203e72:	bfb9                	j	ffffffffc0203dd0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203e74:	4705                	li	a4,1
ffffffffc0203e76:	008a8993          	addi	s3,s5,8
ffffffffc0203e7a:	01074463          	blt	a4,a6,ffffffffc0203e82 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc0203e7e:	22080463          	beqz	a6,ffffffffc02040a6 <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc0203e82:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc0203e86:	24044463          	bltz	s0,ffffffffc02040ce <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc0203e8a:	8622                	mv	a2,s0
ffffffffc0203e8c:	8ace                	mv	s5,s3
ffffffffc0203e8e:	46a9                	li	a3,10
ffffffffc0203e90:	a89d                	j	ffffffffc0203f06 <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc0203e92:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203e96:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0203e98:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc0203e9a:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0203e9e:	8fb5                	xor	a5,a5,a3
ffffffffc0203ea0:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0203ea4:	1ad74363          	blt	a4,a3,ffffffffc020404a <vprintfmt+0x2b4>
ffffffffc0203ea8:	00369793          	slli	a5,a3,0x3
ffffffffc0203eac:	97e2                	add	a5,a5,s8
ffffffffc0203eae:	639c                	ld	a5,0(a5)
ffffffffc0203eb0:	18078d63          	beqz	a5,ffffffffc020404a <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc0203eb4:	86be                	mv	a3,a5
ffffffffc0203eb6:	00002617          	auipc	a2,0x2
ffffffffc0203eba:	1da60613          	addi	a2,a2,474 # ffffffffc0206090 <error_string+0xe8>
ffffffffc0203ebe:	85a6                	mv	a1,s1
ffffffffc0203ec0:	854a                	mv	a0,s2
ffffffffc0203ec2:	240000ef          	jal	ra,ffffffffc0204102 <printfmt>
ffffffffc0203ec6:	b729                	j	ffffffffc0203dd0 <vprintfmt+0x3a>
            lflag ++;
ffffffffc0203ec8:	00144603          	lbu	a2,1(s0)
ffffffffc0203ecc:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203ece:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203ed0:	bf3d                	j	ffffffffc0203e0e <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc0203ed2:	4705                	li	a4,1
ffffffffc0203ed4:	008a8593          	addi	a1,s5,8
ffffffffc0203ed8:	01074463          	blt	a4,a6,ffffffffc0203ee0 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0203edc:	1e080263          	beqz	a6,ffffffffc02040c0 <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0203ee0:	000ab603          	ld	a2,0(s5)
ffffffffc0203ee4:	46a1                	li	a3,8
ffffffffc0203ee6:	8aae                	mv	s5,a1
ffffffffc0203ee8:	a839                	j	ffffffffc0203f06 <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0203eea:	03000513          	li	a0,48
ffffffffc0203eee:	85a6                	mv	a1,s1
ffffffffc0203ef0:	e03e                	sd	a5,0(sp)
ffffffffc0203ef2:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0203ef4:	85a6                	mv	a1,s1
ffffffffc0203ef6:	07800513          	li	a0,120
ffffffffc0203efa:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0203efc:	0aa1                	addi	s5,s5,8
ffffffffc0203efe:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0203f02:	6782                	ld	a5,0(sp)
ffffffffc0203f04:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0203f06:	876e                	mv	a4,s11
ffffffffc0203f08:	85a6                	mv	a1,s1
ffffffffc0203f0a:	854a                	mv	a0,s2
ffffffffc0203f0c:	e1fff0ef          	jal	ra,ffffffffc0203d2a <printnum>
            break;
ffffffffc0203f10:	b5c1                	j	ffffffffc0203dd0 <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0203f12:	000ab603          	ld	a2,0(s5)
ffffffffc0203f16:	0aa1                	addi	s5,s5,8
ffffffffc0203f18:	1c060663          	beqz	a2,ffffffffc02040e4 <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0203f1c:	00160413          	addi	s0,a2,1
ffffffffc0203f20:	17b05c63          	blez	s11,ffffffffc0204098 <vprintfmt+0x302>
ffffffffc0203f24:	02d00593          	li	a1,45
ffffffffc0203f28:	14b79263          	bne	a5,a1,ffffffffc020406c <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203f2c:	00064783          	lbu	a5,0(a2)
ffffffffc0203f30:	0007851b          	sext.w	a0,a5
ffffffffc0203f34:	c905                	beqz	a0,ffffffffc0203f64 <vprintfmt+0x1ce>
ffffffffc0203f36:	000cc563          	bltz	s9,ffffffffc0203f40 <vprintfmt+0x1aa>
ffffffffc0203f3a:	3cfd                	addiw	s9,s9,-1
ffffffffc0203f3c:	036c8263          	beq	s9,s6,ffffffffc0203f60 <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0203f40:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0203f42:	18098463          	beqz	s3,ffffffffc02040ca <vprintfmt+0x334>
ffffffffc0203f46:	3781                	addiw	a5,a5,-32
ffffffffc0203f48:	18fbf163          	bleu	a5,s7,ffffffffc02040ca <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0203f4c:	03f00513          	li	a0,63
ffffffffc0203f50:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0203f52:	0405                	addi	s0,s0,1
ffffffffc0203f54:	fff44783          	lbu	a5,-1(s0)
ffffffffc0203f58:	3dfd                	addiw	s11,s11,-1
ffffffffc0203f5a:	0007851b          	sext.w	a0,a5
ffffffffc0203f5e:	fd61                	bnez	a0,ffffffffc0203f36 <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0203f60:	e7b058e3          	blez	s11,ffffffffc0203dd0 <vprintfmt+0x3a>
ffffffffc0203f64:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203f66:	85a6                	mv	a1,s1
ffffffffc0203f68:	02000513          	li	a0,32
ffffffffc0203f6c:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203f6e:	e60d81e3          	beqz	s11,ffffffffc0203dd0 <vprintfmt+0x3a>
ffffffffc0203f72:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0203f74:	85a6                	mv	a1,s1
ffffffffc0203f76:	02000513          	li	a0,32
ffffffffc0203f7a:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0203f7c:	fe0d94e3          	bnez	s11,ffffffffc0203f64 <vprintfmt+0x1ce>
ffffffffc0203f80:	bd81                	j	ffffffffc0203dd0 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0203f82:	4705                	li	a4,1
ffffffffc0203f84:	008a8593          	addi	a1,s5,8
ffffffffc0203f88:	01074463          	blt	a4,a6,ffffffffc0203f90 <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc0203f8c:	12080063          	beqz	a6,ffffffffc02040ac <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc0203f90:	000ab603          	ld	a2,0(s5)
ffffffffc0203f94:	46a9                	li	a3,10
ffffffffc0203f96:	8aae                	mv	s5,a1
ffffffffc0203f98:	b7bd                	j	ffffffffc0203f06 <vprintfmt+0x170>
ffffffffc0203f9a:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc0203f9e:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fa2:	846a                	mv	s0,s10
ffffffffc0203fa4:	b5ad                	j	ffffffffc0203e0e <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc0203fa6:	85a6                	mv	a1,s1
ffffffffc0203fa8:	02500513          	li	a0,37
ffffffffc0203fac:	9902                	jalr	s2
            break;
ffffffffc0203fae:	b50d                	j	ffffffffc0203dd0 <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc0203fb0:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc0203fb4:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0203fb8:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fba:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc0203fbc:	e40dd9e3          	bgez	s11,ffffffffc0203e0e <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc0203fc0:	8de6                	mv	s11,s9
ffffffffc0203fc2:	5cfd                	li	s9,-1
ffffffffc0203fc4:	b5a9                	j	ffffffffc0203e0e <vprintfmt+0x78>
            goto reswitch;
ffffffffc0203fc6:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc0203fca:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fce:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0203fd0:	bd3d                	j	ffffffffc0203e0e <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc0203fd2:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc0203fd6:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0203fda:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0203fdc:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0203fe0:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0203fe4:	fcd56ce3          	bltu	a0,a3,ffffffffc0203fbc <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc0203fe8:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0203fea:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0203fee:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0203ff2:	0196873b          	addw	a4,a3,s9
ffffffffc0203ff6:	0017171b          	slliw	a4,a4,0x1
ffffffffc0203ffa:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0203ffe:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0204002:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc0204006:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc020400a:	fcd57fe3          	bleu	a3,a0,ffffffffc0203fe8 <vprintfmt+0x252>
ffffffffc020400e:	b77d                	j	ffffffffc0203fbc <vprintfmt+0x226>
            if (width < 0)
ffffffffc0204010:	fffdc693          	not	a3,s11
ffffffffc0204014:	96fd                	srai	a3,a3,0x3f
ffffffffc0204016:	00ddfdb3          	and	s11,s11,a3
ffffffffc020401a:	00144603          	lbu	a2,1(s0)
ffffffffc020401e:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204020:	846a                	mv	s0,s10
ffffffffc0204022:	b3f5                	j	ffffffffc0203e0e <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc0204024:	85a6                	mv	a1,s1
ffffffffc0204026:	02500513          	li	a0,37
ffffffffc020402a:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc020402c:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204030:	02500793          	li	a5,37
ffffffffc0204034:	8d22                	mv	s10,s0
ffffffffc0204036:	d8f70de3          	beq	a4,a5,ffffffffc0203dd0 <vprintfmt+0x3a>
ffffffffc020403a:	02500713          	li	a4,37
ffffffffc020403e:	1d7d                	addi	s10,s10,-1
ffffffffc0204040:	fffd4783          	lbu	a5,-1(s10)
ffffffffc0204044:	fee79de3          	bne	a5,a4,ffffffffc020403e <vprintfmt+0x2a8>
ffffffffc0204048:	b361                	j	ffffffffc0203dd0 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc020404a:	00002617          	auipc	a2,0x2
ffffffffc020404e:	03660613          	addi	a2,a2,54 # ffffffffc0206080 <error_string+0xd8>
ffffffffc0204052:	85a6                	mv	a1,s1
ffffffffc0204054:	854a                	mv	a0,s2
ffffffffc0204056:	0ac000ef          	jal	ra,ffffffffc0204102 <printfmt>
ffffffffc020405a:	bb9d                	j	ffffffffc0203dd0 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc020405c:	00002617          	auipc	a2,0x2
ffffffffc0204060:	01c60613          	addi	a2,a2,28 # ffffffffc0206078 <error_string+0xd0>
            if (width > 0 && padc != '-') {
ffffffffc0204064:	00002417          	auipc	s0,0x2
ffffffffc0204068:	01540413          	addi	s0,s0,21 # ffffffffc0206079 <error_string+0xd1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020406c:	8532                	mv	a0,a2
ffffffffc020406e:	85e6                	mv	a1,s9
ffffffffc0204070:	e032                	sd	a2,0(sp)
ffffffffc0204072:	e43e                	sd	a5,8(sp)
ffffffffc0204074:	18a000ef          	jal	ra,ffffffffc02041fe <strnlen>
ffffffffc0204078:	40ad8dbb          	subw	s11,s11,a0
ffffffffc020407c:	6602                	ld	a2,0(sp)
ffffffffc020407e:	01b05d63          	blez	s11,ffffffffc0204098 <vprintfmt+0x302>
ffffffffc0204082:	67a2                	ld	a5,8(sp)
ffffffffc0204084:	2781                	sext.w	a5,a5
ffffffffc0204086:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc0204088:	6522                	ld	a0,8(sp)
ffffffffc020408a:	85a6                	mv	a1,s1
ffffffffc020408c:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc020408e:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204090:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204092:	6602                	ld	a2,0(sp)
ffffffffc0204094:	fe0d9ae3          	bnez	s11,ffffffffc0204088 <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204098:	00064783          	lbu	a5,0(a2)
ffffffffc020409c:	0007851b          	sext.w	a0,a5
ffffffffc02040a0:	e8051be3          	bnez	a0,ffffffffc0203f36 <vprintfmt+0x1a0>
ffffffffc02040a4:	b335                	j	ffffffffc0203dd0 <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc02040a6:	000aa403          	lw	s0,0(s5)
ffffffffc02040aa:	bbf1                	j	ffffffffc0203e86 <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc02040ac:	000ae603          	lwu	a2,0(s5)
ffffffffc02040b0:	46a9                	li	a3,10
ffffffffc02040b2:	8aae                	mv	s5,a1
ffffffffc02040b4:	bd89                	j	ffffffffc0203f06 <vprintfmt+0x170>
ffffffffc02040b6:	000ae603          	lwu	a2,0(s5)
ffffffffc02040ba:	46c1                	li	a3,16
ffffffffc02040bc:	8aae                	mv	s5,a1
ffffffffc02040be:	b5a1                	j	ffffffffc0203f06 <vprintfmt+0x170>
ffffffffc02040c0:	000ae603          	lwu	a2,0(s5)
ffffffffc02040c4:	46a1                	li	a3,8
ffffffffc02040c6:	8aae                	mv	s5,a1
ffffffffc02040c8:	bd3d                	j	ffffffffc0203f06 <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc02040ca:	9902                	jalr	s2
ffffffffc02040cc:	b559                	j	ffffffffc0203f52 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc02040ce:	85a6                	mv	a1,s1
ffffffffc02040d0:	02d00513          	li	a0,45
ffffffffc02040d4:	e03e                	sd	a5,0(sp)
ffffffffc02040d6:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02040d8:	8ace                	mv	s5,s3
ffffffffc02040da:	40800633          	neg	a2,s0
ffffffffc02040de:	46a9                	li	a3,10
ffffffffc02040e0:	6782                	ld	a5,0(sp)
ffffffffc02040e2:	b515                	j	ffffffffc0203f06 <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc02040e4:	01b05663          	blez	s11,ffffffffc02040f0 <vprintfmt+0x35a>
ffffffffc02040e8:	02d00693          	li	a3,45
ffffffffc02040ec:	f6d798e3          	bne	a5,a3,ffffffffc020405c <vprintfmt+0x2c6>
ffffffffc02040f0:	00002417          	auipc	s0,0x2
ffffffffc02040f4:	f8940413          	addi	s0,s0,-119 # ffffffffc0206079 <error_string+0xd1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02040f8:	02800513          	li	a0,40
ffffffffc02040fc:	02800793          	li	a5,40
ffffffffc0204100:	bd1d                	j	ffffffffc0203f36 <vprintfmt+0x1a0>

ffffffffc0204102 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204102:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204104:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204108:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020410a:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020410c:	ec06                	sd	ra,24(sp)
ffffffffc020410e:	f83a                	sd	a4,48(sp)
ffffffffc0204110:	fc3e                	sd	a5,56(sp)
ffffffffc0204112:	e0c2                	sd	a6,64(sp)
ffffffffc0204114:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204116:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204118:	c7fff0ef          	jal	ra,ffffffffc0203d96 <vprintfmt>
}
ffffffffc020411c:	60e2                	ld	ra,24(sp)
ffffffffc020411e:	6161                	addi	sp,sp,80
ffffffffc0204120:	8082                	ret

ffffffffc0204122 <readline>:
...
ffffffffc0204124:	e486                	sd	ra,72(sp)
ffffffffc0204126:	e0a2                	sd	s0,64(sp)
ffffffffc0204128:	fc26                	sd	s1,56(sp)
ffffffffc020412a:	f84a                	sd	s2,48(sp)
ffffffffc020412c:	f44e                	sd	s3,40(sp)
ffffffffc020412e:	f052                	sd	s4,32(sp)
ffffffffc0204130:	ec56                	sd	s5,24(sp)
ffffffffc0204132:	e85a                	sd	s6,16(sp)
ffffffffc0204134:	e45e                	sd	s7,8(sp)
    if (prompt != NULL) {
ffffffffc0204136:	c901                	beqz	a0,ffffffffc0204146 <readline+0x24>
        cprintf("%s", prompt);
ffffffffc0204138:	85aa                	mv	a1,a0
ffffffffc020413a:	00002517          	auipc	a0,0x2
ffffffffc020413e:	f5650513          	addi	a0,a0,-170 # ffffffffc0206090 <error_string+0xe8>
ffffffffc0204142:	f7dfb0ef          	jal	ra,ffffffffc02000be <cprintf>
readline(const char *prompt) {
ffffffffc0204146:	4481                	li	s1,0
    while (1) {
        c = getchar();
        if (c < 0) {
            return NULL;
...
ffffffffc0204148:	497d                	li	s2,31
            cputchar(c);
            buf[i ++] = c;
        }
        else if (c == '\b' && i > 0) {
ffffffffc020414a:	49a1                	li	s3,8
            cputchar(c);
            i --;
        }
        else if (c == '\n' || c == '\r') {
ffffffffc020414c:	4aa9                	li	s5,10
ffffffffc020414e:	4b35                	li	s6,13
            buf[i ++] = c;
ffffffffc0204150:	0000db97          	auipc	s7,0xd
ffffffffc0204154:	ef0b8b93          	addi	s7,s7,-272 # ffffffffc0211040 <buf>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204158:	3fe00a13          	li	s4,1022
        c = getchar();
ffffffffc020415c:	f9bfb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc0204160:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc0204162:	00054b63          	bltz	a0,ffffffffc0204178 <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc0204166:	00a95b63          	ble	a0,s2,ffffffffc020417c <readline+0x5a>
ffffffffc020416a:	029a5463          	ble	s1,s4,ffffffffc0204192 <readline+0x70>
        c = getchar();
ffffffffc020416e:	f89fb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc0204172:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc0204174:	fe0559e3          	bgez	a0,ffffffffc0204166 <readline+0x44>
            return NULL;
ffffffffc0204178:	4501                	li	a0,0
ffffffffc020417a:	a099                	j	ffffffffc02041c0 <readline+0x9e>
        else if (c == '\b' && i > 0) {
ffffffffc020417c:	03341463          	bne	s0,s3,ffffffffc02041a4 <readline+0x82>
ffffffffc0204180:	e8b9                	bnez	s1,ffffffffc02041d6 <readline+0xb4>
        c = getchar();
ffffffffc0204182:	f75fb0ef          	jal	ra,ffffffffc02000f6 <getchar>
ffffffffc0204186:	842a                	mv	s0,a0
        if (c < 0) {
ffffffffc0204188:	fe0548e3          	bltz	a0,ffffffffc0204178 <readline+0x56>
        else if (c >= ' ' && i < BUFSIZE - 1) {
ffffffffc020418c:	fea958e3          	ble	a0,s2,ffffffffc020417c <readline+0x5a>
ffffffffc0204190:	4481                	li	s1,0
            cputchar(c);
ffffffffc0204192:	8522                	mv	a0,s0
ffffffffc0204194:	f5ffb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i ++] = c;
ffffffffc0204198:	009b87b3          	add	a5,s7,s1
ffffffffc020419c:	00878023          	sb	s0,0(a5)
ffffffffc02041a0:	2485                	addiw	s1,s1,1
ffffffffc02041a2:	bf6d                	j	ffffffffc020415c <readline+0x3a>
        else if (c == '\n' || c == '\r') {
ffffffffc02041a4:	01540463          	beq	s0,s5,ffffffffc02041ac <readline+0x8a>
ffffffffc02041a8:	fb641ae3          	bne	s0,s6,ffffffffc020415c <readline+0x3a>
            cputchar(c);
ffffffffc02041ac:	8522                	mv	a0,s0
ffffffffc02041ae:	f45fb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            buf[i] = '\0';
ffffffffc02041b2:	0000d517          	auipc	a0,0xd
ffffffffc02041b6:	e8e50513          	addi	a0,a0,-370 # ffffffffc0211040 <buf>
ffffffffc02041ba:	94aa                	add	s1,s1,a0
ffffffffc02041bc:	00048023          	sb	zero,0(s1)
            return buf;
        }
    }
}
ffffffffc02041c0:	60a6                	ld	ra,72(sp)
ffffffffc02041c2:	6406                	ld	s0,64(sp)
ffffffffc02041c4:	74e2                	ld	s1,56(sp)
ffffffffc02041c6:	7942                	ld	s2,48(sp)
ffffffffc02041c8:	79a2                	ld	s3,40(sp)
ffffffffc02041ca:	7a02                	ld	s4,32(sp)
ffffffffc02041cc:	6ae2                	ld	s5,24(sp)
ffffffffc02041ce:	6b42                	ld	s6,16(sp)
ffffffffc02041d0:	6ba2                	ld	s7,8(sp)
ffffffffc02041d2:	6161                	addi	sp,sp,80
ffffffffc02041d4:	8082                	ret
            cputchar(c);
ffffffffc02041d6:	4521                	li	a0,8
ffffffffc02041d8:	f1bfb0ef          	jal	ra,ffffffffc02000f2 <cputchar>
            i --;
ffffffffc02041dc:	34fd                	addiw	s1,s1,-1
ffffffffc02041de:	bfbd                	j	ffffffffc020415c <readline+0x3a>

ffffffffc02041e0 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc02041e0:	00054783          	lbu	a5,0(a0)
ffffffffc02041e4:	cb91                	beqz	a5,ffffffffc02041f8 <strlen+0x18>
    size_t cnt = 0;
ffffffffc02041e6:	4781                	li	a5,0
        cnt ++;
ffffffffc02041e8:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc02041ea:	00f50733          	add	a4,a0,a5
ffffffffc02041ee:	00074703          	lbu	a4,0(a4)
ffffffffc02041f2:	fb7d                	bnez	a4,ffffffffc02041e8 <strlen+0x8>
    }
    return cnt;
}
ffffffffc02041f4:	853e                	mv	a0,a5
ffffffffc02041f6:	8082                	ret
    size_t cnt = 0;
ffffffffc02041f8:	4781                	li	a5,0
}
ffffffffc02041fa:	853e                	mv	a0,a5
ffffffffc02041fc:	8082                	ret

ffffffffc02041fe <strnlen>:
 * pointed by @s.
 * */
size_t
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc02041fe:	c185                	beqz	a1,ffffffffc020421e <strnlen+0x20>
ffffffffc0204200:	00054783          	lbu	a5,0(a0)
ffffffffc0204204:	cf89                	beqz	a5,ffffffffc020421e <strnlen+0x20>
    size_t cnt = 0;
ffffffffc0204206:	4781                	li	a5,0
ffffffffc0204208:	a021                	j	ffffffffc0204210 <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc020420a:	00074703          	lbu	a4,0(a4)
ffffffffc020420e:	c711                	beqz	a4,ffffffffc020421a <strnlen+0x1c>
        cnt ++;
ffffffffc0204210:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204212:	00f50733          	add	a4,a0,a5
ffffffffc0204216:	fef59ae3          	bne	a1,a5,ffffffffc020420a <strnlen+0xc>
    }
    return cnt;
}
...
#else
    char *p = dst;
ffffffffc0204224:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204226:	0585                	addi	a1,a1,1
ffffffffc0204228:	fff5c703          	lbu	a4,-1(a1)
ffffffffc020422c:	0785                	addi	a5,a5,1
ffffffffc020422e:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204232:	fb75                	bnez	a4,ffffffffc0204226 <strcpy+0x2>
        /* nothing */;
    return dst;
...
#else
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204236:	00054783          	lbu	a5,0(a0)
ffffffffc020423a:	0005c703          	lbu	a4,0(a1)
ffffffffc020423e:	cb91                	beqz	a5,ffffffffc0204252 <strcmp+0x1c>
ffffffffc0204240:	00e79c63          	bne	a5,a4,ffffffffc0204258 <strcmp+0x22>
        s1 ++, s2 ++;
ffffffffc0204244:	0505                	addi	a0,a0,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204246:	00054783          	lbu	a5,0(a0)
        s1 ++, s2 ++;
ffffffffc020424a:	0585                	addi	a1,a1,1
ffffffffc020424c:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204250:	fbe5                	bnez	a5,ffffffffc0204240 <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204252:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204254:	9d19                	subw	a0,a0,a4
ffffffffc0204256:	8082                	ret
ffffffffc0204258:	0007851b          	sext.w	a0,a5
ffffffffc020425c:	9d19                	subw	a0,a0,a4
...
ffffffffc0204264:	cb91                	beqz	a5,ffffffffc0204278 <strchr+0x18>
        if (*s == c) {
ffffffffc0204266:	00b79563          	bne	a5,a1,ffffffffc0204270 <strchr+0x10>
ffffffffc020426a:	a809                	j	ffffffffc020427c <strchr+0x1c>
ffffffffc020426c:	00b78763          	beq	a5,a1,ffffffffc020427a <strchr+0x1a>
            return (char *)s;
        }
        s ++;
...
ffffffffc0204276:	fbfd                	bnez	a5,ffffffffc020426c <strchr+0xc>
    }
    return NULL;
...
ffffffffc0204286:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc020428a:	fec79de3          	bne	a5,a2,ffffffffc0204284 <memset+0x6>
    }
    return s;
...
ffffffffc0204294:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204296:	0585                	addi	a1,a1,1
ffffffffc0204298:	fff5c703          	lbu	a4,-1(a1)
ffffffffc020429c:	0785                	addi	a5,a5,1
ffffffffc020429e:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc02042a2:	fec59ae3          	bne	a1,a2,ffffffffc0204296 <memcpy+0x6>
    }
    return dst;
