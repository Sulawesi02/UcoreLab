...
ffffffffc020003a:	fba50513          	addi	a0,a0,-70 # ffffffffc02a0ff0 <edata>
...
ffffffffc020004c:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004e:	598060ef          	jal	ra,ffffffffc02065e6 <memset>
...
ffffffffc020007e:	4f9050ef          	jal	ra,ffffffffc0205d76 <proc_init>
...
ffffffffc0200092:	631050ef          	jal	ra,ffffffffc0205ec2 <cpu_idle>
...
ffffffffc02000b2:	58a50513          	addi	a0,a0,1418 # ffffffffc0206638 <etext+0x28>
...
ffffffffc02000c8:	f2cb8b93          	addi	s7,s7,-212 # ffffffffc02a0ff0 <edata>
        else if (c >= ' ' && i < BUFSIZE - 1) {
...
ffffffffc020012a:	eca50513          	addi	a0,a0,-310 # ffffffffc02a0ff0 <edata>
...
ffffffffc0200180:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200182:	03a060ef          	jal	ra,ffffffffc02061bc <vprintfmt>
    return cnt;
}
...
ffffffffc02001b4:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001b6:	006060ef          	jal	ra,ffffffffc02061bc <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc020021c:	45850513          	addi	a0,a0,1112 # ffffffffc0206670 <etext+0x60>
void print_kerninfo(void) {
...
ffffffffc0200232:	46250513          	addi	a0,a0,1122 # ffffffffc0206690 <etext+0x80>
ffffffffc0200236:	f59ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc020023a:	00006597          	auipc	a1,0x6
ffffffffc020023e:	3d658593          	addi	a1,a1,982 # ffffffffc0206610 <etext>
ffffffffc0200242:	00006517          	auipc	a0,0x6
ffffffffc0200246:	46e50513          	addi	a0,a0,1134 # ffffffffc02066b0 <etext+0xa0>
ffffffffc020024a:	f45ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  edata  0x%08x (virtual)\n", edata);
ffffffffc020024e:	000a1597          	auipc	a1,0xa1
ffffffffc0200252:	da258593          	addi	a1,a1,-606 # ffffffffc02a0ff0 <edata>
ffffffffc0200256:	00006517          	auipc	a0,0x6
ffffffffc020025a:	47a50513          	addi	a0,a0,1146 # ffffffffc02066d0 <etext+0xc0>
ffffffffc020025e:	f31ff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("  end    0x%08x (virtual)\n", end);
ffffffffc0200262:	000ac597          	auipc	a1,0xac
ffffffffc0200266:	31658593          	addi	a1,a1,790 # ffffffffc02ac578 <end>
ffffffffc020026a:	00006517          	auipc	a0,0x6
ffffffffc020026e:	48650513          	addi	a0,a0,1158 # ffffffffc02066f0 <etext+0xe0>
ffffffffc0200272:	f1dff0ef          	jal	ra,ffffffffc020018e <cprintf>
    cprintf("Kernel executable memory footprint: %dKB\n",
            (end - kern_init + 1023) / 1024);
ffffffffc0200276:	000ac597          	auipc	a1,0xac
ffffffffc020027a:	70158593          	addi	a1,a1,1793 # ffffffffc02ac977 <end+0x3ff>
...
ffffffffc020029c:	47850513          	addi	a0,a0,1144 # ffffffffc0206710 <etext+0x100>
}
...
ffffffffc02002ac:	39860613          	addi	a2,a2,920 # ffffffffc0206640 <etext+0x30>
ffffffffc02002b0:	04d00593          	li	a1,77
ffffffffc02002b4:	00006517          	auipc	a0,0x6
ffffffffc02002b8:	3a450513          	addi	a0,a0,932 # ffffffffc0206658 <etext+0x48>
void print_stackframe(void) {
...
ffffffffc02002c8:	55c60613          	addi	a2,a2,1372 # ffffffffc0206820 <commands+0xe0>
ffffffffc02002cc:	00006597          	auipc	a1,0x6
ffffffffc02002d0:	57458593          	addi	a1,a1,1396 # ffffffffc0206840 <commands+0x100>
ffffffffc02002d4:	00006517          	auipc	a0,0x6
ffffffffc02002d8:	57450513          	addi	a0,a0,1396 # ffffffffc0206848 <commands+0x108>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc02002e6:	57660613          	addi	a2,a2,1398 # ffffffffc0206858 <commands+0x118>
ffffffffc02002ea:	00006597          	auipc	a1,0x6
ffffffffc02002ee:	59658593          	addi	a1,a1,1430 # ffffffffc0206880 <commands+0x140>
ffffffffc02002f2:	00006517          	auipc	a0,0x6
ffffffffc02002f6:	55650513          	addi	a0,a0,1366 # ffffffffc0206848 <commands+0x108>
ffffffffc02002fa:	e95ff0ef          	jal	ra,ffffffffc020018e <cprintf>
ffffffffc02002fe:	00006617          	auipc	a2,0x6
ffffffffc0200302:	59260613          	addi	a2,a2,1426 # ffffffffc0206890 <commands+0x150>
ffffffffc0200306:	00006597          	auipc	a1,0x6
ffffffffc020030a:	5aa58593          	addi	a1,a1,1450 # ffffffffc02068b0 <commands+0x170>
ffffffffc020030e:	00006517          	auipc	a0,0x6
ffffffffc0200312:	53a50513          	addi	a0,a0,1338 # ffffffffc0206848 <commands+0x108>
...
ffffffffc020034c:	44050513          	addi	a0,a0,1088 # ffffffffc0206788 <commands+0x48>
kmonitor(struct trapframe *tf) {
...
ffffffffc020036e:	44650513          	addi	a0,a0,1094 # ffffffffc02067b0 <commands+0x70>
...
ffffffffc0200384:	3c0c8c93          	addi	s9,s9,960 # ffffffffc0206740 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200388:	00006997          	auipc	s3,0x6
ffffffffc020038c:	45098993          	addi	s3,s3,1104 # ffffffffc02067d8 <commands+0x98>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200390:	00006917          	auipc	s2,0x6
ffffffffc0200394:	45090913          	addi	s2,s2,1104 # ffffffffc02067e0 <commands+0xa0>
        if (argc == MAXARGS - 1) {
ffffffffc0200398:	4a3d                	li	s4,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc020039a:	00006b17          	auipc	s6,0x6
ffffffffc020039e:	44eb0b13          	addi	s6,s6,1102 # ffffffffc02067e8 <commands+0xa8>
    if (argc == 0) {
ffffffffc02003a2:	00006a97          	auipc	s5,0x6
ffffffffc02003a6:	49ea8a93          	addi	s5,s5,1182 # ffffffffc0206840 <commands+0x100>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc02003c0:	208060ef          	jal	ra,ffffffffc02065c8 <strchr>
...
ffffffffc02003da:	36ad0d13          	addi	s10,s10,874 # ffffffffc0206740 <commands>
    if (argc == 0) {
...
ffffffffc02003e4:	1ba060ef          	jal	ra,ffffffffc020659e <strcmp>
...
ffffffffc02003f8:	1a6060ef          	jal	ra,ffffffffc020659e <strcmp>
...
ffffffffc020045e:	16a060ef          	jal	ra,ffffffffc02065c8 <strchr>
...
ffffffffc020047a:	39250513          	addi	a0,a0,914 # ffffffffc0206808 <commands+0xc8>
...
ffffffffc0200488:	f6c30313          	addi	t1,t1,-148 # ffffffffc02ac3f0 <is_panic>
...
ffffffffc02004ac:	f4f73423          	sd	a5,-184(a4) # ffffffffc02ac3f0 <is_panic>
...
ffffffffc02004ba:	40a50513          	addi	a0,a0,1034 # ffffffffc02068c0 <commands+0x180>
    va_start(ap, fmt);
...
ffffffffc02004d0:	3ac50513          	addi	a0,a0,940 # ffffffffc0207878 <default_pmm_manager+0x530>
...
ffffffffc0200502:	3e250513          	addi	a0,a0,994 # ffffffffc02068e0 <commands+0x1a0>
__warn(const char *file, int line, const char *fmt, ...) {
...
ffffffffc0200522:	35a50513          	addi	a0,a0,858 # ffffffffc0207878 <default_pmm_manager+0x530>
...
ffffffffc0200534:	6a078793          	addi	a5,a5,1696 # 186a0 <_binary_obj___user_exit_out_size+0xdc28>
ffffffffc0200538:	000ac717          	auipc	a4,0xac
ffffffffc020053c:	ecf73023          	sd	a5,-320(a4) # ffffffffc02ac3f8 <timebase>
...
ffffffffc020055c:	3a850513          	addi	a0,a0,936 # ffffffffc0206900 <commands+0x1c0>
    ticks = 0;
ffffffffc0200560:	000ac797          	auipc	a5,0xac
ffffffffc0200564:	ee07b423          	sd	zero,-280(a5) # ffffffffc02ac448 <ticks>
    cprintf("++ setup timer interrupts\n");
...
ffffffffc0200574:	e8878793          	addi	a5,a5,-376 # ffffffffc02ac3f8 <timebase>
...
ffffffffc020060e:	de678793          	addi	a5,a5,-538 # ffffffffc02a13f0 <ide>
...
ffffffffc0200620:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc0200622:	7d7050ef          	jal	ra,ffffffffc02065f8 <memcpy>
    return 0;
}
...
ffffffffc0200638:	dbc50513          	addi	a0,a0,-580 # ffffffffc02a13f0 <ide>
                   size_t nsecs) {
...
ffffffffc0200646:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc0200648:	7b1050ef          	jal	ra,ffffffffc02065f8 <memcpy>
    return 0;
}
...
ffffffffc0200688:	5c450513          	addi	a0,a0,1476 # ffffffffc0206c48 <commands+0x508>
void print_regs(struct pushregs* gpr) {
...
ffffffffc0200698:	5cc50513          	addi	a0,a0,1484 # ffffffffc0206c60 <commands+0x520>
...
ffffffffc02006a6:	5d650513          	addi	a0,a0,1494 # ffffffffc0206c78 <commands+0x538>
...
ffffffffc02006b4:	5e050513          	addi	a0,a0,1504 # ffffffffc0206c90 <commands+0x550>
...
ffffffffc02006c2:	5ea50513          	addi	a0,a0,1514 # ffffffffc0206ca8 <commands+0x568>
...
ffffffffc02006d0:	5f450513          	addi	a0,a0,1524 # ffffffffc0206cc0 <commands+0x580>
...
ffffffffc02006de:	5fe50513          	addi	a0,a0,1534 # ffffffffc0206cd8 <commands+0x598>
...
ffffffffc02006ec:	60850513          	addi	a0,a0,1544 # ffffffffc0206cf0 <commands+0x5b0>
...
ffffffffc02006fa:	61250513          	addi	a0,a0,1554 # ffffffffc0206d08 <commands+0x5c8>
...
ffffffffc0200708:	61c50513          	addi	a0,a0,1564 # ffffffffc0206d20 <commands+0x5e0>
...
ffffffffc0200716:	62650513          	addi	a0,a0,1574 # ffffffffc0206d38 <commands+0x5f8>
...
ffffffffc0200724:	63050513          	addi	a0,a0,1584 # ffffffffc0206d50 <commands+0x610>
...
ffffffffc0200732:	63a50513          	addi	a0,a0,1594 # ffffffffc0206d68 <commands+0x628>
...
ffffffffc0200740:	64450513          	addi	a0,a0,1604 # ffffffffc0206d80 <commands+0x640>
...
ffffffffc020074e:	64e50513          	addi	a0,a0,1614 # ffffffffc0206d98 <commands+0x658>
...
ffffffffc020075c:	65850513          	addi	a0,a0,1624 # ffffffffc0206db0 <commands+0x670>
...
ffffffffc020076a:	66250513          	addi	a0,a0,1634 # ffffffffc0206dc8 <commands+0x688>
...
ffffffffc0200778:	66c50513          	addi	a0,a0,1644 # ffffffffc0206de0 <commands+0x6a0>
...
ffffffffc0200786:	67650513          	addi	a0,a0,1654 # ffffffffc0206df8 <commands+0x6b8>
...
ffffffffc0200794:	68050513          	addi	a0,a0,1664 # ffffffffc0206e10 <commands+0x6d0>
...
ffffffffc02007a2:	68a50513          	addi	a0,a0,1674 # ffffffffc0206e28 <commands+0x6e8>
...
ffffffffc02007b0:	69450513          	addi	a0,a0,1684 # ffffffffc0206e40 <commands+0x700>
...
ffffffffc02007be:	69e50513          	addi	a0,a0,1694 # ffffffffc0206e58 <commands+0x718>
...
ffffffffc02007cc:	6a850513          	addi	a0,a0,1704 # ffffffffc0206e70 <commands+0x730>
...
ffffffffc02007da:	6b250513          	addi	a0,a0,1714 # ffffffffc0206e88 <commands+0x748>
...
ffffffffc02007e8:	6bc50513          	addi	a0,a0,1724 # ffffffffc0206ea0 <commands+0x760>
...
ffffffffc02007f6:	6c650513          	addi	a0,a0,1734 # ffffffffc0206eb8 <commands+0x778>
...
ffffffffc0200804:	6d050513          	addi	a0,a0,1744 # ffffffffc0206ed0 <commands+0x790>
...
ffffffffc0200812:	6da50513          	addi	a0,a0,1754 # ffffffffc0206ee8 <commands+0x7a8>
...
ffffffffc0200820:	6e450513          	addi	a0,a0,1764 # ffffffffc0206f00 <commands+0x7c0>
...
ffffffffc020082e:	6ee50513          	addi	a0,a0,1774 # ffffffffc0206f18 <commands+0x7d8>
...
ffffffffc0200840:	6f450513          	addi	a0,a0,1780 # ffffffffc0206f30 <commands+0x7f0>
}
...
ffffffffc0200856:	6f650513          	addi	a0,a0,1782 # ffffffffc0206f48 <commands+0x808>
print_trapframe(struct trapframe *tf) {
...
ffffffffc020086e:	6f650513          	addi	a0,a0,1782 # ffffffffc0206f60 <commands+0x820>
...
ffffffffc020087e:	6fe50513          	addi	a0,a0,1790 # ffffffffc0206f78 <commands+0x838>
...
ffffffffc020088e:	70650513          	addi	a0,a0,1798 # ffffffffc0206f90 <commands+0x850>
...
ffffffffc02008a2:	70250513          	addi	a0,a0,1794 # ffffffffc0206fa0 <commands+0x860>
}
...
ffffffffc02008b4:	cb048493          	addi	s1,s1,-848 # ffffffffc02ac560 <check_mm_struct>
...
ffffffffc02008ea:	2e250513          	addi	a0,a0,738 # ffffffffc0206bc8 <commands+0x488>
...
ffffffffc020095c:	29068693          	addi	a3,a3,656 # ffffffffc0206be8 <commands+0x4a8>
ffffffffc0200960:	00006617          	auipc	a2,0x6
ffffffffc0200964:	2a060613          	addi	a2,a2,672 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0200968:	06b00593          	li	a1,107
ffffffffc020096c:	00006517          	auipc	a0,0x6
ffffffffc0200970:	2ac50513          	addi	a0,a0,684 # ffffffffc0206c18 <commands+0x4d8>
...
ffffffffc02009a6:	22650513          	addi	a0,a0,550 # ffffffffc0206bc8 <commands+0x488>
ffffffffc02009aa:	fe4ff0ef          	jal	ra,ffffffffc020018e <cprintf>
            panic("unhandled page fault.\n");
ffffffffc02009ae:	00006617          	auipc	a2,0x6
ffffffffc02009b2:	28260613          	addi	a2,a2,642 # ffffffffc0206c30 <commands+0x4f0>
ffffffffc02009b6:	07200593          	li	a1,114
ffffffffc02009ba:	00006517          	auipc	a0,0x6
ffffffffc02009be:	25e50513          	addi	a0,a0,606 # ffffffffc0206c18 <commands+0x4d8>
...
ffffffffc02009e0:	f4070713          	addi	a4,a4,-192 # ffffffffc020691c <commands+0x1dc>
...
ffffffffc02009f2:	19a50513          	addi	a0,a0,410 # ffffffffc0206b88 <commands+0x448>
ffffffffc02009f6:	f98ff06f          	j	ffffffffc020018e <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02009fa:	00006517          	auipc	a0,0x6
ffffffffc02009fe:	16e50513          	addi	a0,a0,366 # ffffffffc0206b68 <commands+0x428>
ffffffffc0200a02:	f8cff06f          	j	ffffffffc020018e <cprintf>
            cprintf("User software interrupt\n");
ffffffffc0200a06:	00006517          	auipc	a0,0x6
ffffffffc0200a0a:	12250513          	addi	a0,a0,290 # ffffffffc0206b28 <commands+0x3e8>
ffffffffc0200a0e:	f80ff06f          	j	ffffffffc020018e <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc0200a12:	00006517          	auipc	a0,0x6
ffffffffc0200a16:	13650513          	addi	a0,a0,310 # ffffffffc0206b48 <commands+0x408>
...
ffffffffc0200a22:	18a50513          	addi	a0,a0,394 # ffffffffc0206ba8 <commands+0x468>
...
ffffffffc0200a78:	ed870713          	addi	a4,a4,-296 # ffffffffc020694c <commands+0x20c>
...
ffffffffc0200a94:	ff050513          	addi	a0,a0,-16 # ffffffffc0206a80 <commands+0x340>
...
ffffffffc0200ab6:	fee50513          	addi	a0,a0,-18 # ffffffffc0206aa0 <commands+0x360>
}
...
ffffffffc0200aca:	ffa50513          	addi	a0,a0,-6 # ffffffffc0206ac0 <commands+0x380>
ffffffffc0200ace:	b7f5                	j	ffffffffc0200aba <exception_handler+0x50>
            cprintf("Instruction page fault\n");
ffffffffc0200ad0:	00006517          	auipc	a0,0x6
ffffffffc0200ad4:	01050513          	addi	a0,a0,16 # ffffffffc0206ae0 <commands+0x3a0>
ffffffffc0200ad8:	b7cd                	j	ffffffffc0200aba <exception_handler+0x50>
            cprintf("Load page fault\n");
ffffffffc0200ada:	00006517          	auipc	a0,0x6
ffffffffc0200ade:	01e50513          	addi	a0,a0,30 # ffffffffc0206af8 <commands+0x3b8>
...
ffffffffc0200b00:	01450513          	addi	a0,a0,20 # ffffffffc0206b10 <commands+0x3d0>
...
ffffffffc0200b94:	e6850513          	addi	a0,a0,-408 # ffffffffc02069f8 <commands+0x2b8>
ffffffffc0200b98:	b70d                	j	ffffffffc0200aba <exception_handler+0x50>
            cprintf("Load access fault\n");
ffffffffc0200b9a:	00006517          	auipc	a0,0x6
ffffffffc0200b9e:	e7e50513          	addi	a0,a0,-386 # ffffffffc0206a18 <commands+0x2d8>
...
ffffffffc0200bbc:	e7860613          	addi	a2,a2,-392 # ffffffffc0206a30 <commands+0x2f0>
ffffffffc0200bc0:	0cd00593          	li	a1,205
ffffffffc0200bc4:	00006517          	auipc	a0,0x6
ffffffffc0200bc8:	05450513          	addi	a0,a0,84 # ffffffffc0206c18 <commands+0x4d8>
ffffffffc0200bcc:	8b9ff0ef          	jal	ra,ffffffffc0200484 <__panic>
            cprintf("Store/AMO access fault\n");
ffffffffc0200bd0:	00006517          	auipc	a0,0x6
ffffffffc0200bd4:	e9850513          	addi	a0,a0,-360 # ffffffffc0206a68 <commands+0x328>
...
ffffffffc0200bf4:	e4060613          	addi	a2,a2,-448 # ffffffffc0206a30 <commands+0x2f0>
ffffffffc0200bf8:	0d700593          	li	a1,215
ffffffffc0200bfc:	00006517          	auipc	a0,0x6
ffffffffc0200c00:	01c50513          	addi	a0,a0,28 # ffffffffc0206c18 <commands+0x4d8>
...
ffffffffc0200c18:	e3c60613          	addi	a2,a2,-452 # ffffffffc0206a50 <commands+0x310>
ffffffffc0200c1c:	0d100593          	li	a1,209
ffffffffc0200c20:	00006517          	auipc	a0,0x6
ffffffffc0200c24:	ff850513          	addi	a0,a0,-8 # ffffffffc0206c18 <commands+0x4d8>
...
ffffffffc0200c3c:	df860613          	addi	a2,a2,-520 # ffffffffc0206a30 <commands+0x2f0>
ffffffffc0200c40:	0f100593          	li	a1,241
ffffffffc0200c44:	00006517          	auipc	a0,0x6
ffffffffc0200c48:	fd450513          	addi	a0,a0,-44 # ffffffffc0206c18 <commands+0x4d8>
...
ffffffffc0200e5a:	5fa78793          	addi	a5,a5,1530 # ffffffffc02ac450 <free_area>
...
ffffffffc0200e6c:	5f856503          	lwu	a0,1528(a0) # ffffffffc02ac460 <free_area+0x10>
...
ffffffffc0200e7a:	5da90913          	addi	s2,s2,1498 # ffffffffc02ac450 <free_area>
...
ffffffffc0200f16:	56e78793          	addi	a5,a5,1390 # ffffffffc02ac480 <pages>
...
ffffffffc0200f2a:	4ea70713          	addi	a4,a4,1258 # ffffffffc02ac410 <npage>
...
ffffffffc0200f6e:	4f27b723          	sd	s2,1262(a5) # ffffffffc02ac458 <free_area+0x8>
ffffffffc0200f72:	000ab797          	auipc	a5,0xab
ffffffffc0200f76:	4d27bf23          	sd	s2,1246(a5) # ffffffffc02ac450 <free_area>
    nr_free = 0;
ffffffffc0200f7a:	000ab797          	auipc	a5,0xab
ffffffffc0200f7e:	4e07a323          	sw	zero,1254(a5) # ffffffffc02ac460 <free_area+0x10>
    assert(alloc_page() == NULL);
...
ffffffffc020100e:	4587b323          	sd	s8,1094(a5) # ffffffffc02ac450 <free_area>
ffffffffc0201012:	000ab797          	auipc	a5,0xab
ffffffffc0201016:	4577b323          	sd	s7,1094(a5) # ffffffffc02ac458 <free_area+0x8>
    nr_free = nr_free_store;
ffffffffc020101a:	000ab797          	auipc	a5,0xab
ffffffffc020101e:	4567a323          	sw	s6,1094(a5) # ffffffffc02ac460 <free_area+0x10>
    free_page(p);
...
ffffffffc020105a:	3f27bd23          	sd	s2,1018(a5) # ffffffffc02ac450 <free_area>
ffffffffc020105e:	000ab797          	auipc	a5,0xab
ffffffffc0201062:	3f27bd23          	sd	s2,1018(a5) # ffffffffc02ac458 <free_area+0x8>
    assert(alloc_page() == NULL);
...
ffffffffc020107e:	3e07a323          	sw	zero,998(a5) # ffffffffc02ac460 <free_area+0x10>
    free_pages(p0 + 2, 3);
...
ffffffffc020114e:	3177ab23          	sw	s7,790(a5) # ffffffffc02ac460 <free_area+0x10>
    free_list = free_list_store;
ffffffffc0201152:	000ab797          	auipc	a5,0xab
ffffffffc0201156:	2f67bf23          	sd	s6,766(a5) # ffffffffc02ac450 <free_area>
ffffffffc020115a:	000ab797          	auipc	a5,0xab
ffffffffc020115e:	2f57bf23          	sd	s5,766(a5) # ffffffffc02ac458 <free_area+0x8>
    free_pages(p0, 5);
...
ffffffffc02011a8:	e1468693          	addi	a3,a3,-492 # ffffffffc0206fb8 <commands+0x878>
ffffffffc02011ac:	00006617          	auipc	a2,0x6
ffffffffc02011b0:	a5460613          	addi	a2,a2,-1452 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02011b4:	0f000593          	li	a1,240
ffffffffc02011b8:	00006517          	auipc	a0,0x6
ffffffffc02011bc:	e1050513          	addi	a0,a0,-496 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02011c0:	ac4ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc02011c4:	00006697          	auipc	a3,0x6
ffffffffc02011c8:	e9c68693          	addi	a3,a3,-356 # ffffffffc0207060 <commands+0x920>
ffffffffc02011cc:	00006617          	auipc	a2,0x6
ffffffffc02011d0:	a3460613          	addi	a2,a2,-1484 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02011d4:	0bd00593          	li	a1,189
ffffffffc02011d8:	00006517          	auipc	a0,0x6
ffffffffc02011dc:	df050513          	addi	a0,a0,-528 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02011e0:	aa4ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc02011e4:	00006697          	auipc	a3,0x6
ffffffffc02011e8:	ea468693          	addi	a3,a3,-348 # ffffffffc0207088 <commands+0x948>
ffffffffc02011ec:	00006617          	auipc	a2,0x6
ffffffffc02011f0:	a1460613          	addi	a2,a2,-1516 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02011f4:	0be00593          	li	a1,190
ffffffffc02011f8:	00006517          	auipc	a0,0x6
ffffffffc02011fc:	dd050513          	addi	a0,a0,-560 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201200:	a84ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0201204:	00006697          	auipc	a3,0x6
ffffffffc0201208:	ec468693          	addi	a3,a3,-316 # ffffffffc02070c8 <commands+0x988>
ffffffffc020120c:	00006617          	auipc	a2,0x6
ffffffffc0201210:	9f460613          	addi	a2,a2,-1548 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201214:	0c000593          	li	a1,192
ffffffffc0201218:	00006517          	auipc	a0,0x6
ffffffffc020121c:	db050513          	addi	a0,a0,-592 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201220:	a64ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0201224:	00006697          	auipc	a3,0x6
ffffffffc0201228:	f2c68693          	addi	a3,a3,-212 # ffffffffc0207150 <commands+0xa10>
ffffffffc020122c:	00006617          	auipc	a2,0x6
ffffffffc0201230:	9d460613          	addi	a2,a2,-1580 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201234:	0d900593          	li	a1,217
ffffffffc0201238:	00006517          	auipc	a0,0x6
ffffffffc020123c:	d9050513          	addi	a0,a0,-624 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201240:	a44ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201244:	00006697          	auipc	a3,0x6
ffffffffc0201248:	dbc68693          	addi	a3,a3,-580 # ffffffffc0207000 <commands+0x8c0>
ffffffffc020124c:	00006617          	auipc	a2,0x6
ffffffffc0201250:	9b460613          	addi	a2,a2,-1612 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201254:	0d200593          	li	a1,210
ffffffffc0201258:	00006517          	auipc	a0,0x6
ffffffffc020125c:	d7050513          	addi	a0,a0,-656 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201260:	a24ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(nr_free == 3);
ffffffffc0201264:	00006697          	auipc	a3,0x6
ffffffffc0201268:	edc68693          	addi	a3,a3,-292 # ffffffffc0207140 <commands+0xa00>
ffffffffc020126c:	00006617          	auipc	a2,0x6
ffffffffc0201270:	99460613          	addi	a2,a2,-1644 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201274:	0d000593          	li	a1,208
ffffffffc0201278:	00006517          	auipc	a0,0x6
ffffffffc020127c:	d5050513          	addi	a0,a0,-688 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201280:	a04ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201284:	00006697          	auipc	a3,0x6
ffffffffc0201288:	ea468693          	addi	a3,a3,-348 # ffffffffc0207128 <commands+0x9e8>
ffffffffc020128c:	00006617          	auipc	a2,0x6
ffffffffc0201290:	97460613          	addi	a2,a2,-1676 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201294:	0cb00593          	li	a1,203
ffffffffc0201298:	00006517          	auipc	a0,0x6
ffffffffc020129c:	d3050513          	addi	a0,a0,-720 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02012a0:	9e4ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc02012a4:	00006697          	auipc	a3,0x6
ffffffffc02012a8:	e6468693          	addi	a3,a3,-412 # ffffffffc0207108 <commands+0x9c8>
ffffffffc02012ac:	00006617          	auipc	a2,0x6
ffffffffc02012b0:	95460613          	addi	a2,a2,-1708 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02012b4:	0c200593          	li	a1,194
ffffffffc02012b8:	00006517          	auipc	a0,0x6
ffffffffc02012bc:	d1050513          	addi	a0,a0,-752 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02012c0:	9c4ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(p0 != NULL);
ffffffffc02012c4:	00006697          	auipc	a3,0x6
ffffffffc02012c8:	ed468693          	addi	a3,a3,-300 # ffffffffc0207198 <commands+0xa58>
ffffffffc02012cc:	00006617          	auipc	a2,0x6
ffffffffc02012d0:	93460613          	addi	a2,a2,-1740 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02012d4:	0f800593          	li	a1,248
ffffffffc02012d8:	00006517          	auipc	a0,0x6
ffffffffc02012dc:	cf050513          	addi	a0,a0,-784 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02012e0:	9a4ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(nr_free == 0);
ffffffffc02012e4:	00006697          	auipc	a3,0x6
ffffffffc02012e8:	ea468693          	addi	a3,a3,-348 # ffffffffc0207188 <commands+0xa48>
ffffffffc02012ec:	00006617          	auipc	a2,0x6
ffffffffc02012f0:	91460613          	addi	a2,a2,-1772 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02012f4:	0df00593          	li	a1,223
ffffffffc02012f8:	00006517          	auipc	a0,0x6
ffffffffc02012fc:	cd050513          	addi	a0,a0,-816 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201300:	984ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201304:	00006697          	auipc	a3,0x6
ffffffffc0201308:	e2468693          	addi	a3,a3,-476 # ffffffffc0207128 <commands+0x9e8>
ffffffffc020130c:	00006617          	auipc	a2,0x6
ffffffffc0201310:	8f460613          	addi	a2,a2,-1804 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201314:	0dd00593          	li	a1,221
ffffffffc0201318:	00006517          	auipc	a0,0x6
ffffffffc020131c:	cb050513          	addi	a0,a0,-848 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201320:	964ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0201324:	00006697          	auipc	a3,0x6
ffffffffc0201328:	e4468693          	addi	a3,a3,-444 # ffffffffc0207168 <commands+0xa28>
ffffffffc020132c:	00006617          	auipc	a2,0x6
ffffffffc0201330:	8d460613          	addi	a2,a2,-1836 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201334:	0dc00593          	li	a1,220
ffffffffc0201338:	00006517          	auipc	a0,0x6
ffffffffc020133c:	c9050513          	addi	a0,a0,-880 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201340:	944ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201344:	00006697          	auipc	a3,0x6
ffffffffc0201348:	cbc68693          	addi	a3,a3,-836 # ffffffffc0207000 <commands+0x8c0>
ffffffffc020134c:	00006617          	auipc	a2,0x6
ffffffffc0201350:	8b460613          	addi	a2,a2,-1868 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201354:	0b900593          	li	a1,185
ffffffffc0201358:	00006517          	auipc	a0,0x6
ffffffffc020135c:	c7050513          	addi	a0,a0,-912 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201360:	924ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201364:	00006697          	auipc	a3,0x6
ffffffffc0201368:	dc468693          	addi	a3,a3,-572 # ffffffffc0207128 <commands+0x9e8>
ffffffffc020136c:	00006617          	auipc	a2,0x6
ffffffffc0201370:	89460613          	addi	a2,a2,-1900 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201374:	0d600593          	li	a1,214
ffffffffc0201378:	00006517          	auipc	a0,0x6
ffffffffc020137c:	c5050513          	addi	a0,a0,-944 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201380:	904ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201384:	00006697          	auipc	a3,0x6
ffffffffc0201388:	cbc68693          	addi	a3,a3,-836 # ffffffffc0207040 <commands+0x900>
ffffffffc020138c:	00006617          	auipc	a2,0x6
ffffffffc0201390:	87460613          	addi	a2,a2,-1932 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201394:	0d400593          	li	a1,212
ffffffffc0201398:	00006517          	auipc	a0,0x6
ffffffffc020139c:	c3050513          	addi	a0,a0,-976 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02013a0:	8e4ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02013a4:	00006697          	auipc	a3,0x6
ffffffffc02013a8:	c7c68693          	addi	a3,a3,-900 # ffffffffc0207020 <commands+0x8e0>
ffffffffc02013ac:	00006617          	auipc	a2,0x6
ffffffffc02013b0:	85460613          	addi	a2,a2,-1964 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02013b4:	0d300593          	li	a1,211
ffffffffc02013b8:	00006517          	auipc	a0,0x6
ffffffffc02013bc:	c1050513          	addi	a0,a0,-1008 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02013c0:	8c4ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc02013c4:	00006697          	auipc	a3,0x6
ffffffffc02013c8:	c7c68693          	addi	a3,a3,-900 # ffffffffc0207040 <commands+0x900>
ffffffffc02013cc:	00006617          	auipc	a2,0x6
ffffffffc02013d0:	83460613          	addi	a2,a2,-1996 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02013d4:	0bb00593          	li	a1,187
ffffffffc02013d8:	00006517          	auipc	a0,0x6
ffffffffc02013dc:	bf050513          	addi	a0,a0,-1040 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02013e0:	8a4ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(count == 0);
ffffffffc02013e4:	00006697          	auipc	a3,0x6
ffffffffc02013e8:	f0468693          	addi	a3,a3,-252 # ffffffffc02072e8 <commands+0xba8>
ffffffffc02013ec:	00006617          	auipc	a2,0x6
ffffffffc02013f0:	81460613          	addi	a2,a2,-2028 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02013f4:	12500593          	li	a1,293
ffffffffc02013f8:	00006517          	auipc	a0,0x6
ffffffffc02013fc:	bd050513          	addi	a0,a0,-1072 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201400:	884ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(nr_free == 0);
ffffffffc0201404:	00006697          	auipc	a3,0x6
ffffffffc0201408:	d8468693          	addi	a3,a3,-636 # ffffffffc0207188 <commands+0xa48>
ffffffffc020140c:	00005617          	auipc	a2,0x5
ffffffffc0201410:	7f460613          	addi	a2,a2,2036 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201414:	11a00593          	li	a1,282
ffffffffc0201418:	00006517          	auipc	a0,0x6
ffffffffc020141c:	bb050513          	addi	a0,a0,-1104 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201420:	864ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201424:	00006697          	auipc	a3,0x6
ffffffffc0201428:	d0468693          	addi	a3,a3,-764 # ffffffffc0207128 <commands+0x9e8>
ffffffffc020142c:	00005617          	auipc	a2,0x5
ffffffffc0201430:	7d460613          	addi	a2,a2,2004 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201434:	11800593          	li	a1,280
ffffffffc0201438:	00006517          	auipc	a0,0x6
ffffffffc020143c:	b9050513          	addi	a0,a0,-1136 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201440:	844ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201444:	00006697          	auipc	a3,0x6
ffffffffc0201448:	ca468693          	addi	a3,a3,-860 # ffffffffc02070e8 <commands+0x9a8>
ffffffffc020144c:	00005617          	auipc	a2,0x5
ffffffffc0201450:	7b460613          	addi	a2,a2,1972 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201454:	0c100593          	li	a1,193
ffffffffc0201458:	00006517          	auipc	a0,0x6
ffffffffc020145c:	b7050513          	addi	a0,a0,-1168 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201460:	824ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201464:	00006697          	auipc	a3,0x6
ffffffffc0201468:	e4468693          	addi	a3,a3,-444 # ffffffffc02072a8 <commands+0xb68>
ffffffffc020146c:	00005617          	auipc	a2,0x5
ffffffffc0201470:	79460613          	addi	a2,a2,1940 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201474:	11200593          	li	a1,274
ffffffffc0201478:	00006517          	auipc	a0,0x6
ffffffffc020147c:	b5050513          	addi	a0,a0,-1200 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201480:	804ff0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201484:	00006697          	auipc	a3,0x6
ffffffffc0201488:	e0468693          	addi	a3,a3,-508 # ffffffffc0207288 <commands+0xb48>
ffffffffc020148c:	00005617          	auipc	a2,0x5
ffffffffc0201490:	77460613          	addi	a2,a2,1908 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201494:	11000593          	li	a1,272
ffffffffc0201498:	00006517          	auipc	a0,0x6
ffffffffc020149c:	b3050513          	addi	a0,a0,-1232 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02014a0:	fe5fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc02014a4:	00006697          	auipc	a3,0x6
ffffffffc02014a8:	dbc68693          	addi	a3,a3,-580 # ffffffffc0207260 <commands+0xb20>
ffffffffc02014ac:	00005617          	auipc	a2,0x5
ffffffffc02014b0:	75460613          	addi	a2,a2,1876 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02014b4:	10e00593          	li	a1,270
ffffffffc02014b8:	00006517          	auipc	a0,0x6
ffffffffc02014bc:	b1050513          	addi	a0,a0,-1264 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02014c0:	fc5fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc02014c4:	00006697          	auipc	a3,0x6
ffffffffc02014c8:	d7468693          	addi	a3,a3,-652 # ffffffffc0207238 <commands+0xaf8>
ffffffffc02014cc:	00005617          	auipc	a2,0x5
ffffffffc02014d0:	73460613          	addi	a2,a2,1844 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02014d4:	10d00593          	li	a1,269
ffffffffc02014d8:	00006517          	auipc	a0,0x6
ffffffffc02014dc:	af050513          	addi	a0,a0,-1296 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02014e0:	fa5fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02014e4:	00006697          	auipc	a3,0x6
ffffffffc02014e8:	d4468693          	addi	a3,a3,-700 # ffffffffc0207228 <commands+0xae8>
ffffffffc02014ec:	00005617          	auipc	a2,0x5
ffffffffc02014f0:	71460613          	addi	a2,a2,1812 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02014f4:	10800593          	li	a1,264
ffffffffc02014f8:	00006517          	auipc	a0,0x6
ffffffffc02014fc:	ad050513          	addi	a0,a0,-1328 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201500:	f85fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201504:	00006697          	auipc	a3,0x6
ffffffffc0201508:	c2468693          	addi	a3,a3,-988 # ffffffffc0207128 <commands+0x9e8>
ffffffffc020150c:	00005617          	auipc	a2,0x5
ffffffffc0201510:	6f460613          	addi	a2,a2,1780 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201514:	10700593          	li	a1,263
ffffffffc0201518:	00006517          	auipc	a0,0x6
ffffffffc020151c:	ab050513          	addi	a0,a0,-1360 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201520:	f65fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc0201524:	00006697          	auipc	a3,0x6
ffffffffc0201528:	ce468693          	addi	a3,a3,-796 # ffffffffc0207208 <commands+0xac8>
ffffffffc020152c:	00005617          	auipc	a2,0x5
ffffffffc0201530:	6d460613          	addi	a2,a2,1748 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201534:	10600593          	li	a1,262
ffffffffc0201538:	00006517          	auipc	a0,0x6
ffffffffc020153c:	a9050513          	addi	a0,a0,-1392 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201540:	f45fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201544:	00006697          	auipc	a3,0x6
ffffffffc0201548:	c9468693          	addi	a3,a3,-876 # ffffffffc02071d8 <commands+0xa98>
ffffffffc020154c:	00005617          	auipc	a2,0x5
ffffffffc0201550:	6b460613          	addi	a2,a2,1716 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201554:	10500593          	li	a1,261
ffffffffc0201558:	00006517          	auipc	a0,0x6
ffffffffc020155c:	a7050513          	addi	a0,a0,-1424 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201560:	f25fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201564:	00006697          	auipc	a3,0x6
ffffffffc0201568:	c5c68693          	addi	a3,a3,-932 # ffffffffc02071c0 <commands+0xa80>
ffffffffc020156c:	00005617          	auipc	a2,0x5
ffffffffc0201570:	69460613          	addi	a2,a2,1684 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201574:	10400593          	li	a1,260
ffffffffc0201578:	00006517          	auipc	a0,0x6
ffffffffc020157c:	a5050513          	addi	a0,a0,-1456 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201580:	f05fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201584:	00006697          	auipc	a3,0x6
ffffffffc0201588:	ba468693          	addi	a3,a3,-1116 # ffffffffc0207128 <commands+0x9e8>
ffffffffc020158c:	00005617          	auipc	a2,0x5
ffffffffc0201590:	67460613          	addi	a2,a2,1652 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201594:	0fe00593          	li	a1,254
ffffffffc0201598:	00006517          	auipc	a0,0x6
ffffffffc020159c:	a3050513          	addi	a0,a0,-1488 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02015a0:	ee5fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(!PageProperty(p0));
ffffffffc02015a4:	00006697          	auipc	a3,0x6
ffffffffc02015a8:	c0468693          	addi	a3,a3,-1020 # ffffffffc02071a8 <commands+0xa68>
ffffffffc02015ac:	00005617          	auipc	a2,0x5
ffffffffc02015b0:	65460613          	addi	a2,a2,1620 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02015b4:	0f900593          	li	a1,249
ffffffffc02015b8:	00006517          	auipc	a0,0x6
ffffffffc02015bc:	a1050513          	addi	a0,a0,-1520 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02015c0:	ec5fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc02015c4:	00006697          	auipc	a3,0x6
ffffffffc02015c8:	d0468693          	addi	a3,a3,-764 # ffffffffc02072c8 <commands+0xb88>
ffffffffc02015cc:	00005617          	auipc	a2,0x5
ffffffffc02015d0:	63460613          	addi	a2,a2,1588 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02015d4:	11700593          	li	a1,279
ffffffffc02015d8:	00006517          	auipc	a0,0x6
ffffffffc02015dc:	9f050513          	addi	a0,a0,-1552 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02015e0:	ea5fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(total == 0);
ffffffffc02015e4:	00006697          	auipc	a3,0x6
ffffffffc02015e8:	d1468693          	addi	a3,a3,-748 # ffffffffc02072f8 <commands+0xbb8>
ffffffffc02015ec:	00005617          	auipc	a2,0x5
ffffffffc02015f0:	61460613          	addi	a2,a2,1556 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02015f4:	12600593          	li	a1,294
ffffffffc02015f8:	00006517          	auipc	a0,0x6
ffffffffc02015fc:	9d050513          	addi	a0,a0,-1584 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201600:	e85fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(total == nr_free_pages());
ffffffffc0201604:	00006697          	auipc	a3,0x6
ffffffffc0201608:	9dc68693          	addi	a3,a3,-1572 # ffffffffc0206fe0 <commands+0x8a0>
ffffffffc020160c:	00005617          	auipc	a2,0x5
ffffffffc0201610:	5f460613          	addi	a2,a2,1524 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201614:	0f300593          	li	a1,243
ffffffffc0201618:	00006517          	auipc	a0,0x6
ffffffffc020161c:	9b050513          	addi	a0,a0,-1616 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201620:	e65fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201624:	00006697          	auipc	a3,0x6
ffffffffc0201628:	9fc68693          	addi	a3,a3,-1540 # ffffffffc0207020 <commands+0x8e0>
ffffffffc020162c:	00005617          	auipc	a2,0x5
ffffffffc0201630:	5d460613          	addi	a2,a2,1492 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201634:	0ba00593          	li	a1,186
ffffffffc0201638:	00006517          	auipc	a0,0x6
ffffffffc020163c:	99050513          	addi	a0,a0,-1648 # ffffffffc0206fc8 <commands+0x888>
...
ffffffffc020169e:	db668693          	addi	a3,a3,-586 # ffffffffc02ac450 <free_area>
...
ffffffffc02016ac:	dab72c23          	sw	a1,-584(a4) # ffffffffc02ac460 <free_area+0x10>
...
ffffffffc02016dc:	d6b83c23          	sd	a1,-648(a6) # ffffffffc02ac450 <free_area>
...
ffffffffc02017a8:	b6468693          	addi	a3,a3,-1180 # ffffffffc0207308 <commands+0xbc8>
ffffffffc02017ac:	00005617          	auipc	a2,0x5
ffffffffc02017b0:	45460613          	addi	a2,a2,1108 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02017b4:	08300593          	li	a1,131
ffffffffc02017b8:	00006517          	auipc	a0,0x6
ffffffffc02017bc:	81050513          	addi	a0,a0,-2032 # ffffffffc0206fc8 <commands+0x888>
ffffffffc02017c0:	cc5fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(n > 0);
ffffffffc02017c4:	00006697          	auipc	a3,0x6
ffffffffc02017c8:	b6c68693          	addi	a3,a3,-1172 # ffffffffc0207330 <commands+0xbf0>
ffffffffc02017cc:	00005617          	auipc	a2,0x5
ffffffffc02017d0:	43460613          	addi	a2,a2,1076 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02017d4:	08000593          	li	a1,128
ffffffffc02017d8:	00005517          	auipc	a0,0x5
ffffffffc02017dc:	7f050513          	addi	a0,a0,2032 # ffffffffc0206fc8 <commands+0x888>
...
ffffffffc02017ea:	c6a58593          	addi	a1,a1,-918 # ffffffffc02ac450 <free_area>
...
ffffffffc020186c:	bf072c23          	sw	a6,-1032(a4) # ffffffffc02ac460 <free_area+0x10>
    __op_bit(and, __NOT, nr, ((volatile unsigned long *)addr));
...
ffffffffc0201880:	ab468693          	addi	a3,a3,-1356 # ffffffffc0207330 <commands+0xbf0>
ffffffffc0201884:	00005617          	auipc	a2,0x5
ffffffffc0201888:	37c60613          	addi	a2,a2,892 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc020188c:	06200593          	li	a1,98
ffffffffc0201890:	00005517          	auipc	a0,0x5
ffffffffc0201894:	73850513          	addi	a0,a0,1848 # ffffffffc0206fc8 <commands+0x888>
default_alloc_pages(size_t n) {
...
ffffffffc02018e4:	b7068693          	addi	a3,a3,-1168 # ffffffffc02ac450 <free_area>
...
ffffffffc02018f2:	b6b72923          	sw	a1,-1166(a4) # ffffffffc02ac460 <free_area+0x10>
    if (list_empty(&free_list)) {
...
ffffffffc0201922:	b2b73923          	sd	a1,-1230(a4) # ffffffffc02ac450 <free_area>
    __list_add(elm, listelm->prev, listelm);
...
ffffffffc0201968:	9d468693          	addi	a3,a3,-1580 # ffffffffc0207338 <commands+0xbf8>
ffffffffc020196c:	00005617          	auipc	a2,0x5
ffffffffc0201970:	29460613          	addi	a2,a2,660 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201974:	04900593          	li	a1,73
ffffffffc0201978:	00005517          	auipc	a0,0x5
ffffffffc020197c:	65050513          	addi	a0,a0,1616 # ffffffffc0206fc8 <commands+0x888>
ffffffffc0201980:	b05fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(n > 0);
ffffffffc0201984:	00006697          	auipc	a3,0x6
ffffffffc0201988:	9ac68693          	addi	a3,a3,-1620 # ffffffffc0207330 <commands+0xbf0>
ffffffffc020198c:	00005617          	auipc	a2,0x5
ffffffffc0201990:	27460613          	addi	a2,a2,628 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201994:	04600593          	li	a1,70
ffffffffc0201998:	00005517          	auipc	a0,0x5
ffffffffc020199c:	63050513          	addi	a0,a0,1584 # ffffffffc0206fc8 <commands+0x888>
...
ffffffffc02019b6:	62e78793          	addi	a5,a5,1582 # ffffffffc02a0fe0 <slobfree>
...
ffffffffc02019fa:	5ef73523          	sd	a5,1514(a4) # ffffffffc02a0fe0 <slobfree>
    if (flag) {
...
ffffffffc0201a24:	5c078793          	addi	a5,a5,1472 # ffffffffc02a0fe0 <slobfree>
...
ffffffffc0201a6c:	56f73c23          	sd	a5,1400(a4) # ffffffffc02a0fe0 <slobfree>
    if (flag) {
...
ffffffffc0201ace:	9b678793          	addi	a5,a5,-1610 # ffffffffc02ac480 <pages>
...
ffffffffc0201ae0:	93470713          	addi	a4,a4,-1740 # ffffffffc02ac410 <npage>
    return page - pages + nbase;
...
ffffffffc0201b00:	97478793          	addi	a5,a5,-1676 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc0201b1a:	88260613          	addi	a2,a2,-1918 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0201b1e:	06900593          	li	a1,105
ffffffffc0201b22:	00006517          	auipc	a0,0x6
ffffffffc0201b26:	89e50513          	addi	a0,a0,-1890 # ffffffffc02073c0 <default_pmm_manager+0x78>
...
ffffffffc0201b54:	49048493          	addi	s1,s1,1168 # ffffffffc02a0fe0 <slobfree>
...
ffffffffc0201bb2:	42f73923          	sd	a5,1074(a4) # ffffffffc02a0fe0 <slobfree>
    if (flag) {
...
ffffffffc0201bec:	3ef73c23          	sd	a5,1016(a4) # ffffffffc02a0fe0 <slobfree>
    if (flag) {
...
ffffffffc0201c16:	82668693          	addi	a3,a3,-2010 # ffffffffc0207438 <default_pmm_manager+0xf0>
ffffffffc0201c1a:	00005617          	auipc	a2,0x5
ffffffffc0201c1e:	fe660613          	addi	a2,a2,-26 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0201c22:	06400593          	li	a1,100
ffffffffc0201c26:	00006517          	auipc	a0,0x6
ffffffffc0201c2a:	83250513          	addi	a0,a0,-1998 # ffffffffc0207458 <default_pmm_manager+0x110>
...
ffffffffc0201c38:	83c50513          	addi	a0,a0,-1988 # ffffffffc0207470 <default_pmm_manager+0x128>
kmalloc_init(void) {
...
ffffffffc0201c48:	7d450513          	addi	a0,a0,2004 # ffffffffc0207418 <default_pmm_manager+0xd0>
}
...
ffffffffc0201c60:	e426                	sd	s1,8(sp)
	if (size < PAGE_SIZE - SLOB_UNIT) {
ffffffffc0201c62:	fef90793          	addi	a5,s2,-17 # fef <_binary_obj___user_faultread_out_size-0x8579>
{
...
ffffffffc0201ca2:	76278793          	addi	a5,a5,1890 # ffffffffc02ac400 <bigblocks>
ffffffffc0201ca6:	639c                	ld	a5,0(a5)
		bigblocks = bb;
ffffffffc0201ca8:	000aa717          	auipc	a4,0xaa
ffffffffc0201cac:	74973c23          	sd	s1,1880(a4) # ffffffffc02ac400 <bigblocks>
		bb->next = bigblocks;
...
ffffffffc0201ce4:	72078793          	addi	a5,a5,1824 # ffffffffc02ac400 <bigblocks>
ffffffffc0201ce8:	639c                	ld	a5,0(a5)
		bigblocks = bb;
ffffffffc0201cea:	000aa717          	auipc	a4,0xaa
ffffffffc0201cee:	70973b23          	sd	s1,1814(a4) # ffffffffc02ac400 <bigblocks>
		bb->next = bigblocks;
...
ffffffffc0201d30:	6d478793          	addi	a5,a5,1748 # ffffffffc02ac400 <bigblocks>
...
ffffffffc0201d78:	6fc78793          	addi	a5,a5,1788 # ffffffffc02ac470 <va_pa_offset>
ffffffffc0201d7c:	6394                	ld	a3,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0201d7e:	000aa797          	auipc	a5,0xaa
ffffffffc0201d82:	69278793          	addi	a5,a5,1682 # ffffffffc02ac410 <npage>
...
ffffffffc0201d9e:	6e668693          	addi	a3,a3,1766 # ffffffffc02ac480 <pages>
...
ffffffffc0201dcc:	63878793          	addi	a5,a5,1592 # ffffffffc02ac400 <bigblocks>
...
ffffffffc0201dea:	6087bd23          	sd	s0,1562(a5) # ffffffffc02ac400 <bigblocks>
...
ffffffffc0201dfc:	6087b423          	sd	s0,1544(a5) # ffffffffc02ac400 <bigblocks>
...
ffffffffc0201e0a:	5ca60613          	addi	a2,a2,1482 # ffffffffc02073d0 <default_pmm_manager+0x88>
ffffffffc0201e0e:	06e00593          	li	a1,110
ffffffffc0201e12:	00005517          	auipc	a0,0x5
ffffffffc0201e16:	5ae50513          	addi	a0,a0,1454 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0201e1a:	e6afe0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0201e1e:	00005617          	auipc	a2,0x5
ffffffffc0201e22:	5da60613          	addi	a2,a2,1498 # ffffffffc02073f8 <default_pmm_manager+0xb0>
ffffffffc0201e26:	06200593          	li	a1,98
ffffffffc0201e2a:	00005517          	auipc	a0,0x5
ffffffffc0201e2e:	59650513          	addi	a0,a0,1430 # ffffffffc02073c0 <default_pmm_manager+0x78>
...
ffffffffc0201e3c:	5c060613          	addi	a2,a2,1472 # ffffffffc02073f8 <default_pmm_manager+0xb0>
ffffffffc0201e40:	06200593          	li	a1,98
ffffffffc0201e44:	00005517          	auipc	a0,0x5
ffffffffc0201e48:	57c50513          	addi	a0,a0,1404 # ffffffffc02073c0 <default_pmm_manager+0x78>
pa2page(uintptr_t pa) {
...
ffffffffc0201e68:	60448493          	addi	s1,s1,1540 # ffffffffc02ac468 <pmm_manager>
        {
...
ffffffffc0201e72:	5b2a0a13          	addi	s4,s4,1458 # ffffffffc02ac420 <swap_init_ok>
...
ffffffffc0201e7e:	6e6a8a93          	addi	s5,s5,1766 # ffffffffc02ac560 <check_mm_struct>
...
ffffffffc0201ee6:	58678793          	addi	a5,a5,1414 # ffffffffc02ac468 <pmm_manager>
...
ffffffffc0201f06:	56678793          	addi	a5,a5,1382 # ffffffffc02ac468 <pmm_manager>
...
ffffffffc0201f2c:	54078793          	addi	a5,a5,1344 # ffffffffc02ac468 <pmm_manager>
...
ffffffffc0201f46:	52678793          	addi	a5,a5,1318 # ffffffffc02ac468 <pmm_manager>
...
ffffffffc0201f8c:	48898993          	addi	s3,s3,1160 # ffffffffc02ac410 <npage>
    if (!(*pdep1 & PTE_V)) {
...
ffffffffc0201fa6:	4deb0b13          	addi	s6,s6,1246 # ffffffffc02ac480 <pages>
...
ffffffffc0201fb4:	46098993          	addi	s3,s3,1120 # ffffffffc02ac410 <npage>
    return page - pages + nbase;
...
ffffffffc0201fda:	49a78793          	addi	a5,a5,1178 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc0201fe6:	600040ef          	jal	ra,ffffffffc02065e6 <memset>
    return page - pages + nbase;
...
ffffffffc0202014:	460a8a93          	addi	s5,s5,1120 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc0202046:	43eb0b13          	addi	s6,s6,1086 # ffffffffc02ac480 <pages>
...
ffffffffc0202078:	56e040ef          	jal	ra,ffffffffc02065e6 <memset>
    return page - pages + nbase;
...
ffffffffc02020d2:	2ca60613          	addi	a2,a2,714 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc02020d6:	0e300593          	li	a1,227
ffffffffc02020da:	00005517          	auipc	a0,0x5
ffffffffc02020de:	3de50513          	addi	a0,a0,990 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc02020e2:	ba2fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc02020e6:	00005617          	auipc	a2,0x5
ffffffffc02020ea:	2b260613          	addi	a2,a2,690 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc02020ee:	0ee00593          	li	a1,238
ffffffffc02020f2:	00005517          	auipc	a0,0x5
ffffffffc02020f6:	3c650513          	addi	a0,a0,966 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc0202104:	29860613          	addi	a2,a2,664 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0202108:	0eb00593          	li	a1,235
ffffffffc020210c:	00005517          	auipc	a0,0x5
ffffffffc0202110:	3ac50513          	addi	a0,a0,940 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc020211e:	27e60613          	addi	a2,a2,638 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0202122:	0df00593          	li	a1,223
ffffffffc0202126:	00005517          	auipc	a0,0x5
ffffffffc020212a:	39250513          	addi	a0,a0,914 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc020215c:	2b870713          	addi	a4,a4,696 # ffffffffc02ac410 <npage>
...
ffffffffc020216e:	31670713          	addi	a4,a4,790 # ffffffffc02ac480 <pages>
...
ffffffffc02021d6:	23ec8c93          	addi	s9,s9,574 # ffffffffc02ac410 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc02021da:	000aac17          	auipc	s8,0xaa
ffffffffc02021de:	2a6c0c13          	addi	s8,s8,678 # ffffffffc02ac480 <pages>
...
ffffffffc020226c:	7f868693          	addi	a3,a3,2040 # ffffffffc0207a60 <default_pmm_manager+0x718>
ffffffffc0202270:	00005617          	auipc	a2,0x5
ffffffffc0202274:	99060613          	addi	a2,a2,-1648 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202278:	11000593          	li	a1,272
ffffffffc020227c:	00005517          	auipc	a0,0x5
ffffffffc0202280:	23c50513          	addi	a0,a0,572 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202284:	a00fe0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc0202288:	00005697          	auipc	a3,0x5
ffffffffc020228c:	7a868693          	addi	a3,a3,1960 # ffffffffc0207a30 <default_pmm_manager+0x6e8>
ffffffffc0202290:	00005617          	auipc	a2,0x5
ffffffffc0202294:	97060613          	addi	a2,a2,-1680 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202298:	10f00593          	li	a1,271
ffffffffc020229c:	00005517          	auipc	a0,0x5
ffffffffc02022a0:	21c50513          	addi	a0,a0,540 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc0202322:	0f2d0d13          	addi	s10,s10,242 # ffffffffc02ac410 <npage>
    return KADDR(page2pa(page));
ffffffffc0202326:	00cddd93          	srli	s11,s11,0xc
ffffffffc020232a:	000aa717          	auipc	a4,0xaa
ffffffffc020232e:	14670713          	addi	a4,a4,326 # ffffffffc02ac470 <va_pa_offset>
    return &pages[PPN(pa) - nbase];
ffffffffc0202332:	000aae97          	auipc	t4,0xaa
ffffffffc0202336:	14ee8e93          	addi	t4,t4,334 # ffffffffc02ac480 <pages>
        if (pde1&PTE_V){
...
ffffffffc0202418:	06ce8e93          	addi	t4,t4,108 # ffffffffc02ac480 <pages>
...
ffffffffc020242e:	04670713          	addi	a4,a4,70 # ffffffffc02ac470 <va_pa_offset>
            } while (d0start != 0 && d0start < d1start+PDSIZE && d0start < end);
...
ffffffffc0202458:	01c70713          	addi	a4,a4,28 # ffffffffc02ac470 <va_pa_offset>
ffffffffc020245c:	c0000337          	lui	t1,0xc0000
ffffffffc0202460:	6e02                	ld	t3,0(sp)
ffffffffc0202462:	000aae97          	auipc	t4,0xaa
ffffffffc0202466:	01ee8e93          	addi	t4,t4,30 # ffffffffc02ac480 <pages>
    } while (d1start != 0 && d1start < end);
...
ffffffffc0202496:	59e68693          	addi	a3,a3,1438 # ffffffffc0207a30 <default_pmm_manager+0x6e8>
ffffffffc020249a:	00004617          	auipc	a2,0x4
ffffffffc020249e:	76660613          	addi	a2,a2,1894 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02024a2:	12000593          	li	a1,288
ffffffffc02024a6:	00005517          	auipc	a0,0x5
ffffffffc02024aa:	01250513          	addi	a0,a0,18 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc02024ae:	fd7fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    return KADDR(page2pa(page));
ffffffffc02024b2:	00005617          	auipc	a2,0x5
ffffffffc02024b6:	ee660613          	addi	a2,a2,-282 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc02024ba:	06900593          	li	a1,105
ffffffffc02024be:	00005517          	auipc	a0,0x5
ffffffffc02024c2:	f0250513          	addi	a0,a0,-254 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc02024c6:	fbffd0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02024ca:	00005617          	auipc	a2,0x5
ffffffffc02024ce:	f2e60613          	addi	a2,a2,-210 # ffffffffc02073f8 <default_pmm_manager+0xb0>
ffffffffc02024d2:	06200593          	li	a1,98
ffffffffc02024d6:	00005517          	auipc	a0,0x5
ffffffffc02024da:	eea50513          	addi	a0,a0,-278 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc02024de:	fa7fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc02024e2:	00005697          	auipc	a3,0x5
ffffffffc02024e6:	57e68693          	addi	a3,a3,1406 # ffffffffc0207a60 <default_pmm_manager+0x718>
ffffffffc02024ea:	00004617          	auipc	a2,0x4
ffffffffc02024ee:	71660613          	addi	a2,a2,1814 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02024f2:	12100593          	li	a1,289
ffffffffc02024f6:	00005517          	auipc	a0,0x5
ffffffffc02024fa:	fc250513          	addi	a0,a0,-62 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc020252c:	ee870713          	addi	a4,a4,-280 # ffffffffc02ac410 <npage>
...
ffffffffc020253e:	f4670713          	addi	a4,a4,-186 # ffffffffc02ac480 <pages>
...
ffffffffc02025aa:	eda78793          	addi	a5,a5,-294 # ffffffffc02ac480 <pages>
...
ffffffffc02025e0:	e3470713          	addi	a4,a4,-460 # ffffffffc02ac410 <npage>
...
ffffffffc02025f2:	e92a0a13          	addi	s4,s4,-366 # ffffffffc02ac480 <pages>
...
ffffffffc0202638:	d1478793          	addi	a5,a5,-748 # ffffffffc0207348 <default_pmm_manager>
...
ffffffffc0202644:	ea050513          	addi	a0,a0,-352 # ffffffffc02074e0 <default_pmm_manager+0x198>
void pmm_init(void) {
ffffffffc0202648:	e486                	sd	ra,72(sp)
    pmm_manager = &default_pmm_manager;
ffffffffc020264a:	000aa717          	auipc	a4,0xaa
ffffffffc020264e:	e0f73f23          	sd	a5,-482(a4) # ffffffffc02ac468 <pmm_manager>
void pmm_init(void) {
...
ffffffffc0202668:	e0440413          	addi	s0,s0,-508 # ffffffffc02ac468 <pmm_manager>
    cprintf("memory management: %s\n", pmm_manager->name);
...
ffffffffc0202676:	d9e48493          	addi	s1,s1,-610 # ffffffffc02ac410 <npage>
ffffffffc020267a:	000aa917          	auipc	s2,0xaa
ffffffffc020267e:	e0690913          	addi	s2,s2,-506 # ffffffffc02ac480 <pages>
...
ffffffffc020268e:	e6e50513          	addi	a0,a0,-402 # ffffffffc02074f8 <default_pmm_manager+0x1b0>
    va_pa_offset = KERNBASE - 0x80200000;
ffffffffc0202692:	000aa717          	auipc	a4,0xaa
ffffffffc0202696:	dcf73f23          	sd	a5,-546(a4) # ffffffffc02ac470 <va_pa_offset>
    cprintf("physcial memory map:\n");
...
ffffffffc02026b2:	e6250513          	addi	a0,a0,-414 # ffffffffc0207510 <default_pmm_manager+0x1c8>
...
ffffffffc02026c0:	ebb78793          	addi	a5,a5,-325 # ffffffffc02ad577 <end+0xfff>
ffffffffc02026c4:	8ff9                	and	a5,a5,a4
    npage = maxpa / PGSIZE;
ffffffffc02026c6:	00088737          	lui	a4,0x88
ffffffffc02026ca:	000aa697          	auipc	a3,0xaa
ffffffffc02026ce:	d4e6b323          	sd	a4,-698(a3) # ffffffffc02ac410 <npage>
    pages = (struct Page *)ROUNDUP((void *)end, PGSIZE);
ffffffffc02026d2:	000aa717          	auipc	a4,0xaa
ffffffffc02026d6:	daf73723          	sd	a5,-594(a4) # ffffffffc02ac480 <pages>
...
ffffffffc020271c:	d5898993          	addi	s3,s3,-680 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc020275c:	de050513          	addi	a0,a0,-544 # ffffffffc0207538 <default_pmm_manager+0x1f0>
...
ffffffffc020276a:	ca240413          	addi	s0,s0,-862 # ffffffffc02ac408 <boot_pgdir>
    pmm_manager->check();
ffffffffc020276e:	7b9c                	ld	a5,48(a5)
ffffffffc0202770:	9782                	jalr	a5
    cprintf("check_alloc_page() succeeded!\n");
ffffffffc0202772:	00005517          	auipc	a0,0x5
ffffffffc0202776:	dde50513          	addi	a0,a0,-546 # ffffffffc0207550 <default_pmm_manager+0x208>
...
ffffffffc020278a:	c8d7b123          	sd	a3,-894(a5) # ffffffffc02ac408 <boot_pgdir>
...
ffffffffc02027a0:	ccd7be23          	sd	a3,-804(a5) # ffffffffc02ac478 <boot_cr3>
...
ffffffffc0202820:	000aab83          	lw	s7,0(s5) # 1000 <_binary_obj___user_faultread_out_size-0x8568>
...
ffffffffc0202842:	0007bb03          	ld	s6,0(a5) # 1000 <_binary_obj___user_faultread_out_size-0x8568>
...
ffffffffc02028a4:	000b2783          	lw	a5,0(s6) # 200000 <_binary_obj___user_exit_out_size+0x1f5588>
...
ffffffffc02029cc:	e9850513          	addi	a0,a0,-360 # ffffffffc0207860 <default_pmm_manager+0x518>
...
ffffffffc0202a5c:	100b0613          	addi	a2,s6,256 # 1100 <_binary_obj___user_faultread_out_size-0x8468>
...
ffffffffc0202a78:	f2458593          	addi	a1,a1,-220 # ffffffffc0207998 <default_pmm_manager+0x650>
ffffffffc0202a7c:	10000513          	li	a0,256
ffffffffc0202a80:	30d030ef          	jal	ra,ffffffffc020658c <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a84:	100b0593          	addi	a1,s6,256
ffffffffc0202a88:	10000513          	li	a0,256
ffffffffc0202a8c:	313030ef          	jal	ra,ffffffffc020659e <strcmp>
...
ffffffffc0202ac0:	10068023          	sb	zero,256(a3) # fffffffffffff100 <end+0x3fd52b88>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202ac4:	285030ef          	jal	ra,ffffffffc0206548 <strlen>
...
ffffffffc0202ad0:	609c                	ld	a5,0(s1)
    return pa2page(PDE_ADDR(pde));
ffffffffc0202ad2:	000bb683          	ld	a3,0(s7) # fffffffffffff000 <end+0x3fd52a88>
...
ffffffffc0202b4c:	ec850513          	addi	a0,a0,-312 # ffffffffc0207a10 <default_pmm_manager+0x6c8>
...
ffffffffc0202b76:	d0e68693          	addi	a3,a3,-754 # ffffffffc0207880 <default_pmm_manager+0x538>
ffffffffc0202b7a:	00004617          	auipc	a2,0x4
ffffffffc0202b7e:	08660613          	addi	a2,a2,134 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202b82:	22800593          	li	a1,552
ffffffffc0202b86:	00005517          	auipc	a0,0x5
ffffffffc0202b8a:	93250513          	addi	a0,a0,-1742 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc0202b98:	80460613          	addi	a2,a2,-2044 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0202b9c:	22800593          	li	a1,552
ffffffffc0202ba0:	00005517          	auipc	a0,0x5
ffffffffc0202ba4:	91850513          	addi	a0,a0,-1768 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202ba8:	8ddfd0ef          	jal	ra,ffffffffc0200484 <__panic>
        assert(PTE_ADDR(*ptep) == i);
ffffffffc0202bac:	00005697          	auipc	a3,0x5
ffffffffc0202bb0:	d1468693          	addi	a3,a3,-748 # ffffffffc02078c0 <default_pmm_manager+0x578>
ffffffffc0202bb4:	00004617          	auipc	a2,0x4
ffffffffc0202bb8:	04c60613          	addi	a2,a2,76 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202bbc:	22900593          	li	a1,553
ffffffffc0202bc0:	00005517          	auipc	a0,0x5
ffffffffc0202bc4:	8f850513          	addi	a0,a0,-1800 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc0202bd4:	7c860613          	addi	a2,a2,1992 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0202bd8:	06900593          	li	a1,105
ffffffffc0202bdc:	00004517          	auipc	a0,0x4
ffffffffc0202be0:	7e450513          	addi	a0,a0,2020 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0202be4:	8a1fd0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202be8:	00005617          	auipc	a2,0x5
ffffffffc0202bec:	a6860613          	addi	a2,a2,-1432 # ffffffffc0207650 <default_pmm_manager+0x308>
ffffffffc0202bf0:	07400593          	li	a1,116
ffffffffc0202bf4:	00004517          	auipc	a0,0x4
ffffffffc0202bf8:	7cc50513          	addi	a0,a0,1996 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0202bfc:	889fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc0202c00:	00005697          	auipc	a3,0x5
ffffffffc0202c04:	99068693          	addi	a3,a3,-1648 # ffffffffc0207590 <default_pmm_manager+0x248>
ffffffffc0202c08:	00004617          	auipc	a2,0x4
ffffffffc0202c0c:	ff860613          	addi	a2,a2,-8 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202c10:	1ec00593          	li	a1,492
ffffffffc0202c14:	00005517          	auipc	a0,0x5
ffffffffc0202c18:	8a450513          	addi	a0,a0,-1884 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202c1c:	869fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202c20:	00005697          	auipc	a3,0x5
ffffffffc0202c24:	a5868693          	addi	a3,a3,-1448 # ffffffffc0207678 <default_pmm_manager+0x330>
ffffffffc0202c28:	00004617          	auipc	a2,0x4
ffffffffc0202c2c:	fd860613          	addi	a2,a2,-40 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202c30:	20800593          	li	a1,520
ffffffffc0202c34:	00005517          	auipc	a0,0x5
ffffffffc0202c38:	88450513          	addi	a0,a0,-1916 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202c3c:	849fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202c40:	00005697          	auipc	a3,0x5
ffffffffc0202c44:	cb068693          	addi	a3,a3,-848 # ffffffffc02078f0 <default_pmm_manager+0x5a8>
ffffffffc0202c48:	00004617          	auipc	a2,0x4
ffffffffc0202c4c:	fb860613          	addi	a2,a2,-72 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202c50:	23100593          	li	a1,561
ffffffffc0202c54:	00005517          	auipc	a0,0x5
ffffffffc0202c58:	86450513          	addi	a0,a0,-1948 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202c5c:	829fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202c60:	00005697          	auipc	a3,0x5
ffffffffc0202c64:	aa868693          	addi	a3,a3,-1368 # ffffffffc0207708 <default_pmm_manager+0x3c0>
ffffffffc0202c68:	00004617          	auipc	a2,0x4
ffffffffc0202c6c:	f9860613          	addi	a2,a2,-104 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202c70:	20700593          	li	a1,519
ffffffffc0202c74:	00005517          	auipc	a0,0x5
ffffffffc0202c78:	84450513          	addi	a0,a0,-1980 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202c7c:	809fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202c80:	00005697          	auipc	a3,0x5
ffffffffc0202c84:	b5068693          	addi	a3,a3,-1200 # ffffffffc02077d0 <default_pmm_manager+0x488>
ffffffffc0202c88:	00004617          	auipc	a2,0x4
ffffffffc0202c8c:	f7860613          	addi	a2,a2,-136 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202c90:	20600593          	li	a1,518
ffffffffc0202c94:	00005517          	auipc	a0,0x5
ffffffffc0202c98:	82450513          	addi	a0,a0,-2012 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202c9c:	fe8fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202ca0:	00005697          	auipc	a3,0x5
ffffffffc0202ca4:	b1868693          	addi	a3,a3,-1256 # ffffffffc02077b8 <default_pmm_manager+0x470>
ffffffffc0202ca8:	00004617          	auipc	a2,0x4
ffffffffc0202cac:	f5860613          	addi	a2,a2,-168 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202cb0:	20500593          	li	a1,517
ffffffffc0202cb4:	00005517          	auipc	a0,0x5
ffffffffc0202cb8:	80450513          	addi	a0,a0,-2044 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202cbc:	fc8fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202cc0:	00005697          	auipc	a3,0x5
ffffffffc0202cc4:	ac868693          	addi	a3,a3,-1336 # ffffffffc0207788 <default_pmm_manager+0x440>
ffffffffc0202cc8:	00004617          	auipc	a2,0x4
ffffffffc0202ccc:	f3860613          	addi	a2,a2,-200 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202cd0:	20400593          	li	a1,516
ffffffffc0202cd4:	00004517          	auipc	a0,0x4
ffffffffc0202cd8:	7e450513          	addi	a0,a0,2020 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202cdc:	fa8fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202ce0:	00005697          	auipc	a3,0x5
ffffffffc0202ce4:	a9068693          	addi	a3,a3,-1392 # ffffffffc0207770 <default_pmm_manager+0x428>
ffffffffc0202ce8:	00004617          	auipc	a2,0x4
ffffffffc0202cec:	f1860613          	addi	a2,a2,-232 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202cf0:	20200593          	li	a1,514
ffffffffc0202cf4:	00004517          	auipc	a0,0x4
ffffffffc0202cf8:	7c450513          	addi	a0,a0,1988 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202cfc:	f88fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc0202d00:	00005697          	auipc	a3,0x5
ffffffffc0202d04:	a5868693          	addi	a3,a3,-1448 # ffffffffc0207758 <default_pmm_manager+0x410>
ffffffffc0202d08:	00004617          	auipc	a2,0x4
ffffffffc0202d0c:	ef860613          	addi	a2,a2,-264 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202d10:	20100593          	li	a1,513
ffffffffc0202d14:	00004517          	auipc	a0,0x4
ffffffffc0202d18:	7a450513          	addi	a0,a0,1956 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202d1c:	f68fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(*ptep & PTE_W);
ffffffffc0202d20:	00005697          	auipc	a3,0x5
ffffffffc0202d24:	a2868693          	addi	a3,a3,-1496 # ffffffffc0207748 <default_pmm_manager+0x400>
ffffffffc0202d28:	00004617          	auipc	a2,0x4
ffffffffc0202d2c:	ed860613          	addi	a2,a2,-296 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202d30:	20000593          	li	a1,512
ffffffffc0202d34:	00004517          	auipc	a0,0x4
ffffffffc0202d38:	78450513          	addi	a0,a0,1924 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202d3c:	f48fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(*ptep & PTE_U);
ffffffffc0202d40:	00005697          	auipc	a3,0x5
ffffffffc0202d44:	9f868693          	addi	a3,a3,-1544 # ffffffffc0207738 <default_pmm_manager+0x3f0>
ffffffffc0202d48:	00004617          	auipc	a2,0x4
ffffffffc0202d4c:	eb860613          	addi	a2,a2,-328 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202d50:	1ff00593          	li	a1,511
ffffffffc0202d54:	00004517          	auipc	a0,0x4
ffffffffc0202d58:	76450513          	addi	a0,a0,1892 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202d5c:	f28fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202d60:	00005697          	auipc	a3,0x5
ffffffffc0202d64:	9a868693          	addi	a3,a3,-1624 # ffffffffc0207708 <default_pmm_manager+0x3c0>
ffffffffc0202d68:	00004617          	auipc	a2,0x4
ffffffffc0202d6c:	e9860613          	addi	a2,a2,-360 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202d70:	1fe00593          	li	a1,510
ffffffffc0202d74:	00004517          	auipc	a0,0x4
ffffffffc0202d78:	74450513          	addi	a0,a0,1860 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202d7c:	f08fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202d80:	00005697          	auipc	a3,0x5
ffffffffc0202d84:	95068693          	addi	a3,a3,-1712 # ffffffffc02076d0 <default_pmm_manager+0x388>
ffffffffc0202d88:	00004617          	auipc	a2,0x4
ffffffffc0202d8c:	e7860613          	addi	a2,a2,-392 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202d90:	1fd00593          	li	a1,509
ffffffffc0202d94:	00004517          	auipc	a0,0x4
ffffffffc0202d98:	72450513          	addi	a0,a0,1828 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202d9c:	ee8fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc0202da0:	00005697          	auipc	a3,0x5
ffffffffc0202da4:	90868693          	addi	a3,a3,-1784 # ffffffffc02076a8 <default_pmm_manager+0x360>
ffffffffc0202da8:	00004617          	auipc	a2,0x4
ffffffffc0202dac:	e5860613          	addi	a2,a2,-424 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202db0:	1fa00593          	li	a1,506
ffffffffc0202db4:	00004517          	auipc	a0,0x4
ffffffffc0202db8:	70450513          	addi	a0,a0,1796 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc0202dc6:	5d660613          	addi	a2,a2,1494 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0202dca:	1f900593          	li	a1,505
ffffffffc0202dce:	00004517          	auipc	a0,0x4
ffffffffc0202dd2:	6ea50513          	addi	a0,a0,1770 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc0202de0:	5bc60613          	addi	a2,a2,1468 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0202de4:	06900593          	li	a1,105
ffffffffc0202de8:	00004517          	auipc	a0,0x4
ffffffffc0202dec:	5d850513          	addi	a0,a0,1496 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0202df0:	e94fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc0202df4:	00005697          	auipc	a3,0x5
ffffffffc0202df8:	a2468693          	addi	a3,a3,-1500 # ffffffffc0207818 <default_pmm_manager+0x4d0>
ffffffffc0202dfc:	00004617          	auipc	a2,0x4
ffffffffc0202e00:	e0460613          	addi	a2,a2,-508 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202e04:	21300593          	li	a1,531
ffffffffc0202e08:	00004517          	auipc	a0,0x4
ffffffffc0202e0c:	6b050513          	addi	a0,a0,1712 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202e10:	e74fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202e14:	00005697          	auipc	a3,0x5
ffffffffc0202e18:	9bc68693          	addi	a3,a3,-1604 # ffffffffc02077d0 <default_pmm_manager+0x488>
ffffffffc0202e1c:	00004617          	auipc	a2,0x4
ffffffffc0202e20:	de460613          	addi	a2,a2,-540 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202e24:	21100593          	li	a1,529
ffffffffc0202e28:	00004517          	auipc	a0,0x4
ffffffffc0202e2c:	69050513          	addi	a0,a0,1680 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202e30:	e54fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc0202e34:	00005697          	auipc	a3,0x5
ffffffffc0202e38:	9cc68693          	addi	a3,a3,-1588 # ffffffffc0207800 <default_pmm_manager+0x4b8>
ffffffffc0202e3c:	00004617          	auipc	a2,0x4
ffffffffc0202e40:	dc460613          	addi	a2,a2,-572 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202e44:	21000593          	li	a1,528
ffffffffc0202e48:	00004517          	auipc	a0,0x4
ffffffffc0202e4c:	67050513          	addi	a0,a0,1648 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202e50:	e34fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202e54:	00005697          	auipc	a3,0x5
ffffffffc0202e58:	b2c68693          	addi	a3,a3,-1236 # ffffffffc0207980 <default_pmm_manager+0x638>
ffffffffc0202e5c:	00004617          	auipc	a2,0x4
ffffffffc0202e60:	da460613          	addi	a2,a2,-604 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202e64:	23400593          	li	a1,564
ffffffffc0202e68:	00004517          	auipc	a0,0x4
ffffffffc0202e6c:	65050513          	addi	a0,a0,1616 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202e70:	e14fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202e74:	00005697          	auipc	a3,0x5
ffffffffc0202e78:	acc68693          	addi	a3,a3,-1332 # ffffffffc0207940 <default_pmm_manager+0x5f8>
ffffffffc0202e7c:	00004617          	auipc	a2,0x4
ffffffffc0202e80:	d8460613          	addi	a2,a2,-636 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202e84:	23300593          	li	a1,563
ffffffffc0202e88:	00004517          	auipc	a0,0x4
ffffffffc0202e8c:	63050513          	addi	a0,a0,1584 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202e90:	df4fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202e94:	00005697          	auipc	a3,0x5
ffffffffc0202e98:	a9468693          	addi	a3,a3,-1388 # ffffffffc0207928 <default_pmm_manager+0x5e0>
ffffffffc0202e9c:	00004617          	auipc	a2,0x4
ffffffffc0202ea0:	d6460613          	addi	a2,a2,-668 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202ea4:	23200593          	li	a1,562
ffffffffc0202ea8:	00004517          	auipc	a0,0x4
ffffffffc0202eac:	61050513          	addi	a0,a0,1552 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc0202eba:	4e260613          	addi	a2,a2,1250 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0202ebe:	1f800593          	li	a1,504
ffffffffc0202ec2:	00004517          	auipc	a0,0x4
ffffffffc0202ec6:	5f650513          	addi	a0,a0,1526 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202eca:	dbafd0ef          	jal	ra,ffffffffc0200484 <__panic>
    uintptr_t freemem = PADDR((uintptr_t)pages + sizeof(struct Page) * (npage - nbase));
ffffffffc0202ece:	00004617          	auipc	a2,0x4
ffffffffc0202ed2:	50260613          	addi	a2,a2,1282 # ffffffffc02073d0 <default_pmm_manager+0x88>
ffffffffc0202ed6:	07f00593          	li	a1,127
ffffffffc0202eda:	00004517          	auipc	a0,0x4
ffffffffc0202ede:	5de50513          	addi	a0,a0,1502 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202ee2:	da2fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202ee6:	00005697          	auipc	a3,0x5
ffffffffc0202eea:	aca68693          	addi	a3,a3,-1334 # ffffffffc02079b0 <default_pmm_manager+0x668>
ffffffffc0202eee:	00004617          	auipc	a2,0x4
ffffffffc0202ef2:	d1260613          	addi	a2,a2,-750 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202ef6:	23800593          	li	a1,568
ffffffffc0202efa:	00004517          	auipc	a0,0x4
ffffffffc0202efe:	5be50513          	addi	a0,a0,1470 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202f02:	d82fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202f06:	00005697          	auipc	a3,0x5
ffffffffc0202f0a:	93a68693          	addi	a3,a3,-1734 # ffffffffc0207840 <default_pmm_manager+0x4f8>
ffffffffc0202f0e:	00004617          	auipc	a2,0x4
ffffffffc0202f12:	cf260613          	addi	a2,a2,-782 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202f16:	24400593          	li	a1,580
ffffffffc0202f1a:	00004517          	auipc	a0,0x4
ffffffffc0202f1e:	59e50513          	addi	a0,a0,1438 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202f22:	d62fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202f26:	00004697          	auipc	a3,0x4
ffffffffc0202f2a:	76a68693          	addi	a3,a3,1898 # ffffffffc0207690 <default_pmm_manager+0x348>
ffffffffc0202f2e:	00004617          	auipc	a2,0x4
ffffffffc0202f32:	cd260613          	addi	a2,a2,-814 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202f36:	1f600593          	li	a1,502
ffffffffc0202f3a:	00004517          	auipc	a0,0x4
ffffffffc0202f3e:	57e50513          	addi	a0,a0,1406 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202f42:	d42fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202f46:	00004697          	auipc	a3,0x4
ffffffffc0202f4a:	73268693          	addi	a3,a3,1842 # ffffffffc0207678 <default_pmm_manager+0x330>
ffffffffc0202f4e:	00004617          	auipc	a2,0x4
ffffffffc0202f52:	cb260613          	addi	a2,a2,-846 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202f56:	1f500593          	li	a1,501
ffffffffc0202f5a:	00004517          	auipc	a0,0x4
ffffffffc0202f5e:	55e50513          	addi	a0,a0,1374 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202f62:	d22fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202f66:	00004697          	auipc	a3,0x4
ffffffffc0202f6a:	66268693          	addi	a3,a3,1634 # ffffffffc02075c8 <default_pmm_manager+0x280>
ffffffffc0202f6e:	00004617          	auipc	a2,0x4
ffffffffc0202f72:	c9260613          	addi	a2,a2,-878 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202f76:	1ed00593          	li	a1,493
ffffffffc0202f7a:	00004517          	auipc	a0,0x4
ffffffffc0202f7e:	53e50513          	addi	a0,a0,1342 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202f82:	d02fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((ptep = get_pte(boot_pgdir, 0x0, 0)) != NULL);
ffffffffc0202f86:	00004697          	auipc	a3,0x4
ffffffffc0202f8a:	69a68693          	addi	a3,a3,1690 # ffffffffc0207620 <default_pmm_manager+0x2d8>
ffffffffc0202f8e:	00004617          	auipc	a2,0x4
ffffffffc0202f92:	c7260613          	addi	a2,a2,-910 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202f96:	1f400593          	li	a1,500
ffffffffc0202f9a:	00004517          	auipc	a0,0x4
ffffffffc0202f9e:	51e50513          	addi	a0,a0,1310 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202fa2:	ce2fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202fa6:	00004697          	auipc	a3,0x4
ffffffffc0202faa:	64a68693          	addi	a3,a3,1610 # ffffffffc02075f0 <default_pmm_manager+0x2a8>
ffffffffc0202fae:	00004617          	auipc	a2,0x4
ffffffffc0202fb2:	c5260613          	addi	a2,a2,-942 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202fb6:	1f100593          	li	a1,497
ffffffffc0202fba:	00004517          	auipc	a0,0x4
ffffffffc0202fbe:	4fe50513          	addi	a0,a0,1278 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202fc2:	cc2fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202fc6:	00005697          	auipc	a3,0x5
ffffffffc0202fca:	80a68693          	addi	a3,a3,-2038 # ffffffffc02077d0 <default_pmm_manager+0x488>
ffffffffc0202fce:	00004617          	auipc	a2,0x4
ffffffffc0202fd2:	c3260613          	addi	a2,a2,-974 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202fd6:	20d00593          	li	a1,525
ffffffffc0202fda:	00004517          	auipc	a0,0x4
ffffffffc0202fde:	4de50513          	addi	a0,a0,1246 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0202fe2:	ca2fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202fe6:	00004697          	auipc	a3,0x4
ffffffffc0202fea:	6aa68693          	addi	a3,a3,1706 # ffffffffc0207690 <default_pmm_manager+0x348>
ffffffffc0202fee:	00004617          	auipc	a2,0x4
ffffffffc0202ff2:	c1260613          	addi	a2,a2,-1006 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0202ff6:	20c00593          	li	a1,524
ffffffffc0202ffa:	00004517          	auipc	a0,0x4
ffffffffc0202ffe:	4be50513          	addi	a0,a0,1214 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0203002:	c82fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0203006:	00004697          	auipc	a3,0x4
ffffffffc020300a:	7e268693          	addi	a3,a3,2018 # ffffffffc02077e8 <default_pmm_manager+0x4a0>
ffffffffc020300e:	00004617          	auipc	a2,0x4
ffffffffc0203012:	bf260613          	addi	a2,a2,-1038 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203016:	20900593          	li	a1,521
ffffffffc020301a:	00004517          	auipc	a0,0x4
ffffffffc020301e:	49e50513          	addi	a0,a0,1182 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0203022:	c62fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0203026:	00005697          	auipc	a3,0x5
ffffffffc020302a:	9c268693          	addi	a3,a3,-1598 # ffffffffc02079e8 <default_pmm_manager+0x6a0>
ffffffffc020302e:	00004617          	auipc	a2,0x4
ffffffffc0203032:	bd260613          	addi	a2,a2,-1070 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203036:	23b00593          	li	a1,571
ffffffffc020303a:	00004517          	auipc	a0,0x4
ffffffffc020303e:	47e50513          	addi	a0,a0,1150 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0203042:	c42fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0203046:	00004697          	auipc	a3,0x4
ffffffffc020304a:	7fa68693          	addi	a3,a3,2042 # ffffffffc0207840 <default_pmm_manager+0x4f8>
ffffffffc020304e:	00004617          	auipc	a2,0x4
ffffffffc0203052:	bb260613          	addi	a2,a2,-1102 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203056:	21b00593          	li	a1,539
ffffffffc020305a:	00004517          	auipc	a0,0x4
ffffffffc020305e:	45e50513          	addi	a0,a0,1118 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0203062:	c22fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0203066:	00005697          	auipc	a3,0x5
ffffffffc020306a:	87268693          	addi	a3,a3,-1934 # ffffffffc02078d8 <default_pmm_manager+0x590>
ffffffffc020306e:	00004617          	auipc	a2,0x4
ffffffffc0203072:	b9260613          	addi	a2,a2,-1134 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203076:	22d00593          	li	a1,557
ffffffffc020307a:	00004517          	auipc	a0,0x4
ffffffffc020307e:	43e50513          	addi	a0,a0,1086 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc0203082:	c02fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc0203086:	00004697          	auipc	a3,0x4
ffffffffc020308a:	4ea68693          	addi	a3,a3,1258 # ffffffffc0207570 <default_pmm_manager+0x228>
ffffffffc020308e:	00004617          	auipc	a2,0x4
ffffffffc0203092:	b7260613          	addi	a2,a2,-1166 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203096:	1eb00593          	li	a1,491
ffffffffc020309a:	00004517          	auipc	a0,0x4
ffffffffc020309e:	41e50513          	addi	a0,a0,1054 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc02030a2:	be2fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02030a6:	00004617          	auipc	a2,0x4
ffffffffc02030aa:	32a60613          	addi	a2,a2,810 # ffffffffc02073d0 <default_pmm_manager+0x88>
ffffffffc02030ae:	0c100593          	li	a1,193
ffffffffc02030b2:	00004517          	auipc	a0,0x4
ffffffffc02030b6:	40650513          	addi	a0,a0,1030 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc020310a:	30ac0c13          	addi	s8,s8,778 # ffffffffc02ac410 <npage>
    return &pages[PPN(pa) - nbase];
ffffffffc020310e:	000a9b97          	auipc	s7,0xa9
ffffffffc0203112:	372b8b93          	addi	s7,s7,882 # ffffffffc02ac480 <pages>
    return page - pages + nbase;
...
ffffffffc02031c2:	2b270713          	addi	a4,a4,690 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc02031de:	41a030ef          	jal	ra,ffffffffc02065f8 <memcpy>
...
ffffffffc02031f4:	2b868693          	addi	a3,a3,696 # ffffffffc02074a8 <default_pmm_manager+0x160>
ffffffffc02031f8:	00004617          	auipc	a2,0x4
ffffffffc02031fc:	a0860613          	addi	a2,a2,-1528 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203200:	18d00593          	li	a1,397
ffffffffc0203204:	00004517          	auipc	a0,0x4
ffffffffc0203208:	2b450513          	addi	a0,a0,692 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc020322e:	16e60613          	addi	a2,a2,366 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0203232:	06900593          	li	a1,105
ffffffffc0203236:	00004517          	auipc	a0,0x4
ffffffffc020323a:	18a50513          	addi	a0,a0,394 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc020323e:	a46fd0ef          	jal	ra,ffffffffc0200484 <__panic>
            assert(page != NULL);
ffffffffc0203242:	00004697          	auipc	a3,0x4
ffffffffc0203246:	24668693          	addi	a3,a3,582 # ffffffffc0207488 <default_pmm_manager+0x140>
ffffffffc020324a:	00004617          	auipc	a2,0x4
ffffffffc020324e:	9b660613          	addi	a2,a2,-1610 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203252:	17200593          	li	a1,370
ffffffffc0203256:	00004517          	auipc	a0,0x4
ffffffffc020325a:	26250513          	addi	a0,a0,610 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc020325e:	a26fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(USER_ACCESS(start, end));
ffffffffc0203262:	00004697          	auipc	a3,0x4
ffffffffc0203266:	7fe68693          	addi	a3,a3,2046 # ffffffffc0207a60 <default_pmm_manager+0x718>
ffffffffc020326a:	00004617          	auipc	a2,0x4
ffffffffc020326e:	99660613          	addi	a2,a2,-1642 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203272:	15e00593          	li	a1,350
ffffffffc0203276:	00004517          	auipc	a0,0x4
ffffffffc020327a:	24250513          	addi	a0,a0,578 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc020327e:	a06fd0ef          	jal	ra,ffffffffc0200484 <__panic>
            assert(npage != NULL);
ffffffffc0203282:	00004697          	auipc	a3,0x4
ffffffffc0203286:	21668693          	addi	a3,a3,534 # ffffffffc0207498 <default_pmm_manager+0x150>
ffffffffc020328a:	00004617          	auipc	a2,0x4
ffffffffc020328e:	97660613          	addi	a2,a2,-1674 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203292:	17300593          	li	a1,371
ffffffffc0203296:	00004517          	auipc	a0,0x4
ffffffffc020329a:	22250513          	addi	a0,a0,546 # ffffffffc02074b8 <default_pmm_manager+0x170>
ffffffffc020329e:	9e6fd0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02032a2:	00004617          	auipc	a2,0x4
ffffffffc02032a6:	15660613          	addi	a2,a2,342 # ffffffffc02073f8 <default_pmm_manager+0xb0>
ffffffffc02032aa:	06200593          	li	a1,98
ffffffffc02032ae:	00004517          	auipc	a0,0x4
ffffffffc02032b2:	11250513          	addi	a0,a0,274 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc02032b6:	9cefd0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc02032ba:	00004617          	auipc	a2,0x4
ffffffffc02032be:	39660613          	addi	a2,a2,918 # ffffffffc0207650 <default_pmm_manager+0x308>
ffffffffc02032c2:	07400593          	li	a1,116
ffffffffc02032c6:	00004517          	auipc	a0,0x4
ffffffffc02032ca:	0fa50513          	addi	a0,a0,250 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc02032ce:	9b6fd0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(start % PGSIZE == 0 && end % PGSIZE == 0);
ffffffffc02032d2:	00004697          	auipc	a3,0x4
ffffffffc02032d6:	75e68693          	addi	a3,a3,1886 # ffffffffc0207a30 <default_pmm_manager+0x6e8>
ffffffffc02032da:	00004617          	auipc	a2,0x4
ffffffffc02032de:	92660613          	addi	a2,a2,-1754 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02032e2:	15d00593          	li	a1,349
ffffffffc02032e6:	00004517          	auipc	a0,0x4
ffffffffc02032ea:	1d250513          	addi	a0,a0,466 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc0203326:	0fe78793          	addi	a5,a5,254 # ffffffffc02ac420 <swap_init_ok>
...
ffffffffc0203334:	23078793          	addi	a5,a5,560 # ffffffffc02ac560 <check_mm_struct>
...
ffffffffc0203370:	15c68693          	addi	a3,a3,348 # ffffffffc02074c8 <default_pmm_manager+0x180>
ffffffffc0203374:	00004617          	auipc	a2,0x4
ffffffffc0203378:	88c60613          	addi	a2,a2,-1908 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc020337c:	1cc00593          	li	a1,460
ffffffffc0203380:	00004517          	auipc	a0,0x4
ffffffffc0203384:	13850513          	addi	a0,a0,312 # ffffffffc02074b8 <default_pmm_manager+0x170>
...
ffffffffc02033b0:	16478793          	addi	a5,a5,356 # ffffffffc02ac510 <max_swap_offset>
...
ffffffffc02033c8:	bdc78793          	addi	a5,a5,-1060 # ffffffffc02a0fa0 <swap_manager_fifo>
     int r = sm->init();
ffffffffc02033cc:	6798                	ld	a4,8(a5)
     sm = &swap_manager_fifo;
ffffffffc02033ce:	000a9697          	auipc	a3,0xa9
ffffffffc02033d2:	04f6b523          	sd	a5,74(a3) # ffffffffc02ac418 <sm>
     int r = sm->init();
...
ffffffffc0203400:	01c78793          	addi	a5,a5,28 # ffffffffc02ac418 <sm>
ffffffffc0203404:	639c                	ld	a5,0(a5)
ffffffffc0203406:	00004517          	auipc	a0,0x4
ffffffffc020340a:	6f250513          	addi	a0,a0,1778 # ffffffffc0207af8 <default_pmm_manager+0x7b0>
    return listelm->next;
ffffffffc020340e:	000a9417          	auipc	s0,0xa9
ffffffffc0203412:	04240413          	addi	s0,s0,66 # ffffffffc02ac450 <free_area>
ffffffffc0203416:	638c                	ld	a1,0(a5)
          swap_init_ok = 1;
ffffffffc0203418:	4785                	li	a5,1
ffffffffc020341a:	000a9717          	auipc	a4,0xa9
ffffffffc020341e:	00f72323          	sw	a5,6(a4) # ffffffffc02ac420 <swap_init_ok>
          cprintf("SWAP: manager = %s\n", sm->name);
...
ffffffffc0203468:	6ac50513          	addi	a0,a0,1708 # ffffffffc0207b10 <default_pmm_manager+0x7c8>
...
ffffffffc020347e:	0e678793          	addi	a5,a5,230 # ffffffffc02ac560 <check_mm_struct>
...
ffffffffc020348c:	f8078793          	addi	a5,a5,-128 # ffffffffc02ac408 <boot_pgdir>
ffffffffc0203490:	0007bb03          	ld	s6,0(a5)
     check_mm_struct = mm;
ffffffffc0203494:	000a9797          	auipc	a5,0xa9
ffffffffc0203498:	0ca7b623          	sd	a0,204(a5) # ffffffffc02ac560 <check_mm_struct>
     assert(pgdir[0] == 0);
ffffffffc020349c:	000b3783          	ld	a5,0(s6) # 80000 <_binary_obj___user_exit_out_size+0x75588>
     pde_t *pgdir = mm->pgdir = boot_pgdir;
...
ffffffffc02034c2:	6c250513          	addi	a0,a0,1730 # ffffffffc0207b80 <default_pmm_manager+0x838>
...
ffffffffc02034de:	6f650513          	addi	a0,a0,1782 # ffffffffc0207bd0 <default_pmm_manager+0x888>
ffffffffc02034e2:	000a9997          	auipc	s3,0xa9
ffffffffc02034e6:	fa698993          	addi	s3,s3,-90 # ffffffffc02ac488 <check_rp>
ffffffffc02034ea:	ca5fc0ef          	jal	ra,ffffffffc020018e <cprintf>
     
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
ffffffffc02034ee:	000a9a17          	auipc	s4,0xa9
ffffffffc02034f2:	fbaa0a13          	addi	s4,s4,-70 # ffffffffc02ac4a8 <swap_in_seq_no>
     cprintf("setup Page Table vaddr 0~4MB OVER!\n");
...
ffffffffc020351a:	f72c0c13          	addi	s8,s8,-142 # ffffffffc02ac488 <check_rp>
     list_entry_t free_list_store = free_list;
...
ffffffffc020352c:	f287b823          	sd	s0,-208(a5) # ffffffffc02ac458 <free_area+0x8>
ffffffffc0203530:	000a9797          	auipc	a5,0xa9
ffffffffc0203534:	f287b023          	sd	s0,-224(a5) # ffffffffc02ac450 <free_area>
     nr_free = 0;
ffffffffc0203538:	000a9797          	auipc	a5,0xa9
ffffffffc020353c:	f207a423          	sw	zero,-216(a5) # ffffffffc02ac460 <free_area+0x10>
     for (i=0;i<CHECK_VALID_PHY_PAGE_NUM;i++) {
...
ffffffffc020355e:	6fe50513          	addi	a0,a0,1790 # ffffffffc0207c58 <default_pmm_manager+0x910>
...
ffffffffc020356c:	ea07ae23          	sw	zero,-324(a5) # ffffffffc02ac424 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
ffffffffc0203570:	4629                	li	a2,10
     pgfault_num=0;
ffffffffc0203572:	000a9797          	auipc	a5,0xa9
ffffffffc0203576:	eb278793          	addi	a5,a5,-334 # ffffffffc02ac424 <pgfault_num>
     *(unsigned char *)0x1000 = 0x0a;
ffffffffc020357a:	00c68023          	sb	a2,0(a3) # 1000 <_binary_obj___user_faultread_out_size-0x8568>
...
ffffffffc0203598:	00c68023          	sb	a2,0(a3) # 2000 <_binary_obj___user_faultread_out_size-0x7568>
...
ffffffffc02035b6:	00c68023          	sb	a2,0(a3) # 3000 <_binary_obj___user_faultread_out_size-0x6568>
...
ffffffffc02035d4:	00c68023          	sb	a2,0(a3) # 4000 <_binary_obj___user_faultread_out_size-0x5568>
...
ffffffffc02035f6:	eb678793          	addi	a5,a5,-330 # ffffffffc02ac4a8 <swap_in_seq_no>
ffffffffc02035fa:	000a9717          	auipc	a4,0xa9
ffffffffc02035fe:	ed670713          	addi	a4,a4,-298 # ffffffffc02ac4d0 <swap_out_seq_no>
ffffffffc0203602:	000a9617          	auipc	a2,0xa9
ffffffffc0203606:	ece60613          	addi	a2,a2,-306 # ffffffffc02ac4d0 <swap_out_seq_no>
...
ffffffffc020361c:	f1868693          	addi	a3,a3,-232 # ffffffffc02ac530 <check_ptep>
ffffffffc0203620:	000a9817          	auipc	a6,0xa9
ffffffffc0203624:	e6880813          	addi	a6,a6,-408 # ffffffffc02ac488 <check_rp>
ffffffffc0203628:	6d05                	lui	s10,0x1
    if (PPN(pa) >= npage) {
ffffffffc020362a:	000a9c97          	auipc	s9,0xa9
ffffffffc020362e:	de6c8c93          	addi	s9,s9,-538 # ffffffffc02ac410 <npage>
    return &pages[PPN(pa) - nbase];
...
ffffffffc020363e:	e46c0c13          	addi	s8,s8,-442 # ffffffffc02ac480 <pages>
...
ffffffffc020369e:	66650513          	addi	a0,a0,1638 # ffffffffc0207d00 <default_pmm_manager+0x9b8>
ffffffffc02036a2:	aedfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    int ret = sm->check_swap();
ffffffffc02036a6:	000a9797          	auipc	a5,0xa9
ffffffffc02036aa:	d7278793          	addi	a5,a5,-654 # ffffffffc02ac418 <sm>
...
ffffffffc02036be:	daf72323          	sw	a5,-602(a4) # ffffffffc02ac460 <free_area+0x10>
     free_list = free_list_store;
ffffffffc02036c2:	67e2                	ld	a5,24(sp)
ffffffffc02036c4:	000a9717          	auipc	a4,0xa9
ffffffffc02036c8:	d8f73623          	sd	a5,-628(a4) # ffffffffc02ac450 <free_area>
ffffffffc02036cc:	7782                	ld	a5,32(sp)
ffffffffc02036ce:	000a9717          	auipc	a4,0xa9
ffffffffc02036d2:	d8f73523          	sd	a5,-630(a4) # ffffffffc02ac458 <free_area+0x8>
...
ffffffffc02036f4:	d1878793          	addi	a5,a5,-744 # ffffffffc02ac408 <boot_pgdir>
ffffffffc02036f8:	639c                	ld	a5,0(a5)
     check_mm_struct = NULL;
ffffffffc02036fa:	000a9697          	auipc	a3,0xa9
ffffffffc02036fe:	e606b323          	sd	zero,-410(a3) # ffffffffc02ac560 <check_mm_struct>
    if (PPN(pa) >= npage) {
...
ffffffffc020372e:	d4678793          	addi	a5,a5,-698 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc020379a:	5ba50513          	addi	a0,a0,1466 # ffffffffc0207d50 <default_pmm_manager+0xa08>
...
ffffffffc02037b0:	80c68693          	addi	a3,a3,-2036 # ffffffffc0206fb8 <commands+0x878>
ffffffffc02037b4:	00003617          	auipc	a2,0x3
ffffffffc02037b8:	44c60613          	addi	a2,a2,1100 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02037bc:	0bc00593          	li	a1,188
ffffffffc02037c0:	00004517          	auipc	a0,0x4
ffffffffc02037c4:	32850513          	addi	a0,a0,808 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc02037c8:	cbdfc0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc02037cc:	00004617          	auipc	a2,0x4
ffffffffc02037d0:	c2c60613          	addi	a2,a2,-980 # ffffffffc02073f8 <default_pmm_manager+0xb0>
ffffffffc02037d4:	06200593          	li	a1,98
ffffffffc02037d8:	00004517          	auipc	a0,0x4
ffffffffc02037dc:	be850513          	addi	a0,a0,-1048 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc02037e0:	ca5fc0ef          	jal	ra,ffffffffc0200484 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc02037e4:	00004697          	auipc	a3,0x4
ffffffffc02037e8:	4f468693          	addi	a3,a3,1268 # ffffffffc0207cd8 <default_pmm_manager+0x990>
ffffffffc02037ec:	00003617          	auipc	a2,0x3
ffffffffc02037f0:	41460613          	addi	a2,a2,1044 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02037f4:	0fc00593          	li	a1,252
ffffffffc02037f8:	00004517          	auipc	a0,0x4
ffffffffc02037fc:	2f050513          	addi	a0,a0,752 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203800:	c85fc0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0203804:	00004617          	auipc	a2,0x4
ffffffffc0203808:	e4c60613          	addi	a2,a2,-436 # ffffffffc0207650 <default_pmm_manager+0x308>
ffffffffc020380c:	07400593          	li	a1,116
ffffffffc0203810:	00004517          	auipc	a0,0x4
ffffffffc0203814:	bb050513          	addi	a0,a0,-1104 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0203818:	c6dfc0ef          	jal	ra,ffffffffc0200484 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc020381c:	00004697          	auipc	a3,0x4
ffffffffc0203820:	3f468693          	addi	a3,a3,1012 # ffffffffc0207c10 <default_pmm_manager+0x8c8>
ffffffffc0203824:	00003617          	auipc	a2,0x3
ffffffffc0203828:	3dc60613          	addi	a2,a2,988 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc020382c:	0dd00593          	li	a1,221
ffffffffc0203830:	00004517          	auipc	a0,0x4
ffffffffc0203834:	2b850513          	addi	a0,a0,696 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203838:	c4dfc0ef          	jal	ra,ffffffffc0200484 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc020383c:	00004697          	auipc	a3,0x4
ffffffffc0203840:	3bc68693          	addi	a3,a3,956 # ffffffffc0207bf8 <default_pmm_manager+0x8b0>
ffffffffc0203844:	00003617          	auipc	a2,0x3
ffffffffc0203848:	3bc60613          	addi	a2,a2,956 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc020384c:	0dc00593          	li	a1,220
ffffffffc0203850:	00004517          	auipc	a0,0x4
ffffffffc0203854:	29850513          	addi	a0,a0,664 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203858:	c2dfc0ef          	jal	ra,ffffffffc0200484 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc020385c:	00004697          	auipc	a3,0x4
ffffffffc0203860:	46468693          	addi	a3,a3,1124 # ffffffffc0207cc0 <default_pmm_manager+0x978>
ffffffffc0203864:	00003617          	auipc	a2,0x3
ffffffffc0203868:	39c60613          	addi	a2,a2,924 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc020386c:	0fb00593          	li	a1,251
ffffffffc0203870:	00004517          	auipc	a0,0x4
ffffffffc0203874:	27850513          	addi	a0,a0,632 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203878:	c0dfc0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc020387c:	00004617          	auipc	a2,0x4
ffffffffc0203880:	24c60613          	addi	a2,a2,588 # ffffffffc0207ac8 <default_pmm_manager+0x780>
ffffffffc0203884:	02800593          	li	a1,40
ffffffffc0203888:	00004517          	auipc	a0,0x4
ffffffffc020388c:	26050513          	addi	a0,a0,608 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203890:	bf5fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgfault_num==2);
ffffffffc0203894:	00004697          	auipc	a3,0x4
ffffffffc0203898:	3fc68693          	addi	a3,a3,1020 # ffffffffc0207c90 <default_pmm_manager+0x948>
ffffffffc020389c:	00003617          	auipc	a2,0x3
ffffffffc02038a0:	36460613          	addi	a2,a2,868 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02038a4:	09700593          	li	a1,151
ffffffffc02038a8:	00004517          	auipc	a0,0x4
ffffffffc02038ac:	24050513          	addi	a0,a0,576 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc02038b0:	bd5fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgfault_num==2);
ffffffffc02038b4:	00004697          	auipc	a3,0x4
ffffffffc02038b8:	3dc68693          	addi	a3,a3,988 # ffffffffc0207c90 <default_pmm_manager+0x948>
ffffffffc02038bc:	00003617          	auipc	a2,0x3
ffffffffc02038c0:	34460613          	addi	a2,a2,836 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02038c4:	09900593          	li	a1,153
ffffffffc02038c8:	00004517          	auipc	a0,0x4
ffffffffc02038cc:	22050513          	addi	a0,a0,544 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc02038d0:	bb5fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgfault_num==3);
ffffffffc02038d4:	00004697          	auipc	a3,0x4
ffffffffc02038d8:	3cc68693          	addi	a3,a3,972 # ffffffffc0207ca0 <default_pmm_manager+0x958>
ffffffffc02038dc:	00003617          	auipc	a2,0x3
ffffffffc02038e0:	32460613          	addi	a2,a2,804 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02038e4:	09b00593          	li	a1,155
ffffffffc02038e8:	00004517          	auipc	a0,0x4
ffffffffc02038ec:	20050513          	addi	a0,a0,512 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc02038f0:	b95fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgfault_num==3);
ffffffffc02038f4:	00004697          	auipc	a3,0x4
ffffffffc02038f8:	3ac68693          	addi	a3,a3,940 # ffffffffc0207ca0 <default_pmm_manager+0x958>
ffffffffc02038fc:	00003617          	auipc	a2,0x3
ffffffffc0203900:	30460613          	addi	a2,a2,772 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203904:	09d00593          	li	a1,157
ffffffffc0203908:	00004517          	auipc	a0,0x4
ffffffffc020390c:	1e050513          	addi	a0,a0,480 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203910:	b75fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgfault_num==1);
ffffffffc0203914:	00004697          	auipc	a3,0x4
ffffffffc0203918:	36c68693          	addi	a3,a3,876 # ffffffffc0207c80 <default_pmm_manager+0x938>
ffffffffc020391c:	00003617          	auipc	a2,0x3
ffffffffc0203920:	2e460613          	addi	a2,a2,740 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203924:	09300593          	li	a1,147
ffffffffc0203928:	00004517          	auipc	a0,0x4
ffffffffc020392c:	1c050513          	addi	a0,a0,448 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203930:	b55fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgfault_num==1);
ffffffffc0203934:	00004697          	auipc	a3,0x4
ffffffffc0203938:	34c68693          	addi	a3,a3,844 # ffffffffc0207c80 <default_pmm_manager+0x938>
ffffffffc020393c:	00003617          	auipc	a2,0x3
ffffffffc0203940:	2c460613          	addi	a2,a2,708 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203944:	09500593          	li	a1,149
ffffffffc0203948:	00004517          	auipc	a0,0x4
ffffffffc020394c:	1a050513          	addi	a0,a0,416 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203950:	b35fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgfault_num==4);
ffffffffc0203954:	00004697          	auipc	a3,0x4
ffffffffc0203958:	35c68693          	addi	a3,a3,860 # ffffffffc0207cb0 <default_pmm_manager+0x968>
ffffffffc020395c:	00003617          	auipc	a2,0x3
ffffffffc0203960:	2a460613          	addi	a2,a2,676 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203964:	09f00593          	li	a1,159
ffffffffc0203968:	00004517          	auipc	a0,0x4
ffffffffc020396c:	18050513          	addi	a0,a0,384 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203970:	b15fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgfault_num==4);
ffffffffc0203974:	00004697          	auipc	a3,0x4
ffffffffc0203978:	33c68693          	addi	a3,a3,828 # ffffffffc0207cb0 <default_pmm_manager+0x968>
ffffffffc020397c:	00003617          	auipc	a2,0x3
ffffffffc0203980:	28460613          	addi	a2,a2,644 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203984:	0a100593          	li	a1,161
ffffffffc0203988:	00004517          	auipc	a0,0x4
ffffffffc020398c:	16050513          	addi	a0,a0,352 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203990:	af5fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203994:	00004697          	auipc	a3,0x4
ffffffffc0203998:	1cc68693          	addi	a3,a3,460 # ffffffffc0207b60 <default_pmm_manager+0x818>
ffffffffc020399c:	00003617          	auipc	a2,0x3
ffffffffc02039a0:	26460613          	addi	a2,a2,612 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02039a4:	0cc00593          	li	a1,204
ffffffffc02039a8:	00004517          	auipc	a0,0x4
ffffffffc02039ac:	14050513          	addi	a0,a0,320 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc02039b0:	ad5fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(vma != NULL);
ffffffffc02039b4:	00004697          	auipc	a3,0x4
ffffffffc02039b8:	1bc68693          	addi	a3,a3,444 # ffffffffc0207b70 <default_pmm_manager+0x828>
ffffffffc02039bc:	00003617          	auipc	a2,0x3
ffffffffc02039c0:	24460613          	addi	a2,a2,580 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02039c4:	0cf00593          	li	a1,207
ffffffffc02039c8:	00004517          	auipc	a0,0x4
ffffffffc02039cc:	12050513          	addi	a0,a0,288 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc02039d0:	ab5fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc02039d4:	00004697          	auipc	a3,0x4
ffffffffc02039d8:	1e468693          	addi	a3,a3,484 # ffffffffc0207bb8 <default_pmm_manager+0x870>
ffffffffc02039dc:	00003617          	auipc	a2,0x3
ffffffffc02039e0:	22460613          	addi	a2,a2,548 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02039e4:	0d700593          	li	a1,215
ffffffffc02039e8:	00004517          	auipc	a0,0x4
ffffffffc02039ec:	10050513          	addi	a0,a0,256 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc02039f0:	a95fc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert( nr_free == 0);         
ffffffffc02039f4:	00003697          	auipc	a3,0x3
ffffffffc02039f8:	79468693          	addi	a3,a3,1940 # ffffffffc0207188 <commands+0xa48>
ffffffffc02039fc:	00003617          	auipc	a2,0x3
ffffffffc0203a00:	20460613          	addi	a2,a2,516 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203a04:	0f300593          	li	a1,243
ffffffffc0203a08:	00004517          	auipc	a0,0x4
ffffffffc0203a0c:	0e050513          	addi	a0,a0,224 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203a10:	a75fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203a14:	00004617          	auipc	a2,0x4
ffffffffc0203a18:	98460613          	addi	a2,a2,-1660 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0203a1c:	06900593          	li	a1,105
ffffffffc0203a20:	00004517          	auipc	a0,0x4
ffffffffc0203a24:	9a050513          	addi	a0,a0,-1632 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0203a28:	a5dfc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(count==0);
ffffffffc0203a2c:	00004697          	auipc	a3,0x4
ffffffffc0203a30:	30468693          	addi	a3,a3,772 # ffffffffc0207d30 <default_pmm_manager+0x9e8>
ffffffffc0203a34:	00003617          	auipc	a2,0x3
ffffffffc0203a38:	1cc60613          	addi	a2,a2,460 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203a3c:	11d00593          	li	a1,285
ffffffffc0203a40:	00004517          	auipc	a0,0x4
ffffffffc0203a44:	0a850513          	addi	a0,a0,168 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203a48:	a3dfc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(total==0);
ffffffffc0203a4c:	00004697          	auipc	a3,0x4
ffffffffc0203a50:	2f468693          	addi	a3,a3,756 # ffffffffc0207d40 <default_pmm_manager+0x9f8>
ffffffffc0203a54:	00003617          	auipc	a2,0x3
ffffffffc0203a58:	1ac60613          	addi	a2,a2,428 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203a5c:	11e00593          	li	a1,286
ffffffffc0203a60:	00004517          	auipc	a0,0x4
ffffffffc0203a64:	08850513          	addi	a0,a0,136 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203a68:	a1dfc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc0203a6c:	00004697          	auipc	a3,0x4
ffffffffc0203a70:	1c468693          	addi	a3,a3,452 # ffffffffc0207c30 <default_pmm_manager+0x8e8>
ffffffffc0203a74:	00003617          	auipc	a2,0x3
ffffffffc0203a78:	18c60613          	addi	a2,a2,396 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203a7c:	0ea00593          	li	a1,234
ffffffffc0203a80:	00004517          	auipc	a0,0x4
ffffffffc0203a84:	06850513          	addi	a0,a0,104 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203a88:	9fdfc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(mm != NULL);
ffffffffc0203a8c:	00004697          	auipc	a3,0x4
ffffffffc0203a90:	0ac68693          	addi	a3,a3,172 # ffffffffc0207b38 <default_pmm_manager+0x7f0>
ffffffffc0203a94:	00003617          	auipc	a2,0x3
ffffffffc0203a98:	16c60613          	addi	a2,a2,364 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203a9c:	0c400593          	li	a1,196
ffffffffc0203aa0:	00004517          	auipc	a0,0x4
ffffffffc0203aa4:	04850513          	addi	a0,a0,72 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203aa8:	9ddfc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203aac:	00004697          	auipc	a3,0x4
ffffffffc0203ab0:	09c68693          	addi	a3,a3,156 # ffffffffc0207b48 <default_pmm_manager+0x800>
ffffffffc0203ab4:	00003617          	auipc	a2,0x3
ffffffffc0203ab8:	14c60613          	addi	a2,a2,332 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203abc:	0c700593          	li	a1,199
ffffffffc0203ac0:	00004517          	auipc	a0,0x4
ffffffffc0203ac4:	02850513          	addi	a0,a0,40 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203ac8:	9bdfc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(ret==0);
ffffffffc0203acc:	00004697          	auipc	a3,0x4
ffffffffc0203ad0:	25c68693          	addi	a3,a3,604 # ffffffffc0207d28 <default_pmm_manager+0x9e0>
ffffffffc0203ad4:	00003617          	auipc	a2,0x3
ffffffffc0203ad8:	12c60613          	addi	a2,a2,300 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203adc:	10200593          	li	a1,258
ffffffffc0203ae0:	00004517          	auipc	a0,0x4
ffffffffc0203ae4:	00850513          	addi	a0,a0,8 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
ffffffffc0203ae8:	99dfc0ef          	jal	ra,ffffffffc0200484 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203aec:	00003697          	auipc	a3,0x3
ffffffffc0203af0:	4f468693          	addi	a3,a3,1268 # ffffffffc0206fe0 <commands+0x8a0>
ffffffffc0203af4:	00003617          	auipc	a2,0x3
ffffffffc0203af8:	10c60613          	addi	a2,a2,268 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203afc:	0bf00593          	li	a1,191
ffffffffc0203b00:	00004517          	auipc	a0,0x4
ffffffffc0203b04:	fe850513          	addi	a0,a0,-24 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
...
ffffffffc0203b10:	90c78793          	addi	a5,a5,-1780 # ffffffffc02ac418 <sm>
...
ffffffffc0203b20:	8fc78793          	addi	a5,a5,-1796 # ffffffffc02ac418 <sm>
...
ffffffffc0203b50:	8cc98993          	addi	s3,s3,-1844 # ffffffffc02ac418 <sm>
                    cprintf("swap_out: i %d, store page in vaddr 0x%x to disk swap entry %d\n", i, v, page->pra_vaddr/PGSIZE+1);
ffffffffc0203b54:	00004b17          	auipc	s6,0x4
ffffffffc0203b58:	27cb0b13          	addi	s6,s6,636 # ffffffffc0207dd0 <default_pmm_manager+0xa88>
                    cprintf("SWAP: failed to save\n");
ffffffffc0203b5c:	00004b97          	auipc	s7,0x4
ffffffffc0203b60:	25cb8b93          	addi	s7,s7,604 # ffffffffc0207db8 <default_pmm_manager+0xa70>
...
ffffffffc0203c12:	16250513          	addi	a0,a0,354 # ffffffffc0207d70 <default_pmm_manager+0xa28>
...
ffffffffc0203c24:	18068693          	addi	a3,a3,384 # ffffffffc0207da0 <default_pmm_manager+0xa58>
ffffffffc0203c28:	00003617          	auipc	a2,0x3
ffffffffc0203c2c:	fd860613          	addi	a2,a2,-40 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203c30:	06800593          	li	a1,104
ffffffffc0203c34:	00004517          	auipc	a0,0x4
ffffffffc0203c38:	eb450513          	addi	a0,a0,-332 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
...
ffffffffc0203c7c:	e1050513          	addi	a0,a0,-496 # ffffffffc0207a88 <default_pmm_manager+0x740>
...
ffffffffc0203c9e:	dde68693          	addi	a3,a3,-546 # ffffffffc0207a78 <default_pmm_manager+0x730>
ffffffffc0203ca2:	00003617          	auipc	a2,0x3
ffffffffc0203ca6:	f5e60613          	addi	a2,a2,-162 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203caa:	07e00593          	li	a1,126
ffffffffc0203cae:	00004517          	auipc	a0,0x4
ffffffffc0203cb2:	e3a50513          	addi	a0,a0,-454 # ffffffffc0207ae8 <default_pmm_manager+0x7a0>
...
ffffffffc0203cbe:	89678793          	addi	a5,a5,-1898 # ffffffffc02ac550 <pra_list_head>
 */
static int
...
ffffffffc0203ce2:	13250513          	addi	a0,a0,306 # ffffffffc0207e10 <default_pmm_manager+0xac8>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc0203d00:	72840413          	addi	s0,s0,1832 # ffffffffc02ac424 <pgfault_num>
    cprintf("write Virt Page c in fifo_check_swap\n");
ffffffffc0203d04:	c8afc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x3000 = 0x0c;
ffffffffc0203d08:	01498023          	sb	s4,0(s3) # 3000 <_binary_obj___user_faultread_out_size-0x6568>
    assert(pgfault_num==4);
...
ffffffffc0203d1a:	13a50513          	addi	a0,a0,314 # ffffffffc0207e50 <default_pmm_manager+0xb08>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc0203d22:	c6cfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x1000 = 0x0a;
ffffffffc0203d26:	016a8023          	sb	s6,0(s5) # 1000 <_binary_obj___user_faultread_out_size-0x8568>
    assert(pgfault_num==4);
...
ffffffffc0203d38:	14450513          	addi	a0,a0,324 # ffffffffc0207e78 <default_pmm_manager+0xb30>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc0203d40:	c4efc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x4000 = 0x0d;
ffffffffc0203d44:	018b8023          	sb	s8,0(s7) # 4000 <_binary_obj___user_faultread_out_size-0x5568>
    assert(pgfault_num==4);
...
ffffffffc0203d54:	15050513          	addi	a0,a0,336 # ffffffffc0207ea0 <default_pmm_manager+0xb58>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203d5c:	c32fc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x2000 = 0x0b;
ffffffffc0203d60:	01990023          	sb	s9,0(s2) # 2000 <_binary_obj___user_faultread_out_size-0x7568>
    assert(pgfault_num==4);
...
ffffffffc0203d70:	15c50513          	addi	a0,a0,348 # ffffffffc0207ec8 <default_pmm_manager+0xb80>
...
ffffffffc0203d7c:	00e78023          	sb	a4,0(a5) # 5000 <_binary_obj___user_faultread_out_size-0x4568>
...
ffffffffc0203d8e:	11650513          	addi	a0,a0,278 # ffffffffc0207ea0 <default_pmm_manager+0xb58>
...
ffffffffc0203da6:	0ae50513          	addi	a0,a0,174 # ffffffffc0207e50 <default_pmm_manager+0xb08>
...
ffffffffc0203dc0:	0e450513          	addi	a0,a0,228 # ffffffffc0207ea0 <default_pmm_manager+0xb58>
...
ffffffffc0203dda:	03a50513          	addi	a0,a0,58 # ffffffffc0207e10 <default_pmm_manager+0xac8>
...
ffffffffc0203df4:	08850513          	addi	a0,a0,136 # ffffffffc0207e78 <default_pmm_manager+0xb30>
...
ffffffffc0203e0e:	0be50513          	addi	a0,a0,190 # ffffffffc0207ec8 <default_pmm_manager+0xb80>
ffffffffc0203e12:	b7cfc0ef          	jal	ra,ffffffffc020018e <cprintf>
    *(unsigned char *)0x5000 = 0x0e;
ffffffffc0203e16:	6795                	lui	a5,0x5
ffffffffc0203e18:	4739                	li	a4,14
ffffffffc0203e1a:	00e78023          	sb	a4,0(a5) # 5000 <_binary_obj___user_faultread_out_size-0x4568>
...
ffffffffc0203e2c:	02850513          	addi	a0,a0,40 # ffffffffc0207e50 <default_pmm_manager+0xb08>
ffffffffc0203e30:	b5efc0ef          	jal	ra,ffffffffc020018e <cprintf>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203e34:	6785                	lui	a5,0x1
ffffffffc0203e36:	0007c783          	lbu	a5,0(a5) # 1000 <_binary_obj___user_faultread_out_size-0x8568>
...
ffffffffc0203e68:	e4c68693          	addi	a3,a3,-436 # ffffffffc0207cb0 <default_pmm_manager+0x968>
ffffffffc0203e6c:	00003617          	auipc	a2,0x3
ffffffffc0203e70:	d9460613          	addi	a2,a2,-620 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203e74:	05100593          	li	a1,81
ffffffffc0203e78:	00004517          	auipc	a0,0x4
ffffffffc0203e7c:	fc050513          	addi	a0,a0,-64 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203e80:	e04fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==11);
ffffffffc0203e84:	00004697          	auipc	a3,0x4
ffffffffc0203e88:	0f468693          	addi	a3,a3,244 # ffffffffc0207f78 <default_pmm_manager+0xc30>
ffffffffc0203e8c:	00003617          	auipc	a2,0x3
ffffffffc0203e90:	d7460613          	addi	a2,a2,-652 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203e94:	07300593          	li	a1,115
ffffffffc0203e98:	00004517          	auipc	a0,0x4
ffffffffc0203e9c:	fa050513          	addi	a0,a0,-96 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203ea0:	de4fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203ea4:	00004697          	auipc	a3,0x4
ffffffffc0203ea8:	0ac68693          	addi	a3,a3,172 # ffffffffc0207f50 <default_pmm_manager+0xc08>
ffffffffc0203eac:	00003617          	auipc	a2,0x3
ffffffffc0203eb0:	d5460613          	addi	a2,a2,-684 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203eb4:	07100593          	li	a1,113
ffffffffc0203eb8:	00004517          	auipc	a0,0x4
ffffffffc0203ebc:	f8050513          	addi	a0,a0,-128 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203ec0:	dc4fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==10);
ffffffffc0203ec4:	00004697          	auipc	a3,0x4
ffffffffc0203ec8:	07c68693          	addi	a3,a3,124 # ffffffffc0207f40 <default_pmm_manager+0xbf8>
ffffffffc0203ecc:	00003617          	auipc	a2,0x3
ffffffffc0203ed0:	d3460613          	addi	a2,a2,-716 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203ed4:	06f00593          	li	a1,111
ffffffffc0203ed8:	00004517          	auipc	a0,0x4
ffffffffc0203edc:	f6050513          	addi	a0,a0,-160 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203ee0:	da4fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==9);
ffffffffc0203ee4:	00004697          	auipc	a3,0x4
ffffffffc0203ee8:	04c68693          	addi	a3,a3,76 # ffffffffc0207f30 <default_pmm_manager+0xbe8>
ffffffffc0203eec:	00003617          	auipc	a2,0x3
ffffffffc0203ef0:	d1460613          	addi	a2,a2,-748 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203ef4:	06c00593          	li	a1,108
ffffffffc0203ef8:	00004517          	auipc	a0,0x4
ffffffffc0203efc:	f4050513          	addi	a0,a0,-192 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203f00:	d84fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==8);
ffffffffc0203f04:	00004697          	auipc	a3,0x4
ffffffffc0203f08:	01c68693          	addi	a3,a3,28 # ffffffffc0207f20 <default_pmm_manager+0xbd8>
ffffffffc0203f0c:	00003617          	auipc	a2,0x3
ffffffffc0203f10:	cf460613          	addi	a2,a2,-780 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203f14:	06900593          	li	a1,105
ffffffffc0203f18:	00004517          	auipc	a0,0x4
ffffffffc0203f1c:	f2050513          	addi	a0,a0,-224 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203f20:	d64fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==7);
ffffffffc0203f24:	00004697          	auipc	a3,0x4
ffffffffc0203f28:	fec68693          	addi	a3,a3,-20 # ffffffffc0207f10 <default_pmm_manager+0xbc8>
ffffffffc0203f2c:	00003617          	auipc	a2,0x3
ffffffffc0203f30:	cd460613          	addi	a2,a2,-812 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203f34:	06600593          	li	a1,102
ffffffffc0203f38:	00004517          	auipc	a0,0x4
ffffffffc0203f3c:	f0050513          	addi	a0,a0,-256 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203f40:	d44fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==6);
ffffffffc0203f44:	00004697          	auipc	a3,0x4
ffffffffc0203f48:	fbc68693          	addi	a3,a3,-68 # ffffffffc0207f00 <default_pmm_manager+0xbb8>
ffffffffc0203f4c:	00003617          	auipc	a2,0x3
ffffffffc0203f50:	cb460613          	addi	a2,a2,-844 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203f54:	06300593          	li	a1,99
ffffffffc0203f58:	00004517          	auipc	a0,0x4
ffffffffc0203f5c:	ee050513          	addi	a0,a0,-288 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203f60:	d24fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==5);
ffffffffc0203f64:	00004697          	auipc	a3,0x4
ffffffffc0203f68:	f8c68693          	addi	a3,a3,-116 # ffffffffc0207ef0 <default_pmm_manager+0xba8>
ffffffffc0203f6c:	00003617          	auipc	a2,0x3
ffffffffc0203f70:	c9460613          	addi	a2,a2,-876 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203f74:	06000593          	li	a1,96
ffffffffc0203f78:	00004517          	auipc	a0,0x4
ffffffffc0203f7c:	ec050513          	addi	a0,a0,-320 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203f80:	d04fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==5);
ffffffffc0203f84:	00004697          	auipc	a3,0x4
ffffffffc0203f88:	f6c68693          	addi	a3,a3,-148 # ffffffffc0207ef0 <default_pmm_manager+0xba8>
ffffffffc0203f8c:	00003617          	auipc	a2,0x3
ffffffffc0203f90:	c7460613          	addi	a2,a2,-908 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203f94:	05d00593          	li	a1,93
ffffffffc0203f98:	00004517          	auipc	a0,0x4
ffffffffc0203f9c:	ea050513          	addi	a0,a0,-352 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203fa0:	ce4fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==4);
ffffffffc0203fa4:	00004697          	auipc	a3,0x4
ffffffffc0203fa8:	d0c68693          	addi	a3,a3,-756 # ffffffffc0207cb0 <default_pmm_manager+0x968>
ffffffffc0203fac:	00003617          	auipc	a2,0x3
ffffffffc0203fb0:	c5460613          	addi	a2,a2,-940 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203fb4:	05a00593          	li	a1,90
ffffffffc0203fb8:	00004517          	auipc	a0,0x4
ffffffffc0203fbc:	e8050513          	addi	a0,a0,-384 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203fc0:	cc4fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==4);
ffffffffc0203fc4:	00004697          	auipc	a3,0x4
ffffffffc0203fc8:	cec68693          	addi	a3,a3,-788 # ffffffffc0207cb0 <default_pmm_manager+0x968>
ffffffffc0203fcc:	00003617          	auipc	a2,0x3
ffffffffc0203fd0:	c3460613          	addi	a2,a2,-972 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203fd4:	05700593          	li	a1,87
ffffffffc0203fd8:	00004517          	auipc	a0,0x4
ffffffffc0203fdc:	e6050513          	addi	a0,a0,-416 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
ffffffffc0203fe0:	ca4fc0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgfault_num==4);
ffffffffc0203fe4:	00004697          	auipc	a3,0x4
ffffffffc0203fe8:	ccc68693          	addi	a3,a3,-820 # ffffffffc0207cb0 <default_pmm_manager+0x968>
ffffffffc0203fec:	00003617          	auipc	a2,0x3
ffffffffc0203ff0:	c1460613          	addi	a2,a2,-1004 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0203ff4:	05400593          	li	a1,84
ffffffffc0203ff8:	00004517          	auipc	a0,0x4
ffffffffc0203ffc:	e4050513          	addi	a0,a0,-448 # ffffffffc0207e38 <default_pmm_manager+0xaf0>
...
ffffffffc020402a:	f8268693          	addi	a3,a3,-126 # ffffffffc0207fa8 <default_pmm_manager+0xc60>
ffffffffc020402e:	00003617          	auipc	a2,0x3
ffffffffc0204032:	bd260613          	addi	a2,a2,-1070 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc020404a:	f7268693          	addi	a3,a3,-142 # ffffffffc0207fb8 <default_pmm_manager+0xc70>
ffffffffc020404e:	00003617          	auipc	a2,0x3
ffffffffc0204052:	bb260613          	addi	a2,a2,-1102 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc020408c:	b7860613          	addi	a2,a2,-1160 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02040b0:	b5460613          	addi	a2,a2,-1196 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02040dc:	34878793          	addi	a5,a5,840 # ffffffffc02ac420 <swap_init_ok>
...
ffffffffc0204180:	0105b803          	ld	a6,16(a1) # 1010 <_binary_obj___user_faultread_out_size-0x8558>
insert_vma_struct(struct mm_struct *mm, struct vma_struct *vma) {
...
ffffffffc02041f8:	a0c60613          	addi	a2,a2,-1524 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204218:	9ec60613          	addi	a2,a2,-1556 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204238:	9cc60613          	addi	a2,a2,-1588 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc020428a:	97a60613          	addi	a2,a2,-1670 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc020433c:	8c860613          	addi	a2,a2,-1848 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc020436c:	85aa                	mv	a1,a0
        vma->vm_start = vm_start;
ffffffffc020436e:	0157b423          	sd	s5,8(a5) # 200008 <_binary_obj___user_exit_out_size+0x1f5590>
        insert_vma_struct(to, nvma);
...
ffffffffc02043d8:	82c60613          	addi	a2,a2,-2004 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc020444e:	7b660613          	addi	a2,a2,1974 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02044ae:	75660613          	addi	a2,a2,1878 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02044fc:	70860613          	addi	a2,a2,1800 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02045dc:	62860613          	addi	a2,a2,1576 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204616:	f4a7b723          	sd	a0,-178(a5) # ffffffffc02ac560 <check_mm_struct>
...
ffffffffc0204624:	de878793          	addi	a5,a5,-536 # ffffffffc02ac408 <boot_pgdir>
...
ffffffffc020466e:	2ca41163          	bne	s0,a0,ffffffffc0204930 <vmm_init+0x4ce>
        *(char *)(addr + i) = i;
ffffffffc0204672:	00f78023          	sb	a5,0(a5) # 200000 <_binary_obj___user_exit_out_size+0x1f5588>
        sum += i;
...
ffffffffc020467e:	10000793          	li	a5,256
        sum += i;
ffffffffc0204682:	35670713          	addi	a4,a4,854 # 1356 <_binary_obj___user_faultread_out_size-0x8212>
    }
    for (i = 0; i < 100; i ++) {
...
ffffffffc02046a2:	d72a8a93          	addi	s5,s5,-654 # ffffffffc02ac410 <npage>
...
ffffffffc02046d8:	d9c78793          	addi	a5,a5,-612 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc02046fa:	d8a40413          	addi	s0,s0,-630 # ffffffffc02ac480 <pages>
...
ffffffffc0204744:	e207b023          	sd	zero,-480(a5) # ffffffffc02ac560 <check_mm_struct>
...
ffffffffc0204784:	48060613          	addi	a2,a2,1152 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02047a4:	46060613          	addi	a2,a2,1120 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02047c4:	44060613          	addi	a2,a2,1088 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02047e4:	42060613          	addi	a2,a2,1056 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204804:	40060613          	addi	a2,a2,1024 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204824:	3e060613          	addi	a2,a2,992 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204844:	3c060613          	addi	a2,a2,960 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204864:	3a060613          	addi	a2,a2,928 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204884:	38060613          	addi	a2,a2,896 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02048a4:	36060613          	addi	a2,a2,864 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02048dc:	32860613          	addi	a2,a2,808 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02048fc:	30860613          	addi	a2,a2,776 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc020491c:	2e860613          	addi	a2,a2,744 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc020493c:	2c860613          	addi	a2,a2,712 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204974:	29060613          	addi	a2,a2,656 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc0204994:	27060613          	addi	a2,a2,624 # ffffffffc0206c00 <commands+0x4c0>
...
ffffffffc02049c0:	a6878793          	addi	a5,a5,-1432 # ffffffffc02ac424 <pgfault_num>
ffffffffc02049c4:	439c                	lw	a5,0(a5)
ffffffffc02049c6:	2785                	addiw	a5,a5,1
ffffffffc02049c8:	000a8717          	auipc	a4,0xa8
ffffffffc02049cc:	a4f72e23          	sw	a5,-1444(a4) # ffffffffc02ac424 <pgfault_num>
...
ffffffffc02049f8:	a2c78793          	addi	a5,a5,-1492 # ffffffffc02ac420 <swap_init_ok>
...
ffffffffc0204a50:	61450513          	addi	a0,a0,1556 # ffffffffc0208060 <default_pmm_manager+0xd18>
...
ffffffffc0204a62:	5b250513          	addi	a0,a0,1458 # ffffffffc0208010 <default_pmm_manager+0xcc8>
...
ffffffffc0204a72:	61a50513          	addi	a0,a0,1562 # ffffffffc0208088 <default_pmm_manager+0xd40>
...
ffffffffc0204a82:	5c250513          	addi	a0,a0,1474 # ffffffffc0208040 <default_pmm_manager+0xcf8>
...
ffffffffc0204b3c:	9ca7bc23          	sd	a0,-1576(a5) # ffffffffc02ac510 <max_swap_offset>
}
ffffffffc0204b40:	0141                	addi	sp,sp,16
ffffffffc0204b42:	8082                	ret
        panic("swap fs isn't available.\n");
ffffffffc0204b44:	00004617          	auipc	a2,0x4
ffffffffc0204b48:	82c60613          	addi	a2,a2,-2004 # ffffffffc0208370 <default_pmm_manager+0x1028>
ffffffffc0204b4c:	45b5                	li	a1,13
ffffffffc0204b4e:	00004517          	auipc	a0,0x4
ffffffffc0204b52:	84250513          	addi	a0,a0,-1982 # ffffffffc0208390 <default_pmm_manager+0x1048>
...
ffffffffc0204b68:	9ac70713          	addi	a4,a4,-1620 # ffffffffc02ac510 <max_swap_offset>
...
ffffffffc0204b76:	90e70713          	addi	a4,a4,-1778 # ffffffffc02ac480 <pages>
...
ffffffffc0204b88:	88c68693          	addi	a3,a3,-1908 # ffffffffc02ac410 <npage>
    return page - pages + nbase;
...
ffffffffc0204bac:	8c878793          	addi	a5,a5,-1848 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc0204bc6:	7e660613          	addi	a2,a2,2022 # ffffffffc02083a8 <default_pmm_manager+0x1060>
ffffffffc0204bca:	45d1                	li	a1,20
ffffffffc0204bcc:	00003517          	auipc	a0,0x3
ffffffffc0204bd0:	7c450513          	addi	a0,a0,1988 # ffffffffc0208390 <default_pmm_manager+0x1048>
...
ffffffffc0204be2:	7ba60613          	addi	a2,a2,1978 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0204be6:	00002517          	auipc	a0,0x2
ffffffffc0204bea:	7da50513          	addi	a0,a0,2010 # ffffffffc02073c0 <default_pmm_manager+0x78>
...
ffffffffc0204c00:	91470713          	addi	a4,a4,-1772 # ffffffffc02ac510 <max_swap_offset>
...
ffffffffc0204c0e:	87670713          	addi	a4,a4,-1930 # ffffffffc02ac480 <pages>
...
ffffffffc0204c20:	7f468693          	addi	a3,a3,2036 # ffffffffc02ac410 <npage>
    return page - pages + nbase;
...
ffffffffc0204c44:	83078793          	addi	a5,a5,-2000 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc0204c5e:	74e60613          	addi	a2,a2,1870 # ffffffffc02083a8 <default_pmm_manager+0x1060>
ffffffffc0204c62:	45e5                	li	a1,25
ffffffffc0204c64:	00003517          	auipc	a0,0x3
ffffffffc0204c68:	72c50513          	addi	a0,a0,1836 # ffffffffc0208390 <default_pmm_manager+0x1048>
...
ffffffffc0204c7a:	72260613          	addi	a2,a2,1826 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0204c7e:	00002517          	auipc	a0,0x2
ffffffffc0204c82:	74250513          	addi	a0,a0,1858 # ffffffffc02073c0 <default_pmm_manager+0x78>
...
ffffffffc0204cc8:	11f010ef          	jal	ra,ffffffffc02065e6 <memset>
        proc->tf = NULL;         // 初始化陷阱帧为空
        proc->cr3 = boot_cr3;    // CR3寄存器：页目录表PDT的基址
ffffffffc0204ccc:	000a7797          	auipc	a5,0xa7
ffffffffc0204cd0:	7ac78793          	addi	a5,a5,1964 # ffffffffc02ac478 <boot_cr3>
...
ffffffffc0204cf8:	0e043c23          	sd	zero,248(s0)
    }
    return proc;
}
...
ffffffffc0204d0a:	72278793          	addi	a5,a5,1826 # ffffffffc02ac428 <current>
...
ffffffffc0204d1a:	71278793          	addi	a5,a5,1810 # ffffffffc02ac428 <current>
ffffffffc0204d1e:	639c                	ld	a5,0(a5)
user_main(void *arg) {
ffffffffc0204d20:	7139                	addi	sp,sp,-64
    KERNEL_EXECVE2(TEST, TESTSTART, TESTSIZE);
ffffffffc0204d22:	00004617          	auipc	a2,0x4
ffffffffc0204d26:	a9660613          	addi	a2,a2,-1386 # ffffffffc02087b8 <default_pmm_manager+0x1470>
ffffffffc0204d2a:	43cc                	lw	a1,4(a5)
ffffffffc0204d2c:	00004517          	auipc	a0,0x4
ffffffffc0204d30:	a9c50513          	addi	a0,a0,-1380 # ffffffffc02087c8 <default_pmm_manager+0x1480>
user_main(void *arg) {
...
ffffffffc0204d3e:	a7e78793          	addi	a5,a5,-1410 # ffffffffc02087b8 <default_pmm_manager+0x1470>
ffffffffc0204d42:	3fe05717          	auipc	a4,0x3fe05
ffffffffc0204d46:	58e70713          	addi	a4,a4,1422 # a2d0 <_binary_obj___user_forktest_out_size>
ffffffffc0204d4a:	e43a                	sd	a4,8(sp)
    int64_t ret=0, len = strlen(name);
ffffffffc0204d4c:	853e                	mv	a0,a5
ffffffffc0204d4e:	00043717          	auipc	a4,0x43
ffffffffc0204d52:	2c270713          	addi	a4,a4,706 # ffffffffc0248010 <_binary_obj___user_forktest_out_start>
ffffffffc0204d56:	f03a                	sd	a4,32(sp)
ffffffffc0204d58:	f43e                	sd	a5,40(sp)
ffffffffc0204d5a:	e802                	sd	zero,16(sp)
ffffffffc0204d5c:	7ec010ef          	jal	ra,ffffffffc0206548 <strlen>
...
ffffffffc0204d78:	a7c50513          	addi	a0,a0,-1412 # ffffffffc02087f0 <default_pmm_manager+0x14a8>
...
ffffffffc0204d84:	a8060613          	addi	a2,a2,-1408 # ffffffffc0208800 <default_pmm_manager+0x14b8>
ffffffffc0204d88:	36200593          	li	a1,866
ffffffffc0204d8c:	00004517          	auipc	a0,0x4
ffffffffc0204d90:	a9450513          	addi	a0,a0,-1388 # ffffffffc0208820 <default_pmm_manager+0x14d8>
...
ffffffffc0204daa:	6ca78793          	addi	a5,a5,1738 # ffffffffc02ac470 <va_pa_offset>
ffffffffc0204dae:	6388                	ld	a0,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0204db0:	000a7797          	auipc	a5,0xa7
ffffffffc0204db4:	66078793          	addi	a5,a5,1632 # ffffffffc02ac410 <npage>
...
ffffffffc0204dc6:	f2678793          	addi	a5,a5,-218 # ffffffffc0208ce8 <nbase>
ffffffffc0204dca:	639c                	ld	a5,0(a5)
ffffffffc0204dcc:	000a7717          	auipc	a4,0xa7
ffffffffc0204dd0:	6b470713          	addi	a4,a4,1716 # ffffffffc02ac480 <pages>
...
ffffffffc0204dea:	5ea60613          	addi	a2,a2,1514 # ffffffffc02073d0 <default_pmm_manager+0x88>
ffffffffc0204dee:	06e00593          	li	a1,110
ffffffffc0204df2:	00002517          	auipc	a0,0x2
ffffffffc0204df6:	5ce50513          	addi	a0,a0,1486 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0204dfa:	e8afb0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204dfe:	00002617          	auipc	a2,0x2
ffffffffc0204e02:	5fa60613          	addi	a2,a2,1530 # ffffffffc02073f8 <default_pmm_manager+0xb0>
ffffffffc0204e06:	06200593          	li	a1,98
ffffffffc0204e0a:	00002517          	auipc	a0,0x2
ffffffffc0204e0e:	5b650513          	addi	a0,a0,1462 # ffffffffc02073c0 <default_pmm_manager+0x78>
...
ffffffffc0204e2c:	65878793          	addi	a5,a5,1624 # ffffffffc02ac480 <pages>
ffffffffc0204e30:	6394                	ld	a3,0(a5)
ffffffffc0204e32:	00004797          	auipc	a5,0x4
ffffffffc0204e36:	eb678793          	addi	a5,a5,-330 # ffffffffc0208ce8 <nbase>
ffffffffc0204e3a:	6380                	ld	s0,0(a5)
ffffffffc0204e3c:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc0204e40:	000a7717          	auipc	a4,0xa7
ffffffffc0204e44:	5d070713          	addi	a4,a4,1488 # ffffffffc02ac410 <npage>
    return page - pages + nbase;
...
ffffffffc0204e5e:	61678793          	addi	a5,a5,1558 # ffffffffc02ac470 <va_pa_offset>
ffffffffc0204e62:	6380                	ld	s0,0(a5)
    memcpy(pgdir, boot_pgdir, PGSIZE);
ffffffffc0204e64:	000a7797          	auipc	a5,0xa7
ffffffffc0204e68:	5a478793          	addi	a5,a5,1444 # ffffffffc02ac408 <boot_pgdir>
...
ffffffffc0204e74:	784010ef          	jal	ra,ffffffffc02065f8 <memcpy>
    return 0;
...
ffffffffc0204e8e:	50e60613          	addi	a2,a2,1294 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0204e92:	06900593          	li	a1,105
ffffffffc0204e96:	00002517          	auipc	a0,0x2
ffffffffc0204e9a:	52a50513          	addi	a0,a0,1322 # ffffffffc02073c0 <default_pmm_manager+0x78>
...
ffffffffc0204eb4:	ec06                	sd	ra,24(sp)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204eb6:	730010ef          	jal	ra,ffffffffc02065e6 <memset>
...
ffffffffc0204ec6:	6105                	addi	sp,sp,32
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204ec8:	7300106f          	j	ffffffffc02065f8 <memcpy>
...
ffffffffc0204ed2:	55a78793          	addi	a5,a5,1370 # ffffffffc02ac428 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc0204ef6:	52873b23          	sd	s0,1334(a4) # ffffffffc02ac428 <current>
...
ffffffffc0204f0e:	7cf000ef          	jal	ra,ffffffffc0205edc <switch_to>
    if (flag) {
...
ffffffffc0204f9c:	4a8a0a13          	addi	s4,s4,1192 # ffffffffc02ac440 <nr_process>
...
ffffffffc0204fd6:	456c0c13          	addi	s8,s8,1110 # ffffffffc02ac428 <current>
ffffffffc0204fda:	000c3783          	ld	a5,0(s8)
    assert(current->wait_state == 0);
ffffffffc0204fde:	0ec7a703          	lw	a4,236(a5) # 10ec <_binary_obj___user_faultread_out_size-0x847c>
    proc->parent = current;
...
ffffffffc0204ff6:	48ea8a93          	addi	s5,s5,1166 # ffffffffc02ac480 <pages>
ffffffffc0204ffa:	000ab683          	ld	a3,0(s5)
ffffffffc0204ffe:	00004b17          	auipc	s6,0x4
ffffffffc0205002:	ceab0b13          	addi	s6,s6,-790 # ffffffffc0208ce8 <nbase>
ffffffffc0205006:	000b3783          	ld	a5,0(s6)
ffffffffc020500a:	40d506b3          	sub	a3,a0,a3
    return KADDR(page2pa(page));
ffffffffc020500e:	000a7b97          	auipc	s7,0xa7
ffffffffc0205012:	402b8b93          	addi	s7,s7,1026 # ffffffffc02ac410 <npage>
    return page - pages + nbase;
...
ffffffffc020502e:	446c8c93          	addi	s9,s9,1094 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc0205074:	ee078793          	addi	a5,a5,-288 # 1ee0 <_binary_obj___user_faultread_out_size-0x7688>
...
ffffffffc02050c6:	f2678793          	addi	a5,a5,-218 # ffffffffc02a0fe8 <last_pid.1691>
...
ffffffffc02050d6:	f0a6ab23          	sw	a0,-234(a3) # ffffffffc02a0fe8 <last_pid.1691>
ffffffffc02050da:	14e55263          	ble	a4,a0,ffffffffc020521e <do_fork+0x28a>
    if (last_pid >= next_safe) {
ffffffffc02050de:	0009c797          	auipc	a5,0x9c
ffffffffc02050e2:	f0e78793          	addi	a5,a5,-242 # ffffffffc02a0fec <next_safe.1690>
ffffffffc02050e6:	439c                	lw	a5,0(a5)
ffffffffc02050e8:	000a7497          	auipc	s1,0xa7
ffffffffc02050ec:	48048493          	addi	s1,s1,1152 # ffffffffc02ac568 <proc_list>
...
ffffffffc02050fa:	eef72b23          	sw	a5,-266(a4) # ffffffffc02a0fec <next_safe.1690>
ffffffffc02050fe:	4581                	li	a1,0
ffffffffc0205100:	87aa                	mv	a5,a0
ffffffffc0205102:	000a7497          	auipc	s1,0xa7
ffffffffc0205106:	46648493          	addi	s1,s1,1126 # ffffffffc02ac568 <proc_list>
    repeat:
...
ffffffffc0205114:	45868693          	addi	a3,a3,1112 # ffffffffc02ac568 <proc_list>
...
ffffffffc020513e:	eaf72723          	sw	a5,-338(a4) # ffffffffc02a0fe8 <last_pid.1691>
...
ffffffffc020514c:	eac7a223          	sw	a2,-348(a5) # ffffffffc02a0fec <next_safe.1690>
        proc->pid = get_pid();
ffffffffc0205150:	c048                	sw	a0,4(s0)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0205152:	45a9                	li	a1,10
ffffffffc0205154:	2501                	sext.w	a0,a0
ffffffffc0205156:	7e3000ef          	jal	ra,ffffffffc0206138 <hash32>
ffffffffc020515a:	1502                	slli	a0,a0,0x20
ffffffffc020515c:	000a3797          	auipc	a5,0xa3
ffffffffc0205160:	29478793          	addi	a5,a5,660 # ffffffffc02a83f0 <hash_list>
...
ffffffffc0205186:	3ef5b723          	sd	a5,1006(a1) # ffffffffc02ac570 <proc_list+0x8>
    elm->next = next;
...
ffffffffc02051a6:	28f72f23          	sw	a5,670(a4) # ffffffffc02ac440 <nr_process>
    if (flag) {
ffffffffc02051aa:	10091863          	bnez	s2,ffffffffc02052ba <do_fork+0x326>
    wakeup_proc(proc);
ffffffffc02051ae:	8522                	mv	a0,s0
ffffffffc02051b0:	597000ef          	jal	ra,ffffffffc0205f46 <wakeup_proc>
    ret = proc->pid;
...
ffffffffc0205204:	de878793          	addi	a5,a5,-536 # ffffffffc02a0fe8 <last_pid.1691>
...
ffffffffc0205216:	dca6ab23          	sw	a0,-554(a3) # ffffffffc02a0fe8 <last_pid.1691>
...
ffffffffc0205224:	dcf72423          	sw	a5,-568(a4) # ffffffffc02a0fe8 <last_pid.1691>
...
ffffffffc0205248:	c799                	beqz	a5,ffffffffc0205256 <do_fork+0x2c2>
        schedule();
ffffffffc020524a:	579000ef          	jal	ra,ffffffffc0205fc2 <schedule>
...
ffffffffc02052da:	0c260613          	addi	a2,a2,194 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc02052de:	06900593          	li	a1,105
ffffffffc02052e2:	00002517          	auipc	a0,0x2
ffffffffc02052e6:	0de50513          	addi	a0,a0,222 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc02052ea:	99afb0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(current->wait_state == 0);
ffffffffc02052ee:	00003697          	auipc	a3,0x3
ffffffffc02052f2:	2a268693          	addi	a3,a3,674 # ffffffffc0208590 <default_pmm_manager+0x1248>
ffffffffc02052f6:	00002617          	auipc	a2,0x2
ffffffffc02052fa:	90a60613          	addi	a2,a2,-1782 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02052fe:	1ae00593          	li	a1,430
ffffffffc0205302:	00003517          	auipc	a0,0x3
ffffffffc0205306:	51e50513          	addi	a0,a0,1310 # ffffffffc0208820 <default_pmm_manager+0x14d8>
...
ffffffffc0205314:	0c060613          	addi	a2,a2,192 # ffffffffc02073d0 <default_pmm_manager+0x88>
ffffffffc0205318:	16f00593          	li	a1,367
ffffffffc020531c:	00003517          	auipc	a0,0x3
ffffffffc0205320:	50450513          	addi	a0,a0,1284 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205324:	960fb0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("Unlock failed.\n");
ffffffffc0205328:	00003617          	auipc	a2,0x3
ffffffffc020532c:	28860613          	addi	a2,a2,648 # ffffffffc02085b0 <default_pmm_manager+0x1268>
ffffffffc0205330:	03100593          	li	a1,49
ffffffffc0205334:	00003517          	auipc	a0,0x3
ffffffffc0205338:	28c50513          	addi	a0,a0,652 # ffffffffc02085c0 <default_pmm_manager+0x1278>
ffffffffc020533c:	948fb0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205340:	00002617          	auipc	a2,0x2
ffffffffc0205344:	0b860613          	addi	a2,a2,184 # ffffffffc02073f8 <default_pmm_manager+0xb0>
ffffffffc0205348:	06200593          	li	a1,98
ffffffffc020534c:	00002517          	auipc	a0,0x2
ffffffffc0205350:	07450513          	addi	a0,a0,116 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0205354:	930fb0ef          	jal	ra,ffffffffc0200484 <__panic>
    return pa2page(PADDR(kva));
ffffffffc0205358:	00002617          	auipc	a2,0x2
ffffffffc020535c:	07860613          	addi	a2,a2,120 # ffffffffc02073d0 <default_pmm_manager+0x88>
ffffffffc0205360:	06e00593          	li	a1,110
ffffffffc0205364:	00002517          	auipc	a0,0x2
ffffffffc0205368:	05c50513          	addi	a0,a0,92 # ffffffffc02073c0 <default_pmm_manager+0x78>
...
ffffffffc0205386:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc0205388:	25e010ef          	jal	ra,ffffffffc02065e6 <memset>
...
ffffffffc02053c8:	06c70713          	addi	a4,a4,108 # ffffffffc02ac430 <idleproc>
ffffffffc02053cc:	000a7917          	auipc	s2,0xa7
ffffffffc02053d0:	05c90913          	addi	s2,s2,92 # ffffffffc02ac428 <current>
...
ffffffffc02053ec:	05040413          	addi	s0,s0,80 # ffffffffc02ac438 <initproc>
...
ffffffffc0205400:	07c78793          	addi	a5,a5,124 # ffffffffc02ac478 <boot_cr3>
...
ffffffffc020545e:	1007b703          	ld	a4,256(a5) # ffffffff80000100 <_binary_obj___user_exit_out_size+0xffffffff7fff5688>
...
ffffffffc0205486:	2c1000ef          	jal	ra,ffffffffc0205f46 <wakeup_proc>
...
ffffffffc0205490:	020a1363          	bnez	s4,ffffffffc02054b6 <do_exit+0xf6>
    schedule();
ffffffffc0205494:	32f000ef          	jal	ra,ffffffffc0205fc2 <schedule>
    panic("do_exit will not return!! %d.\n", current->pid);
ffffffffc0205498:	00093783          	ld	a5,0(s2)
ffffffffc020549c:	00003617          	auipc	a2,0x3
ffffffffc02054a0:	0d460613          	addi	a2,a2,212 # ffffffffc0208570 <default_pmm_manager+0x1228>
ffffffffc02054a4:	21500593          	li	a1,533
ffffffffc02054a8:	43d4                	lw	a3,4(a5)
ffffffffc02054aa:	00003517          	auipc	a0,0x3
ffffffffc02054ae:	37650513          	addi	a0,a0,886 # ffffffffc0208820 <default_pmm_manager+0x14d8>
...
ffffffffc02054c0:	09460613          	addi	a2,a2,148 # ffffffffc0208550 <default_pmm_manager+0x1208>
ffffffffc02054c4:	1e900593          	li	a1,489
ffffffffc02054c8:	00003517          	auipc	a0,0x3
ffffffffc02054cc:	35850513          	addi	a0,a0,856 # ffffffffc0208820 <default_pmm_manager+0x14d8>
...
ffffffffc02054ec:	07860613          	addi	a2,a2,120 # ffffffffc0208560 <default_pmm_manager+0x1218>
ffffffffc02054f0:	1ec00593          	li	a1,492
ffffffffc02054f4:	00003517          	auipc	a0,0x3
ffffffffc02054f8:	32c50513          	addi	a0,a0,812 # ffffffffc0208820 <default_pmm_manager+0x14d8>
...
ffffffffc0205506:	bf15                	j	ffffffffc020543a <do_exit+0x7a>
            wakeup_proc(proc);
ffffffffc0205508:	23f000ef          	jal	ra,ffffffffc0205f46 <wakeup_proc>
...
ffffffffc020552c:	f0090913          	addi	s2,s2,-256 # ffffffffc02ac428 <current>
            if (proc->state == PROC_ZOMBIE) {
...
ffffffffc020555a:	0f472623          	sw	s4,236(a4)
        schedule();
ffffffffc020555e:	265000ef          	jal	ra,ffffffffc0205fc2 <schedule>
        if (current->flags & PF_EXITING) {
...
ffffffffc020558e:	ea678793          	addi	a5,a5,-346 # ffffffffc02ac430 <idleproc>
...
ffffffffc020559c:	ea078793          	addi	a5,a5,-352 # ffffffffc02ac438 <initproc>
...
ffffffffc02055e2:	e6278793          	addi	a5,a5,-414 # ffffffffc02ac440 <nr_process>
ffffffffc02055e6:	439c                	lw	a5,0(a5)
ffffffffc02055e8:	37fd                	addiw	a5,a5,-1
ffffffffc02055ea:	000a7717          	auipc	a4,0xa7
ffffffffc02055ee:	e4f72b23          	sw	a5,-426(a4) # ffffffffc02ac440 <nr_process>
    if (flag) {
...
ffffffffc0205602:	e7278793          	addi	a5,a5,-398 # ffffffffc02ac470 <va_pa_offset>
ffffffffc0205606:	6398                	ld	a4,0(a5)
    if (PPN(pa) >= npage) {
ffffffffc0205608:	000a7797          	auipc	a5,0xa7
ffffffffc020560c:	e0878793          	addi	a5,a5,-504 # ffffffffc02ac410 <npage>
...
ffffffffc020561e:	6ce78793          	addi	a5,a5,1742 # ffffffffc0208ce8 <nbase>
ffffffffc0205622:	639c                	ld	a5,0(a5)
ffffffffc0205624:	000a7717          	auipc	a4,0xa7
ffffffffc0205628:	e5c70713          	addi	a4,a4,-420 # ffffffffc02ac480 <pages>
...
ffffffffc0205672:	f6a60613          	addi	a2,a2,-150 # ffffffffc02085d8 <default_pmm_manager+0x1290>
ffffffffc0205676:	31000593          	li	a1,784
ffffffffc020567a:	00003517          	auipc	a0,0x3
ffffffffc020567e:	1a650513          	addi	a0,a0,422 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205682:	e03fa0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0205686:	00002617          	auipc	a2,0x2
ffffffffc020568a:	d7260613          	addi	a2,a2,-654 # ffffffffc02073f8 <default_pmm_manager+0xb0>
ffffffffc020568e:	06200593          	li	a1,98
ffffffffc0205692:	00002517          	auipc	a0,0x2
ffffffffc0205696:	d2e50513          	addi	a0,a0,-722 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc020569a:	debfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    return pa2page(PADDR(kva));
ffffffffc020569e:	00002617          	auipc	a2,0x2
ffffffffc02056a2:	d3260613          	addi	a2,a2,-718 # ffffffffc02073d0 <default_pmm_manager+0x88>
ffffffffc02056a6:	06e00593          	li	a1,110
ffffffffc02056aa:	00002517          	auipc	a0,0x2
ffffffffc02056ae:	d1650513          	addi	a0,a0,-746 # ffffffffc02073c0 <default_pmm_manager+0x78>
...
ffffffffc02056d6:	a841                	j	ffffffffc0205766 <init_main+0xb0>
    ...
    while (do_wait(0, NULL) == 0) {
        schedule();
ffffffffc02056d8:	0eb000ef          	jal	ra,ffffffffc0205fc2 <schedule>
    if (code_store != NULL) {
...
ffffffffc02056ea:	f3250513          	addi	a0,a0,-206 # ffffffffc0208618 <default_pmm_manager+0x12d0>
ffffffffc02056ee:	aa1fa0ef          	jal	ra,ffffffffc020018e <cprintf>
    assert(initproc->cptr == NULL && initproc->yptr == NULL && initproc->optr == NULL);
ffffffffc02056f2:	000a7797          	auipc	a5,0xa7
ffffffffc02056f6:	d4678793          	addi	a5,a5,-698 # ffffffffc02ac438 <initproc>
...
ffffffffc020570e:	d3670713          	addi	a4,a4,-714 # ffffffffc02ac440 <nr_process>
...
ffffffffc020571e:	e4e68693          	addi	a3,a3,-434 # ffffffffc02ac568 <proc_list>
...
ffffffffc0205736:	fce50513          	addi	a0,a0,-50 # ffffffffc0208700 <default_pmm_manager+0x13b8>
...
ffffffffc020574a:	efa68693          	addi	a3,a3,-262 # ffffffffc0208640 <default_pmm_manager+0x12f8>
ffffffffc020574e:	00001617          	auipc	a2,0x1
ffffffffc0205752:	4b260613          	addi	a2,a2,1202 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205756:	37500593          	li	a1,885
ffffffffc020575a:	00003517          	auipc	a0,0x3
ffffffffc020575e:	0c650513          	addi	a0,a0,198 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205762:	d23fa0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("create user_main failed.\n");
ffffffffc0205766:	00003617          	auipc	a2,0x3
ffffffffc020576a:	e9260613          	addi	a2,a2,-366 # ffffffffc02085f8 <default_pmm_manager+0x12b0>
ffffffffc020576e:	36d00593          	li	a1,877
ffffffffc0205772:	00003517          	auipc	a0,0x3
ffffffffc0205776:	0ae50513          	addi	a0,a0,174 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc020577a:	d0bfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(list_prev(&proc_list) == &(initproc->list_link));
ffffffffc020577e:	00003697          	auipc	a3,0x3
ffffffffc0205782:	f5268693          	addi	a3,a3,-174 # ffffffffc02086d0 <default_pmm_manager+0x1388>
ffffffffc0205786:	00001617          	auipc	a2,0x1
ffffffffc020578a:	47a60613          	addi	a2,a2,1146 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc020578e:	37800593          	li	a1,888
ffffffffc0205792:	00003517          	auipc	a0,0x3
ffffffffc0205796:	08e50513          	addi	a0,a0,142 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc020579a:	cebfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(list_next(&proc_list) == &(initproc->list_link));
ffffffffc020579e:	00003697          	auipc	a3,0x3
ffffffffc02057a2:	f0268693          	addi	a3,a3,-254 # ffffffffc02086a0 <default_pmm_manager+0x1358>
ffffffffc02057a6:	00001617          	auipc	a2,0x1
ffffffffc02057aa:	45a60613          	addi	a2,a2,1114 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02057ae:	37700593          	li	a1,887
ffffffffc02057b2:	00003517          	auipc	a0,0x3
ffffffffc02057b6:	06e50513          	addi	a0,a0,110 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc02057ba:	ccbfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(nr_process == 2);
ffffffffc02057be:	00003697          	auipc	a3,0x3
ffffffffc02057c2:	ed268693          	addi	a3,a3,-302 # ffffffffc0208690 <default_pmm_manager+0x1348>
ffffffffc02057c6:	00001617          	auipc	a2,0x1
ffffffffc02057ca:	43a60613          	addi	a2,a2,1082 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc02057ce:	37600593          	li	a1,886
ffffffffc02057d2:	00003517          	auipc	a0,0x3
ffffffffc02057d6:	04e50513          	addi	a0,a0,78 # ffffffffc0208820 <default_pmm_manager+0x14d8>
...
ffffffffc02057e6:	c46a0a13          	addi	s4,s4,-954 # ffffffffc02ac428 <current>
...
ffffffffc020581c:	40050463          	beqz	a0,ffffffffc0205c24 <do_execve+0x446>
    memset(local_name, 0, sizeof(local_name));
ffffffffc0205820:	4641                	li	a2,16
ffffffffc0205822:	4581                	li	a1,0
ffffffffc0205824:	1008                	addi	a0,sp,32
ffffffffc0205826:	5c1000ef          	jal	ra,ffffffffc02065e6 <memset>
...
ffffffffc0205836:	5c3000ef          	jal	ra,ffffffffc02065f8 <memcpy>
    if (mm != NULL) {
ffffffffc020583a:	06090f63          	beqz	s2,ffffffffc02058b8 <do_execve+0xda>
        cputs("mm != NULL");
ffffffffc020583e:	00002517          	auipc	a0,0x2
ffffffffc0205842:	2fa50513          	addi	a0,a0,762 # ffffffffc0207b38 <default_pmm_manager+0x7f0>
ffffffffc0205846:	981fa0ef          	jal	ra,ffffffffc02001c6 <cputs>
        lcr3(boot_cr3);
ffffffffc020584a:	000a7797          	auipc	a5,0xa7
ffffffffc020584e:	c2e78793          	addi	a5,a5,-978 # ffffffffc02ac478 <boot_cr3>
...
ffffffffc0205868:	02e92823          	sw	a4,48(s2)
        if (mm_count_dec(mm) == 0) {
ffffffffc020586c:	28070b63          	beqz	a4,ffffffffc0205b02 <do_execve+0x324>
        current->mm = NULL;
...
ffffffffc020588e:	57f78793          	addi	a5,a5,1407 # 464c457f <_binary_obj___user_exit_out_size+0x464b9b07>
...
ffffffffc02058b0:	549000ef          	jal	ra,ffffffffc02065f8 <memcpy>
    if (mm != NULL) {
...
ffffffffc02058c4:	b0860613          	addi	a2,a2,-1272 # ffffffffc02083c8 <default_pmm_manager+0x1080>
ffffffffc02058c8:	21f00593          	li	a1,543
ffffffffc02058cc:	00003517          	auipc	a0,0x3
ffffffffc02058d0:	f5450513          	addi	a0,a0,-172 # ffffffffc0208820 <default_pmm_manager+0x14d8>
...
ffffffffc020590a:	b7ad8d93          	addi	s11,s11,-1158 # ffffffffc02ac480 <pages>
ffffffffc020590e:	00003d17          	auipc	s10,0x3
ffffffffc0205912:	3dad0d13          	addi	s10,s10,986 # ffffffffc0208ce8 <nbase>
    return KADDR(page2pa(page));
ffffffffc0205916:	e43e                	sd	a5,8(sp)
ffffffffc0205918:	000a7c97          	auipc	s9,0xa7
ffffffffc020591c:	af8c8c93          	addi	s9,s9,-1288 # ffffffffc02ac410 <npage>
        if (ph->p_type != ELF_PT_LOAD) {
ffffffffc0205920:	4018                	lw	a4,0(s0)
ffffffffc0205922:	4785                	li	a5,1
ffffffffc0205924:	0ef70d63          	beq	a4,a5,ffffffffc0205a1e <do_execve+0x240>
    for (; ph < ph_end; ph ++) {
...
ffffffffc0205946:	1a051463          	bnez	a0,ffffffffc0205aee <do_execve+0x310>
...
ffffffffc0205958:	36050263          	beqz	a0,ffffffffc0205cbc <do_execve+0x4de>
...
ffffffffc020596a:	32050963          	beqz	a0,ffffffffc0205c9c <do_execve+0x4be>
...
ffffffffc020597c:	30050063          	beqz	a0,ffffffffc0205c7c <do_execve+0x49e>
...
ffffffffc020598e:	2c050763          	beqz	a0,ffffffffc0205c5c <do_execve+0x47e>
    mm->mm_count += 1;
...
ffffffffc02059a0:	02f92823          	sw	a5,48(s2)
    current->mm = mm;
ffffffffc02059a4:	03263423          	sd	s2,40(a2) # 100028 <_binary_obj___user_exit_out_size+0xf55b0>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc02059a8:	c02007b7          	lui	a5,0xc0200
ffffffffc02059ac:	28f6ec63          	bltu	a3,a5,ffffffffc0205c44 <do_execve+0x466>
ffffffffc02059b0:	000a7797          	auipc	a5,0xa7
ffffffffc02059b4:	ac078793          	addi	a5,a5,-1344 # ffffffffc02ac470 <va_pa_offset>
...
ffffffffc02059d6:	10043483          	ld	s1,256(s0)
    memset(tf, 0, sizeof(struct trapframe));
ffffffffc02059da:	40d000ef          	jal	ra,ffffffffc02065e6 <memset>
    tf->epc = elf->e_entry;
ffffffffc02059de:	018b3703          	ld	a4,24(s6)
    tf->gpr.sp = USTACKTOP;
ffffffffc02059e2:	4785                	li	a5,1
    set_proc_name(current, local_name);
ffffffffc02059e4:	000a3503          	ld	a0,0(s4)
    tf->status = sstatus & ~(SSTATUS_SPP | SSTATUS_SPIE);
ffffffffc02059e8:	edf4f493          	andi	s1,s1,-289
    tf->gpr.sp = USTACKTOP;
ffffffffc02059ec:	07fe                	slli	a5,a5,0x1f
ffffffffc02059ee:	e81c                	sd	a5,16(s0)
    tf->epc = elf->e_entry;
ffffffffc02059f0:	10e43423          	sd	a4,264(s0)
    tf->status = sstatus & ~(SSTATUS_SPP | SSTATUS_SPIE);
ffffffffc02059f4:	10943023          	sd	s1,256(s0)
    set_proc_name(current, local_name);
ffffffffc02059f8:	100c                	addi	a1,sp,32
ffffffffc02059fa:	ca8ff0ef          	jal	ra,ffffffffc0204ea2 <set_proc_name>
}
ffffffffc02059fe:	60ea                	ld	ra,152(sp)
ffffffffc0205a00:	644a                	ld	s0,144(sp)
ffffffffc0205a02:	854e                	mv	a0,s3
ffffffffc0205a04:	64aa                	ld	s1,136(sp)
ffffffffc0205a06:	690a                	ld	s2,128(sp)
ffffffffc0205a08:	79e6                	ld	s3,120(sp)
ffffffffc0205a0a:	7a46                	ld	s4,112(sp)
ffffffffc0205a0c:	7aa6                	ld	s5,104(sp)
ffffffffc0205a0e:	7b06                	ld	s6,96(sp)
ffffffffc0205a10:	6be6                	ld	s7,88(sp)
ffffffffc0205a12:	6c46                	ld	s8,80(sp)
ffffffffc0205a14:	6ca6                	ld	s9,72(sp)
ffffffffc0205a16:	6d06                	ld	s10,64(sp)
ffffffffc0205a18:	7de2                	ld	s11,56(sp)
ffffffffc0205a1a:	610d                	addi	sp,sp,160
ffffffffc0205a1c:	8082                	ret
        if (ph->p_filesz > ph->p_memsz) {
ffffffffc0205a1e:	7410                	ld	a2,40(s0)
ffffffffc0205a20:	701c                	ld	a5,32(s0)
ffffffffc0205a22:	20f66363          	bltu	a2,a5,ffffffffc0205c28 <do_execve+0x44a>
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc0205a26:	405c                	lw	a5,4(s0)
ffffffffc0205a28:	0017f693          	andi	a3,a5,1
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a2c:	0027f713          	andi	a4,a5,2
        if (ph->p_flags & ELF_PF_X) vm_flags |= VM_EXEC;
ffffffffc0205a30:	068a                	slli	a3,a3,0x2
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205a32:	0e071263          	bnez	a4,ffffffffc0205b16 <do_execve+0x338>
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205a36:	4745                	li	a4,17
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a38:	8b91                	andi	a5,a5,4
        vm_flags = 0, perm = PTE_U | PTE_V;
ffffffffc0205a3a:	e03a                	sd	a4,0(sp)
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a3c:	c789                	beqz	a5,ffffffffc0205a46 <do_execve+0x268>
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205a3e:	47cd                	li	a5,19
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205a40:	0016e693          	ori	a3,a3,1
        if (vm_flags & VM_READ) perm |= PTE_R;
ffffffffc0205a44:	e03e                	sd	a5,0(sp)
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205a46:	0026f793          	andi	a5,a3,2
ffffffffc0205a4a:	efe1                	bnez	a5,ffffffffc0205b22 <do_execve+0x344>
        if (vm_flags & VM_EXEC) perm |= PTE_X;
ffffffffc0205a4c:	0046f793          	andi	a5,a3,4
ffffffffc0205a50:	c789                	beqz	a5,ffffffffc0205a5a <do_execve+0x27c>
ffffffffc0205a52:	6782                	ld	a5,0(sp)
ffffffffc0205a54:	0087e793          	ori	a5,a5,8
ffffffffc0205a58:	e03e                	sd	a5,0(sp)
        if ((ret = mm_map(mm, ph->p_va, ph->p_memsz, vm_flags, NULL)) != 0) {
ffffffffc0205a5a:	680c                	ld	a1,16(s0)
ffffffffc0205a5c:	4701                	li	a4,0
ffffffffc0205a5e:	854a                	mv	a0,s2
ffffffffc0205a60:	83ffe0ef          	jal	ra,ffffffffc020429e <mm_map>
ffffffffc0205a64:	89aa                	mv	s3,a0
ffffffffc0205a66:	e541                	bnez	a0,ffffffffc0205aee <do_execve+0x310>
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a68:	01043b83          	ld	s7,16(s0)
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a6c:	02043983          	ld	s3,32(s0)
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a70:	00843a83          	ld	s5,8(s0)
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a74:	77fd                	lui	a5,0xfffff
        end = ph->p_va + ph->p_filesz;
ffffffffc0205a76:	99de                	add	s3,s3,s7
        unsigned char *from = binary + ph->p_offset;
ffffffffc0205a78:	9ada                	add	s5,s5,s6
        uintptr_t start = ph->p_va, end, la = ROUNDDOWN(start, PGSIZE);
ffffffffc0205a7a:	00fbfc33          	and	s8,s7,a5
        while (start < end) {
ffffffffc0205a7e:	053bef63          	bltu	s7,s3,ffffffffc0205adc <do_execve+0x2fe>
ffffffffc0205a82:	aa79                	j	ffffffffc0205c20 <do_execve+0x442>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205a84:	6785                	lui	a5,0x1
ffffffffc0205a86:	418b8533          	sub	a0,s7,s8
ffffffffc0205a8a:	9c3e                	add	s8,s8,a5
ffffffffc0205a8c:	417c0833          	sub	a6,s8,s7
            if (end < la) {
ffffffffc0205a90:	0189f463          	bleu	s8,s3,ffffffffc0205a98 <do_execve+0x2ba>
                size -= la - end;
ffffffffc0205a94:	41798833          	sub	a6,s3,s7
    return page - pages + nbase;
ffffffffc0205a98:	000db683          	ld	a3,0(s11)
ffffffffc0205a9c:	000d3583          	ld	a1,0(s10)
    return KADDR(page2pa(page));
ffffffffc0205aa0:	67a2                	ld	a5,8(sp)
    return page - pages + nbase;
ffffffffc0205aa2:	40d486b3          	sub	a3,s1,a3
ffffffffc0205aa6:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205aa8:	000cb603          	ld	a2,0(s9)
    return page - pages + nbase;
ffffffffc0205aac:	96ae                	add	a3,a3,a1
    return KADDR(page2pa(page));
ffffffffc0205aae:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205ab2:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205ab4:	16c5fc63          	bleu	a2,a1,ffffffffc0205c2c <do_execve+0x44e>
ffffffffc0205ab8:	000a7797          	auipc	a5,0xa7
ffffffffc0205abc:	9b878793          	addi	a5,a5,-1608 # ffffffffc02ac470 <va_pa_offset>
ffffffffc0205ac0:	0007b883          	ld	a7,0(a5)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205ac4:	85d6                	mv	a1,s5
ffffffffc0205ac6:	8642                	mv	a2,a6
ffffffffc0205ac8:	96c6                	add	a3,a3,a7
ffffffffc0205aca:	9536                	add	a0,a0,a3
            start += size, from += size;
ffffffffc0205acc:	9bc2                	add	s7,s7,a6
ffffffffc0205ace:	e842                	sd	a6,16(sp)
            memcpy(page2kva(page) + off, from, size);
ffffffffc0205ad0:	329000ef          	jal	ra,ffffffffc02065f8 <memcpy>
            start += size, from += size;
ffffffffc0205ad4:	6842                	ld	a6,16(sp)
ffffffffc0205ad6:	9ac2                	add	s5,s5,a6
        while (start < end) {
ffffffffc0205ad8:	053bf863          	bleu	s3,s7,ffffffffc0205b28 <do_execve+0x34a>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205adc:	01893503          	ld	a0,24(s2)
ffffffffc0205ae0:	6602                	ld	a2,0(sp)
ffffffffc0205ae2:	85e2                	mv	a1,s8
ffffffffc0205ae4:	815fd0ef          	jal	ra,ffffffffc02032f8 <pgdir_alloc_page>
ffffffffc0205ae8:	84aa                	mv	s1,a0
ffffffffc0205aea:	fd49                	bnez	a0,ffffffffc0205a84 <do_execve+0x2a6>
        ret = -E_NO_MEM;
ffffffffc0205aec:	59f1                	li	s3,-4
    exit_mmap(mm);
ffffffffc0205aee:	854a                	mv	a0,s2
ffffffffc0205af0:	8fdfe0ef          	jal	ra,ffffffffc02043ec <exit_mmap>
    put_pgdir(mm);
ffffffffc0205af4:	854a                	mv	a0,s2
ffffffffc0205af6:	aa2ff0ef          	jal	ra,ffffffffc0204d98 <put_pgdir>
    mm_destroy(mm);
ffffffffc0205afa:	854a                	mv	a0,s2
ffffffffc0205afc:	f50fe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
    return ret;
ffffffffc0205b00:	b355                	j	ffffffffc02058a4 <do_execve+0xc6>
            exit_mmap(mm);
ffffffffc0205b02:	854a                	mv	a0,s2
ffffffffc0205b04:	8e9fe0ef          	jal	ra,ffffffffc02043ec <exit_mmap>
            put_pgdir(mm);
ffffffffc0205b08:	854a                	mv	a0,s2
ffffffffc0205b0a:	a8eff0ef          	jal	ra,ffffffffc0204d98 <put_pgdir>
            mm_destroy(mm);
ffffffffc0205b0e:	854a                	mv	a0,s2
ffffffffc0205b10:	f3cfe0ef          	jal	ra,ffffffffc020424c <mm_destroy>
ffffffffc0205b14:	bbb1                	j	ffffffffc0205870 <do_execve+0x92>
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205b16:	0026e693          	ori	a3,a3,2
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205b1a:	8b91                	andi	a5,a5,4
        if (ph->p_flags & ELF_PF_W) vm_flags |= VM_WRITE;
ffffffffc0205b1c:	2681                	sext.w	a3,a3
        if (ph->p_flags & ELF_PF_R) vm_flags |= VM_READ;
ffffffffc0205b1e:	f20790e3          	bnez	a5,ffffffffc0205a3e <do_execve+0x260>
        if (vm_flags & VM_WRITE) perm |= (PTE_W | PTE_R);
ffffffffc0205b22:	47dd                	li	a5,23
ffffffffc0205b24:	e03e                	sd	a5,0(sp)
ffffffffc0205b26:	b71d                	j	ffffffffc0205a4c <do_execve+0x26e>
ffffffffc0205b28:	01043983          	ld	s3,16(s0)
        end = ph->p_va + ph->p_memsz;
ffffffffc0205b2c:	7414                	ld	a3,40(s0)
ffffffffc0205b2e:	99b6                	add	s3,s3,a3
        if (start < la) {
ffffffffc0205b30:	098bf163          	bleu	s8,s7,ffffffffc0205bb2 <do_execve+0x3d4>
            if (start == end) {
ffffffffc0205b34:	df798ae3          	beq	s3,s7,ffffffffc0205928 <do_execve+0x14a>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205b38:	6505                	lui	a0,0x1
ffffffffc0205b3a:	955e                	add	a0,a0,s7
ffffffffc0205b3c:	41850533          	sub	a0,a0,s8
                size -= la - end;
ffffffffc0205b40:	41798ab3          	sub	s5,s3,s7
            if (end < la) {
ffffffffc0205b44:	0d89fb63          	bleu	s8,s3,ffffffffc0205c1a <do_execve+0x43c>
    return page - pages + nbase;
ffffffffc0205b48:	000db683          	ld	a3,0(s11)
ffffffffc0205b4c:	000d3583          	ld	a1,0(s10)
    return KADDR(page2pa(page));
ffffffffc0205b50:	67a2                	ld	a5,8(sp)
    return page - pages + nbase;
ffffffffc0205b52:	40d486b3          	sub	a3,s1,a3
ffffffffc0205b56:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205b58:	000cb603          	ld	a2,0(s9)
    return page - pages + nbase;
ffffffffc0205b5c:	96ae                	add	a3,a3,a1
    return KADDR(page2pa(page));
ffffffffc0205b5e:	00f6f5b3          	and	a1,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205b62:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205b64:	0cc5f463          	bleu	a2,a1,ffffffffc0205c2c <do_execve+0x44e>
ffffffffc0205b68:	000a7617          	auipc	a2,0xa7
ffffffffc0205b6c:	90860613          	addi	a2,a2,-1784 # ffffffffc02ac470 <va_pa_offset>
ffffffffc0205b70:	00063803          	ld	a6,0(a2)
            memset(page2kva(page) + off, 0, size);
ffffffffc0205b74:	4581                	li	a1,0
ffffffffc0205b76:	8656                	mv	a2,s5
ffffffffc0205b78:	96c2                	add	a3,a3,a6
ffffffffc0205b7a:	9536                	add	a0,a0,a3
ffffffffc0205b7c:	26b000ef          	jal	ra,ffffffffc02065e6 <memset>
            start += size;
ffffffffc0205b80:	017a8733          	add	a4,s5,s7
            assert((end < la && start == end) || (end >= la && start == la));
ffffffffc0205b84:	0389f463          	bleu	s8,s3,ffffffffc0205bac <do_execve+0x3ce>
ffffffffc0205b88:	dae980e3          	beq	s3,a4,ffffffffc0205928 <do_execve+0x14a>
ffffffffc0205b8c:	00003697          	auipc	a3,0x3
ffffffffc0205b90:	86468693          	addi	a3,a3,-1948 # ffffffffc02083f0 <default_pmm_manager+0x10a8>
ffffffffc0205b94:	00001617          	auipc	a2,0x1
ffffffffc0205b98:	06c60613          	addi	a2,a2,108 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205b9c:	27400593          	li	a1,628
ffffffffc0205ba0:	00003517          	auipc	a0,0x3
ffffffffc0205ba4:	c8050513          	addi	a0,a0,-896 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205ba8:	8ddfa0ef          	jal	ra,ffffffffc0200484 <__panic>
ffffffffc0205bac:	ff8710e3          	bne	a4,s8,ffffffffc0205b8c <do_execve+0x3ae>
ffffffffc0205bb0:	8be2                	mv	s7,s8
ffffffffc0205bb2:	000a7a97          	auipc	s5,0xa7
ffffffffc0205bb6:	8bea8a93          	addi	s5,s5,-1858 # ffffffffc02ac470 <va_pa_offset>
        while (start < end) {
ffffffffc0205bba:	053be763          	bltu	s7,s3,ffffffffc0205c08 <do_execve+0x42a>
ffffffffc0205bbe:	b3ad                	j	ffffffffc0205928 <do_execve+0x14a>
            off = start - la, size = PGSIZE - off, la += PGSIZE;
ffffffffc0205bc0:	6785                	lui	a5,0x1
ffffffffc0205bc2:	418b8533          	sub	a0,s7,s8
ffffffffc0205bc6:	9c3e                	add	s8,s8,a5
ffffffffc0205bc8:	417c0633          	sub	a2,s8,s7
            if (end < la) {
ffffffffc0205bcc:	0189f463          	bleu	s8,s3,ffffffffc0205bd4 <do_execve+0x3f6>
                size -= la - end;
ffffffffc0205bd0:	41798633          	sub	a2,s3,s7
    return page - pages + nbase;
ffffffffc0205bd4:	000db683          	ld	a3,0(s11)
ffffffffc0205bd8:	000d3803          	ld	a6,0(s10)
    return KADDR(page2pa(page));
...
ffffffffc0205be2:	8699                	srai	a3,a3,0x6
    return KADDR(page2pa(page));
ffffffffc0205be4:	000cb583          	ld	a1,0(s9)
    return page - pages + nbase;
ffffffffc0205be8:	96c2                	add	a3,a3,a6
    return KADDR(page2pa(page));
ffffffffc0205bea:	00f6f833          	and	a6,a3,a5
    return page2ppn(page) << PGSHIFT;
ffffffffc0205bee:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc0205bf0:	02b87e63          	bleu	a1,a6,ffffffffc0205c2c <do_execve+0x44e>
ffffffffc0205bf4:	000ab803          	ld	a6,0(s5)
            start += size;
ffffffffc0205bf8:	9bb2                	add	s7,s7,a2
            memset(page2kva(page) + off, 0, size);
ffffffffc0205bfa:	4581                	li	a1,0
ffffffffc0205bfc:	96c2                	add	a3,a3,a6
ffffffffc0205bfe:	9536                	add	a0,a0,a3
ffffffffc0205c00:	1e7000ef          	jal	ra,ffffffffc02065e6 <memset>
        while (start < end) {
ffffffffc0205c04:	d33bf2e3          	bleu	s3,s7,ffffffffc0205928 <do_execve+0x14a>
            if ((page = pgdir_alloc_page(mm->pgdir, la, perm)) == NULL) {
ffffffffc0205c08:	01893503          	ld	a0,24(s2)
ffffffffc0205c0c:	6602                	ld	a2,0(sp)
ffffffffc0205c0e:	85e2                	mv	a1,s8
ffffffffc0205c10:	ee8fd0ef          	jal	ra,ffffffffc02032f8 <pgdir_alloc_page>
ffffffffc0205c14:	84aa                	mv	s1,a0
ffffffffc0205c16:	f54d                	bnez	a0,ffffffffc0205bc0 <do_execve+0x3e2>
ffffffffc0205c18:	bdd1                	j	ffffffffc0205aec <do_execve+0x30e>
            off = start + PGSIZE - la, size = PGSIZE - off;
ffffffffc0205c1a:	417c0ab3          	sub	s5,s8,s7
ffffffffc0205c1e:	b72d                	j	ffffffffc0205b48 <do_execve+0x36a>
        while (start < end) {
ffffffffc0205c20:	89de                	mv	s3,s7
ffffffffc0205c22:	b729                	j	ffffffffc0205b2c <do_execve+0x34e>
        return -E_INVAL;
ffffffffc0205c24:	59f5                	li	s3,-3
ffffffffc0205c26:	bbe1                	j	ffffffffc02059fe <do_execve+0x220>
            ret = -E_INVAL_ELF;
ffffffffc0205c28:	59e1                	li	s3,-8
ffffffffc0205c2a:	b5d1                	j	ffffffffc0205aee <do_execve+0x310>
ffffffffc0205c2c:	00001617          	auipc	a2,0x1
ffffffffc0205c30:	76c60613          	addi	a2,a2,1900 # ffffffffc0207398 <default_pmm_manager+0x50>
ffffffffc0205c34:	06900593          	li	a1,105
ffffffffc0205c38:	00001517          	auipc	a0,0x1
ffffffffc0205c3c:	78850513          	addi	a0,a0,1928 # ffffffffc02073c0 <default_pmm_manager+0x78>
ffffffffc0205c40:	845fa0ef          	jal	ra,ffffffffc0200484 <__panic>
    current->cr3 = PADDR(mm->pgdir);
ffffffffc0205c44:	00001617          	auipc	a2,0x1
ffffffffc0205c48:	78c60613          	addi	a2,a2,1932 # ffffffffc02073d0 <default_pmm_manager+0x88>
ffffffffc0205c4c:	28f00593          	li	a1,655
ffffffffc0205c50:	00003517          	auipc	a0,0x3
ffffffffc0205c54:	bd050513          	addi	a0,a0,-1072 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205c58:	82dfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-4*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c5c:	00003697          	auipc	a3,0x3
ffffffffc0205c60:	8ac68693          	addi	a3,a3,-1876 # ffffffffc0208508 <default_pmm_manager+0x11c0>
ffffffffc0205c64:	00001617          	auipc	a2,0x1
ffffffffc0205c68:	f9c60613          	addi	a2,a2,-100 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205c6c:	28a00593          	li	a1,650
ffffffffc0205c70:	00003517          	auipc	a0,0x3
ffffffffc0205c74:	bb050513          	addi	a0,a0,-1104 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205c78:	80dfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-3*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c7c:	00003697          	auipc	a3,0x3
ffffffffc0205c80:	84468693          	addi	a3,a3,-1980 # ffffffffc02084c0 <default_pmm_manager+0x1178>
ffffffffc0205c84:	00001617          	auipc	a2,0x1
ffffffffc0205c88:	f7c60613          	addi	a2,a2,-132 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205c8c:	28900593          	li	a1,649
ffffffffc0205c90:	00003517          	auipc	a0,0x3
ffffffffc0205c94:	b9050513          	addi	a0,a0,-1136 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205c98:	fecfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-2*PGSIZE , PTE_USER) != NULL);
ffffffffc0205c9c:	00002697          	auipc	a3,0x2
ffffffffc0205ca0:	7dc68693          	addi	a3,a3,2012 # ffffffffc0208478 <default_pmm_manager+0x1130>
ffffffffc0205ca4:	00001617          	auipc	a2,0x1
ffffffffc0205ca8:	f5c60613          	addi	a2,a2,-164 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205cac:	28800593          	li	a1,648
ffffffffc0205cb0:	00003517          	auipc	a0,0x3
ffffffffc0205cb4:	b7050513          	addi	a0,a0,-1168 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205cb8:	fccfa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(pgdir_alloc_page(mm->pgdir, USTACKTOP-PGSIZE , PTE_USER) != NULL);
ffffffffc0205cbc:	00002697          	auipc	a3,0x2
ffffffffc0205cc0:	77468693          	addi	a3,a3,1908 # ffffffffc0208430 <default_pmm_manager+0x10e8>
ffffffffc0205cc4:	00001617          	auipc	a2,0x1
ffffffffc0205cc8:	f3c60613          	addi	a2,a2,-196 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205ccc:	28700593          	li	a1,647
ffffffffc0205cd0:	00003517          	auipc	a0,0x3
ffffffffc0205cd4:	b5050513          	addi	a0,a0,-1200 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205cd8:	facfa0ef          	jal	ra,ffffffffc0200484 <__panic>

ffffffffc0205cdc <do_yield>:
    current->need_resched = 1;
ffffffffc0205cdc:	000a6797          	auipc	a5,0xa6
ffffffffc0205ce0:	74c78793          	addi	a5,a5,1868 # ffffffffc02ac428 <current>
ffffffffc0205ce4:	639c                	ld	a5,0(a5)
ffffffffc0205ce6:	4705                	li	a4,1
}
ffffffffc0205ce8:	4501                	li	a0,0
    current->need_resched = 1;
ffffffffc0205cea:	ef98                	sd	a4,24(a5)
}
ffffffffc0205cec:	8082                	ret

ffffffffc0205cee <do_wait>:
do_wait(int pid, int *code_store) {
ffffffffc0205cee:	1101                	addi	sp,sp,-32
ffffffffc0205cf0:	e822                	sd	s0,16(sp)
ffffffffc0205cf2:	e426                	sd	s1,8(sp)
ffffffffc0205cf4:	ec06                	sd	ra,24(sp)
ffffffffc0205cf6:	842e                	mv	s0,a1
ffffffffc0205cf8:	84aa                	mv	s1,a0
    if (code_store != NULL) {
ffffffffc0205cfa:	cd81                	beqz	a1,ffffffffc0205d12 <do_wait+0x24>
    struct mm_struct *mm = current->mm;
ffffffffc0205cfc:	000a6797          	auipc	a5,0xa6
ffffffffc0205d00:	72c78793          	addi	a5,a5,1836 # ffffffffc02ac428 <current>
ffffffffc0205d04:	639c                	ld	a5,0(a5)
        if (!user_mem_check(mm, (uintptr_t)code_store, sizeof(int), 1)) {
ffffffffc0205d06:	4685                	li	a3,1
ffffffffc0205d08:	4611                	li	a2,4
ffffffffc0205d0a:	7788                	ld	a0,40(a5)
ffffffffc0205d0c:	d83fe0ef          	jal	ra,ffffffffc0204a8e <user_mem_check>
ffffffffc0205d10:	c909                	beqz	a0,ffffffffc0205d22 <do_wait+0x34>
ffffffffc0205d12:	85a2                	mv	a1,s0
}
ffffffffc0205d14:	6442                	ld	s0,16(sp)
...
ffffffffc0205d1e:	ff0ff06f          	j	ffffffffc020550e <do_wait.part.1>
ffffffffc0205d22:	60e2                	ld	ra,24(sp)
ffffffffc0205d24:	6442                	ld	s0,16(sp)
ffffffffc0205d26:	64a2                	ld	s1,8(sp)
ffffffffc0205d28:	5575                	li	a0,-3
ffffffffc0205d2a:	6105                	addi	sp,sp,32
ffffffffc0205d2c:	8082                	ret

ffffffffc0205d2e <do_kill>:
do_kill(int pid) {
ffffffffc0205d2e:	1141                	addi	sp,sp,-16
ffffffffc0205d30:	e406                	sd	ra,8(sp)
ffffffffc0205d32:	e022                	sd	s0,0(sp)
    if ((proc = find_proc(pid)) != NULL) {
ffffffffc0205d34:	a04ff0ef          	jal	ra,ffffffffc0204f38 <find_proc>
ffffffffc0205d38:	cd0d                	beqz	a0,ffffffffc0205d72 <do_kill+0x44>
        if (!(proc->flags & PF_EXITING)) {
ffffffffc0205d3a:	0b052703          	lw	a4,176(a0)
ffffffffc0205d3e:	00177693          	andi	a3,a4,1
ffffffffc0205d42:	e695                	bnez	a3,ffffffffc0205d6e <do_kill+0x40>
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d44:	0ec52683          	lw	a3,236(a0)
            proc->flags |= PF_EXITING;
ffffffffc0205d48:	00176713          	ori	a4,a4,1
ffffffffc0205d4c:	0ae52823          	sw	a4,176(a0)
            return 0;
ffffffffc0205d50:	4401                	li	s0,0
            if (proc->wait_state & WT_INTERRUPTED) {
ffffffffc0205d52:	0006c763          	bltz	a3,ffffffffc0205d60 <do_kill+0x32>
}
ffffffffc0205d56:	8522                	mv	a0,s0
ffffffffc0205d58:	60a2                	ld	ra,8(sp)
ffffffffc0205d5a:	6402                	ld	s0,0(sp)
ffffffffc0205d5c:	0141                	addi	sp,sp,16
ffffffffc0205d5e:	8082                	ret
                wakeup_proc(proc);
ffffffffc0205d60:	1e6000ef          	jal	ra,ffffffffc0205f46 <wakeup_proc>
}
...
ffffffffc0205d6c:	8082                	ret
        return -E_KILLED;
ffffffffc0205d6e:	545d                	li	s0,-9
ffffffffc0205d70:	b7dd                	j	ffffffffc0205d56 <do_kill+0x28>
    return -E_INVAL;
ffffffffc0205d72:	5475                	li	s0,-3
ffffffffc0205d74:	b7cd                	j	ffffffffc0205d56 <do_kill+0x28>

ffffffffc0205d76 <proc_init>:
    elm->prev = elm->next = elm;
ffffffffc0205d76:	000a6797          	auipc	a5,0xa6
ffffffffc0205d7a:	7f278793          	addi	a5,a5,2034 # ffffffffc02ac568 <proc_list>

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0205d7e:	1101                	addi	sp,sp,-32
ffffffffc0205d80:	000a6717          	auipc	a4,0xa6
ffffffffc0205d84:	7ef73823          	sd	a5,2032(a4) # ffffffffc02ac570 <proc_list+0x8>
ffffffffc0205d88:	000a6717          	auipc	a4,0xa6
ffffffffc0205d8c:	7ef73023          	sd	a5,2016(a4) # ffffffffc02ac568 <proc_list>
ffffffffc0205d90:	ec06                	sd	ra,24(sp)
ffffffffc0205d92:	e822                	sd	s0,16(sp)
ffffffffc0205d94:	e426                	sd	s1,8(sp)
ffffffffc0205d96:	000a2797          	auipc	a5,0xa2
ffffffffc0205d9a:	65a78793          	addi	a5,a5,1626 # ffffffffc02a83f0 <hash_list>
ffffffffc0205d9e:	000a6717          	auipc	a4,0xa6
ffffffffc0205da2:	65270713          	addi	a4,a4,1618 # ffffffffc02ac3f0 <is_panic>
ffffffffc0205da6:	e79c                	sd	a5,8(a5)
ffffffffc0205da8:	e39c                	sd	a5,0(a5)
ffffffffc0205daa:	07c1                	addi	a5,a5,16
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0205dac:	fee79de3          	bne	a5,a4,ffffffffc0205da6 <proc_init+0x30>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0205db0:	ee3fe0ef          	jal	ra,ffffffffc0204c92 <alloc_proc>
ffffffffc0205db4:	000a6717          	auipc	a4,0xa6
ffffffffc0205db8:	66a73e23          	sd	a0,1660(a4) # ffffffffc02ac430 <idleproc>
ffffffffc0205dbc:	000a6497          	auipc	s1,0xa6
ffffffffc0205dc0:	67448493          	addi	s1,s1,1652 # ffffffffc02ac430 <idleproc>
ffffffffc0205dc4:	c559                	beqz	a0,ffffffffc0205e52 <proc_init+0xdc>
        panic("cannot alloc idleproc.\n");
    }

    idleproc->pid = 0;
    idleproc->state = PROC_RUNNABLE;
ffffffffc0205dc6:	4709                	li	a4,2
ffffffffc0205dc8:	e118                	sd	a4,0(a0)
    idleproc->kstack = (uintptr_t)bootstack;
    idleproc->need_resched = 1;
ffffffffc0205dca:	4405                	li	s0,1
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205dcc:	00003717          	auipc	a4,0x3
ffffffffc0205dd0:	23470713          	addi	a4,a4,564 # ffffffffc0209000 <bootstack>
    set_proc_name(idleproc, "idle");
ffffffffc0205dd4:	00003597          	auipc	a1,0x3
ffffffffc0205dd8:	96458593          	addi	a1,a1,-1692 # ffffffffc0208738 <default_pmm_manager+0x13f0>
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc0205ddc:	e918                	sd	a4,16(a0)
    idleproc->need_resched = 1;
ffffffffc0205dde:	ed00                	sd	s0,24(a0)
    set_proc_name(idleproc, "idle");
ffffffffc0205de0:	8c2ff0ef          	jal	ra,ffffffffc0204ea2 <set_proc_name>
    nr_process ++;
ffffffffc0205de4:	000a6797          	auipc	a5,0xa6
ffffffffc0205de8:	65c78793          	addi	a5,a5,1628 # ffffffffc02ac440 <nr_process>
ffffffffc0205dec:	439c                	lw	a5,0(a5)

    current = idleproc;
ffffffffc0205dee:	6098                	ld	a4,0(s1)

    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205df0:	4601                	li	a2,0
    nr_process ++;
ffffffffc0205df2:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205df4:	4581                	li	a1,0
ffffffffc0205df6:	00000517          	auipc	a0,0x0
ffffffffc0205dfa:	8c050513          	addi	a0,a0,-1856 # ffffffffc02056b6 <init_main>
    nr_process ++;
ffffffffc0205dfe:	000a6697          	auipc	a3,0xa6
ffffffffc0205e02:	64f6a123          	sw	a5,1602(a3) # ffffffffc02ac440 <nr_process>
    current = idleproc;
ffffffffc0205e06:	000a6797          	auipc	a5,0xa6
ffffffffc0205e0a:	62e7b123          	sd	a4,1570(a5) # ffffffffc02ac428 <current>
    int pid = kernel_thread(init_main, NULL, 0);
ffffffffc0205e0e:	d62ff0ef          	jal	ra,ffffffffc0205370 <kernel_thread>
    if (pid <= 0) {
ffffffffc0205e12:	08a05c63          	blez	a0,ffffffffc0205eaa <proc_init+0x134>
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc0205e16:	922ff0ef          	jal	ra,ffffffffc0204f38 <find_proc>
    set_proc_name(initproc, "init");
ffffffffc0205e1a:	00003597          	auipc	a1,0x3
ffffffffc0205e1e:	94658593          	addi	a1,a1,-1722 # ffffffffc0208760 <default_pmm_manager+0x1418>
    initproc = find_proc(pid);
ffffffffc0205e22:	000a6797          	auipc	a5,0xa6
ffffffffc0205e26:	60a7bb23          	sd	a0,1558(a5) # ffffffffc02ac438 <initproc>
    set_proc_name(initproc, "init");
ffffffffc0205e2a:	878ff0ef          	jal	ra,ffffffffc0204ea2 <set_proc_name>

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e2e:	609c                	ld	a5,0(s1)
ffffffffc0205e30:	cfa9                	beqz	a5,ffffffffc0205e8a <proc_init+0x114>
ffffffffc0205e32:	43dc                	lw	a5,4(a5)
ffffffffc0205e34:	ebb9                	bnez	a5,ffffffffc0205e8a <proc_init+0x114>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e36:	000a6797          	auipc	a5,0xa6
ffffffffc0205e3a:	60278793          	addi	a5,a5,1538 # ffffffffc02ac438 <initproc>
ffffffffc0205e3e:	639c                	ld	a5,0(a5)
ffffffffc0205e40:	c78d                	beqz	a5,ffffffffc0205e6a <proc_init+0xf4>
ffffffffc0205e42:	43dc                	lw	a5,4(a5)
ffffffffc0205e44:	02879363          	bne	a5,s0,ffffffffc0205e6a <proc_init+0xf4>
}
ffffffffc0205e48:	60e2                	ld	ra,24(sp)
ffffffffc0205e4a:	6442                	ld	s0,16(sp)
ffffffffc0205e4c:	64a2                	ld	s1,8(sp)
ffffffffc0205e4e:	6105                	addi	sp,sp,32
ffffffffc0205e50:	8082                	ret
        panic("cannot alloc idleproc.\n");
ffffffffc0205e52:	00003617          	auipc	a2,0x3
ffffffffc0205e56:	8ce60613          	addi	a2,a2,-1842 # ffffffffc0208720 <default_pmm_manager+0x13d8>
ffffffffc0205e5a:	38a00593          	li	a1,906
ffffffffc0205e5e:	00003517          	auipc	a0,0x3
ffffffffc0205e62:	9c250513          	addi	a0,a0,-1598 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205e66:	e1efa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0205e6a:	00003697          	auipc	a3,0x3
ffffffffc0205e6e:	92668693          	addi	a3,a3,-1754 # ffffffffc0208790 <default_pmm_manager+0x1448>
ffffffffc0205e72:	00001617          	auipc	a2,0x1
ffffffffc0205e76:	d8e60613          	addi	a2,a2,-626 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205e7a:	39f00593          	li	a1,927
ffffffffc0205e7e:	00003517          	auipc	a0,0x3
ffffffffc0205e82:	9a250513          	addi	a0,a0,-1630 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205e86:	dfefa0ef          	jal	ra,ffffffffc0200484 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0205e8a:	00003697          	auipc	a3,0x3
ffffffffc0205e8e:	8de68693          	addi	a3,a3,-1826 # ffffffffc0208768 <default_pmm_manager+0x1420>
ffffffffc0205e92:	00001617          	auipc	a2,0x1
ffffffffc0205e96:	d6e60613          	addi	a2,a2,-658 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205e9a:	39e00593          	li	a1,926
ffffffffc0205e9e:	00003517          	auipc	a0,0x3
ffffffffc0205ea2:	98250513          	addi	a0,a0,-1662 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205ea6:	ddefa0ef          	jal	ra,ffffffffc0200484 <__panic>
        panic("create init_main failed.\n");
ffffffffc0205eaa:	00003617          	auipc	a2,0x3
ffffffffc0205eae:	89660613          	addi	a2,a2,-1898 # ffffffffc0208740 <default_pmm_manager+0x13f8>
ffffffffc0205eb2:	39800593          	li	a1,920
ffffffffc0205eb6:	00003517          	auipc	a0,0x3
ffffffffc0205eba:	96a50513          	addi	a0,a0,-1686 # ffffffffc0208820 <default_pmm_manager+0x14d8>
ffffffffc0205ebe:	dc6fa0ef          	jal	ra,ffffffffc0200484 <__panic>

ffffffffc0205ec2 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0205ec2:	1141                	addi	sp,sp,-16
ffffffffc0205ec4:	e022                	sd	s0,0(sp)
ffffffffc0205ec6:	e406                	sd	ra,8(sp)
ffffffffc0205ec8:	000a6417          	auipc	s0,0xa6
ffffffffc0205ecc:	56040413          	addi	s0,s0,1376 # ffffffffc02ac428 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc0205ed0:	6018                	ld	a4,0(s0)
ffffffffc0205ed2:	6f1c                	ld	a5,24(a4)
ffffffffc0205ed4:	dffd                	beqz	a5,ffffffffc0205ed2 <cpu_idle+0x10>
            schedule();
ffffffffc0205ed6:	0ec000ef          	jal	ra,ffffffffc0205fc2 <schedule>
ffffffffc0205eda:	bfdd                	j	ffffffffc0205ed0 <cpu_idle+0xe>

ffffffffc0205edc <switch_to>:
.text
...
ffffffffc0205edc:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc0205ee0:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0205ee4:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0205ee6:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0205ee8:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc0205eec:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc0205ef0:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0205ef4:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0205ef8:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc0205efc:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc0205f00:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0205f04:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0205f08:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc0205f0c:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc0205f10:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0205f14:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0205f18:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0205f1a:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc0205f1c:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc0205f20:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0205f24:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0205f28:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc0205f2c:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc0205f30:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0205f34:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0205f38:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc0205f3c:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc0205f40:	0685bd83          	ld	s11,104(a1)
...
ffffffffc0205f78:	6105                	addi	sp,sp,32
        intr_enable();
ffffffffc0205f7a:	edafa06f          	j	ffffffffc0200654 <intr_enable>
            warn("wakeup runnable process.\n");
ffffffffc0205f7e:	00003617          	auipc	a2,0x3
ffffffffc0205f82:	8f260613          	addi	a2,a2,-1806 # ffffffffc0208870 <default_pmm_manager+0x1528>
ffffffffc0205f86:	45c9                	li	a1,18
ffffffffc0205f88:	00003517          	auipc	a0,0x3
ffffffffc0205f8c:	8d050513          	addi	a0,a0,-1840 # ffffffffc0208858 <default_pmm_manager+0x1510>
ffffffffc0205f90:	d60fa0ef          	jal	ra,ffffffffc02004f0 <__warn>
ffffffffc0205f94:	bfd9                	j	ffffffffc0205f6a <wakeup_proc+0x24>
ffffffffc0205f96:	e42a                	sd	a0,8(sp)
        intr_disable();
ffffffffc0205f98:	ec2fa0ef          	jal	ra,ffffffffc020065a <intr_disable>
        return 1;
...
ffffffffc0205fa8:	89468693          	addi	a3,a3,-1900 # ffffffffc0208838 <default_pmm_manager+0x14f0>
ffffffffc0205fac:	00001617          	auipc	a2,0x1
ffffffffc0205fb0:	c5460613          	addi	a2,a2,-940 # ffffffffc0206c00 <commands+0x4c0>
ffffffffc0205fb4:	45a5                	li	a1,9
ffffffffc0205fb6:	00003517          	auipc	a0,0x3
ffffffffc0205fba:	8a250513          	addi	a0,a0,-1886 # ffffffffc0208858 <default_pmm_manager+0x1510>
ffffffffc0205fbe:	cc6fa0ef          	jal	ra,ffffffffc0200484 <__panic>
...
ffffffffc0205fd6:	45678793          	addi	a5,a5,1110 # ffffffffc02ac428 <current>
ffffffffc0205fda:	0007b883          	ld	a7,0(a5)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0205fde:	000a6797          	auipc	a5,0xa6
ffffffffc0205fe2:	45278793          	addi	a5,a5,1106 # ffffffffc02ac430 <idleproc>
ffffffffc0205fe6:	6388                	ld	a0,0(a5)
        current->need_resched = 0;
ffffffffc0205fe8:	0008bc23          	sd	zero,24(a7) # 2018 <_binary_obj___user_faultread_out_size-0x7550>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
...
ffffffffc0205ff8:	57460613          	addi	a2,a2,1396 # ffffffffc02ac568 <proc_list>
        le = last;
...
ffffffffc0206028:	00a88463          	beq	a7,a0,ffffffffc0206030 <schedule+0x6e>
            proc_run(next);
ffffffffc020602c:	ea1fe0ef          	jal	ra,ffffffffc0204ecc <proc_run>
    if (flag) {
...
ffffffffc0206042:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0206044:	e10fa06f          	j	ffffffffc0200654 <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0206048:	000a6617          	auipc	a2,0xa6
ffffffffc020604c:	52060613          	addi	a2,a2,1312 # ffffffffc02ac568 <proc_list>
ffffffffc0206050:	86b2                	mv	a3,a2
ffffffffc0206052:	b76d                	j	ffffffffc0205ffc <schedule+0x3a>
        intr_disable();
ffffffffc0206054:	e06fa0ef          	jal	ra,ffffffffc020065a <intr_disable>
        return 1;
...
ffffffffc0206060:	3cc78793          	addi	a5,a5,972 # ffffffffc02ac428 <current>
...
ffffffffc0206072:	e406                	sd	ra,8(sp)
    cputchar(c);
ffffffffc0206074:	94efa0ef          	jal	ra,ffffffffc02001c2 <cputchar>
}
...
ffffffffc0206082:	cadff06f          	j	ffffffffc0205d2e <do_kill>

ffffffffc0206086 <sys_yield>:
    return do_yield();
ffffffffc0206086:	c57ff06f          	j	ffffffffc0205cdc <do_yield>
...
ffffffffc0206092:	f4cff06f          	j	ffffffffc02057de <do_execve>

ffffffffc0206096 <sys_wait>:
    return do_wait(pid, store);
ffffffffc0206096:	650c                	ld	a1,8(a0)
ffffffffc0206098:	4108                	lw	a0,0(a0)
ffffffffc020609a:	c55ff06f          	j	ffffffffc0205cee <do_wait>

ffffffffc020609e <sys_fork>:
    struct trapframe *tf = current->tf;
ffffffffc020609e:	000a6797          	auipc	a5,0xa6
ffffffffc02060a2:	38a78793          	addi	a5,a5,906 # ffffffffc02ac428 <current>
...
ffffffffc02060ae:	ee7fe06f          	j	ffffffffc0204f94 <do_fork>

ffffffffc02060b2 <sys_exit>:
    return do_exit(error_code);
ffffffffc02060b2:	4108                	lw	a0,0(a0)
ffffffffc02060b4:	b0cff06f          	j	ffffffffc02053c0 <do_exit>
...
ffffffffc02060c0:	36c48493          	addi	s1,s1,876 # ffffffffc02ac428 <current>
...
ffffffffc020611e:	77660613          	addi	a2,a2,1910 # ffffffffc0208890 <default_pmm_manager+0x1548>
...
ffffffffc0206130:	79450513          	addi	a0,a0,1940 # ffffffffc02088c0 <default_pmm_manager+0x1578>
ffffffffc0206134:	b50fa0ef          	jal	ra,ffffffffc0200484 <__panic>

ffffffffc0206138 <hash32>:
 *
...
ffffffffc0206138:	9e3707b7          	lui	a5,0x9e370
ffffffffc020613c:	2785                	addiw	a5,a5,1
ffffffffc020613e:	02f5053b          	mulw	a0,a0,a5
    return (hash >> (32 - bits));
ffffffffc0206142:	02000793          	li	a5,32
ffffffffc0206146:	40b785bb          	subw	a1,a5,a1
}
ffffffffc020614a:	00b5553b          	srlw	a0,a0,a1
ffffffffc020614e:	8082                	ret

ffffffffc0206150 <printnum>:
 * */
static void
...
ffffffffc0206150:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206154:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0206156:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc020615a:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc020615c:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0206160:	f022                	sd	s0,32(sp)
ffffffffc0206162:	ec26                	sd	s1,24(sp)
ffffffffc0206164:	e84a                	sd	s2,16(sp)
ffffffffc0206166:	f406                	sd	ra,40(sp)
ffffffffc0206168:	e44e                	sd	s3,8(sp)
ffffffffc020616a:	84aa                	mv	s1,a0
ffffffffc020616c:	892e                	mv	s2,a1
ffffffffc020616e:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0206172:	2a01                	sext.w	s4,s4

    // first recursively print all preceding (more significant) digits
    if (num >= base) {
ffffffffc0206174:	03067e63          	bleu	a6,a2,ffffffffc02061b0 <printnum+0x60>
ffffffffc0206178:	89be                	mv	s3,a5
        printnum(putch, putdat, result, base, width - 1, padc);
    } else {
        // print any needed pad characters before first digit
        while (-- width > 0)
ffffffffc020617a:	00805763          	blez	s0,ffffffffc0206188 <printnum+0x38>
ffffffffc020617e:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0206180:	85ca                	mv	a1,s2
ffffffffc0206182:	854e                	mv	a0,s3
ffffffffc0206184:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0206186:	fc65                	bnez	s0,ffffffffc020617e <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0206188:	1a02                	slli	s4,s4,0x20
ffffffffc020618a:	020a5a13          	srli	s4,s4,0x20
ffffffffc020618e:	00003797          	auipc	a5,0x3
ffffffffc0206192:	a6a78793          	addi	a5,a5,-1430 # ffffffffc0208bf8 <error_string+0xc8>
ffffffffc0206196:	9a3e                	add	s4,s4,a5
...
ffffffffc0206198:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc020619a:	000a4503          	lbu	a0,0(s4)
}
ffffffffc020619e:	70a2                	ld	ra,40(sp)
ffffffffc02061a0:	69a2                	ld	s3,8(sp)
ffffffffc02061a2:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02061a4:	85ca                	mv	a1,s2
ffffffffc02061a6:	8326                	mv	t1,s1
}
ffffffffc02061a8:	6942                	ld	s2,16(sp)
ffffffffc02061aa:	64e2                	ld	s1,24(sp)
ffffffffc02061ac:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02061ae:	8302                	jr	t1
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc02061b0:	03065633          	divu	a2,a2,a6
ffffffffc02061b4:	8722                	mv	a4,s0
ffffffffc02061b6:	f9bff0ef          	jal	ra,ffffffffc0206150 <printnum>
ffffffffc02061ba:	b7f9                	j	ffffffffc0206188 <printnum+0x38>

ffffffffc02061bc <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc02061bc:	7119                	addi	sp,sp,-128
ffffffffc02061be:	f4a6                	sd	s1,104(sp)
ffffffffc02061c0:	f0ca                	sd	s2,96(sp)
ffffffffc02061c2:	e8d2                	sd	s4,80(sp)
ffffffffc02061c4:	e4d6                	sd	s5,72(sp)
ffffffffc02061c6:	e0da                	sd	s6,64(sp)
ffffffffc02061c8:	fc5e                	sd	s7,56(sp)
ffffffffc02061ca:	f862                	sd	s8,48(sp)
ffffffffc02061cc:	f06a                	sd	s10,32(sp)
ffffffffc02061ce:	fc86                	sd	ra,120(sp)
ffffffffc02061d0:	f8a2                	sd	s0,112(sp)
ffffffffc02061d2:	ecce                	sd	s3,88(sp)
ffffffffc02061d4:	f466                	sd	s9,40(sp)
ffffffffc02061d6:	ec6e                	sd	s11,24(sp)
ffffffffc02061d8:	892a                	mv	s2,a0
ffffffffc02061da:	84ae                	mv	s1,a1
ffffffffc02061dc:	8d32                	mv	s10,a2
ffffffffc02061de:	8ab6                	mv	s5,a3
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc02061e0:	5b7d                	li	s6,-1
        lflag = altflag = 0;

    reswitch:
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02061e2:	00002a17          	auipc	s4,0x2
ffffffffc02061e6:	7f6a0a13          	addi	s4,s4,2038 # ffffffffc02089d8 <syscalls+0x100>
            ...
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc02061ea:	05e00b93          	li	s7,94
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02061ee:	00003c17          	auipc	s8,0x3
ffffffffc02061f2:	942c0c13          	addi	s8,s8,-1726 # ffffffffc0208b30 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc02061f6:	000d4503          	lbu	a0,0(s10)
ffffffffc02061fa:	02500793          	li	a5,37
ffffffffc02061fe:	001d0413          	addi	s0,s10,1
ffffffffc0206202:	00f50e63          	beq	a0,a5,ffffffffc020621e <vprintfmt+0x62>
            if (ch == '\0') {
ffffffffc0206206:	c521                	beqz	a0,ffffffffc020624e <vprintfmt+0x92>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0206208:	02500993          	li	s3,37
ffffffffc020620c:	a011                	j	ffffffffc0206210 <vprintfmt+0x54>
            if (ch == '\0') {
ffffffffc020620e:	c121                	beqz	a0,ffffffffc020624e <vprintfmt+0x92>
            putch(ch, putdat);
ffffffffc0206210:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0206212:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0206214:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0206216:	fff44503          	lbu	a0,-1(s0)
ffffffffc020621a:	ff351ae3          	bne	a0,s3,ffffffffc020620e <vprintfmt+0x52>
ffffffffc020621e:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0206222:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0206226:	4981                	li	s3,0
ffffffffc0206228:	4801                	li	a6,0
        width = precision = -1;
ffffffffc020622a:	5cfd                	li	s9,-1
ffffffffc020622c:	5dfd                	li	s11,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020622e:	05500593          	li	a1,85
                if (ch < '0' || ch > '9') {
ffffffffc0206232:	4525                	li	a0,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206234:	fdd6069b          	addiw	a3,a2,-35
ffffffffc0206238:	0ff6f693          	andi	a3,a3,255
ffffffffc020623c:	00140d13          	addi	s10,s0,1
ffffffffc0206240:	20d5e563          	bltu	a1,a3,ffffffffc020644a <vprintfmt+0x28e>
ffffffffc0206244:	068a                	slli	a3,a3,0x2
ffffffffc0206246:	96d2                	add	a3,a3,s4
ffffffffc0206248:	4294                	lw	a3,0(a3)
ffffffffc020624a:	96d2                	add	a3,a3,s4
ffffffffc020624c:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc020624e:	70e6                	ld	ra,120(sp)
ffffffffc0206250:	7446                	ld	s0,112(sp)
ffffffffc0206252:	74a6                	ld	s1,104(sp)
ffffffffc0206254:	7906                	ld	s2,96(sp)
ffffffffc0206256:	69e6                	ld	s3,88(sp)
ffffffffc0206258:	6a46                	ld	s4,80(sp)
ffffffffc020625a:	6aa6                	ld	s5,72(sp)
ffffffffc020625c:	6b06                	ld	s6,64(sp)
ffffffffc020625e:	7be2                	ld	s7,56(sp)
ffffffffc0206260:	7c42                	ld	s8,48(sp)
ffffffffc0206262:	7ca2                	ld	s9,40(sp)
ffffffffc0206264:	7d02                	ld	s10,32(sp)
ffffffffc0206266:	6de2                	ld	s11,24(sp)
ffffffffc0206268:	6109                	addi	sp,sp,128
ffffffffc020626a:	8082                	ret
    if (lflag >= 2) {
ffffffffc020626c:	4705                	li	a4,1
ffffffffc020626e:	008a8593          	addi	a1,s5,8
ffffffffc0206272:	01074463          	blt	a4,a6,ffffffffc020627a <vprintfmt+0xbe>
    else if (lflag) {
ffffffffc0206276:	26080363          	beqz	a6,ffffffffc02064dc <vprintfmt+0x320>
        return va_arg(*ap, unsigned long);
ffffffffc020627a:	000ab603          	ld	a2,0(s5)
ffffffffc020627e:	46c1                	li	a3,16
ffffffffc0206280:	8aae                	mv	s5,a1
ffffffffc0206282:	a06d                	j	ffffffffc020632c <vprintfmt+0x170>
            goto reswitch;
ffffffffc0206284:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0206288:	4985                	li	s3,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc020628a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc020628c:	b765                	j	ffffffffc0206234 <vprintfmt+0x78>
            putch(va_arg(ap, int), putdat);
ffffffffc020628e:	000aa503          	lw	a0,0(s5)
ffffffffc0206292:	85a6                	mv	a1,s1
ffffffffc0206294:	0aa1                	addi	s5,s5,8
ffffffffc0206296:	9902                	jalr	s2
            break;
ffffffffc0206298:	bfb9                	j	ffffffffc02061f6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc020629a:	4705                	li	a4,1
ffffffffc020629c:	008a8993          	addi	s3,s5,8
ffffffffc02062a0:	01074463          	blt	a4,a6,ffffffffc02062a8 <vprintfmt+0xec>
    else if (lflag) {
ffffffffc02062a4:	22080463          	beqz	a6,ffffffffc02064cc <vprintfmt+0x310>
        return va_arg(*ap, long);
ffffffffc02062a8:	000ab403          	ld	s0,0(s5)
            if ((long long)num < 0) {
ffffffffc02062ac:	24044463          	bltz	s0,ffffffffc02064f4 <vprintfmt+0x338>
            num = getint(&ap, lflag);
ffffffffc02062b0:	8622                	mv	a2,s0
ffffffffc02062b2:	8ace                	mv	s5,s3
ffffffffc02062b4:	46a9                	li	a3,10
ffffffffc02062b6:	a89d                	j	ffffffffc020632c <vprintfmt+0x170>
            err = va_arg(ap, int);
ffffffffc02062b8:	000aa783          	lw	a5,0(s5)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02062bc:	4761                	li	a4,24
            err = va_arg(ap, int);
ffffffffc02062be:	0aa1                	addi	s5,s5,8
            if (err < 0) {
ffffffffc02062c0:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc02062c4:	8fb5                	xor	a5,a5,a3
ffffffffc02062c6:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc02062ca:	1ad74363          	blt	a4,a3,ffffffffc0206470 <vprintfmt+0x2b4>
ffffffffc02062ce:	00369793          	slli	a5,a3,0x3
ffffffffc02062d2:	97e2                	add	a5,a5,s8
ffffffffc02062d4:	639c                	ld	a5,0(a5)
ffffffffc02062d6:	18078d63          	beqz	a5,ffffffffc0206470 <vprintfmt+0x2b4>
                printfmt(putch, putdat, "%s", p);
ffffffffc02062da:	86be                	mv	a3,a5
ffffffffc02062dc:	00000617          	auipc	a2,0x0
ffffffffc02062e0:	35c60613          	addi	a2,a2,860 # ffffffffc0206638 <etext+0x28>
ffffffffc02062e4:	85a6                	mv	a1,s1
ffffffffc02062e6:	854a                	mv	a0,s2
ffffffffc02062e8:	240000ef          	jal	ra,ffffffffc0206528 <printfmt>
ffffffffc02062ec:	b729                	j	ffffffffc02061f6 <vprintfmt+0x3a>
            lflag ++;
ffffffffc02062ee:	00144603          	lbu	a2,1(s0)
ffffffffc02062f2:	2805                	addiw	a6,a6,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02062f4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02062f6:	bf3d                	j	ffffffffc0206234 <vprintfmt+0x78>
    if (lflag >= 2) {
ffffffffc02062f8:	4705                	li	a4,1
ffffffffc02062fa:	008a8593          	addi	a1,s5,8
ffffffffc02062fe:	01074463          	blt	a4,a6,ffffffffc0206306 <vprintfmt+0x14a>
    else if (lflag) {
ffffffffc0206302:	1e080263          	beqz	a6,ffffffffc02064e6 <vprintfmt+0x32a>
        return va_arg(*ap, unsigned long);
ffffffffc0206306:	000ab603          	ld	a2,0(s5)
ffffffffc020630a:	46a1                	li	a3,8
ffffffffc020630c:	8aae                	mv	s5,a1
ffffffffc020630e:	a839                	j	ffffffffc020632c <vprintfmt+0x170>
            putch('0', putdat);
ffffffffc0206310:	03000513          	li	a0,48
ffffffffc0206314:	85a6                	mv	a1,s1
ffffffffc0206316:	e03e                	sd	a5,0(sp)
ffffffffc0206318:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc020631a:	85a6                	mv	a1,s1
ffffffffc020631c:	07800513          	li	a0,120
ffffffffc0206320:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0206322:	0aa1                	addi	s5,s5,8
ffffffffc0206324:	ff8ab603          	ld	a2,-8(s5)
            goto number;
ffffffffc0206328:	6782                	ld	a5,0(sp)
ffffffffc020632a:	46c1                	li	a3,16
            printnum(putch, putdat, num, base, width, padc);
ffffffffc020632c:	876e                	mv	a4,s11
ffffffffc020632e:	85a6                	mv	a1,s1
ffffffffc0206330:	854a                	mv	a0,s2
ffffffffc0206332:	e1fff0ef          	jal	ra,ffffffffc0206150 <printnum>
            break;
ffffffffc0206336:	b5c1                	j	ffffffffc02061f6 <vprintfmt+0x3a>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0206338:	000ab603          	ld	a2,0(s5)
ffffffffc020633c:	0aa1                	addi	s5,s5,8
ffffffffc020633e:	1c060663          	beqz	a2,ffffffffc020650a <vprintfmt+0x34e>
            if (width > 0 && padc != '-') {
ffffffffc0206342:	00160413          	addi	s0,a2,1
ffffffffc0206346:	17b05c63          	blez	s11,ffffffffc02064be <vprintfmt+0x302>
ffffffffc020634a:	02d00593          	li	a1,45
ffffffffc020634e:	14b79263          	bne	a5,a1,ffffffffc0206492 <vprintfmt+0x2d6>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206352:	00064783          	lbu	a5,0(a2)
ffffffffc0206356:	0007851b          	sext.w	a0,a5
ffffffffc020635a:	c905                	beqz	a0,ffffffffc020638a <vprintfmt+0x1ce>
ffffffffc020635c:	000cc563          	bltz	s9,ffffffffc0206366 <vprintfmt+0x1aa>
ffffffffc0206360:	3cfd                	addiw	s9,s9,-1
ffffffffc0206362:	036c8263          	beq	s9,s6,ffffffffc0206386 <vprintfmt+0x1ca>
                    putch('?', putdat);
ffffffffc0206366:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0206368:	18098463          	beqz	s3,ffffffffc02064f0 <vprintfmt+0x334>
ffffffffc020636c:	3781                	addiw	a5,a5,-32
ffffffffc020636e:	18fbf163          	bleu	a5,s7,ffffffffc02064f0 <vprintfmt+0x334>
                    putch('?', putdat);
ffffffffc0206372:	03f00513          	li	a0,63
ffffffffc0206376:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0206378:	0405                	addi	s0,s0,1
ffffffffc020637a:	fff44783          	lbu	a5,-1(s0)
ffffffffc020637e:	3dfd                	addiw	s11,s11,-1
ffffffffc0206380:	0007851b          	sext.w	a0,a5
ffffffffc0206384:	fd61                	bnez	a0,ffffffffc020635c <vprintfmt+0x1a0>
            for (; width > 0; width --) {
ffffffffc0206386:	e7b058e3          	blez	s11,ffffffffc02061f6 <vprintfmt+0x3a>
...
ffffffffc0206392:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0206394:	e60d81e3          	beqz	s11,ffffffffc02061f6 <vprintfmt+0x3a>
ffffffffc0206398:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc020639a:	85a6                	mv	a1,s1
ffffffffc020639c:	02000513          	li	a0,32
ffffffffc02063a0:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc02063a2:	fe0d94e3          	bnez	s11,ffffffffc020638a <vprintfmt+0x1ce>
ffffffffc02063a6:	bd81                	j	ffffffffc02061f6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc02063a8:	4705                	li	a4,1
ffffffffc02063aa:	008a8593          	addi	a1,s5,8
ffffffffc02063ae:	01074463          	blt	a4,a6,ffffffffc02063b6 <vprintfmt+0x1fa>
    else if (lflag) {
ffffffffc02063b2:	12080063          	beqz	a6,ffffffffc02064d2 <vprintfmt+0x316>
        return va_arg(*ap, unsigned long);
ffffffffc02063b6:	000ab603          	ld	a2,0(s5)
ffffffffc02063ba:	46a9                	li	a3,10
ffffffffc02063bc:	8aae                	mv	s5,a1
ffffffffc02063be:	b7bd                	j	ffffffffc020632c <vprintfmt+0x170>
ffffffffc02063c0:	00144603          	lbu	a2,1(s0)
            padc = '-';
ffffffffc02063c4:	02d00793          	li	a5,45
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02063c8:	846a                	mv	s0,s10
ffffffffc02063ca:	b5ad                	j	ffffffffc0206234 <vprintfmt+0x78>
            putch(ch, putdat);
ffffffffc02063cc:	85a6                	mv	a1,s1
ffffffffc02063ce:	02500513          	li	a0,37
ffffffffc02063d2:	9902                	jalr	s2
            break;
ffffffffc02063d4:	b50d                	j	ffffffffc02061f6 <vprintfmt+0x3a>
            precision = va_arg(ap, int);
ffffffffc02063d6:	000aac83          	lw	s9,0(s5)
            goto process_precision;
ffffffffc02063da:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc02063de:	0aa1                	addi	s5,s5,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02063e0:	846a                	mv	s0,s10
            if (width < 0)
ffffffffc02063e2:	e40dd9e3          	bgez	s11,ffffffffc0206234 <vprintfmt+0x78>
                width = precision, precision = -1;
ffffffffc02063e6:	8de6                	mv	s11,s9
ffffffffc02063e8:	5cfd                	li	s9,-1
ffffffffc02063ea:	b5a9                	j	ffffffffc0206234 <vprintfmt+0x78>
            goto reswitch;
ffffffffc02063ec:	00144603          	lbu	a2,1(s0)
            padc = '0';
ffffffffc02063f0:	03000793          	li	a5,48
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc02063f4:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc02063f6:	bd3d                	j	ffffffffc0206234 <vprintfmt+0x78>
                precision = precision * 10 + ch - '0';
ffffffffc02063f8:	fd060c9b          	addiw	s9,a2,-48
                ch = *fmt;
ffffffffc02063fc:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206400:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0206402:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0206406:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc020640a:	fcd56ce3          	bltu	a0,a3,ffffffffc02063e2 <vprintfmt+0x226>
            for (precision = 0; ; ++ fmt) {
ffffffffc020640e:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0206410:	002c969b          	slliw	a3,s9,0x2
                ch = *fmt;
ffffffffc0206414:	00044603          	lbu	a2,0(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0206418:	0196873b          	addw	a4,a3,s9
ffffffffc020641c:	0017171b          	slliw	a4,a4,0x1
ffffffffc0206420:	0117073b          	addw	a4,a4,a7
                if (ch < '0' || ch > '9') {
ffffffffc0206424:	fd06069b          	addiw	a3,a2,-48
                precision = precision * 10 + ch - '0';
ffffffffc0206428:	fd070c9b          	addiw	s9,a4,-48
                ch = *fmt;
ffffffffc020642c:	0006089b          	sext.w	a7,a2
                if (ch < '0' || ch > '9') {
ffffffffc0206430:	fcd57fe3          	bleu	a3,a0,ffffffffc020640e <vprintfmt+0x252>
ffffffffc0206434:	b77d                	j	ffffffffc02063e2 <vprintfmt+0x226>
            if (width < 0)
ffffffffc0206436:	fffdc693          	not	a3,s11
ffffffffc020643a:	96fd                	srai	a3,a3,0x3f
ffffffffc020643c:	00ddfdb3          	and	s11,s11,a3
ffffffffc0206440:	00144603          	lbu	a2,1(s0)
ffffffffc0206444:	2d81                	sext.w	s11,s11
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0206446:	846a                	mv	s0,s10
ffffffffc0206448:	b3f5                	j	ffffffffc0206234 <vprintfmt+0x78>
            putch('%', putdat);
ffffffffc020644a:	85a6                	mv	a1,s1
ffffffffc020644c:	02500513          	li	a0,37
ffffffffc0206450:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0206452:	fff44703          	lbu	a4,-1(s0)
ffffffffc0206456:	02500793          	li	a5,37
ffffffffc020645a:	8d22                	mv	s10,s0
ffffffffc020645c:	d8f70de3          	beq	a4,a5,ffffffffc02061f6 <vprintfmt+0x3a>
ffffffffc0206460:	02500713          	li	a4,37
ffffffffc0206464:	1d7d                	addi	s10,s10,-1
ffffffffc0206466:	fffd4783          	lbu	a5,-1(s10)
ffffffffc020646a:	fee79de3          	bne	a5,a4,ffffffffc0206464 <vprintfmt+0x2a8>
ffffffffc020646e:	b361                	j	ffffffffc02061f6 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0206470:	00003617          	auipc	a2,0x3
ffffffffc0206474:	86860613          	addi	a2,a2,-1944 # ffffffffc0208cd8 <error_string+0x1a8>
ffffffffc0206478:	85a6                	mv	a1,s1
ffffffffc020647a:	854a                	mv	a0,s2
ffffffffc020647c:	0ac000ef          	jal	ra,ffffffffc0206528 <printfmt>
ffffffffc0206480:	bb9d                	j	ffffffffc02061f6 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0206482:	00003617          	auipc	a2,0x3
ffffffffc0206486:	84e60613          	addi	a2,a2,-1970 # ffffffffc0208cd0 <error_string+0x1a0>
            if (width > 0 && padc != '-') {
ffffffffc020648a:	00003417          	auipc	s0,0x3
ffffffffc020648e:	84740413          	addi	s0,s0,-1977 # ffffffffc0208cd1 <error_string+0x1a1>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0206492:	8532                	mv	a0,a2
ffffffffc0206494:	85e6                	mv	a1,s9
ffffffffc0206496:	e032                	sd	a2,0(sp)
ffffffffc0206498:	e43e                	sd	a5,8(sp)
ffffffffc020649a:	0cc000ef          	jal	ra,ffffffffc0206566 <strnlen>
ffffffffc020649e:	40ad8dbb          	subw	s11,s11,a0
ffffffffc02064a2:	6602                	ld	a2,0(sp)
ffffffffc02064a4:	01b05d63          	blez	s11,ffffffffc02064be <vprintfmt+0x302>
ffffffffc02064a8:	67a2                	ld	a5,8(sp)
ffffffffc02064aa:	2781                	sext.w	a5,a5
ffffffffc02064ac:	e43e                	sd	a5,8(sp)
                    putch(padc, putdat);
ffffffffc02064ae:	6522                	ld	a0,8(sp)
ffffffffc02064b0:	85a6                	mv	a1,s1
ffffffffc02064b2:	e032                	sd	a2,0(sp)
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02064b4:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc02064b6:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc02064b8:	6602                	ld	a2,0(sp)
ffffffffc02064ba:	fe0d9ae3          	bnez	s11,ffffffffc02064ae <vprintfmt+0x2f2>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc02064be:	00064783          	lbu	a5,0(a2)
ffffffffc02064c2:	0007851b          	sext.w	a0,a5
ffffffffc02064c6:	e8051be3          	bnez	a0,ffffffffc020635c <vprintfmt+0x1a0>
ffffffffc02064ca:	b335                	j	ffffffffc02061f6 <vprintfmt+0x3a>
        return va_arg(*ap, int);
ffffffffc02064cc:	000aa403          	lw	s0,0(s5)
ffffffffc02064d0:	bbf1                	j	ffffffffc02062ac <vprintfmt+0xf0>
        return va_arg(*ap, unsigned int);
ffffffffc02064d2:	000ae603          	lwu	a2,0(s5)
ffffffffc02064d6:	46a9                	li	a3,10
ffffffffc02064d8:	8aae                	mv	s5,a1
ffffffffc02064da:	bd89                	j	ffffffffc020632c <vprintfmt+0x170>
ffffffffc02064dc:	000ae603          	lwu	a2,0(s5)
ffffffffc02064e0:	46c1                	li	a3,16
ffffffffc02064e2:	8aae                	mv	s5,a1
ffffffffc02064e4:	b5a1                	j	ffffffffc020632c <vprintfmt+0x170>
ffffffffc02064e6:	000ae603          	lwu	a2,0(s5)
ffffffffc02064ea:	46a1                	li	a3,8
ffffffffc02064ec:	8aae                	mv	s5,a1
ffffffffc02064ee:	bd3d                	j	ffffffffc020632c <vprintfmt+0x170>
                    putch(ch, putdat);
ffffffffc02064f0:	9902                	jalr	s2
ffffffffc02064f2:	b559                	j	ffffffffc0206378 <vprintfmt+0x1bc>
                putch('-', putdat);
ffffffffc02064f4:	85a6                	mv	a1,s1
ffffffffc02064f6:	02d00513          	li	a0,45
ffffffffc02064fa:	e03e                	sd	a5,0(sp)
ffffffffc02064fc:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc02064fe:	8ace                	mv	s5,s3
ffffffffc0206500:	40800633          	neg	a2,s0
ffffffffc0206504:	46a9                	li	a3,10
ffffffffc0206506:	6782                	ld	a5,0(sp)
ffffffffc0206508:	b515                	j	ffffffffc020632c <vprintfmt+0x170>
            if (width > 0 && padc != '-') {
ffffffffc020650a:	01b05663          	blez	s11,ffffffffc0206516 <vprintfmt+0x35a>
ffffffffc020650e:	02d00693          	li	a3,45
ffffffffc0206512:	f6d798e3          	bne	a5,a3,ffffffffc0206482 <vprintfmt+0x2c6>
ffffffffc0206516:	00002417          	auipc	s0,0x2
ffffffffc020651a:	7bb40413          	addi	s0,s0,1979 # ffffffffc0208cd1 <error_string+0x1a1>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc020651e:	02800513          	li	a0,40
ffffffffc0206522:	02800793          	li	a5,40
ffffffffc0206526:	bd1d                	j	ffffffffc020635c <vprintfmt+0x1a0>

ffffffffc0206528 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206528:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc020652a:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc020652e:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0206530:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0206532:	ec06                	sd	ra,24(sp)
ffffffffc0206534:	f83a                	sd	a4,48(sp)
ffffffffc0206536:	fc3e                	sd	a5,56(sp)
ffffffffc0206538:	e0c2                	sd	a6,64(sp)
ffffffffc020653a:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc020653c:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc020653e:	c7fff0ef          	jal	ra,ffffffffc02061bc <vprintfmt>
}
ffffffffc0206542:	60e2                	ld	ra,24(sp)
ffffffffc0206544:	6161                	addi	sp,sp,80
ffffffffc0206546:	8082                	ret

ffffffffc0206548 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0206548:	00054783          	lbu	a5,0(a0)
ffffffffc020654c:	cb91                	beqz	a5,ffffffffc0206560 <strlen+0x18>
    size_t cnt = 0;
ffffffffc020654e:	4781                	li	a5,0
        cnt ++;
ffffffffc0206550:	0785                	addi	a5,a5,1
    while (*s ++ != '\0') {
ffffffffc0206552:	00f50733          	add	a4,a0,a5
ffffffffc0206556:	00074703          	lbu	a4,0(a4)
ffffffffc020655a:	fb7d                	bnez	a4,ffffffffc0206550 <strlen+0x8>
    }
    return cnt;
}
...
ffffffffc020655e:	8082                	ret
    size_t cnt = 0;
ffffffffc0206560:	4781                	li	a5,0
}
ffffffffc0206562:	853e                	mv	a0,a5
ffffffffc0206564:	8082                	ret

ffffffffc0206566 <strnlen>:
 * pointed by @s.
 * */
size_t
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206566:	c185                	beqz	a1,ffffffffc0206586 <strnlen+0x20>
ffffffffc0206568:	00054783          	lbu	a5,0(a0)
ffffffffc020656c:	cf89                	beqz	a5,ffffffffc0206586 <strnlen+0x20>
    size_t cnt = 0;
ffffffffc020656e:	4781                	li	a5,0
ffffffffc0206570:	a021                	j	ffffffffc0206578 <strnlen+0x12>
    while (cnt < len && *s ++ != '\0') {
ffffffffc0206572:	00074703          	lbu	a4,0(a4)
ffffffffc0206576:	c711                	beqz	a4,ffffffffc0206582 <strnlen+0x1c>
        cnt ++;
ffffffffc0206578:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc020657a:	00f50733          	add	a4,a0,a5
ffffffffc020657e:	fef59ae3          	bne	a1,a5,ffffffffc0206572 <strnlen+0xc>
    }
    return cnt;
}
...
#else
    char *p = dst;
ffffffffc020658c:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc020658e:	0585                	addi	a1,a1,1
ffffffffc0206590:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0206594:	0785                	addi	a5,a5,1
ffffffffc0206596:	fee78fa3          	sb	a4,-1(a5)
ffffffffc020659a:	fb75                	bnez	a4,ffffffffc020658e <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc02065a2:	0005c703          	lbu	a4,0(a1)
ffffffffc02065a6:	cb91                	beqz	a5,ffffffffc02065ba <strcmp+0x1c>
ffffffffc02065a8:	00e79c63          	bne	a5,a4,ffffffffc02065c0 <strcmp+0x22>
        s1 ++, s2 ++;
...
ffffffffc02065b4:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc02065b8:	fbe5                	bnez	a5,ffffffffc02065a8 <strcmp+0xa>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc02065ba:	4501                	li	a0,0
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc02065bc:	9d19                	subw	a0,a0,a4
ffffffffc02065be:	8082                	ret
ffffffffc02065c0:	0007851b          	sext.w	a0,a5
ffffffffc02065c4:	9d19                	subw	a0,a0,a4
ffffffffc02065c6:	8082                	ret

ffffffffc02065c8 <strchr>:
...
ffffffffc02065cc:	cb91                	beqz	a5,ffffffffc02065e0 <strchr+0x18>
        if (*s == c) {
ffffffffc02065ce:	00b79563          	bne	a5,a1,ffffffffc02065d8 <strchr+0x10>
ffffffffc02065d2:	a809                	j	ffffffffc02065e4 <strchr+0x1c>
ffffffffc02065d4:	00b78763          	beq	a5,a1,ffffffffc02065e2 <strchr+0x1a>
            return (char *)s;
        }
        s ++;
ffffffffc02065d8:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc02065da:	00054783          	lbu	a5,0(a0)
ffffffffc02065de:	fbfd                	bnez	a5,ffffffffc02065d4 <strchr+0xc>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc02065e6:	ca01                	beqz	a2,ffffffffc02065f6 <memset+0x10>
ffffffffc02065e8:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc02065ea:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc02065ec:	0785                	addi	a5,a5,1
ffffffffc02065ee:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc02065f2:	fec79de3          	bne	a5,a2,ffffffffc02065ec <memset+0x6>
    }
    return s;
...
ffffffffc02065f8 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc02065f8:	ca19                	beqz	a2,ffffffffc020660e <memcpy+0x16>
ffffffffc02065fa:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc02065fc:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc02065fe:	0585                	addi	a1,a1,1
ffffffffc0206600:	fff5c703          	lbu	a4,-1(a1)
ffffffffc0206604:	0785                	addi	a5,a5,1
ffffffffc0206606:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc020660a:	fec59ae3          	bne	a1,a2,ffffffffc02065fe <memcpy+0x6>
    }
    return dst;
